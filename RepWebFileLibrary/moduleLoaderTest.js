...
(function() {
  ...
  const FILE_NAME = 'moduleLoaderTest.js';
  ...
  async function loadManifest(basePath) {
    const possibleManifestPaths = [
      `${basePath}/expenses-mfe-test/mfe-manifest.json`,
      `${basePath}/mfe-manifest.json`,
      `${window.location.origin}/expenses-mfe-test/mfe-manifest.json`,
  ...
  async function loadMFE() {
    try {
      ...
      const getAssetUrl = (filename) => {
        const possiblePaths = [
          `${basePath}/expenses-mfe-test/assets/${filename}`,
          `${basePath}/assets/${filename}`,
          `/expenses-mfe-test/assets/${filename}`,
          `/assets/${filename}`,
          `${window.location.origin}/expenses-mfe-test/assets/${filename}`,
