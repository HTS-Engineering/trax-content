...
var _a, _b, _c, _d;
import { D as DiagAPI, r as registerGlobal, g as getGlobal, u as unregisterGlobal, c as createContextKey, b as baggageEntryMetadataFromString, p as propagation, t as trace, i as isSpanContextValid, T as TraceFlags, a as context, S as SeverityNumber, d as createNoopLogger, e as SpanStatusCode, I as INVALID_SPAN_CONTEXT, f as isValidTraceId, R as ROOT_CONTEXT, l as logs, h as getState, j as installErrorCapture, k as activateErrorCapture, m as releaseOtelGlobals, n as DEFAULT_SANITIZER_CONFIG, o as extractPathname, q as toText, s as templatePath } from "./__federation_expose_Mount-CVRhHaHK.js";
...
function validateUserProvidedUrl(url) {
  ...
  try {
    const base = (_a2 = globalThis.location) == null ? void 0 : _a2.href;
...
function formatInspect(className, payload, depth, options, inspect) {
  if (typeof depth === "number" && depth < 0) {
    const tag = `[${className}]`;
    return (options == null ? void 0 : options.stylize) ? options.stylize(tag, "special") : tag;
  }
...
const _SpanImpl = class _SpanImpl {
  ...
  updateName(name) {
    ...
    (_a2 = this._recordEndMetrics) == null ? void 0 : _a2.call(this);
    this._ended = true;
...
const _Tracer = class _Tracer {
  ...
  constructor(instrumentationScope, options) {
    ...
    const meter = options.meterProvider.getMeter("@opentelemetry/sdk-trace", VERSION$2);
...
const _SpanProcessorMetrics = class _SpanProcessorMetrics {
  processedSpans;
  queueSize;
  queueSizeCallback;
  standardAttrs;
...
__name(_SpanProcessorMetrics, "SpanProcessorMetrics");
let SpanProcessorMetrics = _SpanProcessorMetrics;
...
let BatchSpanProcessor$1 = (_a = class extends BatchSpanProcessorBase {
  _visibilityChangeListener;
  _pageHideListener;
  constructor(options) {
    super(options);
...
}, __name(_a, "BatchSpanProcessor"), _a);
...
const _TracerProvider = class _TracerProvider {
  _resource;
  ...
  getTracer(name, version, options) {
    ...
    if (!this._tracers.has(key)) {
      this._tracers.set(key, new Tracer({ name, version, schemaUrl: options == null ? void 0 : options.schemaUrl }, this._tracerOptions));
    }
  ...
  [inspectCustom](depth, options, inspect) {
    ...
    const payload = {
      ...
      spanProcessors: processors.map((p) => {
        var _a2;
        return ((_a2 = p.constructor) == null ? void 0 : _a2.name) ?? "SpanProcessor";
      })
    };
    return formatInspect("TracerProvider", payload, depth, options, inspect);
  }
};
__name(_TracerProvider, "TracerProvider");
let TracerProvider = _TracerProvider;
let SimpleSpanProcessor$1 = (_b = class {
  _exporter;
  _metrics;
  _shutdownOnce;
  _pendingExports;
  ...
  async _doExport(span) {
    ...
    if (span.resource.asyncAttributesPending) {
      await ((_b2 = (_a2 = span.resource).waitForAsyncAttributes) == null ? void 0 : _b2.call(_a2));
    }
...
}, __name(_b, "SimpleSpanProcessor"), _b);
...
const _BasicTracerProvider = class _BasicTracerProvider extends TracerProvider {
  constructor(config = {}) {
...
const _BatchSpanProcessor = class _BatchSpanProcessor extends BatchSpanProcessor$1 {
...
const _SimpleSpanProcessor = class _SimpleSpanProcessor extends SimpleSpanProcessor$1 {
