...
import { h as create, i as devtools, s as subscribeWithSelector, j as immer, as as endpoint, at as collectEndpointTemplates, af as BUSINESS_PURPOSE_ENDPOINTS, C as CONFIGURATION_ENDPOINTS, q as h, U as Ue, R as RefreshCw, k as devWarn } from "./configuration-Cg_hJZZz.js";
...
var DataRouterContext = React$6.createContext(null);
DataRouterContext.displayName = "DataRouter";
var DataRouterStateContext = React$6.createContext(null);
DataRouterStateContext.displayName = "DataRouterState";
var RSCRouterContext = React$6.createContext(false);
function useIsRSCRouterContext() {
  return React$6.useContext(RSCRouterContext);
}
__name(useIsRSCRouterContext, "useIsRSCRouterContext");
var ViewTransitionContext = React$6.createContext({
  isTransitioning: false
});
ViewTransitionContext.displayName = "ViewTransition";
var FetchersContext = React$6.createContext(
  /* @__PURE__ */ new Map()
);
FetchersContext.displayName = "Fetchers";
var AwaitContext = React$6.createContext(null);
AwaitContext.displayName = "Await";
var NavigationContext = React$6.createContext(
  null
);
NavigationContext.displayName = "Navigation";
var LocationContext = React$6.createContext(
  null
);
LocationContext.displayName = "Location";
var RouteContext = React$6.createContext({
  outlet: null,
  matches: [],
  isDataRoute: false
});
RouteContext.displayName = "Route";
var RouteErrorContext = React$6.createContext(null);
...
var RoutePaths = /* @__PURE__ */ ((RoutePaths2) => {
  ...
  RoutePaths2["ExpensesDefault"] = "/expenses?sortBy=expenseDate&sortOrder=desc";
  RoutePaths2["ExpensesNew"] = "/expenses/new";
  RoutePaths2["ExpensesId"] = "/expenses/:id";
  RoutePaths2["Approvals"] = "/approvals";
  RoutePaths2["ApprovalsId"] = "/approvals/:id";
  ...
  RoutePaths2["ExpenseType"] = `/configurations/expense-type`;
  RoutePaths2["MileageType"] = `/configurations/mileage-type`;
...
var RouteNames = /* @__PURE__ */ ((RouteNames2) => {
  ...
  RouteNames2["ExpenseType"] = "Expense Type";
...
const useCompanyStore = create()(
  devtools(
    subscribeWithSelector(
      immer((set) => ({
        ...initialState,
        setAdminCompany: /* @__PURE__ */ __name((company) => set((state) => {
          state.adminCompany = company;
        }), "setAdminCompany"),
        setUserDefaultCompany: /* @__PURE__ */ __name((company) => set((state) => {
...
function extractError(error) {
  ...
  if (typeof detail === "string" && detail.trim()) {
    return { messages: [detail.trim()], fieldErrors: [], source: "business" };
  }
  if (Array.isArray(detail)) return extractFromArray(detail);
  if (typeof body.message === "string" && body.message.trim()) {
    return { messages: [body.message.trim()], fieldErrors: [], source: "business" };
  }
  return EMPTY;
}
...
const ERROR_MESSAGES = {
  ...
  /** A submitted preview whose backend response is missing its field values. */
  PREVIEW_FAILED_TO_LOAD: "Failed to load"
};
const RULES = {
  ...
  // "Expense form not found" and friends are written for the user and say more than we could.
...
function interpretError(error, options = {}) {
  ...
  if (isAppError(error)) {
    const message2 = ((_a2 = options.copy) == null ? void 0 : _a2.override) ?? error.message;
    return {
      kind,
      status,
      message: message2,
  ...
  const override = ((_b2 = options.copy) == null ? void 0 : _b2.override) ?? getCopyOverride(kind, context);
  let message;
  let details;
  if (override) {
    message = override;
    ...
    message = ((_c2 = options.copy) == null ? void 0 : _c2.fallback) ?? getContextFallback(context);
    details = [];
  }
  return {
    kind,
...
function claimQueryErrors(queryHash, claim = {}) {
  const entry = claims.get(queryHash) ?? { live: [], everClaimed: false };
  entry.live.push(claim);
  entry.everClaimed = true;
  ...
  return () => {
    ...
    if (at !== -1) current.live.splice(at, 1);
  };
}
...
function getDisplacedClaimFallback(queryHash) {
  var _a2, _b2;
  return (_b2 = (_a2 = claims.get(queryHash)) == null ? void 0 : _a2.live.find((c) => c.fallback)) == null ? void 0 : _b2.fallback;
}
__name(getDisplacedClaimFallback, "getDisplacedClaimFallback");
function forgetQueryClaims(queryHash) {
  claims.delete(queryHash);
}
__name(forgetQueryClaims, "forgetQueryClaims");
var Subscribable = (_f = class {
  constructor() {
...
}, _focused = new WeakMap(), _cleanup = new WeakMap(), _setup = new WeakMap(), __name(_g, "FocusManager"), _g);
...
}, _provider = new WeakMap(), _providerCalled = new WeakMap(), __name(_h, "TimeoutManager"), _h);
...
}, _online = new WeakMap(), _cleanup2 = new WeakMap(), _setup2 = new WeakMap(), __name(_i, "OnlineManager"), _i);
...
var CancelledError = (_j = class extends Error {
  constructor(options) {
    super("CancelledError");
    this.revert = options == null ? void 0 : options.revert;
    this.silent = options == null ? void 0 : options.silent;
  }
}, __name(_j, "CancelledError"), _j);
...
}, _gcTimeout = new WeakMap(), __name(_k, "Removable"), _k);
...
var Query = (_l = class extends Removable {
  constructor(config) {
    super();
...
var QueryObserver = (_m = class extends Subscribable {
...
}, "#notify"), __name(_m, "QueryObserver"), _m);
...
var Mutation = (_n = class extends Removable {
  constructor(config) {
    super();
...
}, "#dispatch"), __name(_n, "Mutation"), _n);
...
var MutationObserver$1 = (_o = class extends Subscribable {
  constructor(client, options) {
    super();
...
}, _client4 = new WeakMap(), _currentResult2 = new WeakMap(), _currentMutation = new WeakMap(), _mutateOptions = new WeakMap(), _MutationObserver_instances = new WeakSet(), updateResult_fn = /* @__PURE__ */ __name(function() {
  var _a2;
...
var useIsRestoring = /* @__PURE__ */ __name(() => React$4.useContext(IsRestoringContext), "useIsRestoring");
...
var useQueryErrorResetBoundary = /* @__PURE__ */ __name(() => React$3.useContext(QueryErrorResetBoundaryContext), "useQueryErrorResetBoundary");
...
function useAppQuery(options) {
  ...
  return { ...result, queryHash: hashKey(options.queryKey) };
}
__name(useAppQuery, "useAppQuery");
const { useEffect: useEffect$4, useMemo } = await importShared("react");
function useErrorSurface(query, options = {}) {
  const { fallback, canRenderInPlace = true } = options;
  const { queryHash, isError, error, isFetching, refetch } = query;
  useEffect$4(
    () => claimQueryErrors(queryHash, { canRenderInPlace, fallback }),
    [queryHash, canRenderInPlace, fallback]
  );
  const presentation = useMemo(
    () => isError ? interpretError(error, { context: "load", copy: { fallback } }) : null,
    [isError, error, fallback]
  );
  const retry = useMemo(() => () => void refetch(), [refetch]);
  return { hasFailed: isError && !isFetching, presentation, retry, isRetrying: isFetching };
}
__name(useErrorSurface, "useErrorSurface");
const EXPENSE_ENDPOINTS = {
  SAVE_DRAFT: endpoint("/api/v1.0/expense-forms/:tenant/drafts"),
  GET_DRAFT: endpoint("/api/v1.0/expense-forms/:tenant/drafts/:id"),
  UPDATE_DRAFT: endpoint("/api/v1.0/expense-forms/:tenant/drafts/:id"),
  DELETE_DRAFT: endpoint("/api/v1.0/expense-forms/:tenant/drafts/:id"),
  SUBMIT_DRAFT: endpoint("/api/v1.0/expense-forms/:tenant/drafts/:id/submit"),
  GET_EXPENSES: endpoint("/api/v1.0/expense-forms/:tenant"),
  GET_EXPENSES_LIST: endpoint("/api/v1.0/expenses-list"),
  GET_EXPENSE_FORM: endpoint("/api/v1.0/expense-forms/:tenant/:id"),
  GET_PAYMENT_METHODS: endpoint("/api/v1.0/expense-forms/:tenant/payment-methods"),
  GET_APPROVALS: endpoint("/api/v1.0/approvals/:tenant"),
  GET_APPROVAL_HISTORY: endpoint("/api/v1.0/approvals/:tenant/:expenseFormId/approval-history"),
  MANAGER_DECISION: endpoint("/api/v1.0/approvals/:tenant/:expenseFormId/manager-decision"),
  CANCEL_EXPENSE: endpoint("/api/v1.0/approvals/:tenant/:expenseFormId/cancel"),
  SAVE_COST_ALLOCATION: endpoint("/api/v1.0/expense-forms/cost-allocation/:expenseFormId"),
  COST_ALLOCATION_SALES_REP: endpoint("/api/v1.0/expense-forms/cost-allocation/sales-rep"),
  COST_ALLOCATION_SALES_TEAMS: endpoint("/api/v1.0/expense-forms/cost-allocation/sales-teams"),
  COST_ALLOCATION_PROJECT: endpoint("/api/v1.0/expense-forms/cost-allocation/project/:poId"),
  COST_ALLOCATION_ADMIN: endpoint("/api/v1.0/expense-forms/cost-allocation/admin/:poId")
};
const FILE_ENDPOINTS = {
  UPLOAD: endpoint("/api/v1.0/expense-forms/:tenant/files/drafts/:expenseId/files"),
  DOWNLOAD: endpoint("/api/v1.0/files/:fileId"),
...
const RECONCILIATION_ENDPOINTS = {
  ...
  BANK_STATEMENT_RELEASE: endpoint(
    "/api/v1.0/reconciliation/bank-statements/:statementId/release"
  ),
  BANK_STATEMENT_CANCEL: endpoint(
    "/api/v1.0/reconciliation/bank-statements/:statementId/cancel"
  ),
...
var QueryKeyScope = /* @__PURE__ */ ((QueryKeyScope2) => {
  ...
  QueryKeyScope2["MASTER_ACCOUNTS"] = "masterAccounts";
  QueryKeyScope2["CARDHOLDERS"] = "cardholders";
  QueryKeyScope2["CARDHOLDER_EMPLOYEES"] = "cardholderEmployees";
...
const queryKeys = {
  companies: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.COMPANIES], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.COMPANIES, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name(() => [...queryKeys.companies.lists()], "list"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.COMPANIES, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((id) => [...queryKeys.companies.details(), id], "detail")
  },
  businessPurposes: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.BUSINESS_PURPOSES], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.BUSINESS_PURPOSES, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name((companyShortName, includeInactive) => [...queryKeys.businessPurposes.lists(), { companyShortName, includeInactive }], "list"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.BUSINESS_PURPOSES, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((id) => [...queryKeys.businessPurposes.details(), id], "detail")
  },
  expenseTypes: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSE_TYPES], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSE_TYPES, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name((companyShortName, includeInactive) => [...queryKeys.expenseTypes.lists(), { companyShortName, includeInactive }], "list"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSE_TYPES, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((id) => [...queryKeys.expenseTypes.details(), id], "detail")
  },
  formTypes: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.FORM_TYPES], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.FORM_TYPES, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name(() => [...queryKeys.formTypes.lists()], "list"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.FORM_TYPES, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((id) => [...queryKeys.formTypes.details(), id], "detail")
  },
  mileageRates: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.MILEAGE_RATES], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.MILEAGE_RATES, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name(() => [...queryKeys.mileageRates.lists()], "list"),
    byMileageRateId: /* @__PURE__ */ __name((companyShortName, mileageRateId) => [...queryKeys.mileageRates.lists(), { companyShortName, mileageRateId }], "byMileageRateId"),
    effectiveByIdOnDate: /* @__PURE__ */ __name((companyShortName, mileageRateId, date) => [
      ...queryKeys.mileageRates.lists(),
      { companyShortName, mileageRateId, date, kind: "effective" }
    ], "effectiveByIdOnDate"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.MILEAGE_RATES, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((id) => [...queryKeys.mileageRates.details(), id], "detail")
  },
  taxTypes: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.TAX_TYPES], "all"),
    list: /* @__PURE__ */ __name((companyShortName) => [QueryKeyScope.TAX_TYPES, QueryKeyOperation.LIST, { companyShortName }], "list")
  },
  unitOfMeasurements: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.UNIT_OF_MEASUREMENTS], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.UNIT_OF_MEASUREMENTS, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name((showInactive) => [...queryKeys.unitOfMeasurements.lists(), { showInactive }], "list")
  },
  expenses: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSES], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSES, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name(() => [...queryKeys.expenses.lists()], "list"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSES, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((id) => [...queryKeys.expenses.details(), id], "detail")
  },
  expenseDrafts: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSE_DRAFTS], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSE_DRAFTS, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name(() => [...queryKeys.expenseDrafts.lists()], "list"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSE_DRAFTS, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((id) => [...queryKeys.expenseDrafts.details(), id], "detail")
  },
  mileageTrips: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.MILEAGE_TRIPS], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.MILEAGE_TRIPS, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name(() => [...queryKeys.mileageTrips.lists()], "list"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.MILEAGE_TRIPS, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((id) => [...queryKeys.mileageTrips.details(), id], "detail")
  },
  mileagePeriods: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.MILEAGE_PERIODS], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.MILEAGE_PERIODS, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name(() => [...queryKeys.mileagePeriods.lists()], "list"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.MILEAGE_PERIODS, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((id) => [...queryKeys.mileagePeriods.details(), id], "detail")
  },
  mileageDrafts: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.MILEAGE_DRAFTS], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.MILEAGE_DRAFTS, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name(() => [...queryKeys.mileageDrafts.lists()], "list"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.MILEAGE_DRAFTS, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((id) => [...queryKeys.mileageDrafts.details(), id], "detail")
  },
  expenseItem: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSE_ITEM], "all"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSE_ITEM, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((id) => [...queryKeys.expenseItem.details(), id], "detail")
  },
  expensesList: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSES_LIST], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSES_LIST, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name((params) => [...queryKeys.expensesList.lists(), params], "list")
  },
  expenseTypeUsers: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSE_TYPE_USERS], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSE_TYPE_USERS, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name((companyShortName, expenseTypeId) => [...queryKeys.expenseTypeUsers.lists(), { companyShortName, expenseTypeId }], "list")
  },
  currencies: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.CURRENCIES], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.CURRENCIES, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name(() => [...queryKeys.currencies.lists()], "list")
  },
  countries: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.COUNTRIES], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.COUNTRIES, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name(() => [...queryKeys.countries.lists()], "list")
  },
  paymentMethods: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.PAYMENT_METHODS], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.PAYMENT_METHODS, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name((companyShortName) => [...queryKeys.paymentMethods.lists(), { companyShortName }], "list")
  },
  expenseHistory: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSE_HISTORY], "all"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.EXPENSE_HISTORY, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((companyShortName, expenseFormId) => [...queryKeys.expenseHistory.details(), { companyShortName, expenseFormId }], "detail")
  },
  approvalsList: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.APPROVALS_LIST], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.APPROVALS_LIST, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name((params) => [...queryKeys.approvalsList.lists(), params], "list")
  },
  masterAccounts: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.MASTER_ACCOUNTS], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.MASTER_ACCOUNTS, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name((companyShortName) => [...queryKeys.masterAccounts.lists(), { companyShortName }], "list"),
    details: /* @__PURE__ */ __name(() => [QueryKeyScope.MASTER_ACCOUNTS, QueryKeyOperation.DETAIL], "details"),
    detail: /* @__PURE__ */ __name((id) => [...queryKeys.masterAccounts.details(), id], "detail")
  },
  cardholders: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.CARDHOLDERS], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.CARDHOLDERS, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name((companyShortName, masterAccountId) => [...queryKeys.cardholders.lists(), { companyShortName, masterAccountId }], "list")
  },
  cardholderEmployees: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.CARDHOLDER_EMPLOYEES], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.CARDHOLDER_EMPLOYEES, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name((companyShortName, masterAccountId, search) => [...queryKeys.cardholderEmployees.lists(), { companyShortName, masterAccountId, search }], "list")
  },
  authorizedUsers: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.AUTHORIZED_USERS], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.AUTHORIZED_USERS, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name((companyShortName, paymentMethodId, search, cursor) => [
      ...queryKeys.authorizedUsers.lists(),
      { companyShortName, paymentMethodId, search, cursor: cursor ?? null }
    ], "list")
  },
  reconciliations: {
    all: /* @__PURE__ */ __name(() => [QueryKeyScope.RECONCILIATIONS], "all"),
    lists: /* @__PURE__ */ __name(() => [QueryKeyScope.RECONCILIATIONS, QueryKeyOperation.LIST], "lists"),
    list: /* @__PURE__ */ __name((masterAccountId) => [...queryKeys.reconciliations.lists(), { masterAccountId }], "list")
  },
  bankStatements: {
  ...
  cardholderTransactions: {
    ...
    /** Prefix over every row's matchable-expenses pool, without the transaction list. */
    matchableExpensesAll: /* @__PURE__ */ __name(() => [...queryKeys.cardholderTransactions.all(), "matchable-expenses"], "matchableExpensesAll"),
    matchableExpenses: /* @__PURE__ */ __name((transactionId) => [...queryKeys.cardholderTransactions.matchableExpensesAll(), transactionId], "matchableExpenses")
  }
};
    ...
    EmptyState,
    {
      ...
      action: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ue,
        {
          ...
          children: surface.isRetrying ? "Retrying..." : "Retry"
        }
      )
    }
  );
}, "DataLoadError");
const { useCallback: useCallback$4, useEffect: useEffect$3, useRef: useRef$1 } = await importShared("react");
function useDebouncedCallback(callback, delay) {
  const callbackRef = useRef$1(callback);
  const debouncedRef = useRef$1(void 0);
  useEffect$3(() => {
...
const useNavigateBack = /* @__PURE__ */ __name((options = {}) => {
  const {
...
const useNavigateWithReturn = /* @__PURE__ */ __name(() => {
  const navigate = useNavigate();
  const location = useLocation();
  return useCallback$2(
    (to, options) => {
      const returnUrl = `${location.pathname}${location.search}`;
      const state = { ...(options == null ? void 0 : options.state) ?? {}, returnUrl };
...
const useNumericDisplay = /* @__PURE__ */ __name((formValue, options = {}) => {
...
export {
  ...
  DataLoadError as D,
  EmptyState as E,
  formatToISODate as F,
  parseDateOnlyAsLocal as G,
  DEFAULT_CURRENCY_SYMBOL as H,
  formatRateCompact as I,
  hashKey as J,
  RECONCILIATION_ENDPOINTS as K,
  EMPTY_CURRENCY_SYMBOL as L,
  formatExpensePeriod as M,
  NavLink as N,
  Outlet as O,
  formatRate as P,
  ...
  formatDistance as V,
  formatHistoryTimestamp as W,
  DEFAULT_CURRENCY_CODE as X,
  isHttpApiError as Y,
  AppError as Z,
  isNotFoundError as _,
  RoutePaths as a,
  useDebouncedCallback as a0,
  useNumericDisplay as a1,
  getCurrencySymbol as a2,
  interpretError as a3,
  getQueryClaimState as a4,
  getDisplacedClaimFallback as a5,
  forgetQueryClaims as a6,
  classifyError as a7,
  Subscribable as a8,
  Mutation as a9,
  toErrorText as aA,
  ...
  matchMutation as ab,
  noop as ac,
  hashQueryKeyByOptions as ad,
  Query as ae,
  matchQuery as af,
  focusManager as ag,
  onlineManager as ah,
  resolveStaleTime as ai,
  functionalUpdate as aj,
  partialMatchKey as ak,
  skipToken as al,
  QueryObserver as am,
  hasPreviousPage as an,
  hasNextPage as ao,
  useBaseQuery as ap,
  shallowEqualObjects as aq,
  replaceEqualDeep as ar,
  useIsRestoring as as,
  useQueryErrorResetBoundary as at,
  ensureSuspenseTimers as au,
  ensurePreventErrorBoundaryRetry as av,
  useClearResetErrorBoundary as aw,
  shouldSuspend as ax,
  fetchOptimistic as ay,
  getHasError as az,
  RouteNames as b,
  useNavigate as c,
  useCompanyStore as d,
  usePreventPageReload as e,
  createHashRouter as f,
  Navigate as g,
  useErrorSurface as h,
  useQueryClient as i,
  useMutation as j,
  EXPENSE_ENDPOINTS as k,
  useScrollIntoViewRef as l,
  formatDate as m,
  useParams as n,
  ERROR_MESSAGES as o,
  formatAmountWithCurrency as p,
  queryKeys as q,
  formatDateRange as r,
  formatExpenseDate as s,
  useAppQuery as t,
  useLocation as u,
  keepPreviousData as v,
  useSearchParams as w,
  generatePath as x,
  useNavigateBack as y,
  useNavigateWithReturn as z
};
