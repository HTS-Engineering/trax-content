...
let moduleMap = {
  "./mount": /* @__PURE__ */ __name(() => {
    dynamicLoadingCss(["style-D9T_ULYD.css"], false, "./mount");
    return __federation_import("./assets/__federation_expose_Mount-D59B2wJk.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
  }, "./mount")
};
const seen = {};
