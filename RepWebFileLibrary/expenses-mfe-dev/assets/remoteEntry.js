...
let moduleMap = {
  "./mount": /* @__PURE__ */ __name(() => {
    dynamicLoadingCss(["style-Clj0Wo0g.css"], false, "./mount");
    return __federation_import("./assets/__federation_expose_Mount-rs_QLbLj.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
  }, "./mount")
};
const seen = {};
