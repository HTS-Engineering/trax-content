...
let moduleMap = {
  "./mount": () => {
    ...
    return __federation_import("./assets/__federation_expose_Mount-DHmT6D_S.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
  }
};
const seen = {};
