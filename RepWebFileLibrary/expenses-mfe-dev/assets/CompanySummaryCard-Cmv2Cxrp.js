...
import { c as createLucideIcon, b as apiClient, d as devError, f as Us, U as Ue, B as Bn, e as Tr, ai as wn, aj as Do, ak as Pt, al as Mo, am as Eo, an as yn, j as Js, Z as Za, a7 as ti, Q as Qa, k as es, W as Ws, E as Ea, l as Zs, o as ns, t as p } from "./axiosInstance-VUb0TNQ5.js";
import { e as useCompanyStore, j as useQuery, k as keepPreviousData, q as queryKeys, i as formatExpenseDate, v as formatExpensePeriod, t as parseDateOnlyAsLocal, n as useMutation, m as useQueryClient, B as getCurrencySymbol, l as useSearchParams, d as useLocation, a as RoutePaths, x as useNavigateWithReturn, p as useErrorToast, g as generatePath, E as EMPTY_CURRENCY_SYMBOL } from "./date-format-D7sJ1E1F.js";
import { I as Icon } from "./Icon-CjLzMHV-.js";
import { d as formatCurrency, f as formatAmountWithCurrency } from "./formatters-CEjYghxs.js";
...
const RECONCILIATION_ENDPOINTS = {
  ...
  CSV_UPLOAD: /* @__PURE__ */ __name((masterAccountId) => `/api/v1.0/reconciliation/${encodeURIComponent(masterAccountId)}/csv-upload`, "CSV_UPLOAD"),
  // Get bank statements
  ...
  BANK_STATEMENT_RELEASE: /* @__PURE__ */ __name((statementId) => `/api/v1.0/reconciliation/bank-statements/${encodeURIComponent(statementId)}/release`, "BANK_STATEMENT_RELEASE"),
  // Cancel (delete) a staged bank statement upload (abandons the temp data).
  BANK_STATEMENT_CANCEL: /* @__PURE__ */ __name((statementId) => `/api/v1.0/reconciliation/bank-statements/${encodeURIComponent(statementId)}/cancel`, "BANK_STATEMENT_CANCEL"),
  // Aggregated transaction totals per logical company for a given statement.
  GET_COMPANY_TRANSACTIONS_AGGREGATION: /* @__PURE__ */ __name((statementId) => `/api/v1.0/reconciliation/${encodeURIComponent(statementId)}/transactions-company`, "GET_COMPANY_TRANSACTIONS_AGGREGATION")
};
