...
import { c as create, d as devtools, a as apiClient } from "./axiosInstance-Dp1zAOAB.js";
import { b as useQueryClient, a as useCompanyStore, q as queryKeys, E as EXPENSE_ENDPOINTS, c as useQuery, f as useDefaultCompany } from "./company-api-5u1TcqPp.js";
import { a as DEFAULT_CURRENCY, D as DEFAULT_CURRENCY_CODE, g as getCurrencyLocale } from "./currency-BubACaL0.js";
import { u as useForm, a, h as useWatch, s as string, D as DECIMAL_FORMAT_REGEX, o as object, j as boolean, k as custom, m as array, g as date, p as unknown, n as number, l as literal, C as Controller, c as createDecimalChangeHandler, f as useBusinessPurposes, q as useFormState } from "./business-purpose-api-DcYBPVNr.js";
import { E as ECostAllocation, I as ItemCategory } from "./expense-item-oPdxtthH.js";
import { importShared } from "./__federation_fn_import-VIrFz_yB.js";
import { q as queryClient, C as CreditCard } from "./queryClient-Dnoxxvoh.js";
...
const { useCallback: useCallback$n, useEffect: useEffect$i, useRef: useRef$f, useState: useState$7 } = await importShared("react");
...
const { useCallback: useCallback$m, useEffect: useEffect$h, useMemo: useMemo$k, useRef: useRef$e } = await importShared("react");
function useBaseExpenseForm(config2, props) {
  ...
  const prevIsDraftingRef = useRef$e(isDrafting);
  useEffect$h(() => {
...
const { useCallback: useCallback$j, useEffect: useEffect$g, useRef: useRef$d } = await importShared("react");
const useAllocationSync = ({
  ...
  const isEditingAmountRef = useRef$d(false);
  const isEditingPercentageRef = useRef$d(false);
  const disableEqualSplit = useDisableEqualSplit(setValue, getValues, isEqualSplitField);
...
const { useCallback: useCallback$i, useEffect: useEffect$f, useMemo: useMemo$h } = await importShared("react");
const useEqualSplit = ({
  allocations,
  isEqualSplit,
  setValue,
...
const { useEffect: useEffect$e, useRef: useRef$c } = await importShared("react");
const useAmountAllocationSync = ({
  ...
  const prevAmountRef = useRef$c(amount);
  const setValueRef = useRef$c(setValue);
  const getValuesRef = useRef$c(getValues);
  useEffect$e(() => {
...
const { useCallback: useCallback$g, useEffect: useEffect$d, useMemo: useMemo$e, useRef: useRef$b } = await importShared("react");
const { useCallback: useCallback$f, useMemo: useMemo$d } = await importShared("react");
const { useCallback: useCallback$e, useEffect: useEffect$c, useImperativeHandle, useRef: useRef$a } = await importShared("react");
const useFormImperativeHandle = ({
  ...
  const onFormErrorsRef = useRef$a(onFormErrors);
  useEffect$c(() => {
...
const useFormButtonStateSync = ({
  ...
  const onButtonStateChangeRef = useRef$9(onButtonStateChange);
  useEffect$b(() => {
    formRef.current = form;
...
const { useEffect: useEffect$9, useMemo: useMemo$b } = await importShared("react");
...
const { useCallback: useCallback$a, useEffect: useEffect$6, useMemo: useMemo$6, useRef: useRef$7 } = await importShared("react");
...
const ExpenseDetailsSection = ({
  ...
  const prevShowTaxFields = useRef$6(showTaxFields);
  useEffect$5(() => {
...
const { useEffect: useEffect$4, useRef: useRef$5 } = await importShared("react");
const ExpenseJustificationSection = ({
  ...
  const prevShowPersonsEntertained = useRef$5(showPersonsEntertained);
  useEffect$4(() => {
...
const { useCallback: useCallback$8, useEffect: useEffect$3, useRef: useRef$4, useState: useState$5 } = React$2;
const ReceiptUpload = ({
  onReceiptChange,
  onUploadingChange,
  initialReceipt,
...
const { useEffect: useEffect$1, useRef: useRef$2, useState: useState$2 } = await importShared("react");
...
const { useCallback: useCallback$5, useEffect, useRef: useRef$1, useState: useState$1 } = await importShared("react");
