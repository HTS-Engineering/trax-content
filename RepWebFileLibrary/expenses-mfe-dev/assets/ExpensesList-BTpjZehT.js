...
import { n as $r, r as qs, I as Ia, X as Xn, s as ja, U as Us, D as Da, t as Ea, E as En } from "./configuration-BTcuf3wk.js";
import { i as useCompanyStore, m as useQuery, q as queryKeys, I as keepPreviousData, E as EXPENSE_ENDPOINTS, J as getCurrencySymbol, r as useSearchParams, g as useLocation, f as useNavigate, p as generatePath, a as RoutePaths } from "./currency-DLlwBzTW.js";
import { a as apiClient } from "./axiosInstance-Ca9fcNbd.js";
import { a as formatCurrency, E as EmptyState, P as Plus } from "./formatters-DDH3BSEG.js";
...
const formatTotalAmount = (item) => {
  ...
  const code = item.totalAmountCurrencyCode;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col p-6 pt-0!", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 overflow-auto exp-custom-scrollbar", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Us,
      {
        ...
        emptyState: isSearching ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm italic text-exp-neutral-600", children: "No result found" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ExpenseEmptyState, { statusFilter: currentStatusFilter })
      }
    ) })
  ] });
};
