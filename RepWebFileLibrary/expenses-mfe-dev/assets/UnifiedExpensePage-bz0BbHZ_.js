...
import { E as ExpenseFormType } from "./api-BJgH85Oc.js";
import { E as ECostAllocation } from "./cost-allocation-DRGo4_AN.js";
import { i as isRegularExpense, a as isMileageExpense, b as isExpenseItemSubmitted, I as ItemCategory, c as isExpenseItemDraft } from "./expense-item-C9lElBqU.js";
import { a as useNavigateBack } from "./use-prevent-page-reload-B0DFcyGh.js";
...
const useSaveMileageDraft = () => {
  ...
  return useMutation({
    mutationFn: async ({ data, draftId, signal }) => {
      ...
      const response = await apiClient[method](endpoint, { data }, { signal });
      return response.data;
    },
