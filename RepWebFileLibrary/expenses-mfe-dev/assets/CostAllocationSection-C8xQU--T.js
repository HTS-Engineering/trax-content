...
import { b as apiClient, d as devError, a2 as ys, a3 as Ss, g as gr, a4 as Ns, Y as Yn, J as ws, B as Br, l as ls, q as h, Q as wt, R as zt, U as Ue, _ as yt, O as Oa, i as create, j as devtools, a5 as devWarn, a as devLog, Z as Zs, a6 as Qt, y as gn, I as es, f as Mt, E as Et, P as Pt, a7 as Ys, a8 as Ks, a9 as Ws, a1 as ja, H as Ha, aa as cr, ab as ri, ac as Ye, ad as Ga } from "./configuration-CaBH14y1.js";
import { p as useTaxTypesDisplay, f as ExpenseFormType, y as ECostAllocation, t as useDefaultCurrency, a as useExpenseTypes, F as FormTypeId, A as AllowedMimeType, z as FILE_SIZE_LIMITS, B as MIME_TYPE_CONFIG, C as FilePreviewType, s as useCountries, D as useDefaultCountry, w as useEffectiveMileageRate, v as useFormTypeId, b as isRegularExpense, c as isMileageExpense, i as isExpenseItemSubmitted, x as isExpenseItemDraft, I as ItemCategory, G as MILEAGE_RATES_STALE_TIME, H as fetchEffectiveMileageRate, d as useExpenseItem } from "./TaxTypeSearchSelect-BWWNgvpC.js";
import { l as formatDate, K as FILE_ENDPOINTS, f as useCompanyStore, p as formatExpenseDate, J as formatCurrency, G as EMPTY_CURRENCY_SYMBOL, L as formatDistance, I as formatRate, H as formatExpensePeriod, r as useQuery, E as EXPENSE_ENDPOINTS, q as queryKeys, M as formatHistoryTimestamp, P as DEFAULT_CURRENCY_CODE, z as formatToISODate, B as parseDateOnlyAsLocal, S as useDebouncedCallback, i as useQueryClient, j as useMutation, T as useNumericDisplay, U as getCurrencySymbol } from "./formatters-Dvm414Po.js";
import { importShared } from "./__federation_fn_import-CZ2UOLBn.js";
import { t as toastApiError, I as Info, s as string, S as SIGNED_DECIMAL_FORMAT_REGEX, o as object, d as custom, c as boolean, b as array, D as DECIMAL_FORMAT_REGEX, g as date, m as unknown, n as number, _ as _enum, C as ConfirmDialog, f as useWatch, u as useForm, a as u, l as literal, i as useFormState, p as TOOLTIP_DELAY_QUICK, e as Controller, h as createDecimalChangeHandler, T as TOOLTIP_DELAY_TRUNCATED_TEXT } from "./schemas-D_ZTVCQ9.js";
import { a as useDefaultCompany, q as queryClient, E as ERROR_MESSAGES, u as useCompanies } from "./queryClient-C5uG-A1E.js";
import { _ as __vitePreload } from "./preload-helper-Bsq79q8M.js";
import { i as isHttpApiError, g as getApiErrorMessage, a as getHttpErrorMessage, e as extractApiFieldErrors } from "./api-error-Dja-8hfm.js";
import { P as Plus } from "./plus-DmrntmbF.js";
import { R as RefreshCw } from "./refresh-cw-2DeI2uoi.js";
...
const { useEffect: useEffect$l, useRef: useRef$j, useState: useState$a } = await importShared("react");
...
const { useEffect: useEffect$k, useRef: useRef$i, useState: useState$9 } = await importShared("react");
...
const PreviewSupportingFilesSection = /* @__PURE__ */ __name(({
  ...
  const controllersRef = useRef$i(/* @__PURE__ */ new Map());
  useEffect$k(() => {
    return () => {
  ...
  const handleFileClick = /* @__PURE__ */ __name(async (file) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: "Failed to download file. Please try again." });
    } finally {
...
const { useCallback: useCallback$o, useEffect: useEffect$j, useMemo: useMemo$j, useRef: useRef$h } = await importShared("react");
function useBlobUrlManager(options = {}) {
  const { shouldKeepUrl } = options;
  const blobUrlsRef = useRef$h(/* @__PURE__ */ new Set());
  const abortControllerRef = useRef$h(null);
  const batchControllersRef = useRef$h(/* @__PURE__ */ new Set());
  const shouldKeepUrlRef = useRef$h(shouldKeepUrl);
...
function handleUploadError(error) {
  ...
  throw new Error(getApiErrorMessage(error, { fallback: uploadErrorFallback(status) }));
}
...
const deleteFile = /* @__PURE__ */ __name(async (fileId) => {
  try {
    ...
    throw new Error(getApiErrorMessage(error, { fallback: "Failed to delete file" }));
  }
}, "deleteFile");
const downloadFile = /* @__PURE__ */ __name(async (fileId, signal, retryCount = 0) => {
  ...
  try {
    ...
    throw new Error(getApiErrorMessage(error, { fallback: "Failed to load file. Please try again." }));
  }
}, "downloadFile");
...
const { useCallback: useCallback$m, useEffect: useEffect$i, useRef: useRef$g, useState: useState$7 } = React$2;
const ReceiptUpload = /* @__PURE__ */ __name(({
  ...
  const fileInputRef = useRef$g(null);
  const initialReceiptRef = useRef$g(initialReceipt);
  const attachmentRef = useRef$g(void 0);
  const {
    userDefaultCompany,
    blobManager,
    isStoreDataRelevant,
  ...
  const fileLoadAttemptedRef = useRef$g(/* @__PURE__ */ new Set());
  const handleFileUploadInternalRef = useRef$g(null);
  ...
  const prevAttachmentIdRef = useRef$g(void 0);
  useEffect$i(() => {
  ...
  const handleFileUploadInternal = useCallback$m(async (file, targetExpenseId) => {
    ...
    if (!effectiveExpenseId || !(userDefaultCompany == null ? void 0 : userDefaultCompany.shortName)) {
      ...
      Zs.error(errorMsg, { duration: 4e3 });
...
const { useEffect: useEffect$h, useRef: useRef$f } = await importShared("react");
function ConditionalSection({
  ...
  const previousDisabledRef = useRef$f(void 0);
  ...
  if (section.hideHeader) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConditionalSection,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-section-id": section.id, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ys, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ns, { children: section.render(finalProps) }) }) }, section.id)
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ConditionalSection,
    {
      ...
      behavior,
      onDisabledChange: handleDisabledChange,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-section-id": section.id, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ys, { className: hideCardGap, children: [
        "    ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ss, { className: hideCardGap, children: headerActionsNode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            gr,
            {
              title: section.title,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ns, { children: section.render(finalProps) })
      ] }) }, section.id)
    }
  );
...
const { useEffect: useEffect$g, useRef: useRef$e } = await importShared("react");
const useSetDefaultCurrency = /* @__PURE__ */ __name(({
  ...
  const hasSeeded = useRef$e(false);
  useEffect$g(() => {
...
function applyBeFieldErrors(error, setError, fieldMap) {
  ...
  return { appliedCount, unmappedMessages };
}
__name(applyBeFieldErrors, "applyBeFieldErrors");
const { useCallback: useCallback$k, useEffect: useEffect$f, useMemo: useMemo$f, useRef: useRef$d } = await importShared("react");
function useBaseExpenseForm(config2, props) {
  ...
  const prevIsDraftingRef = useRef$d(isDrafting);
  useEffect$f(() => {
  ...
  const handleFormSubmit = useCallback$k(
    async (data) => {
      try {
        ...
        const { appliedCount, unmappedMessages } = applyBeFieldErrors(
          error,
          form.setError,
          config2.beFieldMap ?? {}
        );
        if (appliedCount > 0) {
          if (unmappedMessages.length > 0) {
            Zs.error(unmappedMessages.join("\n"));
          }
        } else {
          Zs.error(getApiErrorMessage(error, { fallback: "Failed to submit. Please try again" }));
        }
      }
    },
    [config2, onSubmit, form]
  );
...
const { useCallback: useCallback$h, useRef: useRef$c } = await importShared("react");
const useAllocationSync = /* @__PURE__ */ __name(({
  ...
  const isEditingAmountRef = useRef$c(false);
  const isEditingPercentageRef = useRef$c(false);
...
const { useEffect: useEffect$d, useRef: useRef$b } = await importShared("react");
const useAmountAllocationSync = /* @__PURE__ */ __name(({
  ...
  const prevAmountRef = useRef$b(amount);
  const setValueRef = useRef$b(setValue);
  const getValuesRef = useRef$b(getValues);
  const triggerRef = useRef$b(trigger);
  useEffect$d(() => {
...
const { useCallback: useCallback$e, useEffect: useEffect$b, useMemo: useMemo$a, useRef: useRef$a } = await importShared("react");
const { useCallback: useCallback$d, useEffect: useEffect$a, useImperativeHandle, useRef: useRef$9 } = await importShared("react");
const useFormImperativeHandle = /* @__PURE__ */ __name(({
  ref,
  form,
  onFormErrors
}) => {
  const formRef = useRef$9(form);
  const onFormErrorsRef = useRef$9(onFormErrors);
  useEffect$a(() => {
...
const { useEffect: useEffect$9, useRef: useRef$8 } = await importShared("react");
const useFormButtonStateSync = /* @__PURE__ */ __name(({
  ...
  const onButtonStateChangeRef = useRef$8(onButtonStateChange);
  useEffect$9(() => {
    formRef.current = form;
...
const { useCallback: useCallback$b, useRef: useRef$7 } = await importShared("react");
...
const useAutoSave = /* @__PURE__ */ __name((options) => {
  ...
  const onSaveDraftRef = useRef$7(onSaveDraft);
...
const { useEffect: useEffect$6, useMemo: useMemo$5, useRef: useRef$6 } = await importShared("react");
...
const useMileageRateSync = /* @__PURE__ */ __name(({
  ...
  const { data: effectiveRate, isFetching, isError: isRateLoadError } = useEffectiveMileageRate({
    companyShortName,
  ...
  const rateErrorShownRef = useRef$6(false);
  useEffect$6(() => {
    if (isRateLoadError && !rateErrorShownRef.current) {
      rateErrorShownRef.current = true;
      Zs.error(ERROR_MESSAGES.LOAD_ALL_DATA_FAILED);
    }
    if (!isRateLoadError) {
      rateErrorShownRef.current = false;
    }
  }, [isRateLoadError]);
  useEffect$6(() => {
...
const useSaveExpenseDraft = /* @__PURE__ */ __name(() => {
  ...
  return useMutation({
    ...
    onError: /* @__PURE__ */ __name((error, variables) => {
      ...
      toastApiError(error, { fallback: "Failed to save. Please try again" });
    }, "onError")
  });
}, "useSaveExpenseDraft");
const useDeleteExpenseDraft = /* @__PURE__ */ __name((options) => {
  ...
  return useMutation({
    ...
    onError: /* @__PURE__ */ __name((error) => {
      ...
      toastApiError(error, { fallback: "Fail to delete. Please try again." });
    }, "onError")
  });
...
function useExpenseItemForm(options) {
  ...
  const { isError: isCompaniesError } = useCompanies();
  const {
    data: expenseItem,
    error: itemError,
  ...
  const companiesErrorHandledRef = useRef$3(false);
  useEffect$3(() => {
    if (isCompaniesError && !companiesErrorHandledRef.current) {
      companiesErrorHandledRef.current = true;
      Zs.error(ERROR_MESSAGES.LOAD_ALL_DATA_FAILED);
      onExit();
    }
  }, [isCompaniesError, onExit]);
  useEffect$3(() => {
    if (hasError && !isDeleteFlowActive && !isCompaniesError) {
      onLoadError == null ? void 0 : onLoadError(itemError);
    }
  }, [hasError, isDeleteFlowActive, itemError, onLoadError, isCompaniesError]);
  useEffect$3(() => {
    return () => {
...
const AddAllocationExpandable = memo$1(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Ys, { open: isOpen, onOpenChange: setIsOpen, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ws, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AllocationTypeChips, { onSelect: handleTypeSelect, disabled }) })
  ] });
});
...
function AffidavitContent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex-1 flex flex-col min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ys, { className: "w-full max-h-full bg-yellow-50 border border-yellow-200 p-3 flex flex-col overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 h-full overflow-y-auto", children: [
...
function ReceiptSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ys, { className: "h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ss, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-nowrap justify-between items-center min-h-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        gr,
        {
          iconClassName: "bg-exp-yellow-001 justify-center items-center flex",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ns, { className: "min-h-0 h-full", children: isReceiptUnavailable ? hideUploadWhenUnavailable ? null : /* @__PURE__ */ jsxRuntimeExports.jsx(AffidavitContent, { control, disabled }) : !shouldHideUpload && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ReceiptUpload,
      {
        onReceiptChange,
        onUploadingChange,
...
function SupportingFileCard({
  ...
  if (isUploading || isLoadingPreview) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ys, { className: "bg-white px-2 py-2 w-full flex justify-between flex-row items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0 flex-1", children: [
  ...
  if (hasError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(ys, { className: "bg-exp-red-100 px-2 py-2 w-full flex justify-between flex-row items-center", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ys, { className: "bg-white hover:bg-trax-neutral-20 px-2 py-2 w-full flex justify-between flex-row items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
...
function SupportingFiles({
  ...
  const handleFileChange = useCallback$1(async (e) => {
    ...
    if (totalFiles > maxFiles) {
      ...
      if (filesToAdd <= 0) {
        Zs.error(`Maximum ${maxFiles} supporting file${maxFiles > 1 ? "s" : ""} allowed`, {
          duration: 3e3
        });
        return;
      }
      Zs.error(`Only ${filesToAdd} more file(s) can be added`, {
        duration: 3e3
      });
    ...
    if (!onSaveDraftForUpload) {
      Zs.error("Cannot upload files: please save the expense first", {
        duration: 3e3
      });
      return;
    }
  ...
  const handleDeleteConfirm = useCallback$1(async () => {
    ...
    if (file) {
      ...
      try {
        ...
        Zs.error("Failed to delete file", {
          duration: 3e3
        });
      }
    }
  ...
  const handlePreviewClick = useCallback$1(async (file) => {
    ...
    if (!blobUrl && ((_a = file.url) == null ? void 0 : _a.startsWith("/api/"))) {
      ...
      try {
        ...
        const isCanceled = error instanceof Error && (error.name === "AbortError" || error.name === "CanceledError");
        if (isCanceled) return;
        Zs.error("Failed to download file. Please try again.", { duration: 3e3 });
        return;
      } finally {
        previewAbortControllersRef.current.delete(file.id);
    ...
    try {
      ...
      Zs.error("Failed to open file preview", {
        duration: 3e3
      });
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Ss, { className: `flex items-center flex-col w-full h-fit overflow-clip ${className}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ys, { className: `bg-white w-full p-0 ${state.attachments.length === 0 && !state.isUploading && pendingSupportingFiles.length === 0 ? "h-0" : "h-auto"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col my-1 mx-2 gap-1", children: [
      ...
      (isSavingDraft || isUploading) && pendingSupportingFiles.map((file, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(ys, { className: "bg-white px-2 py-2 w-full flex justify-between flex-row items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
...
const ExpenseFormLeftColumn = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ys, { className: "w-full h-full flex flex-col pt-1", children: [
...
function CostAllocationSectionComponent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ga, { value: progressValue, disabled: isProgressDisabled, error: progressError }),
...
export {
  useFormImperativeHandle as $,
  useTaxFieldVisibility as A,
  isConvertedExpense as B,
  CostAllocationHeaderActions as C,
  DEFAULT_PAYMENT_METHOD as D,
  ExpensePreview as E,
  usePaymentMethods as F,
  useSetDefaultCurrency as G,
  ExpenseTypeSelect as H,
  allowsNegativeAmounts as I,
  ...
  expenseDetailsSchema as P,
  expenseJustificationSchema as Q,
  costAllocationSchema as R,
  SupportingFiles as S,
  additionalCommentsSchema as T,
  MileageTripFormField as U,
  mileageDetailsSchema as V,
  mileageJustificationSchema as W,
  useBaseExpenseForm as X,
  useValidatePrefilledFields as Y,
  useAutoSave as Z,
  useFormButtonStateSync as _,
  CostAllocationSection as a,
  BaseExpenseFormRenderer as a0,
  useExpenseFormHandlers as a1,
  useExpenseFormSync as a2,
  fullExpenseValidationStrategy as a3,
  ExpenseFormLeftColumn as a4,
  useMileageTripFormHandlers as a5,
  mapMileageTripToDefaultValues as a6,
  mileageTripValidationStrategy as a7,
  supportingFilesSchema as a8,
  useMileagePeriodFormHandlers as a9,
  mapMileagePeriodToDefaultValues as aa,
  mileagePeriodValidationStrategy as ab,
  getExpenseErrorMessage as b,
  costAllocationItemSchema as c,
  isMileagePeriodData as d,
  MileagePeriodPreview as e,
  ExpenseFormHistoryLog as f,
  getExpenseBaseAmount as g,
  EtlErrorBanner as h,
  isMileageTripData as i,
  ExpenseItemType as j,
  useExpenseItemForm as k,
  getExpenseActionSubtitle as l,
  mapCostAllocation as m,
  isValidFileAttachment as n,
  ExpenseFormField as o,
  useFormFieldValues as p,
  computeMileageEffectiveOn as q,
  useMileageRateSync as r,
  useReimbursableAmountSync as s,
  useAmountAllocationSync as t,
  useCostAllocationHandlers as u,
  validateCostAllocation as v,
  affidavitSchema as w,
  basicDetailsSchema as x,
  createValidationStrategy as y,
  createDraftSaveChecker as z
};
