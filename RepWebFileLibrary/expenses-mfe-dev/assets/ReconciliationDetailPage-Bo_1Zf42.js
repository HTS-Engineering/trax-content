...
import { t as useAppQuery, K as RECONCILIATION_ENDPOINTS, q as queryKeys, h as useErrorSurface, n as useParams, u as useLocation, y as useNavigateBack, a as RoutePaths, L as EMPTY_CURRENCY_SYMBOL } from "./use-scroll-into-view-ref-B1iRwpLB.js";
import { a as apiClient, Y as Yn, v as h, U as Ue } from "./configuration-BGy6T4Ra.js";
import { I as Icon } from "./Icon-DBeU9qcx.js";
import "./CardholderReconciliationList-BYmOEbvX.js";
import { C as CompanySummaryCard, A as ALL_COMPANIES_SELECTION, T as TransactionsList, M as MatchedExpenseDetail } from "./TransactionsList-CL7AKpzl.js";
...
const CompanySummaryPanel = /* @__PURE__ */ __name(({
  ...
  var _a;
  const query = useCompanyTransactionsAggregation(statementId);
  const { data, isPending, isError } = query;
  const failure = useErrorSurface(query, { fallback: "Couldn't load company summary." });
  if (isPending) {
  ...
  if (isError || !data) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(PanelShell, { className, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-exp-neutral-30 bg-exp-neutral-0 px-3 py-3 text-xs text-exp-neutral-300", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: ((_a = failure.presentation) == null ? void 0 : _a.message) ?? "Couldn't load company summary." }),
