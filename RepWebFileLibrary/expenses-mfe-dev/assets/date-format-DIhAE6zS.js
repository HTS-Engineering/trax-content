import { c as create, d as devtools, s as subscribeWithSelector, i as immer } from "./axiosInstance-Dka64nrW.js";
import { importShared } from "./__federation_fn_import-CJZmLbkm.js";
import { j as jsxRuntimeExports } from "./jsx-runtime-TULtkvNU.js";
import { b as Us } from "./index.es-CApEQq_T.js";
...
const useCompanyStore = create()(
  devtools(
    subscribeWithSelector(
      immer((set) => ({
        ...initialState,
        setAdminCompany: (company) => set((state) => {
...
var Query = class extends Removable {
  ...
  async fetch(options, fetchOptions) {
    ...
    if (this.state.fetchStatus === "idle" || this.state.fetchMeta !== ((_b = context.fetchOptions) == null ? void 0 : _b.meta)) {
      this.#dispatch({ type: "fetch", meta: (_c = context.fetchOptions) == null ? void 0 : _c.meta });
    }
    ...
    try {
      ...
      this.setData(data);
      (_e = (_d = this.#cache.config).onSuccess) == null ? void 0 : _e.call(_d, data, this);
      (_g = (_f = this.#cache.config).onSettled) == null ? void 0 : _g.call(
        _f,
        data,
        this.state.error,
        this
      ...
      (_i = (_h = this.#cache.config).onError) == null ? void 0 : _i.call(
        _h,
        error,
        this
      );
      (_k = (_j = this.#cache.config).onSettled) == null ? void 0 : _k.call(
        _j,
        this.state.data,
        error,
        this
...
const queryKeys = {
  ...
  masterAccounts: {
    all: () => [QueryKeyScope.MASTER_ACCOUNTS],
    lists: () => [QueryKeyScope.MASTER_ACCOUNTS, QueryKeyOperation.LIST],
    list: (companyShortName) => [...queryKeys.masterAccounts.lists(), { companyShortName }],
    details: () => [QueryKeyScope.MASTER_ACCOUNTS, QueryKeyOperation.DETAIL],
    detail: (id) => [...queryKeys.masterAccounts.details(), id]
  },
  cardholders: {
    all: () => [QueryKeyScope.CARDHOLDERS],
    lists: () => [QueryKeyScope.CARDHOLDERS, QueryKeyOperation.LIST],
    list: (companyShortName, masterAccountId) => [...queryKeys.cardholders.lists(), { companyShortName, masterAccountId }]
  },
  reconciliations: {
    all: () => [QueryKeyScope.RECONCILIATIONS],
    lists: () => [QueryKeyScope.RECONCILIATIONS, QueryKeyOperation.LIST],
    list: (masterAccountId) => [...queryKeys.reconciliations.lists(), { masterAccountId }]
  },
  bankStatements: {
    all: () => [QueryKeyScope.BANK_STATEMENTS],
    lists: () => [QueryKeyScope.BANK_STATEMENTS, QueryKeyOperation.LIST],
    list: (params) => [...queryKeys.bankStatements.lists(), params]
  },
  companyTransactions: {
    all: () => [QueryKeyScope.COMPANY_TRANSACTIONS],
    aggregations: () => [QueryKeyScope.COMPANY_TRANSACTIONS, QueryKeyOperation.LIST],
    aggregation: (statementId) => [...queryKeys.companyTransactions.aggregations(), { statementId }]
  }
};
