...
import { b as apiClient, W as Ws, E as Ea, e as Tr, d as devError, f as Us, J as Ja, $ as $a, U as Ue, B as Bn, g as qt, h as Ut, Y as Yt, i as ir, j as Js, Z as Za, Q as Qa, k as es, M as Ma, P as Pa, l as Zs } from "./configuration-D11IOZL_.js";
import { i as formatExpenseDate, e as useCompanyStore, j as useQuery, k as keepPreviousData, E as EXPENSE_ENDPOINTS, q as queryKeys, l as useSearchParams, d as useLocation, a as RoutePaths, m as useQueryClient, n as useMutation, o as useScrollIntoViewRef, p as useErrorToast, u as useNavigate, r as useParams, g as generatePath } from "./date-format-Dkqd_MkG.js";
import { f as formatAmountWithCurrency, a as formatDate, b as formatDateRange } from "./formatters-DqvanaXQ.js";
import { i as isExpenseItemSubmitted, b as isRegularExpense, g as getExpenseItemAmount, c as isMileageExpense, d as useExpenseItem } from "./expense-api-CVqvVm0I.js";
import { g as getExpenseTypeBadgeConfig } from "./expense-type-badge-CmRfP61L.js";
import { I as Icon } from "./Icon-CjLzMHV-.js";
import { m as mapCostAllocation, g as getExpenseBaseAmount, u as useCostAllocationHandlers, C as CostAllocationHeaderActions, a as CostAllocationSection, v as validateCostAllocation, c as costAllocationItemSchema, E as ExpensePreview, i as isMileageTripData, M as MileageTripPreview, b as isMileagePeriodData, d as MileagePeriodPreview, e as ExpenseFormHistoryLog } from "./CostAllocationSection-Bz1yFlIC.js";
import { u as useRoles, R as Role } from "./hooks-ZYySUT7e.js";
import "./hooks-BXYlc4sL.js";
import { u as useForm, a, o as object, b as array, s as string, c as boolean, d as custom, C as ConfirmDialog } from "./schemas-DLyAVKsc.js";
