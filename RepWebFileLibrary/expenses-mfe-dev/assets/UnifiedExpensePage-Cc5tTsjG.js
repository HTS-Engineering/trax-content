...
import { K as Ks, U as Ua, q as qa, b as Ka, P as Pe, I as In, Y as Ya, D as Dn, E as En, M as Mn, u as us, c as cs, X as Xn, m as ms, d as ds, e as Pr, A as As, f as Xa } from "./index.es-Diw2MuFT.js";
import { a as ExpenseStatusBadge, E as ExpensesList } from "./ExpensesList-DxC6-CDv.js";
import { C as ConfirmDialog, E as ExpenseFormField, u as useFormFieldValues, a as useMileageRateSync, b as useReimbursableAmountSync, c as useAmountAllocationSync, d as useExpenseFormHandlers, e as useExpenseFormSync, f as fullExpenseValidationStrategy, g as ExpenseFormLeftColumn, h as useMileageTripFormHandlers, m as mapMileageTripToDefaultValues, i as mileageTripValidationStrategy, F as FormSectionType, j as mileageDetailsSchema, s as supportingFilesSchema, k as mileageJustificationSchema, l as costAllocationSchema, n as additionalCommentsSchema, o as additionalCommentsFieldOptional, p as supportingFilesField, q as expenseDescriptionFieldOptional, r as businessPurposeFieldOptional, t as reimbursableAmountFieldOptional, v as rateUnitFieldOptional, w as ratePerUnitFieldOptional, x as totalDistanceFieldOptional, y as expensePeriodFieldOptional, z as mileageTypeFieldOptional, A as costAllocationTypeSchema, B as createValidationStrategy, D as createDraftSaveChecker, G as createRequiredFieldsChecker, H as useCostAllocationHandlers, M as MileageFormType, I as resolveFileUrl, J as useFormTypeName, K as ECostAllocation, L as isMileageTripData, N as isMileagePeriodData, O as usePendingUploadStore } from "./ExpenseFormLeftColumn-Cn7hwoBu.js";
import { c as createLucideIcon } from "./createLucideIcon-CWwrLivU.js";
import { a as ChevronRight } from "./credit-card-DGksABcy.js";
import { T as Trash2, S as Send } from "./trash-2-DzpZqt7i.js";
import { a as devLog, d as devError } from "./index-CE7gIUWB.js";
import { E as EXPENSE_DETAILS_SECTION, a as EXPENSE_JUSTIFICATION_SECTION, C as COST_ALLOCATION_SECTION, A as ADDITIONAL_COMMENTS_SECTION, M as MILEAGE_DETAILS_SECTION, b as MILEAGE_JUSTIFICATION_SECTION, c as MILEAGE_COST_ALLOCATION_SECTION, d as MILEAGE_ADDITIONAL_COMMENTS_SECTION, e as MileagePeriodFormField, f as MileageDetailsSection, S as SupportingFilesFormSection, g as MileageJustificationSection, h as CostAllocationHeaderActions, i as CostAllocationSection, j as AdditionalCommentsSection, m as mileagePeriodFormSchema, k as isRegularExpense, l as isMileageExpense, n as isExpenseItemSubmitted, I as ItemCategory, o as isExpenseItemDraft } from "./expense-item-BKX_i1LM.js";
import { I as Icon } from "./Icon-BxYHdB7c.js";
import { D as DEFAULT_CURRENCY, a as DEFAULT_CURRENCY_CODE } from "./currency-DF2IpVR4.js";
import { c as createExpenseForm } from "./form-factory-BP9H3AVM.js";
import { a as apiClient } from "./axiosInstance-unDwCgGj.js";
import { g as useQuery, q as queryKeys, i as useQueryClient, u as useCompanyStore } from "./factory-DSE5qHTU.js";
import "./api-CeTlWAyP.js";
import { o as object, b as boolean, a as array, u as unknown, n as number, s as string, l as literal } from "./zod-PpMdyx4R.js";
import { importShared } from "./__federation_fn_import-VIrFz_yB.js";
import { E as ExpenseFormType, F as FormTypeId } from "./api-DcgizSzM.js";
import { u as useMutation } from "./use-debounced-callback-Ch-mGAvD.js";
import { a as useNavigateBack } from "./use-prevent-page-reload-CJhcvAVt.js";
import { E as EXPENSE_ENDPOINTS } from "./expenses-BLPZFCX-.js";
import { u as useNavigate, j as generatePath, a as RoutePaths, f as useParams, k as useSearchParams } from "./routes-C5J7GVU-.js";
...
function FormPageDialog({
  ...
  const renderHeader = () => /* @__PURE__ */ jsxRuntimeExports.jsx(qa, { className: "pb-3 mb-3 border-b border-exp-primary-blue-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-nowrap items-center justify-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ka, { className: "text-exp-neutral-900 text-xl font-bold", children: header.title }),
        header.titleSuffix,
  ...
  const renderFooter = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Ya, { className: "pt-4 gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: footer.showDeleteButton && /* @__PURE__ */ jsxRuntimeExports.jsxs(Dn, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Mn, { className: "text-sm", children: "Delete draft" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Dn, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(En, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Pe,
            {
              type: "button",
              variant: "outlined",
          ...
          footer.saveDraftButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Mn, { variant: "light", size: "sm", side: "bottom", showArrow: false, children: footer.saveDraftButtonState.tooltip })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Dn, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(En, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Pe,
            {
              type: "button",
              variant: "primary",
              ...
              children: [
                footer.isSubmitting ? /* @__PURE__ */ jsxRuntimeExports.jsx(In, { className: "size-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "size-5" }),
                "Submit Expense"
              ]
            }
          ) }) }),
          footer.submitButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Mn, { className: "text-sm", children: footer.submitButtonState.tooltip })
        ] })
      ] })
    ] }) });
  };
  const renderLoadingOrContent = () => {
    if (isLoading) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(In, { className: "size-8 text-exp-primary-blue-600" }) });
    }
    return renderContent();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    backgroundContent,
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ks, { open: true, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Ua, { className: "max-w-5xl max-h-[90vh] h-full overflow-hidden flex flex-col", children: [
      renderHeader(),
...
const { useCallback: useCallback$4, useMemo: useMemo$3 } = await importShared("react");
...
const PreviewReceiptSection = ({ receipt, stretchToFill = false }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-lg overflow-hidden bg-exp-neutral-30 border border-exp-primary-blue-100", children: [
...
const PreviewAffidavitSection = ({ affidavit }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-exp-yellow-200 bg-exp-yellow-100 p-4", children: [
...
const getCurrencySymbol = (currency) => {
  var _a;
  const code = currency == null ? void 0 : currency.code;
  const locale = currency == null ? void 0 : currency.locale;
  if (!code) return "";
  try {
    return ((_a = new Intl.NumberFormat(locale, {
      style: "currency",
      currency: code
    }).formatToParts(0).find((part) => part.type === "currency")) == null ? void 0 : _a.value) ?? "";
  } catch {
    return "";
  }
};
...
const formatCurrency$1 = (amount, currencyCode = DEFAULT_CURRENCY_CODE) => {
...
const PreviewExpenseDetailsSection = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-8 gap-y-4", children: [
...
const PreviewExpenseJustificationSection = ({
  ...
  const formType = useFormTypeName(expenseTypeName);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { className: "shadow-none border-0 bg-transparent p-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(cs, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Xn,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
...
const PreviewCostAllocationSection = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { className: deferred ? "shadow-none border-0 bg-transparent p-0 gap-0" : "shadow-none border-0 bg-transparent p-0", children: [
    ...
    allocations && !deferred && /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: allocations.map((allocation, index) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 text-right flex", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Pr, { className: "rounded-lg bg-exp-primary-blue-50 text-exp-neutral-900 hover:bg-exp-primary-blue-50", children: [
...
const PreviewSupportingFilesSection = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: files.map((file) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
...
const PreviewAdditionalCommentsSection = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-exp-neutral-900 wrap-break-word", children: comments }) })
  ] });
};
const PreviewMileageTripDetailsSection = ({ data }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { className: "shadow-none border-0 bg-transparent p-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(cs, { className: "p-0 flex items-center justify-between", children: [
      ...
      data.isRoundTrip && /* @__PURE__ */ jsxRuntimeExports.jsx(Pr, { className: "bg-exp-neutral-30 text-exp-neutral-600 font-medium hover:bg-none! cursor-default", children: "Round trip" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-8 gap-y-4", children: [
...
const useSaveExpenseDraft = () => {
  ...
  return useMutation({
    ...
    onSuccess: ({ draft, response, formData }, variables) => {
      ...
      As.success("All changes are saved", {
        duration: 3e3
      });
    },
    onError: (error, variables) => {
      ...
      As.error("Failed to save. Please try again", {
        duration: 3e3
      });
    }
  });
...
const useDeleteExpenseDraft = (options) => {
  ...
  return useMutation({
    ...
    onError: (error) => {
      ...
      As.error("Fail to delete. Please try again.", {
        duration: 3e3
      });
    }
  });
...
const useSubmitExpense = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      ...
      As.success("Expense submitted", {
        duration: 3e3
      });
    },
    onError: (error) => {
      devError("Failed to submit expense:", error);
      As.error("Fail to submit", {
        duration: 3e3
      });
    }
  });
...
const useSaveMileageDraft = () => {
  ...
  return useMutation({
    mutationFn: async ({ data, draftId, signal }) => {
      ...
      const company = selectedCompany.shortName;
      const expenseTypes = queryClient.getQueryData(
        [...queryKeys.expenseTypes.list(company, false), { formTypeIds: [FormTypeId.MILEAGE] }]
      );
      if (draftId) {
...
const useSubmitMileage = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      ...
      As.success("Mileage claim submitted", {
        duration: 3e3
      });
    },
    onError: (error) => {
