...
import { t as useAppQuery, q as queryKeys, i as useQueryClient, j as useMutation } from "./use-scroll-into-view-ref-Ben1Dxy5.js";
import { a as apiClient, af as BUSINESS_PURPOSE_ENDPOINTS } from "./configuration-DH9NKDLt.js";
...
const useCreateBusinessPurpose = /* @__PURE__ */ __name(() => {
  ...
  return useMutation({
    meta: { errorCopy: { fallback: "Could not create the business purpose. Please try again." } },
...
const useUpdateBusinessPurpose = /* @__PURE__ */ __name(() => {
  const queryClient = useQueryClient();
  return useMutation({
    meta: { errorCopy: { fallback: "Could not save the business purpose. Please try again." } },
...
const useToggleBusinessPurposeStatus = /* @__PURE__ */ __name(() => {
  const queryClient = useQueryClient();
  return useMutation({
    meta: { errorCopy: { fallback: "Could not change the business purpose status. Please try again." } },
