...
import { u as useJWTStore, b as apiClient, e as ei, $ as $a, B as Br, f as create, g as devtools, s as subscribeWithSelector, i as immer, S as SessionStorageKeys, d as devError, Z as Zs, h as as, H as Ha, U as Ue, Y as Yn, j as Mt, E as Et, P as Pt, k as gr, o as oi, r as rs, l as os, m as ss, n as ls, T as Ta, z as za, p as ni } from "./configuration-DiNez-jq.js";
import { j as formatAmountWithCurrency, k as formatDate, l as formatDateRange, m as formatExpenseDate, e as useCompanyStore, n as useQuery, q as queryKeys, o as keepPreviousData, E as EXPENSE_ENDPOINTS, p as useSearchParams, u as useLocation, a as RoutePaths, d as useNavigate, r as generatePath, F as FormTypeId, s as isExpenseItemSubmitted, t as useQueryClient, v as useMutation, w as isRegularExpense, x as isMileageExpense, y as useScrollIntoViewRef, z as useExpenseItem, B as useErrorToast, C as useParams } from "./use-scroll-into-view-ref-CN40Qna5.js";
import { g as getExpenseTypeBadgeConfig } from "./expense-type-badge-CzEjWXkn.js";
import { I as Icon } from "./Icon-5RIpWGMw.js";
import { g as getExpenseBaseAmount, a as getExpenseErrorMessage, E as ExpensePreview, i as isMileageTripData, M as MileageTripPreview, b as isMileagePeriodData, c as MileagePeriodPreview, d as ExpenseFormHistoryLog } from "./http-errors-BFuQkHVX.js";
import { b as buildHeaderFromExpenseItem } from "./build-expense-header-CjZOBE-S.js";
import "./hooks-DLf49zr9.js";
import { o as object, s as string, b as boolean, a as array, c as custom, u as useForm, d as u, C as ConfirmDialog } from "./useMileageRates-D9paWAqH.js";
import { m as mapCostAllocation, v as validateCostAllocation, a as useCostAllocationHandlers, C as CostAllocationHeaderActions, b as CostAllocationSection, c as costAllocationItemSchema } from "./CostAllocationSection-Brou5UZX.js";
