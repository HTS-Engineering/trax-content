...
import { c as createLucideIcon, g as formatDate, bs as Decimal, D as devWarn, bt as getCadTaxBaseAmount, j as jsxRuntimeExports, I as Icon, s as ETL_ERROR_MESSAGE, p as apiClient, bu as FILE_ENDPOINTS, Z as devError, bv as Ss, bw as Cs, ao as gr, bx as _s, Y as Yn, n as notifyMessage, by as getErrorMessage, V as Ue, a5 as RefreshCw, bh as isConvertedExpense, k as useCompanyStore, b8 as useTaxTypesDisplay, i as formatExpenseDate, bq as formatCurrency, az as ExpenseFormType, ae as EMPTY_CURRENCY_SYMBOL, b4 as ys, v as jr, bz as ECostAllocation, au as us, aO as notifyError, bj as useDefaultCurrency, bA as formatDistance, bp as formatRate, bg as formatExpensePeriod, E as ERROR_MESSAGES, l as useAppQuery, o as EXPENSE_ENDPOINTS, q as queryKeys, bB as formatHistoryTimestamp, ab as h, H as useErrorSurface, bc as wt, bd as zt, be as yt, y as create, z as devtools, bC as DEFAULT_CURRENCY_CODE, aW as formatToISODate, ag as useQueryClient, ah as useMutation, ai as Qs, aN as devLog, bD as ItemCategory, aV as useQuery, F as FormTypeId, bE as MILEAGE_RATES_STALE_TIME, bF as fetchEffectiveMileageRate, bG as extractError, aX as parseDateOnlyAsLocal, bi as useCountries, bH as useDefaultCountry, a2 as queryClient, bI as AllowedMimeType, bJ as FILE_SIZE_LIMITS, bK as MIME_TYPE_CONFIG, bL as useDebouncedCallback, bl as useDefaultCompany, a7 as useExpenseTypes, bo as useEffectiveMileageRate, bm as useFormTypeId, an as getExpenseBaseAmount, bM as FilePreviewType, bN as isHttpApiError, bO as AppError, al as isRegularExpense, am as isMileageExpense, af as isExpenseItemSubmitted, br as isExpenseItemDraft, aq as useExpenseItem, X as Ba, bn as Ga, ak as Oa, bP as isNotFoundError, bQ as useNumericDisplay, bR as Qt, aP as gn, aY as ts, bS as getCurrencySymbol, M as Mt, r as Et, P as Pt, bT as Ws, bU as Ks, bV as Xs, bW as cr, bX as oi, bY as Ye, bZ as qa } from "./queryClient-haQ_5IC4.js";
import { S as SIGNED_DECIMAL_FORMAT_REGEX, m as TAX_RATE_FORMAT_REGEX, I as Info, u as useForm, a as u, f as useWatch, s as string, o as object, d as custom, c as boolean, b as array, D as DECIMAL_FORMAT_REGEX, g as date, p as unknown, n as number, _ as _enum, l as literal, e as Controller, C as ConfirmDialog, i as useFormState, q as TOOLTIP_DELAY_QUICK, h as createDecimalChangeHandler, T as TOOLTIP_DELAY_TRUNCATED_TEXT } from "./ConfirmDialog-DcA5Fw7j.js";
import { importShared } from "./__federation_fn_import-CZ2UOLBn.js";
import { _ as __vitePreload } from "./preload-helper-Bsq79q8M.js";
import { P as Plus } from "./plus-1V1H1HRt.js";
const __iconNode = [
  [
    "path",
    {
...
export {
  ...
  FormSectionType as K,
  expenseDetailsSchema as L,
  MileageTripPreview as M,
  NO_MILEAGE_RATE_FOR_DATE_MESSAGE as N,
  expenseJustificationSchema as O,
  PreviewLoadError as P,
  costAllocationSchema as Q,
  additionalCommentsSchema as R,
  SupportingFiles as S,
  MileageTripFormField as T,
  mileageDetailsSchema as U,
  mileageJustificationSchema as V,
  useBaseExpenseForm as W,
  useValidatePrefilledFields as X,
  useAutoSave as Y,
  useFormButtonStateSync as Z,
  useFormImperativeHandle as _,
  CostAllocationSection as a,
  useExpenseFormHandlers as a0,
  useExpenseFormSync as a1,
  fullExpenseValidationStrategy as a2,
  ExpenseFormLeftColumn as a3,
  useMileageTripFormHandlers as a4,
  mapMileageTripToDefaultValues as a5,
  mileageTripValidationStrategy as a6,
  supportingFilesSchema as a7,
  useMileagePeriodFormHandlers as a8,
  mapMileagePeriodToDefaultValues as a9,
  mileagePeriodValidationStrategy as aa,
  isMileagePeriodData as b,
  costAllocationItemSchema as c,
  MileagePeriodPreview as d,
  ExpenseFormHistoryLog as e,
  EtlErrorBanner as f,
  ExpenseItemType as g,
  useExpenseItemForm as h,
  isMileageTripData as i,
  getExpenseActionSubtitle as j,
  ExpenseFormField as k,
  isValidFileAttachment as l,
  mapCostAllocation as m,
  useFormFieldValues as n,
  computeMileageEffectiveOn as o,
  useMileageRateSync as p,
  useReimbursableAmountSync as q,
  useAmountAllocationSync as r,
