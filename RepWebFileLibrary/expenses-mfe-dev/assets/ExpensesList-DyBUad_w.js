...
import { a as Tr, W as Ws, E as Ea, j as ar, k as Wa, h as Zs, M as Ma, P as Pa, B as Bn } from "./index.es-CApEQq_T.js";
import { d as useCompanyStore, i as useQuery, q as queryKeys, k as keepPreviousData, j as useSearchParams, l as useLocation, x as useNavigateWithReturn, p as useErrorToast, g as generatePath, a as RoutePaths } from "./date-format-DIhAE6zS.js";
import { a as apiClient } from "./axiosInstance-Dka64nrW.js";
import { E as EXPENSE_ENDPOINTS } from "./expense-api-DSJxHFZV.js";
...
import { f as formatAmountWithCurrency } from "./formatters-DaCXJPio.js";
...
const useExpensesColumns = ({
  ...
  const statusDateColumn = useMemo$2(() => {
    ...
    return {
      ...
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: getStatusColumnHeader(currentStatusFilter) }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ws,
        {
          context,
...
const ExpensesList = () => {
  ...
  const renderToolbar = (table) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Ma, { table, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Pa,
      {
        className: "gap-2",
