...
import { ah as useQuery, R as RECONCILIATION_ENDPOINTS, Y as queryKeys, af as useParams, a9 as useLocation, ac as useNavigateBack, g as RoutePaths, E as EMPTY_CURRENCY_SYMBOL } from "./use-scroll-into-view-ref-B9ZfFHUy.js";
import { x as apiClient, ab as jn, am as p, U as Ue, a1 as devLog } from "./configuration-B4FJFUoo.js";
import { I as Icon } from "./Icon-qrAJyYZL.js";
import { C as CompanySummaryCard, A as ALL_COMPANIES_SELECTION, T as TransactionsList } from "./TransactionsList-BSWIlndq.js";
...
const mapCompanyTransactionsAggregation = /* @__PURE__ */ __name((api) => ({
  ...
  // PENDING FROM BE - falls back to "-" until shipped
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex min-h-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TransactionsList,
        {
          ...
          onMatchedExpenseClick: /* @__PURE__ */ __name((row) => devLog("Matched expense clicked", row), "onMatchedExpenseClick")
        }
      )
    ] })
  ] });
