...
import { c as create, d as devtools, s as subscribeWithSelector, i as immer, a as apiClient } from "./axiosInstance-Dp1zAOAB.js";
...
const EXPENSE_ENDPOINTS = {
  ...
  COST_ALLOCATION_PROJECT: (poId) => `/api/v1.0/expense-forms/cost-allocation/project/${poId}`,
  COST_ALLOCATION_ADMIN: (poId) => `/api/v1.0/expense-forms/cost-allocation/admin/${poId}`,
  COST_ALLOCATION_SAVE: (expenseFormId) => `/api/v1.0/expense-forms/cost-allocation/${expenseFormId}`
};
...
export {
  ...
  hashKey as s,
  partialMatchKey as t,
  useCompanies as u,
  skipToken as v,
  ensureQueryFn as w,
  addToStart as x,
  addToEnd as y,
  addConsumeAwareSignal as z
};
