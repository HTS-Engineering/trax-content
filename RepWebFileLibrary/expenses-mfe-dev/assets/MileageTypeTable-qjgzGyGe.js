...
import { i as useQueryClient, q as queryKeys, y as useEscapeHandler, f as useCompanyStore, r as useQuery, j as useMutation, z as formatToISODate, B as parseDateOnlyAsLocal, D as DEFAULT_CURRENCY_SYMBOL, C as formatRateCompact, u as useErrorToast } from "./formatters-Dvm414Po.js";
import { d as devError, H as Ha, O as Oa, U as Ue, Y as Yn, p as ti, q as h, B as Br, V as Vr, v as $r, w as Tr, x as zr, n as ni, b as apiClient, C as CONFIGURATION_ENDPOINTS, K as Ka, Z as Zs, a as devLog, y as gn, W as Wa, l as ls, A as Kr, f as Mt, E as Et, P as Pt, m as dr, o as oi, r as rs, D as si, F as os, G as ss, I as es, J as ws, L as is, N as Hs } from "./configuration-CaBH14y1.js";
import { E as EmptyState } from "./EmptyState-D4ngR6dG.js";
import { I as Icon } from "./Icon-DBeU9qcx.js";
import { o as object, _ as _enum, s as string, l as literal, u as useForm, a as u, t as toastApiError, e as Controller, C as ConfirmDialog, b as array, f as useWatch, T as TOOLTIP_DELAY_TRUNCATED_TEXT, n as number, g as date, h as createDecimalChangeHandler, i as useFormState, j as filterDecimalInput, k as useController, I as Info } from "./schemas-D_ZTVCQ9.js";
...
import { u as useCreateBusinessPurpose, a as useUpdateBusinessPurpose, b as useToggleBusinessPurposeStatus, c as useBusinessPurposes } from "./business-purpose-api-C-NEP4u5.js";
...
const useExpenseTypeOperations = /* @__PURE__ */ __name((companyId, onSuccess) => {
  ...
  const handleCreateExpenseType = useCallback$m(async (data) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: "Failed to create expense type. Please try again" });
      throw error;
    }
  ...
  const handleUpdateExpenseType = useCallback$m(async (id, data, originalData) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: "Failed to update expense type. Please try again" });
      throw error;
    }
  ...
  const toggleActiveExpenseType = useCallback$m(async (id, currentStatus) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: "Failed to update expense type status. Please try again" });
      throw error;
    }
...
const useMasterAccountOperations = /* @__PURE__ */ __name((companyShortName, onSuccess) => {
  ...
  const handleCreateMasterAccount = useCallback$j(async (data) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: "Failed to create master account. Please try again" });
      throw error;
    }
  ...
  const handleUpdateMasterAccount = useCallback$j(async (id, data, originalData) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: "Failed to update master account. Please try again" });
      throw error;
    }
  ...
  const toggleActiveMasterAccount = useCallback$j(async (id, active) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: "Failed to update master account status. Please try again" });
      throw error;
    }
  }, [companyShortName, updateMasterAccountMutation, onSuccess]);
  return {
...
const SetAsInactiveDialog = /* @__PURE__ */ __name(({
  ...
  const handleConfirm = /* @__PURE__ */ __name(async () => {
    ...
    try {
      ...
      toastApiError(error, { fallback: `Failed to mark "${masterAccountName}" as inactive. Please try again` });
    }
  }, "handleConfirm");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ConfirmDialog,
...
const useCardholderOperations = /* @__PURE__ */ __name((companyShortName, masterAccountId, onSuccess) => {
  ...
  const handleCreateCardholder = useCallback$f(async (data) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: CARDHOLDER_MESSAGES.CREATE_ERROR });
      throw error;
    }
  ...
  const handleUpdateCardholder = useCallback$f(async (id, data, originalData) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: CARDHOLDER_MESSAGES.UPDATE_ERROR });
      throw error;
    }
  ...
  const toggleActiveCardholder = useCallback$f(async (id, currentStatus) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: CARDHOLDER_MESSAGES.TOGGLE_ERROR });
      throw error;
    }
  }, [companyShortName, masterAccountId, updateMutation, onSuccess]);
  return {
...
const CardholderNameField = /* @__PURE__ */ __name(({
  ...
  const handleSearch = useCallback$e(async (query) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: CARDHOLDER_MESSAGES.SEARCH_ERROR });
      return [];
    }
...
const useBusinessPurposeOperations = /* @__PURE__ */ __name((companyShortName, onSuccess) => {
  ...
  const handleCreate = useCallback$9(async (data) => {
    ...
    try {
      ...
      toastApiError(err, { fallback: "Failed to create business purpose. Please try again" });
      throw err;
    }
  ...
  const handleUpdate = useCallback$9(async (id, data, originalData) => {
    ...
    try {
      ...
      toastApiError(err, { fallback: "Failed to update business purpose. Please try again" });
      throw err;
    }
  ...
  const toggleActive = useCallback$9(async (id, currentStatus) => {
    ...
    try {
      ...
      toastApiError(err, { fallback: "Failed to update business purpose status. Please try again" });
      throw err;
    }
...
const useMileageTypeOperations = /* @__PURE__ */ __name((companyId, onSuccess) => {
  ...
  const handleCreateMileageType = useCallback$6(async (data) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: "Failed to create mileage type. Please try again" });
      throw error;
    }
  }, [companyId, createExpenseTypeMutation, onSuccess]);
  const handleUpdateMileageType = useCallback$6(async (id, data, originalData) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: "Failed to update mileage type. Please try again" });
      throw error;
    }
  }, [companyId, updateExpenseTypeMutation, onSuccess]);
  const toggleActiveMileageType = useCallback$6(async (id, currentStatus) => {
    ...
    try {
      ...
      toastApiError(error, { fallback: "Failed to update status. Please try again" });
      throw error;
    }
  }, [companyId, toggleExpenseTypeMutation, onSuccess]);
  return {
...
const ManageMileageRatesDialog = /* @__PURE__ */ __name(({
  ...
  const handleCreateRate = useCallback$2(async (rateData) => {
    ...
    try {
      ...
      toastApiError(error2, { fallback: "Failed to add mileage rate. Please try again" });
      throw error2;
    }
  ...
  const handleDeleteRate = useCallback$2(async (effectiveRateId) => {
    ...
    try {
      ...
      toastApiError(error2, { fallback: "Failed to delete mileage rate. Please try again" });
      throw error2;
    } finally {
...
const AssignEmployeesDialog = /* @__PURE__ */ __name(({
  ...
  const handleSave = useCallback$1(async () => {
    ...
    try {
      ...
      toastApiError(error2, { fallback: "Failed to save. Please try again" });
    }
...
const SetAsDefaultDialog = /* @__PURE__ */ __name(({
  ...
  const handleConfirm = /* @__PURE__ */ __name(async () => {
    ...
    try {
      ...
      toastApiError(error, { fallback: MILEAGE_TYPE_MESSAGES.SET_AS_DEFAULT_FAILURE });
    }
  }, "handleConfirm");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(oi, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    rs,
...
const MileageTypeTable = /* @__PURE__ */ __name(({ className }) => {
  ...
  const { data: unitOfMeasurements, isError: isUnitError } = useUnitOfMeasurements();
  const { data: taxTypes } = useTaxTypesDisplay({
    companyShortName: (adminCompany == null ? void 0 : adminCompany.shortName) || null
  });
  useErrorToast(isUnitError && !error, MILEAGE_TYPE_MESSAGES.UNIT_LOADING_ERROR);
