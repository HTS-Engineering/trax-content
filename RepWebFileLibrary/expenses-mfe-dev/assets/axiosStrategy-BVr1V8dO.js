import { z as shouldMockEndpoint, A as ENDPOINT_REGEX, a as addUploadedFile, h as hasUploadedFile, d as deleteUploadedFile, B as getBusinessPurposes, C as addBusinessPurpose, D as updateBusinessPurpose, F as deleteBusinessPurpose, G as addExpenseDraft, e as getExpenseDrafts, H as updateExpenseDraft, I as deleteExpenseDraft, J as addExpenseSubmitted, c as getExpenseSubmitted, y as findItemById, s as shouldSimulateError, K as createAxiosError, L as addMileageDraft, j as getMileageDrafts, M as updateMileageDraft, N as deleteMileageDraft, O as addMileageSubmitted, i as getMileageSubmitted, m as mockLogicalCompanies, k as mockFormTypes, l as getExpenseTypes, o as addExpenseType, u as updateExpenseType, p as getExpenseType, q as getMileageRates, P as generateDefaultMileageRates, w as setMileageRates, r as recalculateAllRateStatuses, t as sortRatesByStatus, x as calculateRateStatus, n as getNextExpenseTypeId, v as getNextMileageRateId } from "./mileage-rate-utils-Dj9O9qrf.js";
import { F as FILE_ENDPOINTS } from "./cost-allocation-Lb8etbcc.js";
...
import { b as devWarn, a as devLog } from "./use-debounced-callback-DQfTK-qN.js";
...
class AxiosStrategy {
  ...
  async handleFileUploadMock(config) {
    ...
    devLog(`✅ Axios Interceptor: ${isSupporting ? "Supporting file" : "Receipt"} uploaded successfully`, { id: fileId, filename, blobUrl });
    const mockResponse = {
      data: { data: response },
      status: 201,
      statusText: "Created",
  ...
  async handleFileDeleteMock(config) {
    ...
    devLog("✅ Axios Interceptor: File deleted successfully", { fileId });
    const mockResponse = {
