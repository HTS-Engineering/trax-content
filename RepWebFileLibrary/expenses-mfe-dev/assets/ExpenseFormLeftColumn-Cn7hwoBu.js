...
import { w as hs, y as vs, z as bs, H as ys, J as Cs, L as ws, P as Pe, I as In, u as us, V as Va, k as Ma, A as As, c as cs, X as Xn, d as ds, m as ms, a1 as Mt, a2 as za, T as Aa, D as Dn, E as En, M as Mn, a3 as zs, a4 as Ls, a5 as Hs, a6 as Wn } from "./index.es-Diw2MuFT.js";
...
import { c as create, d as devtools, a as apiClient } from "./axiosInstance-unDwCgGj.js";
import { i as useQueryClient, q as queryKeys, u as useCompanyStore } from "./factory-DSE5qHTU.js";
import { a as useDefaultCompany } from "./api-CeTlWAyP.js";
import { E as ExpenseFormType, F as FormTypeId, a as useExpenseTypes } from "./api-DcgizSzM.js";
import { P as Plus } from "./plus-CiLynJ8e.js";
import { a as useDebouncedCallback } from "./use-debounced-callback-Ch-mGAvD.js";
...
const { useCallback: useCallback$a, useEffect: useEffect$a, useImperativeHandle, useRef: useRef$7 } = await importShared("react");
...
const useMileageRateSync = ({
  ...
  }, [mileageType, companyShortName, queryClient]);
  useEffect$6(() => {
    if (!mileageRate) {
      return;
    }
...
const { memo, useCallback: useCallback$2, useState: useState$2 } = await importShared("react");
...
export {
  ...
  ECostAllocation as K,
  isMileageTripData as L,
  MileageFormType as M,
  isMileagePeriodData as N,
  usePendingUploadStore as O,
  minimalExpenseValidationStrategy as P,
  useBaseExpenseForm as Q,
  ReceiptSection as R,
  EXPENSE_LOCATION_OPTIONS as S,
  useReceiptCheckboxEffects as T,
  useFormButtonStateSync as U,
  VENDOR_OPTIONS as V,
  useFormImperativeHandle as W,
  FormSectionProvider as X,
  FormRenderer as Y,
  affidavitExpenseValidationStrategy as Z,
  useAutoSave as _,
  useMileageRateSync as a,
  expenseDescriptionField as a0,
  businessPurposeField as a1,
  reimbursableAmountField as a2,
  rateUnitField as a3,
  ratePerUnitField as a4,
  totalDistanceField as a5,
  expensePeriodField as a6,
  mileageTypeField as a7,
  validateCostAllocation as a8,
  PAYMENT_METHOD_DATA as a9,
  CURRENCY_OPTIONS as aa,
  useFormTypeId as ab,
  useCostAllocation as ac,
  AllocationTypeChips as ad,
  CostAllocationField as ae,
  AddAllocationExpandable as af,
  useEqualSplit as ag,
  COST_ALLOCATION_LABELS as ah,
  SupportingFiles as ai,
  MAX_SUPPORTING_FILES_FOR_MILEAGE_PERIOD as aj,
  expenseDetailsSchema as ak,
  expenseJustificationSchema as al,
  MileageTripFormField as am,
  AllowedMimeType as an,
  MIME_TYPE_CONFIG as ao,
