...
import { a2 as createLucideIcon, T as Ta, a4 as devError, v as Us, a5 as devLog, A as apiClient, $ as $a, az as za, ai as ln, K as Ka, L as La, aj as ms, l as Js, Z as Za, Q as Qa, aa as es, c as Bn, J as Ja, ao as qt, w as Ut, U as Ue, y as Yt, al as ns } from "./configuration-CJUUGdgp.js";
import { E as ExpenseStatusBadge, a as ExpensesList } from "./ExpensesList-BKSFYk0H.js";
import { ac as useQueryClient, _ as useCompanyStore, a4 as useMutation, P as queryKeys, c as EXPENSE_ENDPOINTS, ab as useQuery, r as formatToISODate, a as DEFAULT_CURRENCY_CODE, K as parseDateOnlyAsLocal, p as formatExpensePeriod, a5 as useNavigate, a3 as useLocation, a6 as useNavigateBack, t as generatePath, h as RoutePaths, a9 as useParams, af as useSearchParams } from "./date-format-D3C_Myvb.js";
import { y as isValidFileAttachment, E as ExpenseFormField, Y as useFormFieldValues, $ as useMileageRateSync, a2 as useReimbursableAmountSync, Q as useAmountAllocationSync, D as mapFormDataToUpdateRequest, A as mapFormDataToCreateRequest, z as mapCostAllocation, O as parseOptionalInt, N as parseOptionalDecimal, x as isMileageTripData, l as affidavitSchema, m as basicDetailsSchema, q as createValidationStrategy, p as createDraftSaveChecker, a4 as useTaxFieldVisibility, v as isConvertedExpense, a3 as useSetDefaultCurrency, e as ExpenseTypeSelect, g as MileagePeriodFormField, S as SupportingFiles, M as MAX_SUPPORTING_FILES_FOR_MILEAGE_PERIOD, F as FormSectionType, r as expenseDetailsSchema, s as expenseJustificationSchema, o as costAllocationSchema, k as additionalCommentsSchema, u as getExpenseBaseAmount, C as CostAllocationHeaderActions, a as CostAllocationSection, i as MileageTripFormField, I as mileageDetailsSchema, J as mileageJustificationSchema, T as useBaseExpenseForm, a5 as useValidatePrefilledFields, R as useAutoSave, X as useFormButtonStateSync, Z as useFormImperativeHandle, B as BaseExpenseFormRenderer, V as useExpenseFormHandlers, W as useExpenseFormSync, t as fullExpenseValidationStrategy, c as ExpenseFormLeftColumn, a0 as useMileageTripFormHandlers, H as mapMileageTripToDefaultValues, L as mileageTripValidationStrategy, P as supportingFilesSchema, _ as useMileagePeriodFormHandlers, G as mapMileagePeriodToDefaultValues, K as mileagePeriodValidationStrategy, w as isMileagePeriodData, f as MileageFormType, a1 as usePendingUploadStore, b as ExpenseFormHistoryLog, d as ExpensePreview, j as MileageTripPreview, h as MileagePeriodPreview } from "./CostAllocationSection-CgoM_2Ng.js";
import { p as useExpenseTypes, d as FormTypeId, I as ItemCategory, l as useCurrencies, u as useCountries, v as useTaxTypesDisplay, n as useDefaultCurrency, q as useFormTypeId, a as ExpenseFormType, j as isRegularExpense, h as isMileageExpense, f as isExpenseItemSubmitted, o as useExpenseItem, i as isExpenseItemDraft } from "./expense-api-DTK1gyB4.js";
import { M as MILEAGE_RATES_STALE_TIME, g as fetchEffectiveMileageRate, o as object, s as string, c as boolean, e as custom, a as Controller, d as createDecimalChangeHandler, w as useWatch, C as ConfirmDialog } from "./useMileageRates-BKrPb9cF.js";
import { importShared } from "./__federation_fn_import-CDCQK-Sj.js";
import { u as useBusinessPurposes } from "./business-purpose-api-CPlMNGz9.js";
import { a as useDefaultCompany } from "./queryClient-CJOuzTwC.js";
import { I as Icon } from "./Icon-qrAJyYZL.js";
import { e as formatRate, a as formatCurrency, b as formatDate } from "./formatters-BndmIIYd.js";
import { T as Trash2, S as Send } from "./trash-2-ChWC3EET.js";
const __iconNode$1 = [
...
const getMileageTypesFromCache = /* @__PURE__ */ __name((queryClient, companyShortName) => {
...
async function resolveEffectiveMileageRateId(queryClient, companyShortName, expenseTypes, mileageTypeId) {
  if (!mileageTypeId) return null;
  const selectedType = expenseTypes == null ? void 0 : expenseTypes.find((et) => et.id === mileageTypeId);
  if (!(selectedType == null ? void 0 : selectedType.mileageRateId)) return null;
  const date = formatToISODate(/* @__PURE__ */ new Date());
  if (!date) return null;
  const rate = await queryClient.fetchQuery({
    ...
    queryFn: /* @__PURE__ */ __name(() => fetchEffectiveMileageRate(companyShortName, selectedType.mileageRateId, date), "queryFn"),
...
const MileageDetailsSection = /* @__PURE__ */ __name(({
  ...
  const { ratePerUnit, rateUnit, reimbursableAmount, totalCurrency } = useFormFieldValues(
    control,
    [
      "ratePerUnit",
      "rateUnit",
  ...
  useEffect$2(() => {
    ...
    setMileageValue("totalCurrency", { code: defaultCurrencyCode, symbol: defaultCurrencySymbol }, { shouldValidate: false, shouldDirty: false });
  }, [countriesLoading, currenciesLoading, defaultCurrencyCode, defaultCurrencySymbol, setMileageValue, totalCurrency == null ? void 0 : totalCurrency.code, totalCurrency == null ? void 0 : totalCurrency.symbol]);
...
function FormPageDialog({
  ...
  const renderFooter = /* @__PURE__ */ __name(() => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Ja, { className: "pt-4 gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: footer.showDeleteButton && /* @__PURE__ */ jsxRuntimeExports.jsxs(qt, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Yt, { className: "text-sm", children: "Delete draft" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(qt, { children: [
          ...
          footer.saveDraftButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Yt, { variant: "light", size: "sm", side: "bottom", showArrow: false, children: footer.saveDraftButtonState.tooltip })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(qt, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Ue,
            {
              ...
              children: [
                footer.isSubmitting ? /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "size-5" }),
                "Submit Expense"
              ]
            }
          ) }) }),
          footer.submitButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Yt, { className: "text-sm", children: footer.submitButtonState.tooltip })
        ] })
      ] })
    ] }) });
  }, "renderFooter");
  const renderLoadingOrContent = /* @__PURE__ */ __name(() => {
    if (isLoading) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-8 text-exp-primary-blue-600" }) });
    }
