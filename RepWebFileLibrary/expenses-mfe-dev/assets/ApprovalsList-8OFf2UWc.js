...
import { u as useJWTStore, b as apiClient, e as ei, $ as $a, B as Br, d as devError, Z as Zs, f as as, H as Ha, U as Ue, Y as Yn, g as Mt, E as Et, P as Pt, h as gr, o as oi, r as rs, i as os, s as ss, l as ls, T as Ta, z as za, n as ni } from "./configuration-yhOjQUnR.js";
import { k as formatAmountWithCurrency, l as formatDate, m as formatDateRange, n as formatExpenseDate, e as useCompanyStore, o as useQuery, q as queryKeys, p as keepPreviousData, E as EXPENSE_ENDPOINTS, r as useSearchParams, d as useLocation, a as RoutePaths, F as FormTypeId, s as isExpenseItemSubmitted, t as useQueryClient, v as useMutation, w as isRegularExpense, x as isMileageExpense, y as useScrollIntoViewRef, z as useExpenseItem, B as useErrorToast, u as useNavigate, C as useParams, g as generatePath } from "./use-scroll-into-view-ref-DPvbfUeD.js";
import { g as getExpenseTypeBadgeConfig } from "./expense-type-badge-BW-dllub.js";
import { I as Icon } from "./Icon-5RIpWGMw.js";
import { g as getExpenseBaseAmount, E as ExpensePreview, i as isMileageTripData, M as MileageTripPreview, a as isMileagePeriodData, b as MileagePeriodPreview } from "./http-errors-tf-F7cSg.js";
import { g as getExpenseErrorMessage, b as buildHeaderFromExpenseItem } from "./expense-error-message-CFBABkZl.js";
import "./hooks-JDhUeD9d.js";
import { m as mapCostAllocation, v as validateCostAllocation, a as useCostAllocationHandlers, C as CostAllocationHeaderActions, b as CostAllocationSection, c as costAllocationItemSchema, E as ExpenseFormHistoryLog } from "./CostAllocationSection-f_dRjSFP.js";
import { o as object, s as string, b as boolean, a as array, c as custom, u as useForm, d as u, C as ConfirmDialog } from "./useMileageRates-DMwbaOhj.js";
