...
import { A as apiClient, ab as hs, ax as xs, ae as ir, aw as ws, c as Bn, aj as ms, u as Tr, v as Us, am as p, ak as mt, i as Et, U as Ue, ac as ht, T as Ta, a1 as create, a7 as devtools, a6 as devWarn, a4 as devError, a5 as devLog, j as Gt, ai as ln$1, K as Ka, ao as qt, w as Ut, y as Yt, d as Bs, ag as js, G as Gs, L as La, $ as $a, ap as sr, q as Qs, Y as Ye, O as Oa } from "./configuration-CJUUGdgp.js";
import { I as Icon } from "./Icon-qrAJyYZL.js";
import { v as useTaxTypesDisplay, r as useFormTypeName, a as ExpenseFormType, E as ECostAllocation, n as useDefaultCurrency, p as useExpenseTypes, d as FormTypeId, A as AllowedMimeType, F as FILE_SIZE_LIMITS, M as MIME_TYPE_CONFIG, c as FilePreviewType, u as useCountries, m as useDefaultCountry, q as useFormTypeId } from "./expense-api-DTK1gyB4.js";
import { a as formatCurrency, d as formatDistance, e as formatRate } from "./formatters-BndmIIYd.js";
import { F as FILE_ENDPOINTS, _ as useCompanyStore, o as formatExpenseDate, E as EMPTY_CURRENCY_SYMBOL, p as formatExpensePeriod, ab as useQuery, c as EXPENSE_ENDPOINTS, P as queryKeys, q as formatHistoryTimestamp, a as DEFAULT_CURRENCY_CODE, r as formatToISODate, $ as useDebouncedCallback, a8 as useNumericDisplay, u as getCurrencySymbol } from "./date-format-D3C_Myvb.js";
import { importShared } from "./__federation_fn_import-CDCQK-Sj.js";
import { I as Info, s as string, D as DECIMAL_FORMAT_REGEX, o as object, e as custom, c as boolean, b as array, f as date, i as unknown, n as number, C as ConfirmDialog, w as useWatch, r as useForm, u, l as literal, p as useEffectiveMileageRate, t as useFormState, a as Controller, d as createDecimalChangeHandler } from "./useMileageRates-BKrPb9cF.js";
import { a as useDefaultCompany, q as queryClient } from "./queryClient-CJOuzTwC.js";
...
import { R as RefreshCw } from "./refresh-cw-B_g7jfHM.js";
...
const PreviewReceiptSection = /* @__PURE__ */ __name(({ receipt, stretchToFill = false }) => {
  ...
  const renderLoading = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center h-64 bg-exp-neutral-30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-10" }) }), "renderLoading");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: "shadow-none border-0 bg-transparent p-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(xs, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ir,
      {
        title: "RECEIPT",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ws, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-lg overflow-hidden bg-exp-neutral-30 border border-exp-primary-blue-100", children: [
...
const PreviewAffidavitSection = /* @__PURE__ */ __name(({ affidavit }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ws, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-exp-yellow-200 bg-exp-yellow-100 p-4", children: [
...
const PreviewExpenseDetailsSection = /* @__PURE__ */ __name(({ data }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ws, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-8 gap-y-4", children: [
...
const PreviewExpenseJustificationSection = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ws, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
...
const PreviewCostAllocationSection = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: deferred ? "shadow-none border-0 bg-transparent p-0 gap-0" : "shadow-none border-0 bg-transparent p-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(xs, { className: deferred ? "p-0 gap-0" : "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ir,
        {
    ...
    allocations && !deferred && /* @__PURE__ */ jsxRuntimeExports.jsx(ws, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: allocations.map((allocation, index) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 text-right flex", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tr, { className: "rounded-lg bg-exp-primary-blue-50 text-exp-neutral-900 hover:bg-exp-primary-blue-50", children: [
...
const PreviewSupportingFilesSection = /* @__PURE__ */ __name(({
  ...
  const handleFileClick = /* @__PURE__ */ __name(async (file) => {
    ...
    try {
      ...
      if (controller.signal.aborted) return;
      Us.error("Failed to download file. Please try again.");
    } finally {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ws, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: files.map((file) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-4 shrink-0" }) : getFileIcon(file.mimeType),
...
const PreviewAdditionalCommentsSection = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ws, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-exp-neutral-900 wrap-break-word", children: comments }) })
  ] });
...
const PreviewMileageTripDetailsSection = /* @__PURE__ */ __name(({ data }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: "shadow-none border-0 bg-transparent p-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(xs, { className: "p-0 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ir,
        {
      ...
      data.isRoundTrip && /* @__PURE__ */ jsxRuntimeExports.jsx(Tr, { className: "bg-exp-neutral-30 text-exp-neutral-600 font-medium hover:bg-none! cursor-default", children: "Round trip" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ws, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-8 gap-y-4", children: [
...
const ExpenseFormHistoryLog = /* @__PURE__ */ __name(({
  ...
  const renderContent = /* @__PURE__ */ __name(() => {
    if (isLoading) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-6 text-exp-primary-blue-600" }) });
    }
    if (isError) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(mt, { open, onOpenChange: handleOpenChange, modal: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Et, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Ue,
      {
        ...
        children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center h-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-4" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          statusLabel,
...
P.comparedTo = P.cmp = function(y) {
  var i, j, xdL, ydL, x = this, xd = x.d, yd = (y = new x.constructor(y)).d, xs2 = x.s, ys = y.s;
  if (!xd || !yd) {
    return !xs2 || !ys ? NaN : xs2 !== ys ? xs2 : xd === yd ? 0 : !xd ^ xs2 < 0 ? 1 : -1;
  }
  if (!xd[0] || !yd[0]) return xd[0] ? xs2 : yd[0] ? -ys : 0;
...
function taylorSeries(Ctor, n, x, y, isHyperbolic) {
  var j, t, u2, x2, pr = Ctor.precision, k = Math.ceil(pr / LOG_BASE);
  external = false;
  x2 = x.times(x);
  u2 = new Ctor(y);
  for (; ; ) {
...
const areAllocationsEqual = /* @__PURE__ */ __name((allocations, totalAmount) => {
  ...
  return allocations.every((allocation, index) => {
    ...
    if (isLastItem) {
      const sumOfOthers = allocations.slice(0, -1).reduce((sum2, a) => sum2 + a.amount, 0);
...
const recalculateAmounts = /* @__PURE__ */ __name((allocations, totalAmount) => {
  ...
  if (isFullAllocation) {
    return allocations.map((allocation, index) => {
      const isLastItem = index === allocations.length - 1;
      if (isLastItem) {
        const sumOfOthersDecimal = allocations.slice(0, -1).reduce((sum2, a) => {
...
const generateId = /* @__PURE__ */ __name(() => crypto.randomUUID(), "generateId");
...
const ReceiptUpload = /* @__PURE__ */ __name(({
  ...
  const loadFile = useCallback$j(async (targetAttachment) => {
    ...
    try {
      ...
      fileLoadAttemptedRef.current.add(targetAttachment.id);
      setFileLoadError(getHttpErrorMessage(error));
      setIsLoadingFile(false);
    }
  ...
  const handleFileUploadInternal = useCallback$j(async (file, targetExpenseId) => {
    ...
    if (!effectiveExpenseId || !(userDefaultCompany == null ? void 0 : userDefaultCompany.shortName)) {
      ...
      Us.error(errorMsg, { duration: 4e3 });
    ...
    try {
      ...
      const isCanceled = error instanceof Error && (error.name === "AbortError" || error.name === "CanceledError");
      if (isCanceled) return;
      setUploadStatus("error", getHttpErrorMessage(error));
      handleError({
        type: "network",
  ...
  const renderLoadingState = /* @__PURE__ */ __name((message) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full items-center justify-center p-8 text-center gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4.5 flex items-center justify-center bg-exp-teal-200 rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-14" }) }),
  ...
  if (section.hideHeader) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConditionalSection,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-section-id": section.id, children: /* @__PURE__ */ jsxRuntimeExports.jsx(hs, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ws, { children: section.render(finalProps) }) }) }, section.id)
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ConditionalSection,
    {
      ...
      behavior,
      onDisabledChange: handleDisabledChange,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-section-id": section.id, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: hideCardGap, children: [
        "    ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(xs, { className: hideCardGap, children: headerActionsNode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ir,
            {
              title: section.title,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ws, { children: section.render(finalProps) })
      ] }) }, section.id)
    }
  );
...
const useMileageRateSync = /* @__PURE__ */ __name(({
  ...
  const selectedType = useMemo$3(() => {
    if (!mileageType) return void 0;
    return expenseTypes == null ? void 0 : expenseTypes.find((et) => et.id === mileageType);
  }, [mileageType, expenseTypes]);
  const todayISO = useMemo$3(() => formatToISODate(/* @__PURE__ */ new Date()) ?? "", []);
  const { data: effectiveRate } = useEffectiveMileageRate({
    companyShortName,
    mileageRateId: (selectedType == null ? void 0 : selectedType.mileageRateId) ?? null,
    date: todayISO,
    enabled: !!(selectedType == null ? void 0 : selectedType.mileageRateId)
  });
  useEffect$4(() => {
  ...
  }, [selectedType, effectiveRate, setValue, getValues]);
}, "useMileageRateSync");
...
const AllocationTypeChips = memo$2(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: allocationTypes.map((allocationType) => /* @__PURE__ */ jsxRuntimeExports.jsxs(qt, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Gt,
      {
        disabled,
...
const AddAllocationExpandable = memo$1(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Bs, { open: isOpen, onOpenChange: setIsOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(js, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ue, { variant: "outlined", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, {}), disabled, children: COST_ALLOCATION_LABELS.ADD_ALLOCATION }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Gs, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AllocationTypeChips, { onSelect: handleTypeSelect, disabled }) })
  ] });
});
...
function AffidavitContent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex-1 flex flex-col min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(hs, { className: "w-full max-h-full bg-yellow-50 border border-yellow-200 p-3 flex flex-col overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 h-full overflow-y-auto", children: [
...
function ReceiptSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: "h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(xs, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-nowrap justify-between items-center min-h-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ir,
        {
          iconClassName: "bg-exp-yellow-001 justify-center items-center flex",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ws, { className: "min-h-0 h-full", children: isReceiptUnavailable ? hideUploadWhenUnavailable ? null : /* @__PURE__ */ jsxRuntimeExports.jsx(AffidavitContent, { control, disabled }) : !shouldHideUpload && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ReceiptUpload,
      {
        onReceiptChange,
        onUploadingChange,
...
function FileName({ name, showTooltip = true }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(qt, { open: canShowTooltip && isOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        ref,
...
function SupportingFileCard({
  ...
  if (isUploading || isLoadingPreview) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(hs, { className: "bg-white px-2 py-2 w-full flex justify-between flex-row items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-4 shrink-0" }),
  ...
  if (hasError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: "bg-exp-red-100 px-2 py-2 w-full flex justify-between flex-row items-center", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: "bg-white hover:bg-trax-neutral-20 px-2 py-2 w-full flex justify-between flex-row items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
...
function SupportingFiles({
    ...
    for (let i = 0; i < filesToProcess.length; i++) {
      ...
      if (error) {
        ...
        try {
          ...
          const errorMessage = getHttpErrorMessage(error2);
  ...
  const handleFileChange = useCallback$1(async (e) => {
    ...
    if (totalFiles > maxFiles) {
      ...
      if (filesToAdd <= 0) {
        Us.error(`Maximum ${maxFiles} supporting file${maxFiles > 1 ? "s" : ""} allowed`, {
          duration: 3e3
        });
        return;
      }
      Us.error(`Only ${filesToAdd} more file(s) can be added`, {
        duration: 3e3
      });
    ...
    if (!onSaveDraftForUpload) {
      Us.error("Cannot upload files: please save the expense first", {
        duration: 3e3
      });
      return;
    }
    ...
    try {
      ...
      Us.error("Failed to save expense. Please try again.", {
        duration: 3e3
      });
    }
  ...
  const handleDeleteConfirm = useCallback$1(async () => {
    ...
    if (file) {
      ...
      try {
        ...
        Us.error("Failed to delete file", {
          duration: 3e3
        });
      }
    }
  ...
  const handlePreviewClick = useCallback$1(async (file) => {
    ...
    if (!blobUrl && ((_a = file.url) == null ? void 0 : _a.startsWith("/api/"))) {
      ...
      try {
        ...
        const isCanceled = error instanceof Error && (error.name === "AbortError" || error.name === "CanceledError");
        if (isCanceled) return;
        Us.error("Failed to download file. Please try again.", { duration: 3e3 });
        return;
      } finally {
        previewAbortControllersRef.current.delete(file.id);
    ...
    try {
      ...
      Us.error("Failed to open file preview", {
        duration: 3e3
      });
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(xs, { className: `flex items-center flex-col w-full h-fit overflow-clip ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row w-full items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center w-full ml-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(qt, { delayDuration: TOOLTIP_DELAY_QUICK, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(GrCircleInformation, { className: "text-gray-500 hover:cursor-pointer select-none" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Yt, { variant: "default", side: "top", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-trax-blue-700 text-white border-none text-sm p-2 w-64", children: displayTooltip }) })
      ] }) }),
      ...
      ) : !hideAddButtonWhenFull ? /* @__PURE__ */ jsxRuntimeExports.jsxs(qt, { delayDuration: TOOLTIP_DELAY_QUICK, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleAddSupportingDocumentClick, disabled: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaPlus, { className: "opacity-20 hover:cursor-not-allowed" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Yt,
          {
            variant: "light",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(hs, { className: `bg-white w-full p-0 ${state.attachments.length === 0 && !state.isUploading && pendingSupportingFiles.length === 0 ? "h-0" : "h-auto"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col my-1 mx-2 gap-1", children: [
      ...
      (isSavingDraft || isUploading) && pendingSupportingFiles.map((file, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(hs, { className: "bg-white px-2 py-2 w-full flex justify-between flex-row items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
...
const ExpenseFormLeftColumn = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: "w-full h-full flex flex-col pt-1", children: [
...
function CostAllocationSectionComponent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Oa, { value: progressValue, disabled: isProgressDisabled, error: progressError }),
...
export {
  useMileageRateSync as $,
  mapFormDataToCreateRequest as A,
  BaseExpenseFormRenderer as B,
  CostAllocationHeaderActions as C,
  mapFormDataToUpdateRequest as D,
  ExpenseFormField as E,
  FormSectionType as F,
  mapMileagePeriodToDefaultValues as G,
  mapMileageTripToDefaultValues as H,
  mileageDetailsSchema as I,
  mileageJustificationSchema as J,
  mileagePeriodValidationStrategy as K,
  mileageTripValidationStrategy as L,
  MAX_SUPPORTING_FILES_FOR_MILEAGE_PERIOD as M,
  parseOptionalDecimal as N,
  parseOptionalInt as O,
  supportingFilesSchema as P,
  ...
  useFormButtonStateSync as X,
  useFormFieldValues as Y,
  useFormImperativeHandle as Z,
  useMileagePeriodFormHandlers as _,
  CostAllocationSection as a,
  useMileageTripFormHandlers as a0,
  usePendingUploadStore as a1,
  useReimbursableAmountSync as a2,
  useSetDefaultCurrency as a3,
  useTaxFieldVisibility as a4,
  useValidatePrefilledFields as a5,
  validateCostAllocation as a6,
  ExpenseFormHistoryLog as b,
  ExpenseFormLeftColumn as c,
  ExpensePreview as d,
  ExpenseTypeSelect as e,
  MileageFormType as f,
  MileagePeriodFormField as g,
  MileagePeriodPreview as h,
  MileageTripFormField as i,
  MileageTripPreview as j,
  additionalCommentsSchema as k,
  affidavitSchema as l,
  basicDetailsSchema as m,
  costAllocationItemSchema as n,
  costAllocationSchema as o,
  createDraftSaveChecker as p,
  createValidationStrategy as q,
  expenseDetailsSchema as r,
  expenseJustificationSchema as s,
  fullExpenseValidationStrategy as t,
  getExpenseBaseAmount as u,
  isConvertedExpense as v,
  isMileagePeriodData as w,
  isMileageTripData as x,
  isValidFileAttachment as y,
  mapCostAllocation as z
};
