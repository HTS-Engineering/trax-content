...
import { a as apiClient, t as ti, T as Ta, j as jr, n as dr, p as ns, r as ri, z as za, A as Aa, Y as Yn } from "./configuration-nK8EePvi.js";
import { d as useCompanyStore, t as useAppQuery, v as keepPreviousData, k as EXPENSE_ENDPOINTS, q as queryKeys, p as formatAmountWithCurrency, w as useSearchParams, u as useLocation, E as EmptyState, z as useNavigateWithReturn, h as useErrorSurface, x as generatePath, a as RoutePaths, D as DataLoadError } from "./use-scroll-into-view-ref-jD-IsvAs.js";
...
const useExpensesColumns = /* @__PURE__ */ __name(({
  ...
  const statusDateColumn = useMemo$2(() => {
    ...
    return {
      ...
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ta, { column, title: getStatusColumnHeader(currentStatusFilter) }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ti,
        {
          context,
...
const LIST_LOAD_ERROR = "Failed to load expenses. Please try again later.";
const ExpensesList = /* @__PURE__ */ __name(() => {
  ...
  const query = useExpensesList(queryParams, { enabled: isOnListPage });
  ...
  const failure = useErrorSurface(query, {
    ...
    canRenderInPlace: expenses.length === 0
  });
  ...
  const renderToolbar = /* @__PURE__ */ __name((table) => /* @__PURE__ */ jsxRuntimeExports.jsxs(za, { table, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Aa,
      {
        className: "gap-2",
