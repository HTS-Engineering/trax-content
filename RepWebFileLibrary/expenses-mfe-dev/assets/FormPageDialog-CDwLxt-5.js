...
import { j as isValidFileAttachment, D as DEFAULT_PAYMENT_METHOD, k as ExpenseFormField, l as useFormFieldValues, n as computeMileageEffectiveOn, o as useMileageRateSync, p as useReimbursableAmountSync, q as useAmountAllocationSync, r as useMileageCurrencySync, E as ExpenseItemType, s as affidavitSchema, t as basicDetailsSchema, w as createValidationStrategy, x as createDraftSaveChecker, y as useTaxFieldVisibility, z as usePaymentMethods, A as useSetDefaultCurrency, B as ExpenseTypeSelect, F as allowsNegativeAmounts, G as getTaxAmountWarning, H as MileagePeriodFormField, S as SupportingFiles, I as MAX_SUPPORTING_FILES_FOR_MILEAGE_PERIOD, J as isSameCalendarMonth, K as useHomeCurrency, L as MILEAGE_CURRENCY_UNAVAILABLE_MESSAGE, N as NO_MILEAGE_RATE_FOR_DATE_MESSAGE, O as FormSectionType, C as CostAllocationHeaderActions, g as CostAllocationSection, Q as MileageTripFormField, R as useBaseExpenseForm, T as useValidatePrefilledFields, U as useAutoSave, V as useFormButtonStateSync, W as useFormImperativeHandle, X as BaseExpenseFormRenderer, Y as useExpenseFormHandlers, Z as useExpenseFormSync, _ as fullExpenseValidationStrategy, $ as ExpenseFormLeftColumn, a0 as useMileageTripFormHandlers, a1 as mapMileageTripToDefaultValues, a2 as mileageTripValidationStrategy, a3 as useMileagePeriodFormHandlers, a4 as mapMileagePeriodToDefaultValues, a5 as mileagePeriodValidationStrategy, i as isMileageTripData, d as isMileagePeriodData } from "./CostAllocationSection-kFfn9PzT.js";
import { o as object, s as string, c as boolean, d as custom, e as Controller, h as createDecimalChangeHandler, f as useWatch, C as ConfirmDialog } from "./schemas-B77TBeqV.js";
import { bo as createLucideIcon, bt as useDefaultCompany, v as jsxRuntimeExports, aM as Ba, aE as useExpenseTypes, al as FormTypeId, E as useCompanyStore, bu as isConvertedExpense, aU as useCurrencies, bv as useCountries, bi as useTaxTypesDisplay, bw as useDefaultCurrency, ap as Oa, bx as ja, b3 as formatToISODate, b4 as parseDateOnlyAsLocal, aY as gn, b5 as ts, bf as TaxTypeSearchSelect, by as useFormTypeId, aG as ExpenseFormType, bz as Ga, b9 as useMileageRates, bA as useEffectiveMileageRate, bd as ys, bB as formatRate, bC as formatCurrency, aa as Icon, au as getExpenseBaseAmount, aW as devLog, O as isMileageExpense, bD as isExpenseItemDraft, $ as isRegularExpense, aC as ai, aD as os, b0 as as, b1 as is, a0 as us, aj as Yn, ao as ss, aq as Ue, ar as Mt, as as Et, at as Pt } from "./__federation_expose_Mount-C0AnMBl2.js";
import { importShared } from "./__federation_fn_import-CZ2UOLBn.js";
import { c as useBusinessPurposes } from "./business-purpose-api-DynBWPvI.js";
import { T as Trash2, S as Send } from "./trash-2-a5zJFDCe.js";
const __iconNode$1 = [
...
const mapFullExpenseToDefaultValues = /* @__PURE__ */ __name((initialData) => {
  return {
    ...
    // written back by the form sync; must be in the baseline or that write reads as a user change
...
const buildFooter = /* @__PURE__ */ __name((result, recall) => {
  if (result.mode === "preview") {
    return recall ? { kind: "recall", ...recall } : void 0;
  }
  if (!result.isNewItem && result.isLoading) return void 0;
  return {
    kind: "edit",
    showDeleteButton: !!result.currentDraftId,
    submitButtonState: result.submitButtonState,
    saveDraftButtonState: result.saveDraftButtonState,
    isSavingDraft: result.isSavingDraft,
    isSubmitting: result.isSubmitting,
    onDeleteClick: result.handleDeleteDraft,
    onSaveDraftClick: result.handleSaveDraftClick,
    onSubmitClick: result.handleSubmitClick
  };
}, "buildFooter");
const buildExpenseItemFormDialogProps = /* @__PURE__ */ __name((result, options = {}) => {
  return {
    footer: buildFooter(result, options.recall),
    deleteDialog: {
      isOpen: result.isDeleteDialogOpen,
      isDeleting: result.isDeleting,
      description: deleteDescription(result.itemType),
      onOpenChange: result.handleDeleteDialogOpenChange,
      onCloseComplete: result.handleDeleteDialogCloseComplete,
      onConfirm: result.handleDeleteConfirm,
      onCancel: result.handleDeleteCancel
    }
  };
}, "buildExpenseItemFormDialogProps");
...
const TaxAmountInput = /* @__PURE__ */ __name(({ control, taxTypes, disabled, allowNegative }) => {
  const { taxAmount, taxType, netAmount, totalAmount, netCurrency, totalCurrency } = useFormFieldValues(control, [
    "taxAmount",
    "taxType",
    "netAmount",
    "totalAmount",
  ...
  const taxAmountWarning = getTaxAmountWarning({ taxAmount, taxType, taxTypes, netAmount, totalAmount, netCurrency, totalCurrency });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Controller,
    {
      name: "taxAmount",
      ...
      render: /* @__PURE__ */ __name(({ field, fieldState }) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          ts,
          {
            ...
            warning: taxAmountWarning ?? void 0,
            disabled
          }
        );
      }, "render")
...
const ExpenseDetailsSection = /* @__PURE__ */ __name(({
  ...
  const isReferenceDataReady = !!currencies && !!countriesResponse && !!paymentMethods;
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Controller,
        {
          ...
          control,
          render: /* @__PURE__ */ __name(({ fieldState }) => {
            var _a;
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              Oa,
              {
...
const createExpenseForm = /* @__PURE__ */ __name((config) => {
  const FormComponent = forwardRef(
    (props, ref) => {
      ...
      useFormButtonStateSync({ form, onButtonStateChange });
...
const ExpenseItemFormBody = /* @__PURE__ */ __name(({ result }) => {
  const {
    formRef,
    formKey,
    itemType,
  ...
  const isTrip = itemType === ExpenseItemType.MileageTrip || expenseItem && isMileageExpense(expenseItem) && isMileageTripData(expenseItem.data);
  if (isTrip) {
  ...
  const isPeriod = itemType === ExpenseItemType.MileagePeriod || expenseItem && isMileageExpense(expenseItem) && isMileagePeriodData(expenseItem.data);
  if (isPeriod) {
...
function FormPageDialog({
  ...
  const renderHeader = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsxRuntimeExports.jsx(as, { className: "pb-3 mb-3 border-b border-exp-primary-blue-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between gap-2 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-nowrap items-center justify-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(is, { className: "text-exp-neutral-900 text-xl font-bold flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(us, { variant: "light", size: "sm", maxWidth: 320, tooltipDisabled: true, className: "text-exp-neutral-900 text-xl font-bold", children: header.title }) }),
      header.titleSuffix,
  ...
  const renderEditActions = /* @__PURE__ */ __name((config) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: config.showDeleteButton && /* @__PURE__ */ jsxRuntimeExports.jsxs(Mt, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Et, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Ue,
        {
          type: "button",
          variant: "ghost",
          onClick: config.onDeleteClick,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Mt, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Et, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ue,
          {
            type: "button",
            variant: "outlined",
            onClick: config.onSaveDraftClick,
            disabled: config.saveDraftButtonState.disabled,
            children: config.isSavingDraft ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Yn, { className: "size-5" }),
              "Save Draft"
            ] }) : "Save Draft"
          }
        ) }) }),
        config.saveDraftButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Pt, { variant: "light", size: "sm", side: "bottom", showArrow: false, children: config.saveDraftButtonState.tooltip })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Mt, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Et, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Ue,
          {
            type: "button",
            variant: "primary",
            onClick: config.onSubmitClick,
            disabled: config.submitButtonState.disabled,
            children: [
              config.isSubmitting ? /* @__PURE__ */ jsxRuntimeExports.jsx(Yn, { className: "size-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "size-5" }),
              "Submit Expense"
            ]
          }
        ) }) }),
        config.submitButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Pt, { className: "text-sm", children: config.submitButtonState.tooltip })
      ] })
    ] })
  ] }), "renderEditActions");
  const renderRecallActions = /* @__PURE__ */ __name((config) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-end w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Ue,
    {
      type: "button",
      variant: "secondary",
      onClick: config.onRecall,
      disabled: config.isRecalling,
      children: [
        config.isRecalling && /* @__PURE__ */ jsxRuntimeExports.jsx(Yn, { className: "size-5" }),
        RECALL_LABEL[config.intent]
      ]
    }
  ) }), "renderRecallActions");
  const renderFooter = /* @__PURE__ */ __name(() => {
    if (!footer) return null;
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ss, { className: "pt-4 gap-4", children: footer.kind === "recall" ? renderRecallActions(footer) : renderEditActions(footer) });
  }, "renderFooter");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    backgroundContent,
    /* @__PURE__ */ jsxRuntimeExports.jsx(ai, { open: true, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      os,
      {
...
export {
  ExpenseItemFormBody as E,
  FormPageDialog as F,
  MileageTripForm as M,
  ExpenseForm as a,
  buildExpenseItemFormDialogProps as b,
  MileagePeriodForm as c
};
