...
var _a, _list, _lens, _LensList_instances, openLens_fn, _b, _c, _d, _e, _f, _returnType, _g, _listeners, _listenerOptions, _listenerAbortCleanups, _typelessListeners, _hookListeners, _hookListenerOptions, _hookListenerAbortCleanups, _Emitter_instances, deleteHookListener_fn, deleteListener_fn, addListener_fn, proxyEvent_fn, callListener_fn, matchListeners_fn, isTypelessListener_fn, _h, _i, _j, _k, _l, _m, _executor, _DeferredPromise_instances, decorate_fn, _n, _o, _p, _q, _r, _s, _t, _u, _v, _storageKey, _jar, _memoryStore, _HandlersController_instances, validateHandlers_fn, _handlers, _initialHandlers, _replacements, _w, _x, _y, _z, _A, _B, _C, _D, _E, _interceptor, _frames, _InterceptorSource_instances, handleRequest_fn, handleResponse_fn, handleWebSocketConnection_fn, _controller, _F, _G, _H, _I, _J, _K, _executor2, __this_instances, decorate_fn2, _L, _M, _N, _O, _P, _Q, _R, _S, _T, _executor3, __this_instances2, decorate_fn3, _U, _V, _RequestController2_instances, handled_get, _W, _X, _list2, _lens2, __this_instances3, openLens_fn2, _Y, _Z, __, _$, _aa, _returnType2, _ba, _listeners2, _listenerOptions2, _listenerAbortCleanups2, _typelessListeners2, _hookListeners2, _hookListenerOptions2, _hookListenerAbortCleanups2, __this_instances4, deleteHookListener_fn2, deleteListener_fn2, addListener_fn2, proxyEvent_fn2, callListener_fn2, matchListeners_fn2, isTypelessListener_fn2, _ca, _workerEvent, _da, _getWorker, _controller2, _ea, _fa, _current, _options, _frames2, _channel, _listenerController, _clientPromise, _keepAliveInterval, _stoppedAt, __ServiceWorkerSource_instances, startWorker_fn, handleRequest_fn2, handleResponse_fn2, _defaultFindWorker, checkWorkerIntegrity_fn, printStartMessage_fn, printStopMessage_fn, _event, __this_instances5, respondWith_fn, _ga, _ha, _ia, _ja, _ka, _la, _ma, _na, __this_instances6, printStartMessage_fn2, printStopMessage_fn2, _oa;
import { E as ENDPOINT_PATTERNS, v as validateFile, g as generateFileId, f as fileToBase64, a as addUploadedFile, b as getUploadedFile, c as base64ToBuffer, h as hasUploadedFile, d as deleteUploadedFile, e as generateBusinessId, i as isMileageRequest, j as createExpenseDraftResponse, s as setRawRequest$1, k as addMileageDraft, l as buildMileageDraftMock, m as addExpenseDraft, n as buildExpenseDraftMock, o as findDraftById, r as reverseMapToMileageFormData, u as updateMileageDraft, p as reverseMapToExpenseFormData, q as updateExpenseDraft, t as getRawRequest, w as getExpenseDrafts, x as getMileageDrafts, y as deleteDraftById, z as addMileageSubmitted, A as buildSubmittedMileageMock, B as addExpenseSubmitted, C as buildSubmittedExpenseMock, D as shouldSimulateError, F as generateMockError, G as mockLogicalCompanies, H as mockFormTypes, I as getExpenseTypes, J as getNextExpenseTypeId, K as addExpenseType, L as updateExpenseType, M as getExpenseType, N as getMileageRates, O as recalculateAllRateStatuses, P as sortRatesByStatus, Q as getNextMileageRateId, R as setMileageRates, S as calculateRateStatus, T as getExpenseSubmitted, U as mapMockToExpenseFormResponse, V as getMileageSubmitted, W as findItemById, X as shouldMockEndpoint } from "./expense-response-mappers-DhgImaNn.js";
import { a as devLog, b as devWarn, d as devError } from "./index-vtzBEVcA.js";
import { E as ExpenseFormStatus } from "./expense-data-Du2WjKhi.js";
import { z as MileageRateStatus } from "./expense-api-DJdfwUeG.js";
...
__name(serializePositional$1, "serializePositional$1");
...
__name(cleanErrorStack$1, "cleanErrorStack$1");
var InvariantError$1 = (_a = class extends Error {
...
}, __name(_a, "InvariantError"), _a);
var invariant$1 = /* @__PURE__ */ __name((predicate, message2, ...positionals) => {
  if (!predicate) {
...
}, _list = new WeakMap(), _lens = new WeakMap(), _LensList_instances = new WeakSet(), openLens_fn = /* @__PURE__ */ __name(function(key, setter) {
  setter(__privateGet(this, _lens).get(key) || __privateGet(this, _lens).set(key, []).get(key));
}, "#openLens"), __name(_b, "LensList"), _b);
const kDefaultPrevented$2 = /* @__PURE__ */ Symbol("kDefaultPrevented");
const kPropagationStopped$1 = /* @__PURE__ */ Symbol("kPropagationStopped");
const kImmediatePropagationStopped$1 = /* @__PURE__ */ Symbol("kImmediatePropagationStopped");
var TypedEvent$1 = (_g = class extends (_f = MessageEvent, _e = kDefaultPrevented$2, _d = kPropagationStopped$1, _c = kImmediatePropagationStopped$1, _f) {
  constructor(...args) {
    super(args[0], args[1]);
    /**
...
}, _returnType = new WeakMap(), __name(_g, "TypedEvent"), _g);
var Emitter$2 = (_h = class {
  constructor() {
    ...
    __privateSet(this, _listeners, new LensList$1());
    ...
    __privateSet(this, _hookListeners, new LensList$1());
    ...
    this.hooks = {
      on: /* @__PURE__ */ __name((hook, callback, options) => {
        var _a2;
        if ((_a2 = options == null ? void 0 : options.signal) == null ? void 0 : _a2.aborted) return;
      ...
      removeListener: /* @__PURE__ */ __name((hook, callback) => {
        __privateMethod(this, _Emitter_instances, deleteHookListener_fn).call(this, hook, callback);
      }, "removeListener")
    };
  }
  ...
  */
  removeAllListeners(type) {
    ...
    if (type == null) {
      ...
      for (const [hookType, hookListener] of [...__privateGet(this, _hookListeners)]) if (!((_a2 = __privateGet(this, _hookListenerOptions).get(hookListener)) == null ? void 0 : _a2.persist)) __privateMethod(this, _Emitter_instances, deleteHookListener_fn).call(this, hookType, hookListener);
      return;
    }
  ...
  */
...
}, _listeners = new WeakMap(), _listenerOptions = new WeakMap(), _listenerAbortCleanups = new WeakMap(), _typelessListeners = new WeakMap(), _hookListeners = new WeakMap(), _hookListenerOptions = new WeakMap(), _hookListenerAbortCleanups = new WeakMap(), _Emitter_instances = new WeakSet(), deleteHookListener_fn = /* @__PURE__ */ __name(function(hook, callback) {
...
}, "#deleteHookListener"), deleteListener_fn = /* @__PURE__ */ __name(function(type, listener) {
  ...
  return removed;
}, "#deleteListener"), addListener_fn = /* @__PURE__ */ __name(function(type, listener, options, insertMode = "append") {
  var _a2;
  if ((_a2 = options == null ? void 0 : options.signal) == null ? void 0 : _a2.aborted) return;
...
}, "#addListener"), proxyEvent_fn = /* @__PURE__ */ __name(function(event) {
...
}, "#proxyEvent"), callListener_fn = /* @__PURE__ */ __name(function(event, listener) {
  ...
  return returnValue;
}, "#callListener"), matchListeners_fn = /* @__PURE__ */ __name(function* (type) {
  const snapshot = [];
  for (const [key, listener] of __privateGet(this, _listeners)) if (key === "*" || key === type) snapshot.push(listener);
  yield* snapshot;
}, "#matchListeners"), isTypelessListener_fn = /* @__PURE__ */ __name(function(listener) {
  return __privateGet(this, _typelessListeners).has(listener);
}, "#isTypelessListener"), __name(_h, "Emitter"), _h);
const _NetworkFrame = class _NetworkFrame {
...
__name(_NetworkFrame, "NetworkFrame");
let NetworkFrame = _NetworkFrame;
const _NetworkFrameEvent = class _NetworkFrameEvent extends TypedEvent$1 {
  frame;
...
__name(_NetworkFrameEvent, "NetworkFrameEvent");
let NetworkFrameEvent = _NetworkFrameEvent;
const _NetworkSource = class _NetworkSource {
  emitter;
  constructor() {
...
__name(_NetworkSource, "NetworkSource");
let NetworkSource = _NetworkSource;
...
__name(isCommonAssetRequest, "isCommonAssetRequest");
...
const _InternalError = class _InternalError extends Error {
...
let InternalError = _InternalError;
...
__name(isNodeProcess$1, "isNodeProcess$1");
...
__export$1(colors_exports$1, {
  blue: /* @__PURE__ */ __name(() => blue$1, "blue"),
  gray: /* @__PURE__ */ __name(() => gray$1, "gray"),
  green: /* @__PURE__ */ __name(() => green$1, "green"),
  red: /* @__PURE__ */ __name(() => red$1, "red"),
  yellow: /* @__PURE__ */ __name(() => yellow$1, "yellow")
});
function yellow$1(text) {
  return `\x1B[33m${text}\x1B[0m`;
}
__name(yellow$1, "yellow$1");
function blue$1(text) {
  return `\x1B[34m${text}\x1B[0m`;
}
__name(blue$1, "blue$1");
function gray$1(text) {
  return `\x1B[90m${text}\x1B[0m`;
}
__name(gray$1, "gray$1");
function red$1(text) {
...
__name(green$1, "green$1");
var IS_NODE$1 = isNodeProcess$1();
var Logger$1 = (_i = class {
  constructor(name) {
    this.name = name;
...
var PerformanceEntry$1 = (_j = class {
  startTime;
  endTime;
  deltaTime;
  constructor() {
...
}, __name(_j, "PerformanceEntry"), _j);
var noop$1 = /* @__PURE__ */ __name(() => void 0, "noop$1");
...
__name(getVariable$1, "getVariable$1");
function isDefinedAndNotEquals$1(value, expected) {
  return value !== void 0 && value !== expected;
}
__name(isDefinedAndNotEquals$1, "isDefinedAndNotEquals$1");
...
__name(serializeInput$1, "serializeInput$1");
var MemoryLeakError$1 = (_k = class extends Error {
...
}, __name(_k, "MemoryLeakError"), _k);
var _Emitter$1 = (_l = class {
  ...
  _wrapOnceListener(eventName, listener) {
    const onceListener = /* @__PURE__ */ __name((...data) => {
...
}, __name(_l, "_Emitter"), _l);
var Emitter$1 = _Emitter$1;
Emitter$1.defaultMaxListeners = 10;
function getGlobalSymbol$1(symbol) {
  return globalThis[symbol] || void 0;
}
__name(getGlobalSymbol$1, "getGlobalSymbol$1");
function setGlobalSymbol$1(symbol, value) {
  globalThis[symbol] = value;
}
__name(setGlobalSymbol$1, "setGlobalSymbol$1");
function deleteGlobalSymbol$1(symbol) {
  delete globalThis[symbol];
}
__name(deleteGlobalSymbol$1, "deleteGlobalSymbol$1");
let InterceptorReadyState$1 = /* @__PURE__ */ (function(InterceptorReadyState$12) {
  InterceptorReadyState$12["INACTIVE"] = "INACTIVE";
  InterceptorReadyState$12["APPLYING"] = "APPLYING";
  InterceptorReadyState$12["APPLIED"] = "APPLIED";
  InterceptorReadyState$12["DISPOSING"] = "DISPOSING";
  InterceptorReadyState$12["DISPOSED"] = "DISPOSED";
  return InterceptorReadyState$12;
})({});
var Interceptor$1 = (_m = class {
  constructor(symbol) {
    this.symbol = symbol;
    this.readyState = InterceptorReadyState$1.INACTIVE;
  ...
  */
  apply() {
    ...
    if (this.readyState === InterceptorReadyState$1.APPLIED) {
    ...
    this.readyState = InterceptorReadyState$1.APPLYING;
    ...
    if (runningInstance) {
      ...
      this.readyState = InterceptorReadyState$1.APPLIED;
      return;
    }
  ...
  */
  on(event, listener) {
    ...
    if (this.readyState === InterceptorReadyState$1.DISPOSING || this.readyState === InterceptorReadyState$1.DISPOSED) {
  ...
  */
  dispose() {
    ...
    if (this.readyState === InterceptorReadyState$1.DISPOSED) {
      logger.info("cannot dispose, already disposed!");
      return;
    }
    logger.info("disposing the interceptor...");
    this.readyState = InterceptorReadyState$1.DISPOSING;
    if (!this.getInstance()) {
    ...
    this.readyState = InterceptorReadyState$1.DISPOSED;
  }
  getInstance() {
    var _a2;
...
}, __name(_m, "Interceptor"), _m);
function createRequestId$1() {
  return Math.random().toString(16).slice(2);
}
__name(createRequestId$1, "createRequestId$1");
function createDeferredExecutor$1() {
  const executor = /* @__PURE__ */ __name((resolve, reject) => {
...
__name(createDeferredExecutor$1, "createDeferredExecutor$1");
var DeferredPromise$1 = (_n = class extends Promise {
...
}, _executor = new WeakMap(), _DeferredPromise_instances = new WeakSet(), decorate_fn = /* @__PURE__ */ __name(function(promise) {
  return Object.defineProperties(promise, {
    resolve: { configurable: true, value: this.resolve },
    reject: { configurable: true, value: this.reject }
  });
}, "#decorate"), __name(_n, "DeferredPromise"), _n);
...
__name(canParseUrl$1, "canParseUrl$1");
...
__name(getValueBySymbol$1, "getValueBySymbol$1");
const kStatus = /* @__PURE__ */ Symbol("kStatus");
const kUrl = /* @__PURE__ */ Symbol("kUrl");
var FetchResponse$1 = (_o = class extends Response {
  static isConfigurableStatusCode(status) {
    return status >= 200 && status <= 599;
  }
  static isRedirectResponse(status) {
    return _o.STATUS_CODES_WITH_REDIRECT.includes(status);
  }
  /**
  ...
  */
  static isResponseWithBody(status) {
    return !_o.STATUS_CODES_WITHOUT_BODY.includes(status);
  }
  ...
  */
  ...
  constructor(body, init = {}) {
    ...
    const safeStatus = _o.isConfigurableStatusCode(status) ? status : 200;
    const finalBody = _o.isResponseWithBody(status) ? body : null;
    super(finalBody, {
      status: safeStatus,
      statusText: init.statusText,
      headers: init.headers
    });
    if (status !== safeStatus) _o.setStatus(status, this);
    _o.setUrl(init.url, this);
  }
  clone() {
    const clonedResponse = super.clone();
    const customStatus = Reflect.get(this, kStatus);
    if (customStatus) _o.setStatus(customStatus, clonedResponse);
    const customUrl = Reflect.get(this, kUrl);
    if (customUrl) _o.setUrl(customUrl, clonedResponse);
    return clonedResponse;
  }
}, __name(_o, "FetchResponse"), _o.STATUS_CODES_WITHOUT_BODY = [
  101,
  103,
  204,
  205,
  304
], _o.STATUS_CODES_WITH_REDIRECT = [
  301,
  302,
  303,
  307,
...
__name(resolveWebSocketUrl$1, "resolveWebSocketUrl$1");
var BatchInterceptor = (_p = class extends Interceptor$1 {
  constructor(options) {
    _p.symbol = Symbol(options.name);
    super(_p.symbol);
...
}, __name(_p, "BatchInterceptor"), _p);
function getCleanUrl(url, isAbsolute = true) {
  return [isAbsolute && url.origin, url.pathname].filter(Boolean).join("");
}
__name(getCleanUrl, "getCleanUrl");
...
__name(toPublicUrl, "toPublicUrl");
...
__name(isNonEmptyString$1, "isNonEmptyString$1");
...
const NORMALIZED_HEADERS = /* @__PURE__ */ Symbol("normalizedHeaders");
const RAW_HEADER_NAMES = /* @__PURE__ */ Symbol("rawHeaderNames");
const HEADER_VALUE_DELIMITER = ", ";
var Headers$1 = (_q = class {
  constructor(init) {
    var _a2;
    this[NORMALIZED_HEADERS] = {};
    this[RAW_HEADER_NAMES] = /* @__PURE__ */ new Map();
    this[_Symbol$toStringTag] = "Headers";
    if (["Headers", "HeadersPolyfill"].includes((_a2 = init == null ? void 0 : init.constructor) == null ? void 0 : _a2.name) || init instanceof _q || typeof globalThis.Headers !== "undefined" && init instanceof globalThis.Headers) init.forEach((value, name) => {
...
__name(getCallFrame, "getCallFrame");
...
var __commonJS$1 = /* @__PURE__ */ __name((cb, mod) => /* @__PURE__ */ __name(function __require() {
  return mod || (0, cb[__getOwnPropNames$1(cb)[0]])((mod = { exports: {} }).exports, mod), mod.exports;
}, "__require"), "__commonJS$1");
var __copyProps$1 = /* @__PURE__ */ __name((to, from, except, desc) => {
  if (from && typeof from === "object" || typeof from === "function") {
    for (let key of __getOwnPropNames$1(from))
      if (!__hasOwnProp$1.call(to, key) && key !== except)
        __defProp$2(to, key, { get: /* @__PURE__ */ __name(() => from[key], "get"), enumerable: !(desc = __getOwnPropDesc$1(from, key)) || desc.enumerable });
  }
  return to;
}, "__copyProps$1");
var __toESM$1 = /* @__PURE__ */ __name((mod, isNodeMode, target) => (target = mod != null ? __create$1(__getProtoOf$1(mod)) : {}, __copyProps$1(
...
var require_codes = __commonJS$1({
...
var require_statuses = __commonJS$1({
...
var allStatuses = __toESM$1(require_statuses());
...
__name(normalizeResponseInit, "normalizeResponseInit");
...
__name(decorateResponse, "decorateResponse");
function getRawSetCookie(response) {
  return Reflect.get(response, kSetCookie);
}
__name(getRawSetCookie, "getRawSetCookie");
...
__name(forwardResponseCookies, "forwardResponseCookies");
const executeHandlers = /* @__PURE__ */ __name(async ({
  request,
  requestId,
  handlers: handlers2,
  resolutionContext
...
var objectToString = /* @__PURE__ */ __name((obj) => Object.prototype.toString.call(obj), "objectToString");
var safeArrayToString = /* @__PURE__ */ __name((arr, seenArrays) => {
...
var safeToStringImpl = /* @__PURE__ */ __name((val, seenArrays = /* @__PURE__ */ new WeakSet()) => {
...
var safeToString = /* @__PURE__ */ __name((val) => safeToStringImpl(val), "safeToString");
function createPromiseCallback(cb) {
  ...
  if (typeof cb === "function") {
    callback = /* @__PURE__ */ __name((err, result) => {
      try {
        if (err) cb(err);
        else cb(null, result);
      } catch (e) {
  ...
  return {
    ...
    reject: /* @__PURE__ */ __name((error2) => {
      callback(error2);
      return promise;
    }, "reject")
  };
}
__name(createPromiseCallback, "createPromiseCallback");
function inOperator(k, o) {
  return k in o;
}
__name(inOperator, "inOperator");
var MemoryCookieStore = (_s = class extends Store {
  /**
...
}, __name(_s, "MemoryCookieStore"), _s);
...
var ParameterError = (_t = class extends Error {
}, __name(_t, "ParameterError"), _t);
var version = "6.0.1";
...
var _Cookie = (_u = class {
  ...
  constructor(options = {}) {
    ...
    Object.defineProperty(this, "creationIndex", {
      ...
      writable: true,
      value: ++_u.cookiesCreated
    });
    this.creationIndex = _u.cookiesCreated;
  }
  ...
  toJSON() {
    const obj = {};
    for (const prop of _u.serializableProperties) {
      const val = this[prop];
  ...
  toString() {
    ...
    if (this.sameSite && this.sameSite !== "none") {
      if (this.sameSite.toLowerCase() === _u.sameSiteCanonical.lax.toLowerCase()) {
        str += `; SameSite=${_u.sameSiteCanonical.lax}`;
      } else if (this.sameSite.toLowerCase() === _u.sameSiteCanonical.strict.toLowerCase()) {
        str += `; SameSite=${_u.sameSiteCanonical.strict}`;
      } else {
...
__name(isLoopbackV4, "isLoopbackV4");
function isLoopbackV6(address) {
  return address === "::1";
}
__name(isLoopbackV6, "isLoopbackV6");
function isNormalizedLocalhostTLD(lowerHost) {
  return lowerHost.endsWith(".localhost");
}
__name(isNormalizedLocalhostTLD, "isNormalizedLocalhostTLD");
...
__name(hostNoBrackets, "hostNoBrackets");
...
__name(isPotentiallyTrustworthy, "isPotentiallyTrustworthy");
...
var CookieJar = (_v = class {
  ...
  setCookie(cookie2, url, options, callback) {
    ...
    try {
      ...
      if (!isNonEmptyString(cookie2) && !isObject$1(cookie2) && cookie2 instanceof String && cookie2.length == 0) {
        return promiseCallback.resolve(void 0);
      }
    } catch (err) {
    ...
    const withCookie = /* @__PURE__ */ __name(function withCookie2(err, oldCookie) {
      if (err) {
        cb(err);
        return;
      }
      const next = /* @__PURE__ */ __name(function(err2) {
        if (err2) {
          cb(err2);
  ...
  clone(newStore, callback) {
    ...
    this.serialize((err, serialized) => {
      ...
      return _v.deserialize(serialized ?? "", newStore, cb);
    });
    return promiseCallback.promise;
  }
  /**
  ...
  removeAllCookies(callback) {
    ...
    store.getAllCookies((err, cookies) => {
      ...
      const removeErrors = [];
      const removeCookieCb = /* @__PURE__ */ __name(function removeCookieCb2(removeErr) {
        if (removeErr) {
  ...
  static deserialize(strOrObj, store, callback) {
    ...
    const readSerializedProperty = /* @__PURE__ */ __name((property) => {
      return serialized && typeof serialized === "object" && inOperator(property, serialized) ? serialized[property] : void 0;
    }, "readSerializedProperty");
    const readSerializedBoolean = /* @__PURE__ */ __name((property) => {
      const value = readSerializedProperty(property);
      return typeof value === "boolean" ? value : void 0;
    }, "readSerializedBoolean");
    const readSerializedString = /* @__PURE__ */ __name((property) => {
      const value = readSerializedProperty(property);
      return typeof value === "string" ? value : void 0;
    }, "readSerializedString");
    const jar = new _v(store, {
  ...
  static fromJSON(jsonString, store) {
    return _v.deserializeSync(jsonString, store);
  }
}, __name(_v, "_CookieJar"), _v);
...
const _CookieStore = class _CookieStore {
  constructor() {
...
__name(storeResponseCookies, "storeResponseCookies");
const REQUEST_INTENTION_HEADER_NAME = "x-msw-intention";
function shouldBypassRequest(request) {
  var _a2;
  return !!((_a2 = request.headers.get("accept")) == null ? void 0 : _a2.includes("msw/passthrough"));
}
__name(shouldBypassRequest, "shouldBypassRequest");
...
__name(isPassthroughResponse, "isPassthroughResponse");
...
__name(deleteRequestPassthroughHeader, "deleteRequestPassthroughHeader");
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
__name(matchRequestUrl, "matchRequestUrl");
function getTimestamp$1(options) {
  const now = /* @__PURE__ */ new Date();
  const timestamp = `${now.getHours().toString().padStart(2, "0")}:${now.getMinutes().toString().padStart(2, "0")}:${now.getSeconds().toString().padStart(2, "0")}`;
  return timestamp;
}
__name(getTimestamp$1, "getTimestamp$1");
...
__name(getSiblingHandlers, "getSiblingHandlers");
function groupHandlersByKind(handlers2) {
  const groups = {};
  const pushUnique = /* @__PURE__ */ __name((kind, handler) => {
...
__name(groupHandlersByKind, "groupHandlersByKind");
const _HandlersController = class _HandlersController {
  constructor() {
...
validateHandlers_fn = /* @__PURE__ */ __name(function(handlers2) {
  return handlers2.every((handler) => !Array.isArray(handler));
}, "#validateHandlers");
__name(_HandlersController, "HandlersController");
let HandlersController = _HandlersController;
const _InMemoryHandlersController = class _InMemoryHandlersController extends HandlersController {
...
__name(_InMemoryHandlersController, "InMemoryHandlersController");
let InMemoryHandlersController = _InMemoryHandlersController;
const _RequestEvent = class _RequestEvent extends TypedEvent$1 {
  requestId;
  request;
...
__name(_RequestEvent, "RequestEvent");
let RequestEvent = _RequestEvent;
const _ResponseEvent = class _ResponseEvent extends TypedEvent$1 {
  requestId;
  request;
  response;
  constructor(type, data) {
...
__name(_ResponseEvent, "ResponseEvent");
let ResponseEvent = _ResponseEvent;
const _UnhandledExceptionEvent = class _UnhandledExceptionEvent extends TypedEvent$1 {
  error;
  requestId;
  request;
  constructor(type, data) {
...
__name(_UnhandledExceptionEvent, "UnhandledExceptionEvent");
let UnhandledExceptionEvent = _UnhandledExceptionEvent;
const _HttpNetworkFrame = class _HttpNetworkFrame extends NetworkFrame {
  constructor(options) {
...
` : ""}`;
    const message2 = `intercepted a request without a matching request handler:${details}If you still wish to intercept this unhandled request, please create a request handler for it.
  ...
  async resolve(handlers2, onUnhandledFrame, resolutionContext) {
    ...
    const [lookupError, lookupResult] = await until$1(() => {
      ...
      return executeHandlers({
        ...
        handlers: handlers2,
        resolutionContext: {
          baseUrl: (_a2 = resolutionContext == null ? void 0 : resolutionContext.baseUrl) == null ? void 0 : _a2.toString(),
...
__name(_HttpNetworkFrame, "HttpNetworkFrame");
let HttpNetworkFrame = _HttpNetworkFrame;
async function executeUnhandledFrameHandle(frame, handle) {
  const printStrategyMessage = /* @__PURE__ */ __name(async (strategy) => {
    if (strategy === "bypass") {
      return;
    }
    const message2 = await frame.getUnhandledMessage();
    switch (strategy) {
      case "warn": {
        return devUtils.warn("Warning: %s", message2);
      }
      case "error": {
        return devUtils.error("Error: %s", message2);
      }
    }
  }, "printStrategyMessage");
  const applyStrategy = /* @__PURE__ */ __name(async (strategy) => {
    invariant$1.as(
      InternalError,
...
__name(executeUnhandledFrameHandle, "executeUnhandledFrameHandle");
function toReadonlyArray(source) {
  const clone = [...source];
  Object.freeze(clone);
  return clone;
}
__name(toReadonlyArray, "toReadonlyArray");
...
__name(colorlessPromiseAll, "colorlessPromiseAll");
...
__name(defineNetwork, "defineNetwork");
...
__name(emitAsync$1, "emitAsync$1");
var PatchesRegistry = (_w = class {
  constructor() {
  ...
  applyPatch(owner, key, getNextValue) {
    ...
    invariant$1(!(ownerReplacements == null ? void 0 : ownerReplacements.has(key)), `Failed to replace a global value at "${String(key)}": already replaced.`);
    ...
    const restorePatch = /* @__PURE__ */ __name(() => {
...
}, _replacements = new WeakMap(), __name(_w, "PatchesRegistry"), _w);
...
__name(getDeepPropertyDescriptor, "getDeepPropertyDescriptor");
...
__name(hasConfigurableGlobal$1, "hasConfigurableGlobal$1");
...
__name(bindEvent$1, "bindEvent$1");
const kCancelable$1 = /* @__PURE__ */ Symbol("kCancelable");
const kDefaultPrevented$1 = /* @__PURE__ */ Symbol("kDefaultPrevented");
var CancelableMessageEvent$1 = (_x = class extends MessageEvent {
...
}, __name(_x, "CancelableMessageEvent"), _x);
var CloseEvent$1 = (_y = class extends Event {
  constructor(type, init = {}) {
    super(type, init);
...
}, __name(_y, "CloseEvent"), _y);
var CancelableCloseEvent$1 = (_z = class extends CloseEvent$1 {
  constructor(type, init = {}) {
    super(type, init);
    this[kCancelable$1] = !!init.cancelable;
    this[kDefaultPrevented$1] = false;
...
}, __name(_z, "CancelableCloseEvent"), _z);
const kEmitter$1$1 = /* @__PURE__ */ Symbol("kEmitter");
const kBoundListener$1$1 = /* @__PURE__ */ Symbol("kBoundListener");
var WebSocketClientConnection$1 = (_A = class {
  constructor(socket, transport) {
    ...
    this.transport.addEventListener("outgoing", (event) => {
      const message2 = bindEvent$1(this.socket, new CancelableMessageEvent$1("message", {
        data: event.data,
        origin: event.origin,
        cancelable: true
      }));
      this[kEmitter$1$1].dispatchEvent(message2);
      if (message2.defaultPrevented) event.preventDefault();
    });
...
}, __name(_A, "WebSocketClientConnection"), _A);
const WEBSOCKET_CLOSE_CODE_RANGE_ERROR$1 = "InvalidAccessError: close code out of user configurable range";
const kPassthroughPromise$1 = /* @__PURE__ */ Symbol("kPassthroughPromise");
const kOnSend$1 = /* @__PURE__ */ Symbol("kOnSend");
const kClose$1 = /* @__PURE__ */ Symbol("kClose");
var WebSocketOverride$1 = (_B = class extends EventTarget {
  ...
  */
  send(data) {
    ...
    queueMicrotask(() => {
      var _a2;
      this.bufferedAmount = 0;
      (_a2 = this[kOnSend$1]) == null ? void 0 : _a2.call(this, data);
    });
  }
...
}, __name(_B, "WebSocketOverride"), _B.CONNECTING = 0, _B.OPEN = 1, _B.CLOSING = 2, _B.CLOSED = 3, _B);
function getDataSize$1(data) {
  if (typeof data === "string") return data.length;
  if (data instanceof Blob) return data.size;
  return data.byteLength;
}
__name(getDataSize$1, "getDataSize$1");
const kEmitter$2 = /* @__PURE__ */ Symbol("kEmitter");
const kBoundListener$2 = /* @__PURE__ */ Symbol("kBoundListener");
const kSend$1 = /* @__PURE__ */ Symbol("kSend");
var WebSocketServerConnection$1 = (_C = class {
...
}, __name(_C, "WebSocketServerConnection"), _C);
var WebSocketClassTransport$1 = (_D = class extends EventTarget {
  constructor(socket) {
    super();
    this.socket = socket;
  ...
  send(data) {
    queueMicrotask(() => {
      ...
      const dispatchEvent = /* @__PURE__ */ __name(() => {
...
}, __name(_D, "WebSocketClassTransport"), _D);
_E = class extends Interceptor$1 {
  constructor() {
    super(_E.symbol);
  }
  checkEnvironment() {
  ...
  setup() {
    const logger = this.logger.extend("setup");
    const WebSocketProxy = new Proxy(globalThis.WebSocket, { construct: /* @__PURE__ */ __name((target, args, newTarget) => {
      const [url, protocols] = args;
      const createConnection = /* @__PURE__ */ __name(() => {
      ...
      queueMicrotask(async () => {
        try {
          ...
          if (error2 instanceof Error) {
            ...
            if (socket.readyState !== WebSocket.CLOSING && socket.readyState !== WebSocket.CLOSED) socket[kClose$1](1011, error2.message, false);
...
}, __name(_E, "WebSocketInterceptor"), _E.symbol = /* @__PURE__ */ Symbol("websocket"), _E;
const _WebSocketConnectionEvent = class _WebSocketConnectionEvent extends TypedEvent$1 {
  url;
  protocols;
  constructor(type, data) {
    super(...[type, {}]);
...
__name(_WebSocketConnectionEvent, "WebSocketConnectionEvent");
let WebSocketConnectionEvent = _WebSocketConnectionEvent;
const _UnhandledWebSocketExceptionEvent = class _UnhandledWebSocketExceptionEvent extends TypedEvent$1 {
  url;
  protocols;
  error;
  constructor(type, data) {
...
__name(_UnhandledWebSocketExceptionEvent, "UnhandledWebSocketExceptionEvent");
let UnhandledWebSocketExceptionEvent = _UnhandledWebSocketExceptionEvent;
const _WebSocketNetworkFrame = class _WebSocketNetworkFrame extends NetworkFrame {
  constructor(options) {
    super("ws", {
...
__name(_WebSocketNetworkFrame, "WebSocketNetworkFrame");
let WebSocketNetworkFrame = _WebSocketNetworkFrame;
const _InterceptorSource = class _InterceptorSource extends NetworkSource {
  constructor(options) {
    super();
...
handleRequest_fn = /* @__PURE__ */ __name(async function({
  requestId,
  request,
  controller
}) {
...
handleResponse_fn = /* @__PURE__ */ __name(async function({
  requestId,
  request,
  response,
  isMockedResponse
...
handleWebSocketConnection_fn = /* @__PURE__ */ __name(async function(connection) {
  await this.queue(
...
__name(_InterceptorSource, "InterceptorSource");
let InterceptorSource = _InterceptorSource;
const _InterceptorHttpNetworkFrame = class _InterceptorHttpNetworkFrame extends HttpNetworkFrame {
  constructor(options) {
    super({
      id: options.id,
...
__name(_InterceptorHttpNetworkFrame, "InterceptorHttpNetworkFrame");
let InterceptorHttpNetworkFrame = _InterceptorHttpNetworkFrame;
const _InterceptorWebSocketNetworkFrame = class _InterceptorWebSocketNetworkFrame extends WebSocketNetworkFrame {
  constructor(args) {
...
__name(_InterceptorWebSocketNetworkFrame, "InterceptorWebSocketNetworkFrame");
let InterceptorWebSocketNetworkFrame = _InterceptorWebSocketNetworkFrame;
...
__name(fromLegacyOnUnhandledRequest, "fromLegacyOnUnhandledRequest");
...
__name(toResponseInit, "toResponseInit");
...
var InvariantError = (_F = class extends Error {
  constructor(message2, ...positionals) {
    super(message2);
    this.message = message2;
    this.name = "Invariant Violation";
...
}, __name(_F, "InvariantError"), _F);
var invariant = /* @__PURE__ */ __name((predicate, message2, ...positionals) => {
  if (!predicate) {
...
var MemoryLeakError = (_I = class extends Error {
  constructor(emitter, type, count) {
    super(
      `Possible EventEmitter memory leak detected. ${count} ${type.toString()} listeners added. Use emitter.setMaxListeners() to increase limit`
    );
...
}, __name(_I, "MemoryLeakError"), _I);
var _Emitter = (_J = class {
  static listenerCount(emitter, eventName) {
    return emitter.listenerCount(eventName);
  }
  constructor() {
...
var InterceptorReadyState = /* @__PURE__ */ (function(InterceptorReadyState$12) {
  InterceptorReadyState$12["INACTIVE"] = "INACTIVE";
  InterceptorReadyState$12["APPLYING"] = "APPLYING";
  InterceptorReadyState$12["APPLIED"] = "APPLIED";
  InterceptorReadyState$12["DISPOSING"] = "DISPOSING";
...
__name(resolveWebSocketUrl, "resolveWebSocketUrl");
async function emitAsync(emitter, eventName, ...data) {
  const listeners = emitter.listeners(eventName);
  if (listeners.length === 0) return;
  for (const listener of listeners) await listener.apply(emitter, data);
}
__name(emitAsync, "emitAsync");
...
__name(hasConfigurableGlobal, "hasConfigurableGlobal");
...
var DeferredPromise = (_L = class extends Promise {
  constructor(executor = null) {
  ...
  then(onFulfilled, onRejected) {
    return __privateMethod(this, __this_instances, decorate_fn2).call(this, super.then(onFulfilled, onRejected));
  }
  catch(onRejected) {
    return __privateMethod(this, __this_instances, decorate_fn2).call(this, super.catch(onRejected));
  }
  finally(onfinally) {
    return __privateMethod(this, __this_instances, decorate_fn2).call(this, super.finally(onfinally));
  }
}, _executor2 = new WeakMap(), __this_instances = new WeakSet(), decorate_fn2 = /* @__PURE__ */ __name(function(promise) {
  return Object.defineProperties(promise, {
    resolve: { configurable: true, value: this.resolve },
    reject: { configurable: true, value: this.reject }
  });
}, "#decorate"), __name(_L, "DeferredPromise"), _L);
...
}, __name(_M, "CancelableMessageEvent"), _M);
var CloseEvent = (_N = class extends Event {
  constructor(type, init = {}) {
    super(type, init);
    this.code = init.code === void 0 ? 0 : init.code;
    this.reason = init.reason === void 0 ? "" : init.reason;
...
}, __name(_N, "CloseEvent"), _N);
var CancelableCloseEvent = (_O = class extends CloseEvent {
  constructor(type, init = {}) {
    super(type, init);
    this[kCancelable] = !!init.cancelable;
    this[kDefaultPrevented] = false;
...
var WebSocketClientConnection = (_P = class {
  constructor(socket, transport) {
    ...
    this.transport.addEventListener("outgoing", (event) => {
      const message2 = bindEvent(this.socket, new CancelableMessageEvent("message", {
        data: event.data,
        origin: event.origin,
        cancelable: true
      }));
      this[kEmitter$1].dispatchEvent(message2);
      if (message2.defaultPrevented) event.preventDefault();
    });
    this.transport.addEventListener("close", (event) => {
...
}, __name(_P, "WebSocketClientConnection"), _P);
...
var WebSocketOverride = (_Q = class extends EventTarget {
  constructor(url, protocols) {
    super();
    this.CONNECTING = 0;
    this.OPEN = 1;
...
}, __name(_Q, "WebSocketOverride"), _Q.CONNECTING = 0, _Q.OPEN = 1, _Q.CLOSING = 2, _Q.CLOSED = 3, _Q);
function getDataSize(data) {
  if (typeof data === "string") return data.length;
  if (data instanceof Blob) return data.size;
  return data.byteLength;
}
__name(getDataSize, "getDataSize");
var kEmitter = /* @__PURE__ */ Symbol("kEmitter");
var kBoundListener = /* @__PURE__ */ Symbol("kBoundListener");
var kSend = /* @__PURE__ */ Symbol("kSend");
var WebSocketServerConnection = (_R = class {
  constructor(client, transport, createConnection) {
    this.client = client;
    this.transport = transport;
    this.createConnection = createConnection;
...
}, __name(_R, "WebSocketServerConnection"), _R);
var WebSocketClassTransport = (_S = class extends EventTarget {
  constructor(socket) {
    super();
    this.socket = socket;
    this.socket.addEventListener("close", (event) => {
...
}, __name(_S, "WebSocketClassTransport"), _S);
var WebSocketInterceptor = (_T = class extends Interceptor {
  constructor() {
    super(_T.symbol);
  }
  checkEnvironment() {
...
}, __name(_T, "WebSocketInterceptor2"), _T.symbol = /* @__PURE__ */ Symbol("websocket"), _T);
function supportsServiceWorker() {
  return typeof navigator !== "undefined" && "serviceWorker" in navigator && typeof location !== "undefined" && location.protocol !== "file:";
}
__name(supportsServiceWorker, "supportsServiceWorker");
function supportsReadableStreamTransfer() {
  try {
    const stream = new ReadableStream({
      start: /* @__PURE__ */ __name((controller) => controller.close(), "start")
    });
...
__name(supportsReadableStreamTransfer, "supportsReadableStreamTransfer");
...
__name(createDeferredExecutor2, "createDeferredExecutor2");
var DeferredPromise2 = (_U = class extends Promise {
  constructor(executor = null) {
    ...
    __privateAdd(this, _executor3);
    __publicField(this, "resolve");
    __publicField(this, "reject");
    __privateSet(this, _executor3, deferredExecutor);
    this.resolve = __privateGet(this, _executor3).resolve;
    this.reject = __privateGet(this, _executor3).reject;
  }
  get state() {
    return __privateGet(this, _executor3).state;
  }
  get rejectionReason() {
    return __privateGet(this, _executor3).rejectionReason;
  }
  then(onFulfilled, onRejected) {
    return __privateMethod(this, __this_instances2, decorate_fn3).call(this, super.then(onFulfilled, onRejected));
  }
  catch(onRejected) {
    return __privateMethod(this, __this_instances2, decorate_fn3).call(this, super.catch(onRejected));
  }
  finally(onfinally) {
    return __privateMethod(this, __this_instances2, decorate_fn3).call(this, super.finally(onfinally));
  }
}, _executor3 = new WeakMap(), __this_instances2 = new WeakSet(), decorate_fn3 = /* @__PURE__ */ __name(function(promise) {
  return Object.defineProperties(promise, {
    resolve: {
      configurable: true,
      value: this.resolve
...
}, "#decorate"), __name(_U, "DeferredPromise2"), _U);
var IS_PATCHED_MODULE = /* @__PURE__ */ Symbol("isPatchedModule");
var InterceptorError = (_V = class extends Error {
  constructor(message2) {
    super(message2);
    this.name = "InterceptorError";
    Object.setPrototypeOf(this, _V.prototype);
  }
}, __name(_V, "InterceptorError2"), _V);
var RequestController = (_W = class {
  constructor(request, source) {
    __privateAdd(this, _RequestController2_instances);
    this.request = request;
    this.source = source;
    this.readyState = _W.PENDING;
  ...
  */
  async passthrough() {
    invariant.as(InterceptorError, this.readyState === _W.PENDING, 'Failed to passthrough the "%s %s" request: the request has already been handled', this.request.method, this.request.url);
    this.readyState = _W.PASSTHROUGH;
  ...
  */
  respondWith(response) {
    invariant.as(InterceptorError, this.readyState === _W.PENDING, 'Failed to respond to the "%s %s" request with "%d %s": the request has already been handled (%d)', this.request.method, this.request.url, response.status, response.statusText || "OK", this.readyState);
    this.readyState = _W.RESPONSE;
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  ...
  */
  errorWith(reason) {
    invariant.as(InterceptorError, this.readyState === _W.PENDING, 'Failed to error the "%s %s" request with "%s": the request has already been handled (%d)', this.request.method, this.request.url, reason == null ? void 0 : reason.toString(), this.readyState);
    this.readyState = _W.ERROR;
    this.source.errorWith(reason);
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  }
}, _RequestController2_instances = new WeakSet(), handled_get = /* @__PURE__ */ __name(function() {
  return this.handled;
}, "#handled"), __name(_W, "RequestController2"), _W.PENDING = 0, _W.PASSTHROUGH = 1, _W.RESPONSE = 2, _W.ERROR = 3, _W);
...
__name(getValueBySymbol, "getValueBySymbol");
var FetchResponse = (_X = class extends Response {
  static isConfigurableStatusCode(status) {
    return status >= 200 && status <= 599;
  }
  static isRedirectResponse(status) {
    return _X.STATUS_CODES_WITH_REDIRECT.includes(status);
  }
  /**
  * Returns a boolean indicating whether the given response status
  * code represents a response that can have a body.
  */
  static isResponseWithBody(status) {
    return !_X.STATUS_CODES_WITHOUT_BODY.includes(status);
  }
  static setUrl(url, response) {
  ...
  */
  ...
  constructor(body, init = {}) {
    const status = init.status ?? 200;
    const safeStatus = _X.isConfigurableStatusCode(status) ? status : 200;
    const finalBody = _X.isResponseWithBody(status) ? body : null;
    super(finalBody, {
      status: safeStatus,
      statusText: init.statusText,
      headers: init.headers
    ...
    _X.setUrl(init.url, this);
  }
}, __name(_X, "FetchResponse2"), _X.STATUS_CODES_WITHOUT_BODY = [
  101,
  103,
  204,
  205,
  304
], _X.STATUS_CODES_WITH_REDIRECT = [
  301,
  302,
  303,
  307,
...
__name(setRawRequest, "setRawRequest");
...
__name(getAbsoluteWorkerUrl, "getAbsoluteWorkerUrl");
...
__name(getWorkerByRegistration, "getWorkerByRegistration");
var getWorkerInstance = /* @__PURE__ */ __name(async (url, options = {}, findWorker) => {
...
var LensList = (_Y = class {
  constructor() {
    __privateAdd(this, __this_instances3);
    __privateAdd(this, _list2);
    __privateAdd(this, _lens2);
    __privateSet(this, _list2, []);
    __privateSet(this, _lens2, /* @__PURE__ */ new Map());
  }
  get [Symbol.iterator]() {
    return __privateGet(this, _list2)[Symbol.iterator].bind(__privateGet(this, _list2));
  }
  entries() {
    return __privateGet(this, _lens2).entries();
  }
  /**
  * Return an order-sensitive list of values by the given key.
  */
  get(key) {
    return __privateGet(this, _lens2).get(key) || [];
  }
  /**
  * Return an order-sensitive list of all values.
  */
  getAll() {
    return __privateGet(this, _list2).map(([, value]) => value);
  }
  /**
  * Append a new value to the given key.
  */
  append(key, value) {
    __privateGet(this, _list2).push([key, value]);
    __privateMethod(this, __this_instances3, openLens_fn2).call(this, key, (list) => list.push(value));
  }
  /**
  * Prepend a new value to the given key.
  */
  prepend(key, value) {
    __privateGet(this, _list2).unshift([key, value]);
    __privateMethod(this, __this_instances3, openLens_fn2).call(this, key, (list) => list.unshift(value));
  }
  /**
  * Delete the value belonging to the given key.
  * Returns `true` if the value was present and removed, `false` otherwise.
  */
  delete(key, value) {
    if (this.size === 0) return false;
    const values = __privateGet(this, _lens2).get(key);
    if (!values) return false;
    const index = values.indexOf(value);
    if (index === -1) return false;
    values.splice(index, 1);
    __privateGet(this, _list2).splice(__privateGet(this, _list2).findIndex((item) => item[0] === key && item[1] === value), 1);
    return true;
  }
  /**
  * Delete all values belogning to the given key.
  */
  deleteAll(key) {
    if (this.size === 0) return;
    __privateSet(this, _list2, __privateGet(this, _list2).filter((item) => item[0] !== key));
    __privateGet(this, _lens2).delete(key);
  }
  get size() {
    return __privateGet(this, _list2).length;
  }
  clear() {
    if (this.size === 0) return;
    __privateGet(this, _list2).length = 0;
    __privateGet(this, _lens2).clear();
  }
}, _list2 = new WeakMap(), _lens2 = new WeakMap(), __this_instances3 = new WeakSet(), openLens_fn2 = /* @__PURE__ */ __name(function(key, setter) {
  setter(__privateGet(this, _lens2).get(key) || __privateGet(this, _lens2).set(key, []).get(key));
}, "#openLens"), __name(_Y, "LensList"), _Y);
...
var TypedEvent = (_ba = class extends (_aa = MessageEvent, _$ = kDefaultPrevented2, __ = kPropagationStopped, _Z = kImmediatePropagationStopped, _aa) {
  constructor(...args) {
    super(args[0], args[1]);
    /**
    * @note Keep a placeholder property with the return type
    ...
    * correctly associated and inferred from the event.
    */
    __privateAdd(this, _returnType2);
...
}, _returnType2 = new WeakMap(), __name(_ba, "TypedEvent"), _ba);
var Emitter2 = (_ca = class {
  constructor() {
    __privateAdd(this, __this_instances4);
    __privateAdd(this, _listeners2);
    __privateAdd(this, _listenerOptions2);
    __privateAdd(this, _listenerAbortCleanups2);
    __privateAdd(this, _typelessListeners2);
    __privateAdd(this, _hookListeners2);
    __privateAdd(this, _hookListenerOptions2);
    __privateAdd(this, _hookListenerAbortCleanups2);
    __publicField(this, "hooks");
    __privateSet(this, _listeners2, new LensList());
    __privateSet(this, _listenerOptions2, /* @__PURE__ */ new WeakMap());
    __privateSet(this, _listenerAbortCleanups2, /* @__PURE__ */ new WeakMap());
    __privateSet(this, _typelessListeners2, /* @__PURE__ */ new WeakSet());
    __privateSet(this, _hookListeners2, new LensList());
    __privateSet(this, _hookListenerOptions2, /* @__PURE__ */ new WeakMap());
    __privateSet(this, _hookListenerAbortCleanups2, /* @__PURE__ */ new WeakMap());
    this.hooks = {
      on: /* @__PURE__ */ __name((hook, callback, options) => {
        var _a2;
        if ((_a2 = options == null ? void 0 : options.signal) == null ? void 0 : _a2.aborted) return;
        if (options == null ? void 0 : options.once) {
          const original = callback;
          const wrapper = /* @__PURE__ */ __name(((...args) => {
            __privateMethod(this, __this_instances4, deleteHookListener_fn2).call(this, hook, wrapper);
            return original(...args);
          }), "wrapper");
          callback = wrapper;
        }
        __privateGet(this, _hookListeners2).append(hook, callback);
        if (options) __privateGet(this, _hookListenerOptions2).set(callback, options);
        if (options == null ? void 0 : options.signal) {
          const { signal } = options;
          const onAbort = /* @__PURE__ */ __name(() => {
            __privateMethod(this, __this_instances4, deleteHookListener_fn2).call(this, hook, callback);
          }, "onAbort");
          signal.addEventListener("abort", onAbort, { once: true });
          __privateGet(this, _hookListenerAbortCleanups2).set(callback, () => {
            signal.removeEventListener("abort", onAbort);
          });
        }
      }, "on"),
  ...
  */
  on(type, listener, options) {
    __privateMethod(this, __this_instances4, addListener_fn2).call(this, type, listener, options);
    return this;
  }
  /**
  * Adds a one-time listener for the given event type.
  ...
  */
  earlyOn(type, listener, options) {
    __privateMethod(this, __this_instances4, addListener_fn2).call(this, type, listener, options, "prepend");
    return this;
  }
  /**
  * Prepends a one-time listener for the given event type.
  ...
  */
  emit(event) {
    if (__privateGet(this, _listeners2).size === 0) return false;
    const hasListeners = this.listenerCount(event.type) > 0;
    const proxiedEvent = __privateMethod(this, __this_instances4, proxyEvent_fn2).call(this, event);
    for (const listener of __privateMethod(this, __this_instances4, matchListeners_fn2).call(this, event.type)) {
      ...
      __privateMethod(this, __this_instances4, callListener_fn2).call(this, proxiedEvent.event, listener);
    }
    proxiedEvent.revoke();
    return hasListeners;
  }
  ...
  */
  async emitAsPromise(event) {
    if (__privateGet(this, _listeners2).size === 0) return [];
    const pendingListeners = [];
    const proxiedEvent = __privateMethod(this, __this_instances4, proxyEvent_fn2).call(this, event);
    for (const listener of __privateMethod(this, __this_instances4, matchListeners_fn2).call(this, event.type)) {
      if (proxiedEvent.event[kPropagationStopped] != null && proxiedEvent.event[kPropagationStopped] !== this) {
      ...
      if (proxiedEvent.event[kImmediatePropagationStopped]) break;
      const returnValue = await Promise.resolve(__privateMethod(this, __this_instances4, callListener_fn2).call(this, proxiedEvent.event, listener));
      if (!__privateMethod(this, __this_instances4, isTypelessListener_fn2).call(this, listener)) pendingListeners.push(returnValue);
    }
    proxiedEvent.revoke();
    return Promise.allSettled(pendingListeners).then((results) => {
      return results.map((result) => result.status === "fulfilled" ? result.value : result.reason);
  ...
  *emitAsGenerator(event) {
    ...
    for (const listener of __privateMethod(this, __this_instances4, matchListeners_fn2).call(this, event.type)) {
      ...
      if (proxiedEvent.event[kImmediatePropagationStopped]) break;
      const returnValue = __privateMethod(this, __this_instances4, callListener_fn2).call(this, proxiedEvent.event, listener);
      if (!__privateMethod(this, __this_instances4, isTypelessListener_fn2).call(this, listener)) yield returnValue;
    }
    proxiedEvent.revoke();
  }
  /**
  ...
  */
  removeListener(type, listener) {
    const options = __privateGet(this, _listenerOptions2).get(listener);
    if (!__privateMethod(this, __this_instances4, deleteListener_fn2).call(this, type, listener)) return;
    for (const hook of __privateGet(this, _hookListeners2).get("removeListener").slice()) hook(type, listener, options);
  }
  /**
  * Removes all listeners for the given event type.
  * If no event type is provided, removes all existing listeners.
  */
  removeAllListeners(type) {
    var _a2;
    if (type == null) {
      for (const [listenerType, listeners$1] of __privateGet(this, _listeners2).entries()) while (listeners$1.length > 0) this.removeListener(listenerType, listeners$1[0]);
      for (const [hookType, hookListener] of [...__privateGet(this, _hookListeners2)]) if (!((_a2 = __privateGet(this, _hookListenerOptions2).get(hookListener)) == null ? void 0 : _a2.persist)) __privateMethod(this, __this_instances4, deleteHookListener_fn2).call(this, hookType, hookListener);
      return;
    }
    const listeners = this.listeners(type);
    while (listeners.length > 0) this.removeListener(type, listeners[0]);
  ...
  */
  listeners(type) {
    if (type == null) return __privateGet(this, _listeners2).getAll();
    return __privateGet(this, _listeners2).get(type);
  }
  /**
  * Returns the number of listeners for the given event type.
  * If no even type is provided, returns the total number of listeners.
  */
  listenerCount(type) {
    if (type == null) return __privateGet(this, _listeners2).size;
    return this.listeners(type).length;
  }
}, _listeners2 = new WeakMap(), _listenerOptions2 = new WeakMap(), _listenerAbortCleanups2 = new WeakMap(), _typelessListeners2 = new WeakMap(), _hookListeners2 = new WeakMap(), _hookListenerOptions2 = new WeakMap(), _hookListenerAbortCleanups2 = new WeakMap(), __this_instances4 = new WeakSet(), deleteHookListener_fn2 = /* @__PURE__ */ __name(function(hook, callback) {
  __privateGet(this, _hookListeners2).delete(hook, callback);
  const cleanup = __privateGet(this, _hookListenerAbortCleanups2).get(callback);
  if (cleanup) {
    cleanup();
    __privateGet(this, _hookListenerAbortCleanups2).delete(callback);
  }
}, "#deleteHookListener"), deleteListener_fn2 = /* @__PURE__ */ __name(function(type, listener) {
  const removed = __privateGet(this, _listeners2).delete(type, listener);
  const cleanup = __privateGet(this, _listenerAbortCleanups2).get(listener);
  if (cleanup) {
    cleanup();
    __privateGet(this, _listenerAbortCleanups2).delete(listener);
  }
  return removed;
}, "#deleteListener"), addListener_fn2 = /* @__PURE__ */ __name(function(type, listener, options, insertMode = "append") {
  var _a2;
  if ((_a2 = options == null ? void 0 : options.signal) == null ? void 0 : _a2.aborted) return;
  for (const hook of __privateGet(this, _hookListeners2).get("newListener").slice()) hook(type, listener, options);
  if (type === "*") __privateGet(this, _typelessListeners2).add(listener);
  if (insertMode === "prepend") __privateGet(this, _listeners2).prepend(type, listener);
  else __privateGet(this, _listeners2).append(type, listener);
  if (options) {
    __privateGet(this, _listenerOptions2).set(listener, options);
    if (options.signal) {
      const { signal } = options;
      const onAbort = /* @__PURE__ */ __name(() => {
        this.removeListener(type, listener);
      ...
      signal.addEventListener("abort", onAbort, { once: true });
      __privateGet(this, _listenerAbortCleanups2).set(listener, () => {
        signal.removeEventListener("abort", onAbort);
      });
    }
  }
}, "#addListener"), proxyEvent_fn2 = /* @__PURE__ */ __name(function(event) {
  const { stopPropagation } = event;
  event.stopPropagation = () => {
...
}, "#proxyEvent"), callListener_fn2 = /* @__PURE__ */ __name(function(event, listener) {
  for (const hook of __privateGet(this, _hookListeners2).get("beforeEmit").slice()) if (hook(event) === false) return;
  const returnValue = listener.call(this, event);
  const options = __privateGet(this, _listenerOptions2).get(listener);
  if (options == null ? void 0 : options.once) {
    const type = __privateMethod(this, __this_instances4, isTypelessListener_fn2).call(this, listener) ? "*" : event.type;
    if (__privateMethod(this, __this_instances4, deleteListener_fn2).call(this, type, listener)) for (const hook of __privateGet(this, _hookListeners2).get("removeListener").slice()) hook(type, listener, options);
  }
  return returnValue;
}, "#callListener"), matchListeners_fn2 = /* @__PURE__ */ __name(function* (type) {
  const snapshot = [];
  for (const [key, listener] of __privateGet(this, _listeners2)) if (key === "*" || key === type) snapshot.push(listener);
  yield* snapshot;
}, "#matchListeners"), isTypelessListener_fn2 = /* @__PURE__ */ __name(function(listener) {
  return __privateGet(this, _typelessListeners2).has(listener);
}, "#isTypelessListener"), __name(_ca, "Emitter2"), _ca);
var SUPPORTS_SERVICE_WORKER = supportsServiceWorker();
var WorkerEvent = (_da = class extends TypedEvent {
...
}, _workerEvent = new WeakMap(), __name(_da, "WorkerEvent"), _da);
var WorkerChannel = (_ea = class extends Emitter2 {
  constructor(options) {
    super();
    ...
    navigator.serviceWorker.addEventListener(
      "message",
      async (event) => {
        const worker2 = await __privateGet(this, _getWorker).call(this);
  ...
  postMessage(type) {
    ...
    __privateGet(this, _getWorker).call(this).then((worker2) => {
...
}, _getWorker = new WeakMap(), _controller2 = new WeakMap(), __name(_ea, "WorkerChannel"), _ea);
...
__name(pruneGetRequestBody, "pruneGetRequestBody");
...
__name(validateWorkerScope, "validateWorkerScope");
...
__name(shouldInvalidateWorker, "shouldInvalidateWorker");
var ServiceWorkerSource = (_fa = class extends NetworkSource {
  constructor(options) {
    super();
    ...
    __privateAdd(this, _defaultFindWorker, /* @__PURE__ */ __name((workerUrl, mockServiceWorkerUrl) => {
    ...
    __privateSet(this, _channel, new WorkerChannel({
      getWorker: /* @__PURE__ */ __name(() => this.workerPromise.then(([worker2]) => worker2), "getWorker")
    }));
  }
  /**
  ...
  static async from(options) {
    if (__privateGet(_fa, _current) == null) {
      __privateSet(_fa, _current, new _fa(options));
    } else if (shouldInvalidateWorker(__privateGet(__privateGet(_fa, _current), _options), options)) {
      await __privateGet(_fa, _current).terminate();
      __privateSet(_fa, _current, new _fa(options));
    }
    return __privateGet(_fa, _current);
  }
  async enable() {
    ...
    const [worker2, registration] = await __privateMethod(this, __ServiceWorkerSource_instances, startWorker_fn).call(this);
  ...
  disable() {
    ...
    (_a2 = __privateGet(this, _listenerController)) == null ? void 0 : _a2.abort();
  ...
  async terminate() {
    ...
    if (__privateGet(_fa, _current) === this) {
      __privateSet(_fa, _current, void 0);
    }
  }
}, _current = new WeakMap(), _options = new WeakMap(), _frames2 = new WeakMap(), _channel = new WeakMap(), _listenerController = new WeakMap(), _clientPromise = new WeakMap(), _keepAliveInterval = new WeakMap(), _stoppedAt = new WeakMap(), __ServiceWorkerSource_instances = new WeakSet(), startWorker_fn = /* @__PURE__ */ __name(async function() {
  var _a2, _b2;
  ...
  if (worker2 == null) {
    const missingWorkerMessage = ((_a2 = __privateGet(this, _options)) == null ? void 0 : _a2.findWorker) ? devUtils.formatMessage(
...
}, "#startWorker"), handleRequest_fn2 = /* @__PURE__ */ __name(async function(event) {
...
}, "#handleRequest"), handleResponse_fn2 = /* @__PURE__ */ __name(async function(event) {
  var _a2;
  const { request, response, isMockedResponse } = event.data;
  const frame = __privateGet(this, _frames2).get(request.id);
  if ((_a2 = response.type) == null ? void 0 : _a2.includes("opaque")) {
...
}, "#handleResponse"), _defaultFindWorker = new WeakMap(), checkWorkerIntegrity_fn = /* @__PURE__ */ __name(async function() {
...
You can also automate this process and make the worker script update automatically upon the library installations. Read more: https://mswjs.io/docs/cli/init.`
...
}, "#checkWorkerIntegrity"), printStartMessage_fn = /* @__PURE__ */ __name(async function() {
  ...
  console.groupEnd();
}, "#printStartMessage"), printStopMessage_fn = /* @__PURE__ */ __name(function() {
  console.log(
    `%c${devUtils.formatMessage("Mocking disabled.")}`,
    "color:orangered;font-weight:bold;"
  );
}, "#printStopMessage"), __name(_fa, "_ServiceWorkerSource"), __privateAdd(_fa, _current), _fa);
var ServiceWorkerHttpNetworkFrame = (_ga = class extends HttpNetworkFrame {
  constructor(options) {
  ...
  respondWith(response) {
    if (response) {
      __privateMethod(this, __this_instances5, respondWith_fn).call(this, response);
    }
  }
  errorWith(reason) {
    if (reason instanceof Response) {
...
}, _event = new WeakMap(), __this_instances5 = new WeakSet(), respondWith_fn = /* @__PURE__ */ __name(async function(response) {
  let responseBody;
  let transfer;
...
}, "#respondWith"), __name(_ga, "ServiceWorkerHttpNetworkFrame"), _ga);
var until2 = /* @__PURE__ */ __name(async (promise) => {
  try {
...
__name(isPropertyAccessible, "isPropertyAccessible");
...
__name(createServerErrorResponse, "createServerErrorResponse");
function isResponseError(response) {
  return response != null && response instanceof Response && isPropertyAccessible(response, "type") && response.type === "error";
}
__name(isResponseError, "isResponseError");
...
__name(isResponseLike, "isResponseLike");
...
__name(isNodeLikeError, "isNodeLikeError");
async function handleRequest(options) {
  ...
  const handleResponseError = /* @__PURE__ */ __name(async (error2) => {
...
__name(followFetchRedirect, "followFetchRedirect");
...
var BrotliDecompressionStream = (_ha = class extends TransformStream {
  constructor() {
...
}, __name(_ha, "BrotliDecompressionStream"), _ha);
var PipelineStream = (_ia = class extends TransformStream {
...
}, __name(_ia, "PipelineStream"), _ia);
function parseContentEncoding(contentEncoding) {
  return contentEncoding.toLowerCase().split(",").map((coding) => coding.trim());
}
__name(parseContentEncoding, "parseContentEncoding");
...
var FetchInterceptor = (_ja = class extends Interceptor {
  constructor() {
    super(_ja.symbol);
  }
  checkEnvironment() {
  ...
  async setup() {
    ...
    globalThis.fetch = async (input, init) => {
      ...
      const controller = new RequestController(request, {
        passthrough: /* @__PURE__ */ __name(async () => {
        ...
        respondWith: /* @__PURE__ */ __name(async (rawResponse) => {
        ...
        errorWith: /* @__PURE__ */ __name((reason) => {
...
}, __name(_ja, "FetchInterceptor2"), _ja.symbol = /* @__PURE__ */ Symbol("fetch"), _ja);
...
__name(concatArrayBuffer, "concatArrayBuffer");
var EventPolyfill = (_ka = class {
...
}, __name(_ka, "EventPolyfill"), _ka);
var ProgressEventPolyfill = (_la = class extends EventPolyfill {
  constructor(type, init) {
    super(type);
...
}, __name(_la, "ProgressEventPolyfill"), _la);
...
__name(findPropertySource, "findPropertySource");
...
function optionsToProxyHandler(options) {
  ...
  handler.get = function(target, propertyName, receiver) {
    const next = /* @__PURE__ */ __name(() => target[propertyName], "next");
...
__name(optionsToProxyHandler, "optionsToProxyHandler");
...
__name(isDomParserSupportedType, "isDomParserSupportedType");
...
__name(createHeadersFromXMLHttpRequestHeaders, "createHeadersFromXMLHttpRequestHeaders");
...
var XMLHttpRequestController = (_ma = class {
  constructor(initialRequest, logger) {
    ...
    this.request = createProxy(initialRequest, {
      setProperty: /* @__PURE__ */ __name(([propertyName, nextValue], invoke) => {
        switch (propertyName) {
          case "ontimeout": {
      ...
      methodCall: /* @__PURE__ */ __name(([methodName, args], invoke) => {
        switch (methodName) {
          case "open": {
          ...
          case "send": {
            ...
            queueMicrotask(() => {
              var _a2;
              (((_a2 = this.onRequest) == null ? void 0 : _a2.call(this, {
                request: fetchRequest,
                requestId: this.requestId
  ...
  */
  async respondWith(response) {
    ...
    this.request.getResponseHeader = new Proxy(this.request.getResponseHeader, { apply: /* @__PURE__ */ __name((_, __2, args) => {
    ...
    this.request.getAllResponseHeaders = new Proxy(this.request.getAllResponseHeaders, { apply: /* @__PURE__ */ __name(() => {
    ...
    Object.defineProperties(this.request, {
      response: {
        enumerable: true,
        configurable: false,
        get: /* @__PURE__ */ __name(() => this.response, "get")
      },
      responseText: {
        enumerable: true,
        configurable: false,
        get: /* @__PURE__ */ __name(() => this.responseText, "get")
      },
      responseXML: {
        enumerable: true,
        configurable: false,
        get: /* @__PURE__ */ __name(() => this.responseXML, "get")
      }
    });
    ...
    const finalizeResponse = /* @__PURE__ */ __name(() => {
    ...
    if (response.body) {
      ...
      const readNextResponseBodyChunk = /* @__PURE__ */ __name(async () => {
  ...
  */
  toFetchApiRequest(body) {
    ...
    define(fetchRequest, "headers", createProxy(fetchRequest.headers, { methodCall: /* @__PURE__ */ __name(([methodName, args], invoke) => {
      switch (methodName) {
        case "append":
        case "set": {
...
}, __name(_ma, "XMLHttpRequestController"), _ma);
  ...
  return new Proxy(globalThis.XMLHttpRequest, { construct(target, args, newTarget) {
    ...
    xhrRequestController.onRequest = async function({ request, requestId }) {
      const controller = new RequestController(request, {
        ...
        respondWith: /* @__PURE__ */ __name(async (response) => {
          if (isResponseError(response)) {
...
__name(createXMLHttpRequestProxy, "createXMLHttpRequestProxy");
var XMLHttpRequestInterceptor = (_na = class extends Interceptor {
  constructor() {
    super(_na.interceptorSymbol);
  }
  checkEnvironment() {
...
}, __name(_na, "XMLHttpRequestInterceptor2"), _na.interceptorSymbol = /* @__PURE__ */ Symbol("xhr"), _na);
var FallbackHttpSource = (_oa = class extends InterceptorSource {
  constructor(options) {
    super({
      interceptors: [new XMLHttpRequestInterceptor(), new FetchInterceptor()]
    });
    __privateAdd(this, __this_instances6);
    this.options = options;
  }
  enable() {
    super.enable();
    if (!this.options.quiet) {
      __privateMethod(this, __this_instances6, printStartMessage_fn2).call(this);
    }
  }
  disable() {
    super.disable();
    if (!this.options.quiet) {
      __privateMethod(this, __this_instances6, printStopMessage_fn2).call(this);
    }
  }
}, __this_instances6 = new WeakSet(), printStartMessage_fn2 = /* @__PURE__ */ __name(function() {
  console.groupCollapsed(
  ...
  console.log("Found an issue? https://github.com/mswjs/msw/issues");
  console.groupEnd();
}, "#printStartMessage"), printStopMessage_fn2 = /* @__PURE__ */ __name(function() {
  console.log(
    `%c${devUtils.formatMessage("Mocking disabled.")}`,
    "color:orangered;font-weight:bold;"
  );
}, "#printStopMessage"), __name(_oa, "FallbackHttpSource"), _oa);
  ...
  return {
    async start(options) {
      ...
      const httpSource = supportsServiceWorker() ? await ServiceWorkerSource.from({
        serviceWorker: {
          url: ((_b2 = (_a2 = options == null ? void 0 : options.serviceWorker) == null ? void 0 : _a2.url) == null ? void 0 : _b2.toString()) || DEFAULT_WORKER_URL,
...
__name(checkGlobals, "checkGlobals");
function isStringEqual(actual, expected) {
  return actual.toLowerCase() === expected.toLowerCase();
}
__name(isStringEqual, "isStringEqual");
...
__name(getStatusCodeColor, "getStatusCodeColor");
...
var require_dist = __commonJS({
  "node_modules/.pnpm/cookie@1.1.1/node_modules/cookie/dist/index.js"(exports) {
    ...
    __name(parseSetCookie2, "parseSetCookie");
...
__name(getAllDocumentCookies, "getAllDocumentCookies");
...
__name(getDocumentCookies, "getDocumentCookies");
...
__name(getAllRequestCookies, "getAllRequestCookies");
...
const _HttpHandler = class _HttpHandler extends RequestHandler {
...
__name(hasRefCounted, "hasRefCounted");
...
__name(getRealisticResponseTime, "getRealisticResponseTime");
async function delay(durationOrMode) {
  ...
  return new Promise((resolve) => {
    ...
    if (delayTime === SET_TIMEOUT_MAX_ALLOWED_INT && isNodeProcess$1() && hasRefCounted(timeoutId)) {
      timeoutId.unref();
    }
  });
}
...
checkGlobals();
const fileHandlers = [
  // Upload file (receipt or supporting) - Real backend endpoint
  // POST /api/v1.0/expense-forms/:company/files/drafts/:expenseId/files?document_type=receipt|supporting
  http.post(ENDPOINT_PATTERNS.FILES_UPLOAD, async ({ request, params }) => {
    var _a2;
    const url = new URL(request.url);
    const documentType = url.searchParams.get("document_type") || "receipt";
    const { company, expenseId } = params;
    devLog("MSW: Intercepting file upload request", { company, expenseId, documentType });
    await delay(1500);
    try {
      ...
      if (!file) {
        return HttpResponse.json(
          { error: "No file provided", message: "File is required for upload" },
          { status: 400 }
        );
      }
      ...
      try {
        ...
        devWarn("Failed to convert file to base64:", error2);
      }
      const uploadedFile = {
        id: fileId,
      ...
      const response = {
        ...
        mimeType: file.type,
        documentType,
        expenseId: parseInt(expenseId, 10) || 0,
        uploadedAt: (/* @__PURE__ */ new Date()).toISOString()
      };
      devLog("MSW: File uploaded successfully", { fileId, documentType });
      return HttpResponse.json(response, { status: 201 });
    } catch (error2) {
      devError("MSW: File upload error:", error2);
      return HttpResponse.json(
  ...
  // Download file - GET /api/v1.0/files/:fileId
  http.get(ENDPOINT_PATTERNS.FILES_DOWNLOAD, async ({ params }) => {
    const { fileId } = params;
    devLog("MSW: Downloading file", { fileId });
    await delay(500);
    const file = getUploadedFile(fileId);
    if (!file || !file.data) {
      return HttpResponse.json(
        { error: "File not found", message: `File with ID ${fileId} does not exist` },
        { status: 404 }
      );
    }
  ...
  // Delete file - DELETE /api/v1.0/files/:fileId
  http.delete(ENDPOINT_PATTERNS.FILES_DELETE, async ({ params }) => {
    const { fileId } = params;
    devLog("MSW: Deleting file", { fileId });
    await delay(500);
    ...
    devLog("MSW: File deleted successfully", { fileId });
...
function checkSimulatedError(url) {
...
__name(checkSimulatedError, "checkSimulatedError");
const expenseFormHandlers = [
  // POST /expense-forms/:company/drafts — create draft
  http.post(ENDPOINT_PATTERNS.EXPENSE_FORMS_DRAFTS, async ({ request }) => {
    await delay(DELAYS.create);
    const endpoint = new URL(request.url).pathname;
    const errorResponse = checkSimulatedError(endpoint);
    ...
    try {
      ...
      setRawRequest$1(String(draftId), data);
      if (isMileage) {
      ...
      devLog("MSW: Draft created", { id: draftId, businessId, isMileage });
      return HttpResponse.json(response, { status: 201 });
    } catch {
      return HttpResponse.json({ error: "Failed to save draft" }, { status: 500 });
    }
  }),
  // PUT /expense-forms/:company/drafts/:id — update draft
  http.put(ENDPOINT_PATTERNS.EXPENSE_FORMS_DRAFT_BY_ID, async ({ request, params }) => {
    ...
    try {
      ...
      devLog("MSW: Draft updated", { id: draftId, category });
      return HttpResponse.json(response, { status: 200 });
    } catch {
      return HttpResponse.json({ error: "Failed to update draft" }, { status: 500 });
    }
  }),
  // GET /expense-forms/:company/drafts/:id — get single draft
  http.get(ENDPOINT_PATTERNS.EXPENSE_FORMS_DRAFT_BY_ID, async ({ params }) => {
  ...
  // GET /expense-forms/:company/drafts — list all drafts
  http.get(ENDPOINT_PATTERNS.EXPENSE_FORMS_DRAFTS, async () => {
    await delay(DELAYS.get);
    const expenseDrafts = Array.from(getExpenseDrafts().values());
    const mileageDrafts = Array.from(getMileageDrafts().values());
    const allDrafts = [...expenseDrafts, ...mileageDrafts].sort(
      (a, b) => new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime()
    );
    return HttpResponse.json(allDrafts, { status: 200 });
  }),
  // DELETE /expense-forms/:company/drafts/:id — delete draft
  http.delete(ENDPOINT_PATTERNS.EXPENSE_FORMS_DRAFT_BY_ID, async ({ request, params }) => {
    ...
    devLog("MSW: Draft deleted", { draftId });
    return HttpResponse.json("Draft deleted successfully", { status: 200 });
  }),
  // POST /expense-forms/:company/drafts/:id/submit — submit draft
  http.post(ENDPOINT_PATTERNS.EXPENSE_FORMS_SUBMIT, async ({ request }) => {
    await delay(DELAYS.submit);
    const endpoint = new URL(request.url).pathname;
    const errorResponse = checkSimulatedError(endpoint);
    if (errorResponse) return errorResponse;
    const match2 = endpoint.match(/\/drafts\/([^/]+)\/submit$/);
    const draftId = match2 ? match2[1] : null;
    if (!draftId) {
    ...
    deleteDraftById(draftId);
    devLog("MSW: Draft submitted", { id: draftId, category });
    return HttpResponse.json(response, { status: 200 });
  })
];
const configurationHandlers = [
  // Logical Companies
  http.get(ENDPOINT_PATTERNS.CONFIG_LOGICAL_COMPANIES, async () => {
    var _a2;
    await delay(300);
    const defaultCompany = mockLogicalCompanies.find((c) => c.defaultLogicalCompany);
    const response = {
      userDefaultLogicalCompanyId: (defaultCompany == null ? void 0 : defaultCompany.id) ?? ((_a2 = mockLogicalCompanies[0]) == null ? void 0 : _a2.id) ?? 0,
      items: mockLogicalCompanies
    };
    devLog("✅ MSW: Logical companies fetched", { count: mockLogicalCompanies.length });
    return HttpResponse.json(response, { status: 200 });
  }),
  // Form Types
  http.get(ENDPOINT_PATTERNS.CONFIG_FORM_TYPES, async () => {
    await delay(300);
    devLog("✅ MSW: Form types fetched", { count: mockFormTypes.length });
    return HttpResponse.json(mockFormTypes, { status: 200 });
  }),
  // Expense Types
  http.get(ENDPOINT_PATTERNS.CONFIG_EXPENSE_TYPES, async ({ params }) => {
    ...
    devLog("✅ MSW: Expense types fetched", { company: companyShortName, count: expenseTypes.length });
  ...
  http.post(ENDPOINT_PATTERNS.CONFIG_EXPENSE_TYPE_CRUD, async ({ request, params }) => {
    ...
    try {
      ...
      devLog("✅ MSW: Expense type created", newExpenseType);
  ...
  http.put(ENDPOINT_PATTERNS.CONFIG_EXPENSE_TYPE_CRUD, async ({ request, params }) => {
    ...
    try {
      ...
      const updated = updateExpenseType(companyShortName, body.id, {
        ...
        expenseTypeDescription: body.expenseTypeDescription ?? void 0,
        isActive: body.isActive ?? void 0,
        updatedBy: "system",
        updatedDate: (/* @__PURE__ */ new Date()).toISOString()
      });
      if (!updated) {
      ...
      devLog("✅ MSW: Expense type updated", { id: updated.id, name: updated.expenseTypeName, isActive: updated.isActive });
  ...
  // Mileage Rates handlers
  // GET /{company}/mileage-rates?mileage_rate_id=X
  http.get(ENDPOINT_PATTERNS.CONFIG_MILEAGE_RATES, async ({ request, params }) => {
    await delay(300);
    try {
      const companyShortName = params.company;
      const url = new URL(request.url);
      const mileageRateId = parseInt(url.searchParams.get("mileage_rate_id") || "0", 10);
      if (!mileageRateId) {
        return HttpResponse.json({ error: "mileage_rate_id is required" }, { status: 400 });
      }
      ...
      devLog("✅ MSW: Mileage rates fetched", { company: companyShortName, mileageRateId, count: rates.length });
      return HttpResponse.json(rates, { status: 200 });
    } catch {
      return HttpResponse.json(
        { error: "Failed to fetch mileage rates" },
        { status: 500 }
      );
    }
  }),
  // POST /{company}/mileage-rates  body: { mileageRateId, rate, effectiveDate }
  http.post(ENDPOINT_PATTERNS.CONFIG_MILEAGE_RATES, async ({ request, params }) => {
    await delay(500);
    try {
      const companyShortName = params.company;
      const body = await request.json();
      const mileageRateId = body.mileageRateId;
      const expenseType = getExpenseType(companyShortName, mileageRateId);
      const isExpenseTypeActive = (expenseType == null ? void 0 : expenseType.isActive) ?? true;
      if (!isExpenseTypeActive) {
        return HttpResponse.json(
          { error: "Cannot add new rates to an inactive mileage type" },
          { status: 400 }
        );
      }
      let rates = getMileageRates(companyShortName, mileageRateId);
      ...
      devLog("✅ MSW: Mileage rate created", newRate);
      return HttpResponse.json(String(newRate.id), { status: 201 });
    } catch {
      return HttpResponse.json(
        { error: "Failed to create mileage rate" },
        { status: 500 }
      );
    }
  }),
  // DELETE /{company}/mileage-rates/{effectiveRateId}
  http.delete(ENDPOINT_PATTERNS.CONFIG_MILEAGE_RATE_DELETE, async ({ params }) => {
    ...
    try {
      ...
      if (!isExpenseTypeActive) {
        return HttpResponse.json(
          { error: "Cannot delete rates of an inactive mileage type" },
          { status: 400 }
        );
      }
      const currentStatus = calculateRateStatus(
        rateToDelete.effectiveDate,
        rateToDelete.expiryDate,
        isExpenseTypeActive
      );
      if (currentStatus !== MileageRateStatus.FUTURE) {
        return HttpResponse.json(
          { error: "Only future rates can be deleted" },
          { status: 400 }
        );
      }
      let rates = getMileageRates(companyShortName, mileageRateId);
      ...
      rates = sortRatesByStatus(rates);
      setMileageRates(companyShortName, mileageRateId, rates);
      devLog("✅ MSW: Mileage rate deleted", { rateId });
      return HttpResponse.json({ message: "Mileage Effective Rate successfully deleted" }, { status: 200 });
    } catch {
      return HttpResponse.json(
        { error: "Failed to delete mileage rate" },
        { status: 500 }
      );
    }
  })
];
const isExpenseMock = /* @__PURE__ */ __name((item) => {
  return "vendor" in item.data;
}, "isExpenseMock");
const addItemType = /* @__PURE__ */ __name((item) => {
  if (isExpenseMock(item)) {
    return { ...item, itemType: "expense" };
  }
  return { ...item, itemType: "mileage" };
}, "addItemType");
const filterByStatus = /* @__PURE__ */ __name((items, status) => {
  if (!status || status === "all") return items;
  return items.filter((item) => item.status === status);
}, "filterByStatus");
const searchById = /* @__PURE__ */ __name((items, search) => {
  if (!(search == null ? void 0 : search.trim())) return items;
  return items.filter((item) => item.id === search.trim());
}, "searchById");
const getExpenseDateTimestamp = /* @__PURE__ */ __name((item) => {
  const { data } = item;
...
const getStatusDateTimestamp = /* @__PURE__ */ __name((item, field) => {
  if (field in item) {
...
const getTimestamp = /* @__PURE__ */ __name((item, field) => {
...
const sortItems = /* @__PURE__ */ __name((items, sortBy, sortOrder) => {
...
const expensesListHandlers = [
  // New endpoint: /api/v1.0/expense-forms/:company
  http.get(ENDPOINT_PATTERNS.EXPENSE_FORMS_LIST, async ({ params }) => {
    await delay(300);
    ...
    devLog("MSW: Expense forms list fetched", { company, count: all.length });
    return HttpResponse.json(response, { status: 200 });
  }),
  // Legacy endpoint: /api/v1.0/expenses-list
  http.get(ENDPOINT_PATTERNS.EXPENSES_LIST_UNIFIED, async ({ request }) => {
    ...
    const allMockItems = [
      ...Array.from(getExpenseDrafts().values()),
      ...Array.from(getExpenseSubmitted().values()),
      ...Array.from(getMileageDrafts().values()),
      ...Array.from(getMileageSubmitted().values())
    ];
...
const expenseItemHandlers = [
  http.get(ENDPOINT_PATTERNS.EXPENSE_ITEM_BY_ID, async ({ params }) => {
    await delay(300);
    ...
    return HttpResponse.json(
      { error: "Expense item not found", code: "404" },
      { status: 404 }
    );
  })
];
const mockApprovalItems = [
  {
    ...
    vendor: "Home Depot",
    totalAmount: 71.59,
    totalAmountCurrency: { isoCode: "CAD", name: "Canadian Dollar", symbol: "$" },
    paymentMethod: { id: 1, name: "Corporate Card - CAD", currencyCode: "CAD" },
    status: "Submitted",
    actionDate: "2025-10-18"
  },
  {
    id: 10002,
    businessId: "EXP-10002",
    ...
    totalAmount: 450,
    totalAmountCurrency: { isoCode: "USD", name: "US Dollar", symbol: "$" },
    paymentMethod: { id: 2, name: "Personal Card", currencyCode: "USD" },
    status: "Submitted",
    actionDate: "2025-09-20"
  },
  {
    id: 10003,
    businessId: "MIL-10003",
    employeeFullName: "Alex Johnson",
    date: "2025-10-01",
    periodStart: null,
    periodEnd: null,
    expenseType: "Mileage - Personal Car",
    vendor: "",
    totalAmount: 25.5,
    totalAmountCurrency: { isoCode: "CAD", name: "Canadian Dollar", symbol: "$" },
    paymentMethod: null,
    status: "Submitted",
    actionDate: "2025-10-05"
  },
  {
    id: 10004,
    businessId: "EXP-10004",
    employeeFullName: "Sarah Wilson",
    date: "2025-08-20",
    periodStart: null,
    periodEnd: null,
    ...
    paymentMethod: { id: 1, name: "Corporate Card - CAD", currencyCode: "CAD" },
    status: "Submitted",
    actionDate: "2025-08-25"
  }
];
const mockExpenseFormDetails = {
  "10001": {
    expenseId: 10001,
    status: "Submitted",
    expenseType: "Materials",
    ...
    country: { id: 1, isoCode: "CA", name: "Canada", defaultCurrencyIso: "CAD" },
    description: "Special materials needed for the job",
    from: null,
    to: null,
    totalDistance: null,
    effectiveRate: null,
    effectiveMileageRateId: null,
    roundTrip: null,
    periodStart: null,
    periodEnd: null,
    totalAmount: 71.59,
    ...
    costAllocations: [
      {
        ...
        project: {
          projectId: 1,
          projectBaseId: "232226",
          projectDescription: "EXP-VISA / 1: Birdville ISD Walker Creek Emergency Geo System Repairs",
          poId: 1,
          poBaseId: "232226",
          poDescription: "EXP-VISA Walker Creek",
    ...
    costAllocationDeferral: false,
    affidavitJustification: null,
    affidavitInitials: null,
    additionalComments: "Split the allocation according to agreement",
    personsEntertained: null,
    files: [
      {
        id: "mock-receipt-1",
        name: "receipt_home_depot.pdf",
        size: 245e3,
      ...
      {
        id: "mock-supporting-1",
        name: "hotel-bill_Marriott.pdf",
        size: 18e4,
        mimeType: "application/pdf",
        documentType: "supporting",
        expenseId: 10001,
        uploadedAt: "2025-10-04T16:00:00Z"
      },
      {
        id: "mock-supporting-2",
        name: "data-c.png",
        size: 95e3,
        mimeType: "image/png",
        documentType: "supporting",
        expenseId: 10001,
        uploadedAt: "2025-10-04T16:05:00Z"
      }
    ],
    paymentMethod: { id: 1, name: "Corporate Card - CAD", currencyCode: "CAD", active: true, userId: null },
    createdBy: "user-guid-001",
    updatedBy: "user-guid-001",
    createdDate: "2025-10-04T14:00:00Z",
    updatedDate: "2025-10-18T09:00:00Z",
    businessId: "EXP-10001",
    employeeFullName: "John Doe"
  },
  "10002": {
    ...
    country: { id: 2, isoCode: "US", name: "United States", defaultCurrencyIso: "USD" },
    ...
    businessPurposeId: 2,
    costAllocations: [],
    costAllocationDeferral: true,
    affidavitJustification: null,
    affidavitInitials: null,
    additionalComments: null,
    personsEntertained: null,
    files: [],
    paymentMethod: { id: 2, name: "Personal Card", currencyCode: "USD", active: true, userId: null },
    createdBy: "user-guid-002",
    updatedBy: null,
    createdDate: "2025-09-15T10:00:00Z",
    updatedDate: "2025-09-20T14:00:00Z",
    businessId: "EXP-10002",
    employeeFullName: "Jane Smith"
  },
  "10003": {
    ...
    country: { id: 1, isoCode: "CA", name: "Canada", defaultCurrencyIso: "CAD" },
    description: "Daily commute to client site",
    from: "Home",
    to: "Client Office",
    totalDistance: 38,
    effectiveRate: 0.67,
    effectiveMileageRateId: 1,
    roundTrip: false,
    periodStart: null,
    periodEnd: null,
    totalAmount: 25.46,
    ...
    files: [],
    paymentMethod: null,
    createdBy: "user-guid-003",
    updatedBy: null,
    createdDate: "2025-10-01T08:00:00Z",
    updatedDate: "2025-10-05T11:00:00Z",
    businessId: "MIL-10003",
    employeeFullName: "Alex Johnson"
  },
  "10004": {
    ...
    files: [],
    paymentMethod: { id: 1, name: "Corporate Card - CAD", currencyCode: "CAD", active: true, userId: null },
    createdBy: "user-guid-004",
    updatedBy: null,
    createdDate: "2025-08-20T13:00:00Z",
    updatedDate: "2025-08-25T10:00:00Z",
    businessId: "EXP-10004",
    employeeFullName: "Sarah Wilson"
  }
};
const approvalsHandlers = [
  // GET /api/v1.0/approvals/{company} — approvals list
  http.get(ENDPOINT_PATTERNS.APPROVALS_LIST, async ({ request }) => {
    await delay(300);
    const url = new URL(request.url);
    const status = url.searchParams.get("status") || "submitted";
    const pageNumber = Number(url.searchParams.get("pageNumber") ?? 1);
    const pageSize = Number(url.searchParams.get("pageSize") ?? 10);
    const filtered = mockApprovalItems.filter(
  ...
  // GET /api/v1.0/expense-forms/{company}/{id} — expense form detail
  http.get(ENDPOINT_PATTERNS.EXPENSE_FORM_BY_ID, async ({ params }) => {
    await delay(300);
    const id = params.id;
    const detail = mockExpenseFormDetails[id];
    if (detail) {
      return HttpResponse.json(detail);
    }
    return HttpResponse.json(
      { error: "Expense form not found" },
      { status: 404 }
    );
  }),
  // GET /api/v1.0/approvals/{company}/{id}/approval-history
  http.get(ENDPOINT_PATTERNS.APPROVAL_HISTORY, async () => {
    await delay(200);
    return HttpResponse.json({ history: [] });
  })
];
const RECONCILIATION_SUCCESS_SUMMARY = {
  totalTransactions: 286,
  totalAmount: 218234.56,
  totalCardholders: 25,
  statementId: "00000000-0000-0000-0000-000000000123"
};
const STATEMENT_ACTION_SUCCESS = /* @__PURE__ */ __name((action, statementId) => ({
  message: `Bank statement ${action} successfully`,
  statement_id: statementId
}), "STATEMENT_ACTION_SUCCESS");
const masterMismatchSection = {
  type: "Master account mismatch",
  errors: {
    message: "Master account description mismatch detected",
    details: []
  }
};
const dataErrorsSection = {
  type: "Data Errors",
  errors: {
    message: "Data quality issues found",
    details: [
      {
        row: "3",
        issues: [
          "Transaction Date should be in mm/dd/yyyy format",
          "Transaction Amount should be a numeric value"
        ]
      },
      {
        row: "8",
        issues: [
          "Missing required fields: Transaction Date, Transaction Amount",
          "Ending Digits must be 4 numbers"
        ]
      }
    ]
  }
};
const cardholdersSection = {
  type: "Unrecognized cardholders",
  errors: {
    message: "Unrecognized cardholder card endings",
    details: [
      { card_last_digits: "7119" },
      { card_last_digits: "8604" },
      { card_last_digits: "9999" }
    ]
  }
};
const cardholdersOnceCounter = /* @__PURE__ */ new Map();
const pickReconciliationScenario = /* @__PURE__ */ __name((fileName) => {
  const name = fileName.toLowerCase();
  if (name.startsWith("empty-")) {
    return {
      status: 400,
      body: { detail: "The uploaded file is empty. Upload a valid file." }
    };
  }
  if (name.startsWith("template-")) {
    return {
      status: 400,
      body: {
        detail: "The file doesn't match the import template. Use matching column headers."
      }
    };
  }
  if (name.startsWith("big-")) {
    return { status: 413, body: { detail: "File too large" } };
  }
  if (name.startsWith("unsupported-")) {
    return { status: 415, body: { detail: "Unsupported Media Type" } };
  }
  if (name.startsWith("corrupted-")) {
    return {
      status: 400,
      body: { detail: "The file cannot be opened. Upload a valid file." }
    };
  }
  if (name.startsWith("generic-error-")) {
    return { status: 500, body: { detail: "Internal Server Error" } };
  }
  if (name.startsWith("validation-master-")) {
    return { status: 422, body: { detail: [masterMismatchSection] } };
  }
  if (name.startsWith("validation-data-")) {
    return { status: 422, body: { detail: [dataErrorsSection] } };
  }
  if (name.startsWith("validation-both-")) {
    return {
      status: 422,
      body: { detail: [masterMismatchSection, dataErrorsSection] }
    };
  }
  if (name.startsWith("validation-cardholders-once-")) {
    const nextCount = (cardholdersOnceCounter.get(name) ?? 0) + 1;
    cardholdersOnceCounter.set(name, nextCount);
    if (nextCount === 1) {
      return { status: 422, body: { detail: [cardholdersSection] } };
    }
    return null;
  }
  if (name.startsWith("validation-cardholders-")) {
    return { status: 422, body: { detail: [cardholdersSection] } };
  }
  if (name.startsWith("validation-all-")) {
    return {
      status: 422,
      body: {
        detail: [masterMismatchSection, dataErrorsSection, cardholdersSection]
      }
    };
  }
  return null;
}, "pickReconciliationScenario");
const FIXTURE = [
  {
    id: "stmt-cibc-cad-0125",
    master_account_id: "ma-cibc-cad",
    master_account_name: "CIBC Canadian Bank",
    master_account_active: true,
    currency: "CAD",
    start_period: "2026-01-05",
    end_period: "2026-02-04",
    reconciliation_due_date: "2026-02-14",
    status: "upload"
  },
  {
    id: "stmt-cibc-usd-0125",
    master_account_id: "ma-cibc-usd",
    master_account_name: "CIBC US Bank",
    master_account_active: true,
    currency: "USD",
    start_period: "2026-01-05",
    end_period: "2026-02-04",
  ...
  {
    id: "stmt-rbc-cad-1225",
    master_account_id: "ma-rbc-cad",
    master_account_name: "RBC Royal Bank",
    master_account_active: true,
    currency: "CAD",
    start_period: "2025-12-05",
    end_period: "2026-01-04",
    reconciliation_due_date: "2026-01-14",
    total_amount: "45120.33",
    reconciled_amount: "41200.00",
    variance: "3920.33",
    status: "in progress"
  },
  {
    id: "stmt-scotia-cad-1125",
    master_account_id: "ma-scotia-cad",
    master_account_name: "Scotiabank",
    master_account_active: true,
    currency: "CAD",
    start_period: "2025-11-05",
    end_period: "2025-12-04",
    reconciliation_due_date: "2025-12-14",
    total_amount: "62430.00",
    reconciled_amount: "62430.00",
    variance: "0.00",
    status: "complete"
  },
  {
    id: "stmt-bmo-cad-1025",
    master_account_id: "ma-bmo-cad",
    master_account_name: "BMO Bank of Montreal",
    master_account_active: true,
    currency: "CAD",
    start_period: "2025-10-05",
    end_period: "2025-11-04",
    reconciliation_due_date: "2025-11-14",
    total_amount: "28900.00",
    reconciled_amount: "15000.00",
    variance: "13900.00",
    status: "overdue"
  },
  // TRX-435 demo: triggers the "-" placeholder rule (variance = 0).
  // Click this row to see Reconciled = $50,000.00, Variance = "-" on the All companies card.
  {
    id: "stmt-fully-reconciled",
    master_account_id: "ma-demo-fully",
    master_account_name: "Demo: Fully Reconciled (variance = 0)",
    master_account_active: true,
    currency: "CAD",
    start_period: "2025-09-05",
    end_period: "2025-10-04",
    reconciliation_due_date: "2025-10-14",
    total_amount: "50000.00",
    reconciled_amount: "50000.00",
    variance: "0.00",
    status: "complete"
  },
  // TRX-435 demo: triggers the panel vertical-scroll behavior (12 logical companies).
  {
    id: "stmt-many-companies",
    master_account_id: "ma-demo-many",
    master_account_name: "Demo: Many Logical Companies (panel scroll)",
    master_account_active: true,
    currency: "CAD",
    start_period: "2025-08-05",
    end_period: "2025-09-04",
    reconciliation_due_date: "2025-09-14",
    total_amount: "900000.00",
    reconciled_amount: "700000.00",
    variance: "200000.00",
    status: "in progress"
  }
];
const buildReconciliationListResponse = /* @__PURE__ */ __name(({
  pageNumber,
  pageSize
}) => {
  ...
  const results = FIXTURE.slice(start, start + safeSize);
  return {
    results,
    totalObjects: FIXTURE.length,
    pageNumber: safePage,
    pageSize: safeSize,
    totalPages: Math.max(1, Math.ceil(FIXTURE.length / safeSize))
  };
}, "buildReconciliationListResponse");
const DEFAULT_COMPANY_AGGREGATION = {
  all_companies: {
    total_amount: "256789.01",
    reconciled_amount: "217318.70",
    variance_amount: "39470.31"
  },
  logical_company_breakdown: [
    {
      total_amount: "113267.56",
      reconciled_amount: "107708.06",
      variance_amount: "6159.00",
      physical_company_name: "HTS Ontario",
      logical_company_name: "Logical company A",
      logical_company_id: 101
    },
    {
      total_amount: "90834.30",
      reconciled_amount: "90834.30",
      variance_amount: "0.00",
      physical_company_name: "HTS Texas",
      logical_company_name: "Logical company B",
      logical_company_id: 102
    },
    {
      total_amount: "52687.15",
      reconciled_amount: "49165.84",
      variance_amount: "3311.31",
      physical_company_name: "HTS Texas",
      logical_company_name: "Logical company C",
      logical_company_id: 103
    }
  ]
};
const PER_STATEMENT_AGGREGATIONS = {
  // Reconciled-or-variance is 0 case: triggers the "-" placeholder in the panel.
  "stmt-fully-reconciled": {
    all_companies: {
      total_amount: "50000.00",
      reconciled_amount: "50000.00",
      variance_amount: "0.00"
    ...
    logical_company_breakdown: [
      {
        ...
        physical_company_name: "HTS Ontario",
        logical_company_name: "Logical company A",
        logical_company_id: 201
      }
    ]
  },
  // Long-list scenario: verifies left panel vertical scroll.
  "stmt-many-companies": {
    all_companies: {
      total_amount: "900000.00",
      reconciled_amount: "700000.00",
    ...
    logical_company_breakdown: Array.from({ length: 12 }, (_, i) => ({
      total_amount: "75000.00",
      reconciled_amount: "58000.00",
      variance_amount: "17000.00",
      physical_company_name: i % 2 === 0 ? "HTS Ontario" : "HTS Texas",
      logical_company_name: `Logical company ${String.fromCharCode(65 + i)}`,
      logical_company_id: 300 + i
    }))
  }
};
const buildCompanyTransactionsAggregationResponse = /* @__PURE__ */ __name((statementId) => {
  return PER_STATEMENT_AGGREGATIONS[statementId] ?? DEFAULT_COMPANY_AGGREGATION;
}, "buildCompanyTransactionsAggregationResponse");
const reconciliationHandlers = [
  // GET list of bank statements (populates the Reconciliations dashboard)
  http.get(ENDPOINT_PATTERNS.RECONCILIATION_BANK_STATEMENTS, async ({ request }) => {
    const url = new URL(request.url);
    const pageNumber = Number(url.searchParams.get("pageNumber") ?? "1");
    const pageSize = Number(url.searchParams.get("pageSize") ?? "10");
    devLog("MSW: GET reconciliation bank-statements", { pageNumber, pageSize });
    await delay(300);
    return HttpResponse.json(buildReconciliationListResponse({ pageNumber, pageSize }));
  }),
  // POST CSV upload (filename-prefix scenario routing)
  http.post(ENDPOINT_PATTERNS.RECONCILIATION_CSV_UPLOAD, async ({ request, params }) => {
    var _a2;
    const { masterAccountId } = params;
    devLog("MSW: POST reconciliation csv-upload", { masterAccountId });
    const formData = await request.formData();
    const file = formData.get("file");
    const name = ((_a2 = file == null ? void 0 : file.name) == null ? void 0 : _a2.toLowerCase()) ?? "";
    await delay(1200);
    const scenario = pickReconciliationScenario(name);
    if (scenario) {
      return HttpResponse.json(scenario.body, { status: scenario.status });
    }
    return HttpResponse.json(RECONCILIATION_SUCCESS_SUMMARY, { status: 200 });
  }),
  // POST release a staged statement
  http.post(ENDPOINT_PATTERNS.RECONCILIATION_BANK_STATEMENT_RELEASE, async ({ params }) => {
    devLog("MSW: POST reconciliation release", params);
    await delay(400);
    return HttpResponse.json(STATEMENT_ACTION_SUCCESS("released", String(params.statementId)));
  }),
  // DELETE cancel a staged statement
  http.delete(ENDPOINT_PATTERNS.RECONCILIATION_BANK_STATEMENT_CANCEL, async ({ params }) => {
    devLog("MSW: DELETE reconciliation cancel", params);
    await delay(400);
    return HttpResponse.json(STATEMENT_ACTION_SUCCESS("cancelled", String(params.statementId)));
  }),
  // GET aggregated transaction totals per logical company for a given statement
  http.get(
    ENDPOINT_PATTERNS.RECONCILIATION_COMPANY_TRANSACTIONS_AGGREGATION,
    async ({ params }) => {
      const { statementId } = params;
      devLog("MSW: GET reconciliation transactions-company aggregation", { statementId });
      await delay(300);
      return HttpResponse.json(
        buildCompanyTransactionsAggregationResponse(String(statementId))
      );
    }
  )
];
...
const createSmartHandler = /* @__PURE__ */ __name(() => {
  return http.all("*", async ({ request }) => {
    const url = request.url;
    if (shouldMockEndpoint(url)) {
      return;
    }
    devLog("🔄 MSW: Passing through to real backend:", url);
    return passthrough();
  });
}, "createSmartHandler");
...
const startOptions = {
  onUnhandledRequest(request) {
    ...
    if (url.pathname.includes("/api/") || url.pathname.includes("/files/")) {
      devWarn("MSW: Unhandled request (bypassing):", request.url);
    }
  },
  serviceWorker: {
...
const _MSWStrategy = class _MSWStrategy {
  active = false;
  async initialize() {
    if (this.active) {
...
__name(_MSWStrategy, "MSWStrategy");
let MSWStrategy = _MSWStrategy;
export {
  MSWStrategy
};
