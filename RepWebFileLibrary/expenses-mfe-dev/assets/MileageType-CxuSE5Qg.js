...
import { B as Ba, l as qs, a as Pa, e as Pr, P as Pe, I as In, D as Dn, E as En, M as Mn, j as js, K as Ks, U as Ua, n as Xs, q as qa, b as Ka, k as Ma, p, C as Cr, S as Sr, R as Rr, N as Nr, o as Ds } from "./index.es-Diw2MuFT.js";
import { E as EmptyState } from "./EmptyState-BG8ydf6E.js";
import { I as Icon } from "./Icon-BxYHdB7c.js";
import { f as useMileageTypes, e as useExpenseTypeTableState } from "./useExpenseTypeTableState-CYTYGn1g.js";
...
import { b as useCreateExpenseType, c as useUpdateExpenseType, d as useToggleExpenseTypeStatus, E as ExpenseFormType } from "./api-BJnc1Fn1.js";
...
const { useCallback: useCallback$4, useState: useState$2 } = await importShared("react");
...
const { useCallback: useCallback$1, useMemo: useMemo$1, useState: useState$1 } = await importShared("react");
const ManageMileageRatesDialog = ({
  ...
  const [deletingRateIds, setDeletingRateIds] = useState$1(/* @__PURE__ */ new Set());
  ...
  const handleDeleteRate = useCallback$1(async (effectiveRateId) => {
    if (!companyShortName) return;
