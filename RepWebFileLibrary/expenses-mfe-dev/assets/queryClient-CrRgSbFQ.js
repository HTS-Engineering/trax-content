...
import { d as devError, a as apiClient, C as CONFIGURATION_ENDPOINTS } from "./configuration-Cg_hJZZz.js";
import { a3 as interpretError, a4 as getQueryClaimState, a5 as getDisplacedClaimFallback, a6 as forgetQueryClaims, a7 as classifyError, a8 as Subscribable, a9 as Mutation, aa as notifyManager, ab as matchMutation, ac as noop, ad as hashQueryKeyByOptions, ae as Query, af as matchQuery, ag as focusManager, ah as onlineManager, ai as resolveStaleTime, aj as functionalUpdate, J as hashKey, ak as partialMatchKey, al as skipToken, t as useAppQuery, q as queryKeys, d as useCompanyStore } from "./use-scroll-into-view-ref-BYTXl063.js";
import { b as notifyPresentation } from "./notifier-2sXDB8Vo.js";
function reportQueryError(error, query) {
  ...
  if (claimState === "claimed" || claimState === "abandoned") return;
  notifyPresentation(presentation);
}
...
function reportMutationError(error, mutation) {
  ...
  notifyPresentation(presentation, false);
}
