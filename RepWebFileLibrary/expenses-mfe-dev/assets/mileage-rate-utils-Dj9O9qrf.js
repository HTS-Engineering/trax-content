...
import { c as RouteCompanyIds } from "./routes-WnAX1wqE.js";
const ENDPOINT_PATTERNS = {
  // Files - Legacy mock endpoints
  ...
  // Mileage Rates
  CONFIG_MILEAGE_RATES: "*/api/v1.0/configuration/:company/expense-types/:expenseTypeId/mileage-rates",
  CONFIG_MILEAGE_RATE_CRUD: "*/api/v1.0/configuration/:company/expense-types/:expenseTypeId/mileage-rate",
  CONFIG_MILEAGE_RATE_DELETE: "*/api/v1.0/configuration/:company/expense-types/:expenseTypeId/mileage-rates/:rateId",
  // Expenses (legacy)
...
const ENDPOINT_REGEX = {
  ...
  EXPENSES_LIST_UNIFIED: /\/api\/v1\.0\/expenses-list/,
  // Global unified expense item endpoint - searches all types
  EXPENSE_ITEM_BY_ID: /\/api\/v1\.0\/expense-item\/[^/]+$/,
...
const MOCKED_ENDPOINTS_CONFIG = [
  // ═══════════════════════════════════════════════════════════════════════════
  // FILE ENDPOINTS
  // NOTE: Files use real backend - removed from mocking (TRX-270)
  // Handlers remain in axiosStrategy for potential future mock testing
  // ═══════════════════════════════════════════════════════════════════════════
  // ═══════════════════════════════════════════════════════════════════════════
  // EXPENSE ENDPOINTS
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // EXPENSE FORM ENDPOINTS (new with company)
  // NOTE: Drafts use real backend - removed from mocking
  // ═══════════════════════════════════════════════════════════════════════════
  // ═══════════════════════════════════════════════════════════════════════════
  ...
  // NOTE: CONFIG_FORM_TYPES and CONFIG_EXPENSE_TYPES are NOT mocked - use real backend
  // ═══════════════════════════════════════════════════════════════════════════
  {
...
export {
  ENDPOINT_REGEX as A,
  getBusinessPurposes as B,
  addBusinessPurpose as C,
  updateBusinessPurpose as D,
  ENDPOINT_PATTERNS as E,
  deleteBusinessPurpose as F,
  addExpenseDraft as G,
  updateExpenseDraft as H,
  deleteExpenseDraft as I,
  addExpenseSubmitted as J,
  createAxiosError as K,
  addMileageDraft as L,
  updateMileageDraft as M,
  deleteMileageDraft as N,
  addMileageSubmitted as O,
  generateDefaultMileageRates as P,
  ...
  mockFormTypes as k,
  getExpenseTypes as l,
  mockLogicalCompanies as m,
  getNextExpenseTypeId as n,
  addExpenseType as o,
  getExpenseType as p,
  getMileageRates as q,
  recalculateAllRateStatuses as r,
  shouldSimulateError as s,
  sortRatesByStatus as t,
  updateExpenseType as u,
  getNextMileageRateId as v,
  setMileageRates as w,
  calculateRateStatus as x,
  findItemById as y,
  shouldMockEndpoint as z
};
