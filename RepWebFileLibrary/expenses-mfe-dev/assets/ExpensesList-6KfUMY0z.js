...
import { a as $r, K as Ks, D as Da, r as rr, h as Ka, g as Xs, E as Ea, M as Ma, A as An } from "./index.es-CeB-gwY0.js";
import { u as useCompanyStore, a as useQuery, q as queryKeys, k as keepPreviousData } from "./date-format-oMF6p_ER.js";
import { a as apiClient } from "./axiosInstance-DyMZFiGB.js";
import { E as EXPENSE_ENDPOINTS } from "./expense-api-E_z7Shit.js";
...
import { f as formatAmountWithCurrency } from "./formatters-BQnG64EW.js";
import { f as useSearchParams, h as useLocation, m as useNavigateWithReturn, j as useErrorToast, g as generatePath, a as RoutePaths } from "./use-scroll-into-view-ref-DvhGnMjx.js";
...
const useExpensesList = (queryParams, options = {}) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const baseUrl = EXPENSE_ENDPOINTS.GET_EXPENSES(userDefaultCompany.shortName);
...
const useExpensesColumns = ({
  ...
  const staticColumns = useMemo$2(() => [
    ...
    {
      id: "totalAmount",
      accessorFn: (item) => formatAmountWithCurrency(item.totalAmount, item.totalAmountCurrencyCode),
      enableSorting: false,
      size: 140,
  ...
  const statusColumn = useMemo$2(() => ({
    ...
    header: ({ column }) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Status" });
    },
    cell: (context) => {
      if (currentStatusFilter !== "all") return null;
  ...
  const statusDateColumn = useMemo$2(() => {
    ...
    return {
      ...
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: getStatusColumnHeader(currentStatusFilter) }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ks,
        {
          context,
...
const ExpensesList = () => {
  ...
  const renderToolbar = (table) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Ea, { table, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Ma,
      {
        className: "gap-2",
