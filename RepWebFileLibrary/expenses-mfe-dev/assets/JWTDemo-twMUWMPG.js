...
import { c as createLucideIcon, ao as DOMEventNames, S as SessionStorageKeys, s as hs, e as Tr, ap as ct, aq as TokenPlaceholders, U as Ue, ar as On, as as tn, b as apiClient, at as axios } from "./axiosInstance-VUb0TNQ5.js";
import { u as useAuth, a as useJWT, b as useUser, c as usePermissions, d as useTokenExpiration, e as useJWTStatus, f as useJWTPayload } from "./hooks-4H22m0Z9.js";
...
import { T as Trash2, S as Send } from "./trash-2-iQvQtrZQ.js";
const __iconNode$6 = [
...
const JWTDemo = /* @__PURE__ */ __name(() => {
  ...
  const handleTestAPI = /* @__PURE__ */ __name(async () => {
    ...
    try {
      const response = await apiClient.get(CONFIGURATION_ENDPOINTS.LOGICAL_COMPANIES);
      setApiResponse({
