import { aj as AllowedMimeType, ak as MIME_TYPE_CONFIG } from "./ExpenseFormLeftColumn-Bh-f7UJC.js";
import { E as ENDPOINT_PATTERNS, a as addUploadedFile, g as getUploadedFile, h as hasUploadedFile, d as deleteUploadedFile, s as shouldSimulateError, b as generateMockError, c as getExpenseSubmitted, e as getExpenseDrafts, f as getMileageSubmitted, i as getMileageDrafts, m as mockLogicalCompanies, j as mockFormTypes, k as getExpenseTypes, l as getNextExpenseTypeId, n as addExpenseType, u as updateExpenseType, o as getExpenseType, p as getMileageRates, r as recalculateAllRateStatuses, q as sortRatesByStatus, t as getNextMileageRateId, v as setMileageRates, w as calculateRateStatus, x as mapMockToExpenseFormResponse, y as findItemById, z as shouldMockEndpoint } from "./expense-response-mappers-Dux7-l82.js";
import "./mileage-trip-sections-COQp1nUa.js";
import "./jsx-runtime-TULtkvNU.js";
import "./index.es-BBFLzT0B.js";
import "./Icon-iZGOgNHC.js";
...
var kDefaultPrevented$1 = /* @__PURE__ */ Symbol("kDefaultPrevented");
...
const createDraftHandlers = (config) => {
  ...
  const drafts = ((_a2 = config.externalStore) == null ? void 0 : _a2.drafts) ?? /* @__PURE__ */ new Map();
  const submitted = ((_b2 = config.externalStore) == null ? void 0 : _b2.submitted) ?? /* @__PURE__ */ new Map();
  ...
  const delays = {
    save: ((_c2 = config.delays) == null ? void 0 : _c2.save) ?? 600,
    update: ((_d = config.delays) == null ? void 0 : _d.update) ?? 600,
    get: ((_e = config.delays) == null ? void 0 : _e.get) ?? 300,
    delete: ((_f = config.delays) == null ? void 0 : _f.delete) ?? 500,
    submit: ((_g = config.delays) == null ? void 0 : _g.submit) ?? 1e3
  };
  return [
