...
import { C as useQueryClient, aE as useExpenseTypes, aF as ExpenseTypeScope, G as queryKeys, al as FormTypeId, aG as ExpenseFormType, W as devError, aH as useEscapeHandler, aI as useCreateExpenseType, aJ as useUpdateExpenseType, aK as useToggleExpenseTypeStatus, v as jsxRuntimeExports, ap as Oa, aL as useFormTypeOptions, aM as Ba, aq as Ue, aj as Yn, aa as Icon, aN as ni, aO as h, a6 as jr, aP as $r, aQ as Tr, aR as zr, aS as Ar, E as useCompanyStore, ad as useErrorSurface, ag as DataLoadError, af as ri, a9 as EmptyState, a1 as useAppQuery, H as apiClient, aT as CONFIGURATION_ENDPOINTS, F as useMutation, aU as useCurrencies, aV as Ka, Q as Qs, aW as devLog, aX as notifyError, aY as gn, aZ as Xa, a0 as us, a_ as Kr, ar as Mt, as as Et, at as Pt, ab as dr, aC as ai, aD as os, a$ as ii, b0 as as, b1 as is, b2 as useQuery, b3 as formatToISODate, b4 as parseDateOnlyAsLocal, b5 as ts, b6 as DEFAULT_CURRENCY_SYMBOL, b7 as formatRateCompact, b8 as MileageRateStatus, b9 as useMileageRates, ba as useCreateMileageRate, bb as useDeleteMileageRate, bc as hashKey, bd as ys, be as ls, bf as TaxTypeSearchSelect, bg as Info, bh as Os, bi as useTaxTypesDisplay, bj as useEffectiveMileageRatesByIds } from "./__federation_expose_Mount-C9z_Zlnl.js";
import { o as object, _ as _enum, s as string, l as literal, u as useForm, a as u, e as Controller, C as ConfirmDialog, b as array, f as useWatch, T as TOOLTIP_DELAY_TRUNCATED_TEXT, n as number, g as date, h as createDecimalChangeHandler, i as useFormState, j as filterDecimalInput, k as useController } from "./schemas-DfSO1dBb.js";
import { u as useCreateBusinessPurpose, a as useUpdateBusinessPurpose, b as useToggleBusinessPurposeStatus, c as useBusinessPurposes } from "./business-purpose-api-Ca5h4LyV.js";
import { P as Plus } from "./plus-dUr2dQFq.js";
import { u as useInfiniteQuery } from "./useInfiniteQuery-DMjquuhY.js";
...
const useExpenseTypeOperations = /* @__PURE__ */ __name((companyId, onSuccess) => {
  ...
  const handleCreateExpenseType = useCallback$m(async (data) => {
    ...
    try {
      ...
      devError("Failed to create expense type:", error);
      throw error;
    }
  ...
  const handleUpdateExpenseType = useCallback$m(async (id, data, originalData) => {
    ...
    try {
      ...
      devError("Failed to update expense type:", error);
      throw error;
    }
  ...
  const toggleActiveExpenseType = useCallback$m(async (id, currentStatus) => {
    ...
    try {
      ...
      devError("Failed to toggle expense type status:", error);
      throw error;
    }
...
const getFormTypeBadge = /* @__PURE__ */ __name((formType) => {
  switch (formType) {
    case "standard":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(jr, { variant: "outline", className: "text-trax-blue-600 bg-trax-primary-blue-50", children: EXPENSE_TYPE_LABELS.STANDARD });
    case "entertainment":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(jr, { variant: "outline", className: "text-trax-green-800 bg-trax-green-100", children: EXPENSE_TYPE_LABELS.ENTERTAINMENT });
    default:
      return null;
  }
}, "getFormTypeBadge");
...
const ActionsCell$3 = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs($r, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tr, { asChild: true, disabled: isToggling, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ue,
        {
          variant: "ghost",
...
const ExpenseTypeTable = /* @__PURE__ */ __name(({ className }) => {
  ...
  const expenseTypesQuery = useNonMileageTypes((adminCompany == null ? void 0 : adminCompany.id) || null, true);
  const { data: expenseTypes, isError, isLoading } = expenseTypesQuery;
  const {
    editingRowId,
    isAddingNew,
    editingData,
  ...
  const canRenderInPlace = processedData.length === 0;
  const failure = useErrorSurface(expenseTypesQuery, {
    fallback: EXPENSE_TYPE_MESSAGES.LOADING_ERROR,
    canRenderInPlace
  });
  ...
  if (failure.hasFailed && canRenderInPlace) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DataLoadError, { surface: failure }) });
  }
  if (isLoading || isError && failure.isRetrying) {
...
const useCreateMasterAccount = /* @__PURE__ */ __name(() => {
  const queryClient = useQueryClient();
  return useMutation({
    meta: { errorCopy: { fallback: "Could not create the master account. Please try again." } },
...
const useUpdateMasterAccount = /* @__PURE__ */ __name(() => {
  const queryClient = useQueryClient();
  return useMutation({
    meta: { errorCopy: { fallback: "Could not save the master account. Please try again." } },
...
const useCreateCardholder = /* @__PURE__ */ __name(() => {
  const queryClient = useQueryClient();
  return useMutation({
    meta: { errorCopy: { fallback: "Could not create the cardholder. Please try again." } },
...
const useUpdateCardholder = /* @__PURE__ */ __name(() => {
  const queryClient = useQueryClient();
  return useMutation({
    meta: { errorCopy: { fallback: "Could not save the cardholder. Please try again." } },
    mutationFn: /* @__PURE__ */ __name(async ({
      companyShortName,
      masterAccountId,
      data
...
const CardholderNameField = /* @__PURE__ */ __name(({
  ...
  const handleSearch = useCallback$e(async (query) => {
    ...
    try {
      ...
      notifyError(error, { context: "action", copy: { fallback: CARDHOLDER_MESSAGES.SEARCH_ERROR } });
      return [];
    }
  ...
  const handleSearch = useCallback$e(async (query, cursor) => {
    ...
    try {
      const page = await queryClient.fetchQuery({
        // This is a real cached query, so the cache-level handler would speak too; the catch
        // below decides which failures are worth a word.
...
const ManageCardholdersDialog = /* @__PURE__ */ __name(({
  ...
  const { data: cardholders, isError, isLoading } = cardholdersQuery;
  const failure = useErrorSurface(cardholdersQuery, { fallback: CARDHOLDER_MESSAGES.LOADING_ERROR });
  const [tableKey, setTableKey] = useState$6(0);
  useEffect$4(() => {
    if (open) setTableKey((k) => k + 1);
  }, [open]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ai, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    os,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(as, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(is, { className: "flex items-center gap-2 text-base font-semibold text-exp-primary-blue-800", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: isLoading || isError && failure.isRetrying ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Yn, { className: "size-6" }) }) : failure.hasFailed ? /* @__PURE__ */ jsxRuntimeExports.jsx(DataLoadError, { surface: failure }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardholderTable,
          {
            cardholders: cardholders ?? [],
            companyShortName,
...
const MasterAccountTable = /* @__PURE__ */ __name(({ className }) => {
  const { adminCompany } = useCompanyStore();
  const masterAccountsQuery = useMasterAccounts((adminCompany == null ? void 0 : adminCompany.id) || null);
  const { data: masterAccounts, isLoading, isFetching } = masterAccountsQuery;
  ...
  const canRenderInPlace = processedData.length === 0;
  const failure = useErrorSurface(masterAccountsQuery, {
    fallback: CORPORATE_CARDS_MESSAGES.LOADING_ERROR,
    canRenderInPlace
  });
...
const useBusinessPurposeOperations = /* @__PURE__ */ __name((companyShortName, onSuccess) => {
  ...
  const handleCreate = useCallback$9(async (data) => {
    ...
    try {
      ...
      devError("Failed to create business purpose:", err);
      throw err;
    }
  ...
  const handleUpdate = useCallback$9(async (id, data, originalData) => {
    ...
    try {
      ...
      devError("Failed to update business purpose:", err);
      throw err;
    }
  ...
  const toggleActive = useCallback$9(async (id, currentStatus) => {
    ...
    try {
      ...
      devError("Failed to toggle business purpose status:", err);
      throw err;
    }
...
const BusinessPurposeTable = /* @__PURE__ */ __name(({ className }) => {
  const { adminCompany } = useCompanyStore();
  const businessPurposesQuery = useBusinessPurposes((adminCompany == null ? void 0 : adminCompany.id) || null, true);
  const { data: businessPurposes, isError, isLoading } = businessPurposesQuery;
  const {
    editingRowId,
    isAddingNew,
    editingData,
  ...
  const canRenderInPlace = processedData.length === 0;
  const failure = useErrorSurface(businessPurposesQuery, {
    fallback: BUSINESS_PURPOSE_MESSAGES.LOADING_ERROR,
    canRenderInPlace
  });
...
const MILEAGE_TYPE_MESSAGES = {
  ...
  UNIT_LOADING_ERROR: "Failed to load units of measurement. Please try again.",
...
const ManageMileageRatesDialog = /* @__PURE__ */ __name(({
  ...
  const { adminCompany } = useCompanyStore();
  const companyShortName = (adminCompany == null ? void 0 : adminCompany.id) || null;
  const ratesQuery = useMileageRates({
    companyShortName,
    mileageRateId,
    enabled: open
  });
  const { data: rates, isFetching } = ratesQuery;
  const failure = useErrorSurface(ratesQuery, { fallback: MILEAGE_RATE_MESSAGES.LOADING_ERROR });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ai, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    os,
    {
      ...
      onInteractOutside: /* @__PURE__ */ __name((e) => e.preventDefault(), "onInteractOutside"),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ii, { className: "absolute right-6 top-6 text-exp-neutral-100 hover:text-exp-primary-blue-600 focus:text-exp-primary-blue-800 disabled:text-exp-neutral-70 focus:outline-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "close", className: "size-6" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(as, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(is, { className: "flex items-center gap-2 text-base font-semibold text-exp-primary-blue-800", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: isFetching ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Yn, { className: "size-6" }) }) : failure.hasFailed ? /* @__PURE__ */ jsxRuntimeExports.jsx(DataLoadError, { surface: failure }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          MileageRateTable,
          {
            rates: rates ?? [],
            unit: unit || "-",
...
const useExpenseTypeUsers = /* @__PURE__ */ __name(({
  ...
  return { ...query, queryHash: hashKey(queryKey) };
}, "useExpenseTypeUsers");
const useAssignEmployees = /* @__PURE__ */ __name(() => {
  const queryClient = useQueryClient();
  return useMutation({
    meta: { errorCopy: { fallback: "Could not save the employee assignment. Please try again." } },
...
const EMPLOYEES_LOAD_ERROR = "Failed to load employees. Please try again.";
const AssignEmployeesDialog = /* @__PURE__ */ __name(({
  ...
  const usersQuery = useExpenseTypeUsers({
    companyShortName,
    expenseTypeId,
    search,
    enabled: open
  ...
  const handleSave = useCallback$1(async () => {
    ...
    try {
      ...
      devError("Failed to assign employees:", error);
    }
  ...
  const failure = useErrorSurface(usersQuery, {
    fallback: EMPLOYEES_LOAD_ERROR,
    canRenderInPlace: displayAssigned.length === 0 && displayUnassigned.length === 0
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ai, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    os,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: scrollContainerRef, className: "mt-4 h-[400px] overflow-y-auto exp-custom-scrollbar border border-exp-neutral-30 rounded-lg", children: [
          ...
          isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Yn, { className: "size-6" }) }) : failure.hasFailed ? /* @__PURE__ */ jsxRuntimeExports.jsx(DataLoadError, { surface: failure }) : noResults ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-start py-2.5 px-6 text-sm text-exp-neutral-300 italic", children: MILEAGE_TYPE_MESSAGES.ASSIGN_EMPLOYEES_NO_RESULTS }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
const useSetAsDefault = /* @__PURE__ */ __name(() => {
  const queryClient = useQueryClient();
  return useMutation({
    meta: { errorCopy: { fallback: "Could not set this as the default. Please try again." } },
    ...
    os,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(is, { className: "text-base font-semibold text-exp-neutral-900", children: MILEAGE_TYPE_MESSAGES.SET_AS_DEFAULT_TITLE }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ls, { className: "text-sm font-normal text-exp-grey-600", children: `Set "${expenseTypeName}" ${MILEAGE_TYPE_MESSAGES.SET_AS_DEFAULT_MESSAGE}` })
        ] }),
...
const MileageTypeTable = /* @__PURE__ */ __name(({ className }) => {
  const { adminCompany } = useCompanyStore();
  const mileageTypesQuery = useMileageTypes((adminCompany == null ? void 0 : adminCompany.id) || null, true);
  const { data: mileageTypes, isError, isLoading } = mileageTypesQuery;
  ...
  const canRenderInPlace = processedData.length === 0;
  const failure = useErrorSurface(mileageTypesQuery, {
    fallback: MILEAGE_TYPE_MESSAGES.LOADING_ERROR,
    canRenderInPlace
  });
