...
import { v as jsxRuntimeExports, aa as Icon } from "./__federation_expose_Mount-DyIWSVcC.js";
const ICON_NAMES = [
  "action",
  "add",
  "add_chart",
...
const ICON_METADATA = {
  generatedAt: "2026-09-22T15:17:28.389Z"
};
const React = await importShared("react");
const { useMemo, useState } = React;
const IconCard = /* @__PURE__ */ __name(({ iconName, className }) => {
...
const IconsTestingPage = /* @__PURE__ */ __name(() => {
