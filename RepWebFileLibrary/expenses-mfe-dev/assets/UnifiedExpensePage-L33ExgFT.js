...
import { c as createLucideIcon, W as Ws, q as qa, Y as Ya, b as Wa, $ as $e, E as En, K as Ka, M as Mn, P as Pn, V as Vn, B as Bs, d as cs, g as gs, Q as Qn, p as ps, u as us, e as $r, Z as Za } from "./configuration-DCdBxpzA.js";
import { a as ExpenseStatusBadge, E as ExpensesList } from "./ExpensesList-DyIn3ofR.js";
import { a as apiClient } from "./axiosInstance-Dp1zAOAB.js";
import { b as useQueryClient, a as useCompanyStore, q as queryKeys, E as EXPENSE_ENDPOINTS } from "./company-api-DItIZs4s.js";
import { C as ConfirmDialog, t as toISODateString, m as mapCostAllocation, p as parseOptionalInt, a as parseOptionalDecimal, i as isMileageTripData, r as resolveFileUrl, b as isMileagePeriodData, u as useSaveExpenseDraft, c as useSubmitExpense, d as useDeleteExpenseDraft, M as MileageFormType, e as usePendingUploadStore, f as MileageTripForm, g as MileagePeriodForm, E as ExpenseForm } from "./ExpenseFormDialog-CjUn6I_P.js";
...
import { F as FormTypeId, b as useMutation, c as useTaxTypesDisplay, d as useFormTypeName, E as ExpenseFormType, e as useExpenseItem } from "./expense-api-8-6W2Gtz.js";
import { D as DEFAULT_CURRENCY_CODE, a as DEFAULT_CURRENCY } from "./currency-BubACaL0.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ps, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-8 gap-y-4", children: [
      ...
      hasTaxData && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-start-2 grid grid-cols-2 gap-x-4", children: [
        ...
        data.taxAmount && /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            label: "Tax amount",
            value: formatCurrency(data.taxAmount, { code: TAX_CURRENCY_CODE })
          }
        )
      ] })
    ] }) })
