...
import { u as useJWTStore, Y as Yn, a as apiClient, t as ti, T as Ta, j as jr, f as create, h as devtools, i as subscribeWithSelector, k as immer, S as SessionStorageKeys, l as devWarn, z as za, A as Aa, r as ri } from "./configuration-BGy6T4Ra.js";
import { g as Navigate, a as RoutePaths, o as ERROR_MESSAGES, p as formatAmountWithCurrency, m as formatDate, r as formatDateRange, s as formatExpenseDate, d as useCompanyStore, t as useAppQuery, q as queryKeys, v as keepPreviousData, k as EXPENSE_ENDPOINTS, w as useSearchParams, u as useLocation, c as useNavigate, x as generatePath, h as useErrorSurface, D as DataLoadError } from "./use-scroll-into-view-ref-PERXLDXX.js";
import "./TaxTypeSearchSelect-BPtsO4N4.js";
import { g as getExpenseTypeBadgeConfig, E as EtlErrorIndicator } from "./EtlErrorIndicator-D_VoHB8A.js";
import { I as Icon } from "./Icon-DBeU9qcx.js";
import { u as useAuth } from "./hooks-CZwGXqVH.js";
...
const ApprovalsList = /* @__PURE__ */ __name(() => {
  ...
  const renderToolbar = useCallback((table) => /* @__PURE__ */ jsxRuntimeExports.jsx(za, { table, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Aa,
    {
      className: "gap-2",
      column: "status",
