...
import { p, d as Er, f as Bs, R as Ra, g as Un, O as Oa, A as As, k as _a, m as Na, _ as _n } from "./index.es-D1zjfnnK.js";
import { u as useCompanyStore, l as useQuery, q as queryKeys, v as keepPreviousData } from "./query-keys-BTZcEQIj.js";
...
import { k as useSearchParams, e as useLocation, u as useNavigate, j as generatePath, a as RoutePaths } from "./routes-WnAX1wqE.js";
...
const useExpensesColumns = ({
  ...
  const statusDateColumn = useMemo$2(() => {
    ...
    return {
      ...
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ra, { column, title: getStatusColumnHeader(currentStatusFilter) }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Bs,
        {
          context,
...
const ExpensesList = () => {
  ...
  const { data, isFetching } = useExpensesList(queryParams, { enabled: isOnListPage });
