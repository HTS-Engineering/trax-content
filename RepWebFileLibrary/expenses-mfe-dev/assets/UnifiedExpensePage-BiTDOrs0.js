...
import { c as createLucideIcon, U as Us, B as Ba, G as Ga, a as Ua, P as Pe, _ as _n, j as ja, N as Nn, F as Fn, I as In, i as is, l as ls, Y as Yn, b as cs, d as Er, L as Ls, e as Ya } from "./index.es-D1zjfnnK.js";
import { a as ExpenseStatusBadge, E as ExpensesList } from "./ExpensesList-DZgKOKxN.js";
...
import { a as ChevronRight, b as useNavigateBack } from "./use-prevent-page-reload-ued9sZAd.js";
import { T as Trash2, S as Send } from "./trash-2-vaX-UFiV.js";
import { a as devLog, d as devError } from "./use-debounced-callback-DQfTK-qN.js";
import { D as DEFAULT_CURRENCY, E as EXPENSE_DETAILS_SECTION, a as EXPENSE_JUSTIFICATION_SECTION, C as COST_ALLOCATION_SECTION, A as ADDITIONAL_COMMENTS_SECTION, M as MILEAGE_DETAILS_SECTION, b as MILEAGE_JUSTIFICATION_SECTION, c as MILEAGE_COST_ALLOCATION_SECTION, d as MILEAGE_ADDITIONAL_COMMENTS_SECTION, e as MileagePeriodFormField, f as MileageDetailsSection, S as SupportingFilesFormSection, g as MileageJustificationSection, h as CostAllocationHeaderActions, i as DEFAULT_CURRENCY_CODE, j as CostAllocationSection, k as AdditionalCommentsSection, m as mileagePeriodFormSchema } from "./mileage-trip-sections-DjgxQNm-.js";
import { I as Icon } from "./Icon-0rSrBywh.js";
import { c as createExpenseForm } from "./form-factory-CmSVgHoX.js";
...
import { o as object, b as boolean, a as array, u as unknown, n as number, s as string, l as literal } from "./zod-0mrSG730.js";
import { importShared } from "./__federation_fn_import-DYyjX-5O.js";
import { E as ECostAllocation } from "./cost-allocation-Lb8etbcc.js";
...
import { u as useMutation } from "./useMutation-BEVd3q_C.js";
...
function useUnifiedExpensePage() {
  ...
  useEffect(() => {
    return () => {
      const { uploadStatus } = usePendingUploadStore.getState();
      if (uploadStatus === "saving-draft" || uploadStatus === "uploading") {
        return;
      }
      resetUploadStore();
    };
