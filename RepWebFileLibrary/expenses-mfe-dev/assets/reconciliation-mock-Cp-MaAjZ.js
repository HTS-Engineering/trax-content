import { p as ECostAllocation, I as ItemCategory, l as ExpenseFormType, z as MileageRateStatus, A as AllowedMimeType, M as MIME_TYPE_CONFIG, F as FormTypeId } from "./expense-api-E_z7Shit.js";
import "./index-DGIiGjWN.js";
import { E as ExpenseFormStatus } from "./expense-data-Du2WjKhi.js";
import { d as formatToISODate, p as parseDateOnlyAsLocal } from "./date-format-oMF6p_ER.js";
...
const MOCKED_ENDPOINTS_CONFIG = [
  // {
  //   path: ENDPOINT_REGEX.RECONCILIATION_BANK_STATEMENTS,
  //   description: 'Reconciliation bank-statements list (dashboard fixture)',
  // },
  // {
  //   path: ENDPOINT_REGEX.RECONCILIATION_CSV_UPLOAD,
  //   description: 'Reconciliation CSV upload (filename-prefix scenario routing)',
  // },
  // {
  //   path: ENDPOINT_REGEX.RECONCILIATION_BANK_STATEMENT_RELEASE,
  //   description: 'Reconciliation statement release (always 200)',
  // },
  // {
  //   path: ENDPOINT_REGEX.RECONCILIATION_BANK_STATEMENT_CANCEL,
  //   description: 'Reconciliation statement cancel (always 200)',
  // },
  // APPROVALS ENDPOINTS
  // {
  //   path: ENDPOINT_REGEX.APPROVALS_LIST,
  //   description: 'Approvals list (pending/approved/rejected)',
  // },
  // {
  //   path: ENDPOINT_REGEX.EXPENSE_FORM_BY_ID,
  //   description: 'Single expense form by ID (for approver detail view)',
  // },
  // {
  //   path: ENDPOINT_REGEX.APPROVAL_HISTORY,
  //   description: 'Approval history for expense',
  // },
  // FILE ENDPOINTS
  // {
...
export {
  ...
  findItemById as W,
  buildReconciliationListResponse as X,
  pickReconciliationScenario as Y,
  RECONCILIATION_SUCCESS_SUMMARY as Z,
  STATEMENT_ACTION_SUCCESS as _,
  addUploadedFile as a,
  createAxiosError as a0,
  ENDPOINT_REGEX as a1,
  getBusinessPurposes as a2,
  addBusinessPurpose as a3,
  updateBusinessPurpose as a4,
  deleteBusinessPurpose as a5,
  generateDefaultMileageRates as a6,
