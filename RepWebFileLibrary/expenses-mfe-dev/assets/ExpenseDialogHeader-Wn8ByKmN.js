...
import { l as getExpenseActionSubtitle, i as isMileageTripData, d as isMileagePeriodData } from "./CostAllocationSection-C8xQU--T.js";
import { c as isMileageExpense, r as getExpenseItemAmount, i as isExpenseItemSubmitted, b as isRegularExpense } from "./TaxTypeSearchSelect-BWWNgvpC.js";
import { n as formatAmountWithCurrency, H as formatExpensePeriod } from "./formatters-Dvm414Po.js";
import { j as jsxRuntimeExports } from "./jsx-runtime-aCTp6CKK.js";
import { E as ERROR_MESSAGES } from "./queryClient-C5uG-A1E.js";
import { F as os, G as ss, l as ls, Y as Yn } from "./configuration-CaBH14y1.js";
...
const ExpenseDialogHeader = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(os, { className: "pb-3 mb-3 border-b border-exp-primary-blue-100", children: header ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ss, { className: "sr-only", children: "Expense details" }),
