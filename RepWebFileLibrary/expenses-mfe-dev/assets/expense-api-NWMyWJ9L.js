...
import { s as formatToISODate, t as parseDateOnlyAsLocal, D as DEFAULT_CURRENCY_CODE, B as getCurrencySymbol, j as useQuery, m as useQueryClient, q as queryKeys, e as useCompanyStore, n as useMutation } from "./date-format-D7sJ1E1F.js";
import { C as create, D as devtools, ag as subscribeWithSelector, ah as immer, b as apiClient, F as devWarn } from "./axiosInstance-VUb0TNQ5.js";
...
const FILE_ENDPOINTS = {
  ...
  UPLOAD: /* @__PURE__ */ __name((company, expenseId) => `/api/v1.0/expense-forms/${company}/files/drafts/${expenseId}/files`, "UPLOAD"),
  // Download/Delete file by ID
  DOWNLOAD: /* @__PURE__ */ __name((fileId) => `/api/v1.0/files/${fileId}`, "DOWNLOAD"),
  DELETE: /* @__PURE__ */ __name((fileId) => `/api/v1.0/files/${fileId}`, "DELETE")
};
const EXPENSE_ENDPOINTS = {
  // Draft operations (require company)
  SAVE_DRAFT: /* @__PURE__ */ __name((company) => `/api/v1.0/expense-forms/${company}/drafts`, "SAVE_DRAFT"),
  GET_DRAFT: /* @__PURE__ */ __name((company, id) => `/api/v1.0/expense-forms/${company}/drafts/${id}`, "GET_DRAFT"),
  UPDATE_DRAFT: /* @__PURE__ */ __name((company, id) => `/api/v1.0/expense-forms/${company}/drafts/${id}`, "UPDATE_DRAFT"),
  DELETE_DRAFT: /* @__PURE__ */ __name((company, id) => `/api/v1.0/expense-forms/${company}/drafts/${id}`, "DELETE_DRAFT"),
  SUBMIT_DRAFT: /* @__PURE__ */ __name((company, id) => `/api/v1.0/expense-forms/${company}/drafts/${id}/submit`, "SUBMIT_DRAFT"),
  // List operations
  GET_EXPENSES: /* @__PURE__ */ __name((company) => `/api/v1.0/expense-forms/${company}`, "GET_EXPENSES"),
  GET_EXPENSES_LIST: "/api/v1.0/expenses-list",
  // Single expense form by ID (any status: draft, submitted, etc.)
  GET_EXPENSE_FORM: /* @__PURE__ */ __name((company, id) => `/api/v1.0/expense-forms/${company}/${id}`, "GET_EXPENSE_FORM"),
  // Payment methods
  GET_PAYMENT_METHODS: /* @__PURE__ */ __name((company) => `/api/v1.0/expense-forms/${company}/payment-methods`, "GET_PAYMENT_METHODS"),
  // Approvals
  GET_APPROVALS: /* @__PURE__ */ __name((company) => `/api/v1.0/approvals/${company}`, "GET_APPROVALS"),
  // Approval history
  GET_APPROVAL_HISTORY: /* @__PURE__ */ __name((company, expenseFormId) => `/api/v1.0/approvals/${company}/${expenseFormId}/approval-history`, "GET_APPROVAL_HISTORY"),
  MANAGER_DECISION: /* @__PURE__ */ __name((company, expenseFormId) => `/api/v1.0/approvals/${company}/${encodeURIComponent(expenseFormId)}/manager-decision`, "MANAGER_DECISION"),
  SAVE_COST_ALLOCATION: /* @__PURE__ */ __name((expenseFormId) => `/api/v1.0/expense-forms/cost-allocation/${encodeURIComponent(expenseFormId)}`, "SAVE_COST_ALLOCATION"),
  ...
  COST_ALLOCATION_PROJECT: /* @__PURE__ */ __name((poId) => `/api/v1.0/expense-forms/cost-allocation/project/${encodeURIComponent(poId)}`, "COST_ALLOCATION_PROJECT"),
  COST_ALLOCATION_ADMIN: /* @__PURE__ */ __name((poId) => `/api/v1.0/expense-forms/cost-allocation/admin/${encodeURIComponent(poId)}`, "COST_ALLOCATION_ADMIN")
};
...
export {
  ...
  useFormTypeId as k,
  ExpenseFormType as l,
  isExpenseItemDraft as m,
  FILE_ENDPOINTS as n,
  useFormTypeName as o,
  ECostAllocation as p,
  FILE_SIZE_LIMITS as q,
  FilePreviewType as r,
  useDefaultCountry as s,
  ExpenseTypeScope as t,
  useFormTypes as u,
  useCreateExpenseType as v,
  useUpdateExpenseType as w,
  useToggleExpenseTypeStatus as x,
  useFormTypeOptions as y,
