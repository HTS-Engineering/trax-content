...
import { g as getDefaultExportFromCjs } from "./_commonjsHelpers-DRoQK5uS.js";
var ieee754 = {};
...
const _StringType = class _StringType {
...
let StringType = _StringType;
const defaultMessages = "End-Of-Stream";
const _EndOfStreamError = class _EndOfStreamError extends Error {
  constructor() {
...
let EndOfStreamError = _EndOfStreamError;
...
const _AbstractStreamReader = class _AbstractStreamReader {
  constructor() {
...
let AbstractStreamReader = _AbstractStreamReader;
const _WebStreamReader = class _WebStreamReader extends AbstractStreamReader {
  constructor(reader) {
    super();
    this.reader = reader;
  }
...
let WebStreamReader = _WebStreamReader;
const _WebStreamByobReader = class _WebStreamByobReader extends WebStreamReader {
  /**
   * Read from stream
   * @param buffer - Target Uint8Array (or Buffer) to store data read from stream in
...
let WebStreamByobReader = _WebStreamByobReader;
const _WebStreamDefaultReader = class _WebStreamDefaultReader extends AbstractStreamReader {
  constructor(reader) {
    super();
    this.reader = reader;
    this.buffer = null;
...
let WebStreamDefaultReader = _WebStreamDefaultReader;
...
const _AbstractTokenizer = class _AbstractTokenizer {
  /**
   * Constructor
...
let AbstractTokenizer = _AbstractTokenizer;
const maxBufferSize = 256e3;
const _ReadStreamTokenizer = class _ReadStreamTokenizer extends AbstractTokenizer {
  /**
   * Constructor
...
let ReadStreamTokenizer = _ReadStreamTokenizer;
const _BufferTokenizer = class _BufferTokenizer extends AbstractTokenizer {
  /**
...
let BufferTokenizer = _BufferTokenizer;
const _BlobTokenizer = class _BlobTokenizer extends AbstractTokenizer {
  /**
   * Construct BufferTokenizer
...
__name(_BlobTokenizer, "BlobTokenizer");
let BlobTokenizer = _BlobTokenizer;
...
const _ZipHandler = class _ZipHandler {
...
const _GzipHandler = class _GzipHandler {
  constructor(tokenizer) {
    this.tokenizer = tokenizer;
  }
  inflate() {
...
__name(_GzipHandler, "GzipHandler");
let GzipHandler = _GzipHandler;
({
...
const _ParserHardLimitError = class _ParserHardLimitError extends Error {
};
__name(_ParserHardLimitError, "ParserHardLimitError");
let ParserHardLimitError = _ParserHardLimitError;
function patchWebByobTokenizerClose(tokenizer) {
  ...
  const cancelAndRelease = /* @__PURE__ */ __name(async () => {
    await reader.cancel();
    reader.releaseLock();
  }, "cancelAndRelease");
...
__name(patchWebByobTokenizerClose, "patchWebByobTokenizerClose");
...
__name(readByobReaderWithSignal, "readByobReaderWithSignal");
...
const _FileTypeParser = class _FileTypeParser {
  constructor(options) {
...
let FileTypeParser = _FileTypeParser;
