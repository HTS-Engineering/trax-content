...
import { al as FormTypeId, am as MISSING_VALUE_INDICATOR, X as isExpenseItemSubmitted, an as ApprovalTab, C as useQueryClient, E as useCompanyStore, F as useMutation, W as devError, G as queryKeys, Q as Qs, H as apiClient, J as EXPENSE_ENDPOINTS, v as jsxRuntimeExports, ao as ss, ap as Oa, aq as Ue, aj as Yn, ar as Mt, as as Et, aa as Icon, at as Pt, $ as isRegularExpense, O as isMileageExpense, au as getExpenseBaseAmount, av as gr, aw as useScrollIntoViewRef, ax as useRoles, ay as Role, z as useExpenseSwapStore, az as notifyMessage, aA as useExpenseItem, ad as useErrorSurface, aB as formatDate, _ as isSubmittedPreviewRenderable, aC as ai, aD as os, Y as ExpenseFormHistoryLog } from "./__federation_expose_Mount-C9z_Zlnl.js";
import { m as mapCostAllocation, f as useCostAllocationHandlers, C as CostAllocationHeaderActions, g as CostAllocationSection, v as validateCostAllocation, h as costAllocationItemSchema, P as PreviewLoadError, b as ExpensePreview, i as isMileageTripData, M as MileageTripPreview, d as isMileagePeriodData, e as MileagePeriodPreview, a as EtlErrorBanner } from "./CostAllocationSection-BuxL1cVK.js";
import { b as buildHeaderFromExpenseItem, E as ExpenseDialogHeader } from "./ExpenseDialogHeader-CVJGYUqM.js";
import { u as useForm, a as u, o as object, b as array, s as string, c as boolean, d as custom, C as ConfirmDialog } from "./schemas-DfSO1dBb.js";
...
const useApproveExpense = /* @__PURE__ */ __name(() => {
  ...
  return useMutation({
    meta: { errorCopy: { fallback: "Failed to approve. Please try again." } },
...
const useCancelExpense = /* @__PURE__ */ __name(() => {
  const queryClient = useQueryClient();
  return useMutation({
    meta: { errorCopy: { fallback: "Failed to cancel. Please try again." } },
    mutationFn: /* @__PURE__ */ __name(async ({ expenseFormId, comment }) => {
      await apiClient.post(
        EXPENSE_ENDPOINTS.CANCEL_EXPENSE.build({ expenseFormId }),
        { comment }
      );
    }, "mutationFn"),
    onSuccess: /* @__PURE__ */ __name((_data, { expenseFormId }) => {
...
const useSaveCostAllocation = /* @__PURE__ */ __name(() => {
  const queryClient = useQueryClient();
  return useMutation({
    meta: { errorCopy: { fallback: "Failed to save cost allocation. Please try again." } },
...
const ApproverFooter = /* @__PURE__ */ __name(({
  ...
  if (isRejecting) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ss, { className: "pt-4 w-full max-w-[600px] ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full items-center gap-2", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ss, { className: "pt-4 gap-4 w-full max-w-[600px] ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end w-full gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Ue,
      {
        type: "button",
...
const { useCallback: useCallback$1, useEffect: useEffect$1, useImperativeHandle, useMemo: useMemo$1, useRef: useRef$1 } = await importShared("react");
...
const ApproverAllocationForm = /* @__PURE__ */ __name(({ ref, expense, onSave, isSaving, onStateChange }) => {
  ...
  const getBaseAmount = useCallback$1(() => {
    var _a, _b;
...
const CancelExpenseFooter = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ss, { className: "pt-4 w-full max-w-[600px] ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-end w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Ue,
    {
      className: "h-9",
      type: "button",
...
const DETAIL_LOAD_ERROR = "Failed to load the expense form. Please try again later.";
const ApproverExpenseDetail = /* @__PURE__ */ __name(({ expenseId, item, onClose }) => {
  ...
  useEffect(() => {
    if (!isEmployee) {
      ...
      notifyMessage("Insufficient permissions to view expense details.");
      onClose();
    }
  }, [isEmployee, onClose]);
  const expenseQuery = useExpenseItem(expenseId, { companyShortName: logicalCompanyShortName, enabled: isEmployee });
  const { data: expenseItem, isPending, isError } = expenseQuery;
  const hasCommittedStatusChange = statusOverride !== null;
  const isInitialLoadError = isError && !expenseItem;
  const shouldReportLoadFailure = isInitialLoadError && !hasCommittedStatusChange;
  useErrorSurface(expenseQuery, {
    fallback: DETAIL_LOAD_ERROR,
    canRenderInPlace: !shouldReportLoadFailure
  });
  useEffect(() => {
    if (shouldReportLoadFailure) onClose();
  }, [shouldReportLoadFailure, onClose]);
  useEffect(() => {
    if (expenseItem && expenseItem.status === "draft") {
      notifyMessage("Expense form is still in draft and cannot be viewed in the approval flow.");
      onClose();
    }
  }, [expenseItem, onClose]);
  const getActionDateForStatus = useCallback((status, submittedExpense) => {
  ...
  const handleRejectCommentChange = useCallback((comment) => {
  ...
  const handleSaveAllocation = useCallback((allocations) => {
  ...
  const handleStartCancelExpense = useCallback(() => {
    setIsEditingCancellationNote(true);
  }, []);
  const handleCancellationNoteChange = useCallback((note) => {
  ...
  }, [cancelExpense, cancellationNote, expenseId, clearUnpostedReviewExpenseId]);
  ...
  const renderContent = useCallback((expenseItemData) => {
    ...
    if (isRegularExpense(expenseItemData)) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(ExpensePreview, { expense: expenseItemData, renderCostAllocation: allocationSlot, showTaxWarning: true });
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ai, { open: true, onOpenChange: handleDialogOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      os,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              header,
              historyLog: /* @__PURE__ */ jsxRuntimeExports.jsx(ExpenseFormHistoryLog, { expenseFormId: (expenseItem == null ? void 0 : expenseItem.id) ? Number(expenseItem.id) : 0, companyShortName: logicalCompanyShortName, className: "ml-2" }),
              mode: "preview"
            }
          ),
