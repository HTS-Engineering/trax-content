...
import { c as createLucideIcon, a as apiClient, d as devError, U as Ue, Y as Yn, j as jr, am as Rn, an as $o, ao as Ht, ap as zo, aq as To, ar as Nn, e as ai, o as os, H as ii, I as as, J as is, t as ti, T as Ta, r as ri } from "./configuration-nK8EePvi.js";
import { d as useCompanyStore, t as useAppQuery, v as keepPreviousData, K as RECONCILIATION_ENDPOINTS, q as queryKeys, s as formatExpenseDate, M as formatExpensePeriod, G as parseDateOnlyAsLocal, j as useMutation, i as useQueryClient, Y as isHttpApiError, a7 as classifyError, $ as extractError, a2 as getCurrencySymbol, S as formatCurrency, p as formatAmountWithCurrency, w as useSearchParams, u as useLocation, a as RoutePaths, z as useNavigateWithReturn, h as useErrorSurface, x as generatePath, D as DataLoadError, E as EmptyState } from "./use-scroll-into-view-ref-jD-IsvAs.js";
import { I as Icon } from "./Icon-DBeU9qcx.js";
import { n as notifyMessage, a as notifyError } from "./notifier-CAeBfiFR.js";
...
const useUploadStatementCsv = /* @__PURE__ */ __name(() => useMutation({
  // The dialog turns every upload failure into one of its own screens (upload / validation /
  // import error), so a toast on top of it would repeat what the user is already looking at.
...
const useReleaseStatement = /* @__PURE__ */ __name(() => {
  ...
  return useMutation({
    // The upload flow maps 409 and 404 to their own message and state transition, so it owns this
    // failure end to end.
    meta: { errorSurface: "local" },
...
const useCancelStatement = /* @__PURE__ */ __name(() => {
  const queryClient = useQueryClient();
  return useMutation({
    // A 404 means the staged data is already gone, which the upload flow treats as success and says
    // nothing about; only it can tell that apart from a real failure.
    meta: { errorSurface: "local" },
    mutationFn: /* @__PURE__ */ __name(async ({ statementId }) => {
...
const mapUploadError = /* @__PURE__ */ __name((error) => {
  ...
  const d = extractError(error).messages.join(" ").toLowerCase();
    ...
    async (file) => {
      ...
      try {
        ...
        if (isValidationOrImportError(error)) {
          ...
          notifyMessage("Validation failed. The uploaded file contains issues that must be fixed.");
          setState({ kind: "idle" });
          return;
        }
    ...
    cancelMutate(
      { statementId: summary.statementId },
      {
        ...
        onError: /* @__PURE__ */ __name((error) => {
          ...
          notifyError(error, {
            context: "action",
            copy: { fallback: "Failed to cancel the upload. Please try again." }
          });
          setState({ kind: "success", summary });
        }, "onError")
      }
      ...
      { statementId: summary.statementId },
      {
        ...
        onError: /* @__PURE__ */ __name((error) => {
          ...
          if (isHttpApiError(error) && ((_a = error.response) == null ? void 0 : _a.status) === 409) {
            notifyMessage("This statement has already been released.");
            onFinished();
            return;
          }
          if (isHttpApiError(error) && ((_b = error.response) == null ? void 0 : _b.status) === 404) {
            attemptRef.current += 1;
            setState({ kind: "idle" });
            notifyMessage("Your upload session expired. Please upload the file again.");
            return;
          }
          notifyError(error, {
            context: "action",
            copy: { fallback: "Failed to release the statement. Please try again." }
          });
          setState({ kind: "success", summary });
        }, "onError")
      }
...
const DataErrorsSection = /* @__PURE__ */ __name(({ rows }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(BgSection, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Rn, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx($o, { className: "[&_tr]:border-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Ht, { className: "border-0 hover:bg-transparent", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(zo, { className: "w-16 text-exp-neutral-200 font-semibold", children: VALIDATION_ERROR_COPY.columnRow }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(zo, { className: "text-exp-neutral-200 font-semibold", children: VALIDATION_ERROR_COPY.columnIssue })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(To, { children: rows.map((row, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Ht,
        {
...
const UploadStatementDialog = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ai, { open, onOpenChange: handleOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    os,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(as, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(is, { className: "flex items-center gap-2 min-w-0 text-base font-semibold leading-[1.4] text-exp-primary-blue-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { context }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ref: fileInputRef,
...
const ActionStatusCell = /* @__PURE__ */ __name(({ value, onUpload }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(jr, { variant: "outline", className: `${config.bgColor} ${config.textColor} rounded-[20px]`, children: config.label }),
  ...
  const staticColumns = useMemo$5(() => [
    {
      ...
      minSize: 150,
      maxSize: 250,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ta, { column, title: "Master Account" }), "header"),
    ...
    },
    {
      ...
      enableSorting: false,
      size: 100,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ta, { column, title: "Currency" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ti,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 160,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ta, { column, title: "Statement Period" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ti,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: true,
      size: 160,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ta, { column, title: "Due Date" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ti,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 140,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ta, { column, title: "Reconciled" }) }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ti,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 140,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ta, { column, title: "Variance" }) }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ti,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 140,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ta, { column, title: "Action/Status" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ti,
        {
          context,
...
const LIST_LOAD_ERROR$1 = "Failed to load reconciliations. Please try again later.";
const ReconciliationsList = /* @__PURE__ */ __name(() => {
  ...
  const query = useReconciliationsList(queryParams, { enabled: isOnListPage });
  ...
  const failure = useErrorSurface(query, {
    ...
    canRenderInPlace: reconciliations.length === 0
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col p-6 pt-0!", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 overflow-auto exp-custom-scrollbar", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ri,
      {
        ...
        emptyState: failure.hasFailed ? /* @__PURE__ */ jsxRuntimeExports.jsx(DataLoadError, { surface: failure }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          EmptyState,
          {
...
const StatusCell = /* @__PURE__ */ __name(({ value }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(jr, { variant: "outline", className: `${config.bgColor} ${config.textColor} rounded-20!`, children: config.label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "size-4 text-exp-neutral-50 group-hover:text-exp-neutral-200 transition-colors shrink-0" })
  ] });
}, "StatusCell");
  ...
  const columns = useMemo$2(() => [
    {
      ...
      minSize: 150,
      maxSize: 250,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ta, { column, title: "Corporate Card" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ti,
        {
          context,
...
const LIST_LOAD_ERROR = "Failed to load reconciliations. Please try again later.";
const CardholderReconciliationList = /* @__PURE__ */ __name(() => {
  ...
  const query = useCardholderReconciliationList(queryParams);
