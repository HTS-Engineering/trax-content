...
import { E as ExpenseFormType, b as useCreateExpenseType, c as useUpdateExpenseType, d as useToggleExpenseTypeStatus, e as useFormTypeOptions, f as useMileageRateOptions, a as useExpenseTypes } from "./api-CIr5-LKk.js";
import { u as useCompanyStore } from "./store-BItkyi0Q.js";
import { P as Pe, D as Da, E as Ea, V as Gs, A as p, o as Er, W as Nr, X as Fr, Z as Ir, _ as _n, Q as As } from "./axiosInstance-CmeuJera.js";
import { o as object, n as number, _ as _enum, s as string, l as literal, d as useForm, e as a, C as Controller } from "./zod-Cj9_4baa.js";
import { T as Table2, u as useSubmitOnEnter, C as Check, X, P as Pencil, E as EllipsisVertical, s as sortByCreatedDate } from "./date-sorting.utils-YsPuD3H0.js";
...
const createActionsColumn = ({
  ...
  cell: (context) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Nr, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Fr, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Pe,
          {
...
const ExpenseTypeTable = ({ className }) => {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(_n, {}) });
  }
