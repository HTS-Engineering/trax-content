...
import { f as create, g as devtools, s as subscribeWithSelector, i as immer, ar as endpoint, as as collectEndpointTemplates, ab as BUSINESS_PURPOSE_ENDPOINTS, C as CONFIGURATION_ENDPOINTS, b as apiClient, D as devWarn, t as gn, Z as Zs } from "./configuration-VilRQx4O.js";
  ...
  devtools(
    subscribeWithSelector(
      immer((set) => ({
        ...
        reset: /* @__PURE__ */ __name(() => set(() => initialState$1), "reset")
      }))
    ),
    {
...
function inferTotalCurrencyCode(response) {
  var _a2, _b2;
  return ((_a2 = response.paymentMethod) == null ? void 0 : _a2.currencyCode) ?? ((_b2 = response.country) == null ? void 0 : _b2.defaultCurrencyIso) ?? DEFAULT_CURRENCY_CODE;
}
...
function mapToExpenseFormData(response, isDraft, context, formTypeId) {
  ...
  const data = {
    ...
    paymentMethod: isDraft ? shouldClearPaymentMethod ? "" : stringifyEntityId((_a2 = response.paymentMethod) == null ? void 0 : _a2.id) : ((_b2 = response.paymentMethod) == null ? void 0 : _b2.name) ?? "",
    expenseLocation: isDraft ? stringifyEntityId((_c2 = response.country) == null ? void 0 : _c2.id) : ((_d2 = response.country) == null ? void 0 : _d2.name) ?? "",
    ...
    netAmount: ((_e2 = response.foreignAmount) == null ? void 0 : _e2.toString()) ?? ((_f2 = response.totalAmount) == null ? void 0 : _f2.toString()) ?? "",
    totalAmount: ((_g2 = response.totalAmount) == null ? void 0 : _g2.toString()) ?? "",
    taxType: response.taxTypeId != null ? String(response.taxTypeId) : void 0,
    taxAmount: ((_h2 = response.taxAmount) == null ? void 0 : _h2.toString()) ?? void 0,
...
function mapSingleExpenseFormToExpenseItem(response, context) {
  ...
  const submittedStatus = ((_b2 = response.status) == null ? void 0 : _b2.toLowerCase()) ?? "submitted";
...
const useDefaultCurrency = /* @__PURE__ */ __name(() => {
  ...
  const defaultCurrencySymbol = ((_b2 = currencies == null ? void 0 : currencies.find((c) => c.isoCode === defaultCurrencyCode)) == null ? void 0 : _b2.symbol) || getCurrencySymbol(defaultCurrencyCode);
  return {
    defaultCurrencyCode,
...
const TaxTypeSearchSelect = /* @__PURE__ */ __name(({
  ...
  const [remountKey, setRemountKey] = useState$2(0);
  ...
  const search = useCallback$5(async (query) => {
  ...
  const handleChange = useCallback$5((item) => {
  ...
  const renderItem = useCallback$5(
...
const useErrorToast = /* @__PURE__ */ __name((isError, message, duration = 3e3) => {
  const shownRef = useRef$1(false);
  useEffect$3(() => {
    if (isError && !shownRef.current) {
      shownRef.current = true;
      Zs.error(message, { duration });
    }
    if (!isError) {
...
export {
  ...
  useErrorToast as B,
  useParams as C,
  formatToISODate as D,
  EXPENSE_ENDPOINTS as E,
  FormTypeId as F,
  DEFAULT_CURRENCY_CODE as G,
  useCurrencies as H,
  ItemCategory as I,
  useCountries as J,
  useTaxTypesDisplay as K,
  useDefaultCurrency as L,
  parseDateOnlyAsLocal as M,
  Navigate as N,
  Outlet as O,
  useFormTypeId as P,
  QueryClientProvider as Q,
  RouterProvider as R,
  ExpenseFormType as S,
  TaxTypeSearchSelect as T,
  formatRate as U,
  formatCurrency as V,
  formatExpensePeriod as W,
  isExpenseItemDraft as X,
  ...
  matchMutation as a1,
  noop as a2,
  hashQueryKeyByOptions as a3,
  Query as a4,
  matchQuery as a5,
  focusManager as a6,
  onlineManager as a7,
  resolveStaleTime as a8,
  functionalUpdate as a9,
  useQueryErrorResetBoundary as aA,
  ensureSuspenseTimers as aB,
  ensurePreventErrorBoundaryRetry as aC,
  useClearResetErrorBoundary as aD,
  shouldSuspend as aE,
  fetchOptimistic as aF,
  getHasError as aG,
  RECONCILIATION_ENDPOINTS as aH,
  EMPTY_CURRENCY_SYMBOL as aI,
  getExpenseItemAmount as aJ,
  formatDistance as aK,
  formatHistoryTimestamp as aL,
  hasPreviousPage as aM,
  hasNextPage as aN,
  useBaseQuery as aO,
  hashKey as aa,
  partialMatchKey as ab,
  skipToken as ac,
  ECostAllocation as ad,
  AllowedMimeType as ae,
  FILE_SIZE_LIMITS as af,
  MIME_TYPE_CONFIG as ag,
  FilePreviewType as ah,
  useDefaultCountry as ai,
  FILE_ENDPOINTS as aj,
  useDebouncedCallback as ak,
  useNumericDisplay as al,
  getCurrencySymbol as am,
  ExpenseTypeScope as an,
  useEscapeHandler as ao,
  useCreateExpenseType as ap,
  useUpdateExpenseType as aq,
  useToggleExpenseTypeStatus as ar,
  useFormTypeOptions as as,
  DEFAULT_CURRENCY_SYMBOL as at,
  formatRateCompact as au,
  MileageRateStatus as av,
  shallowEqualObjects as aw,
  replaceEqualDeep as ax,
  QueryObserver as ay,
  useIsRestoring as az,
  RouteNames as b,
  NavLink as c,
  useNavigate as d,
  useCompanyStore as e,
  usePreventPageReload as f,
  createHashRouter as g,
  useFormTypes as h,
  useExpenseTypes as i,
  formatAmountWithCurrency as j,
  formatDate as k,
  formatDateRange as l,
  formatExpenseDate as m,
  useQuery as n,
  keepPreviousData as o,
  useSearchParams as p,
  queryKeys as q,
  generatePath as r,
  isExpenseItemSubmitted as s,
  useQueryClient as t,
  useLocation as u,
  useMutation as v,
  isRegularExpense as w,
  isMileageExpense as x,
  useScrollIntoViewRef as y,
  useExpenseItem as z
};
