import { aj as AllowedMimeType, ak as MIME_TYPE_CONFIG } from "./ExpenseFormLeftColumn-BVQViiTc.js";
import { E as ENDPOINT_PATTERNS, a as addUploadedFile, h as hasUploadedFile, d as deleteUploadedFile, g as getUploadedFile, f as findUploadedFileByFilename, s as shouldSimulateError, b as generateMockError, c as getExpenseSubmitted, e as getExpenseDrafts, i as getMileageSubmitted, j as getMileageDrafts, m as mockLogicalCompanies, k as mockFormTypes, l as getExpenseTypes, n as getNextExpenseTypeId, o as addExpenseType, u as updateExpenseType, p as getExpenseType, q as getMileageRates, r as recalculateAllRateStatuses, t as sortRatesByStatus, v as getNextMileageRateId, w as setMileageRates, x as calculateRateStatus, y as findItemById, z as shouldMockEndpoint } from "./mileage-rate-utils-Dj9O9qrf.js";
import "./mileage-trip-sections-DjgxQNm-.js";
import "./jsx-runtime-TULtkvNU.js";
import "./index.es-D1zjfnnK.js";
...
const fileHandlers = [
  ...
  http.get(ENDPOINT_PATTERNS.FILES_STORAGE, ({ params }) => {
    ...
    const file = findUploadedFileByFilename(filename);
    if (!file || !file.data) {
