...
import { q as qs, U as Ue, A as An, a as $r, a7 as xn, a8 as Io, a9 as Mt, aa as Eo, ab as Do, ac as vn, f as Qs, X as Xa, S as ei, Z as Za, J as Ja, K as Ks, D as Da, g as Xs } from "./index.es-CeB-gwY0.js";
import { u as useCompanyStore, a as useQuery, q as queryKeys, k as keepPreviousData, f as formatExpenseDate, e as formatExpensePeriod, p as parseDateOnlyAsLocal, c as useMutation, b as useQueryClient, h as getCurrencySymbol } from "./date-format-oMF6p_ER.js";
import { a as apiClient } from "./axiosInstance-DyMZFiGB.js";
import { I as Icon } from "./Icon-08JP3B1K.js";
import { d as formatCurrency, f as formatAmountWithCurrency } from "./formatters-BQnG64EW.js";
...
import { f as useSearchParams, h as useLocation, a as RoutePaths, m as useNavigateWithReturn, j as useErrorToast, g as generatePath } from "./use-scroll-into-view-ref-DvhGnMjx.js";
import { E as EmptyState } from "./EmptyState-CC9WlRbq.js";
...
const { useCallback: useCallback$3, useEffect: useEffect$1, useRef: useRef$2, useState: useState$1 } = await importShared("react");
const useUploadFlow = ({
  context,
  onFinished
}) => {
    ...
    cancelMutate(
      { statementId: summary.statementId },
      {
        ...
        onError: (error) => {
          ...
          qs.error("Failed to cancel the upload. Please try again.", {
            duration: 3e3
          });
          setState({ kind: "success", summary });
        }
    ...
    releaseMutate(
      { statementId: summary.statementId },
      {
        ...
        onError: (error) => {
          ...
          qs.error("Failed to release the statement. Please try again.", {
            duration: 3e3
          });
          setState({ kind: "success", summary });
        }
...
const ProcessingView = ({ phase, onCancel }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-exp-grey-100 flex flex-col items-center justify-center gap-3 py-16 px-8 min-h-[280px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-24 rounded-full bg-exp-teal-100 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-16" }) }),
...
const DataErrorsSection = ({ rows }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(BgSection, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(xn, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Io, { className: "[&_tr]:border-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Mt, { className: "border-0 hover:bg-transparent", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Eo, { className: "w-16 text-exp-neutral-200 font-semibold", children: VALIDATION_ERROR_COPY.columnRow }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Eo, { className: "text-exp-neutral-200 font-semibold", children: VALIDATION_ERROR_COPY.columnIssue })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Do, { children: rows.map((row, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Mt,
        {
          className: "border-0 hover:bg-transparent",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(vn, { className: "align-top text-sm text-exp-neutral-500", children: row.row }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(vn, { className: "align-top whitespace-normal text-sm text-exp-neutral-500", children: row.issues.map((issue, issueIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: issue }, issueIndex)) })
          ]
        },
        `${row.row}-${index}`
      )) })
...
const SummaryRow = ({ label, value }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
...
const UploadStatementDialog = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Qs, { open, onOpenChange: handleOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Xa,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Za, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ja, { className: "flex items-center gap-2 min-w-0 text-base font-semibold leading-[1.4] text-exp-primary-blue-800", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { context }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ref: fileInputRef,
...
const ActionStatusCell = ({ value, onUpload }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx($r, { variant: "outline", className: `${config.bgColor} ${config.textColor} rounded-[20px]`, children: config.label }),
  ...
  const staticColumns = useMemo$2(() => [
    {
      ...
      minSize: 150,
      maxSize: 250,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Master Account" }),
    ...
    },
    {
      ...
      enableSorting: false,
      size: 100,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Currency" }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ks,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 160,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Statement Period" }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ks,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: true,
      size: 160,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Due Date" }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ks,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 140,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Reconciled" }) }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ks,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 140,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Variance" }) }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ks,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 140,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Action/Status" }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ks,
        {
          context,
