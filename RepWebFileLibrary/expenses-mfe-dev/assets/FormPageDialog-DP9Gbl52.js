...
import { l as isValidFileAttachment, D as DEFAULT_PAYMENT_METHOD, n as ExpenseFormField, o as useFormFieldValues, p as computeMileageEffectiveOn, q as useMileageRateSync, r as useReimbursableAmountSync, s as useAmountAllocationSync, h as ExpenseItemType, t as affidavitSchema, w as basicDetailsSchema, x as createValidationStrategy, y as createDraftSaveChecker, z as useTaxFieldVisibility, A as isConvertedExpense, B as usePaymentMethods, F as useSetDefaultCurrency, G as ExpenseTypeSelect, H as allowsNegativeAmounts, I as getTaxAmountWarning, J as MileagePeriodFormField, S as SupportingFiles, K as MAX_SUPPORTING_FILES_FOR_MILEAGE_PERIOD, L as isSameCalendarMonth, N as NO_MILEAGE_RATE_FOR_DATE_MESSAGE, O as FormSectionType, Q as expenseDetailsSchema, R as expenseJustificationSchema, T as costAllocationSchema, U as additionalCommentsSchema, g as getExpenseBaseAmount, C as CostAllocationHeaderActions, a as CostAllocationSection, V as MileageTripFormField, W as mileageDetailsSchema, X as mileageJustificationSchema, Y as useBaseExpenseForm, Z as useValidatePrefilledFields, _ as useAutoSave, $ as useFormButtonStateSync, a0 as useFormImperativeHandle, a1 as BaseExpenseFormRenderer, a2 as useExpenseFormHandlers, a3 as useExpenseFormSync, a4 as fullExpenseValidationStrategy, a5 as ExpenseFormLeftColumn, a6 as useMileageTripFormHandlers, a7 as mapMileageTripToDefaultValues, a8 as mileageTripValidationStrategy, a9 as supportingFilesSchema, aa as useMileagePeriodFormHandlers, ab as mapMileagePeriodToDefaultValues, ac as mileagePeriodValidationStrategy, i as isMileageTripData, b as isMileagePeriodData } from "./CostAllocationSection-CCCFSGKf.js";
import { j as jsxRuntimeExports } from "./jsx-runtime-aCTp6CKK.js";
import { d as useCompanyStore, F as formatToISODate, G as parseDateOnlyAsLocal, P as formatRate, S as formatCurrency } from "./use-scroll-into-view-ref-B1iRwpLB.js";
import { c as createLucideIcon, B as Ba, O as Oa, a2 as ja, F as gn, L as ts, a3 as Ga, N as ys, D as devLog, e as ai, o as os, I as as, J as is, m as us, Y as Yn, s as ss, M as Mt, b as Et, U as Ue, P as Pt } from "./configuration-BGy6T4Ra.js";
import { a as useExpenseTypes, F as FormTypeId, l as useCurrencies, s as useCountries, p as useTaxTypesDisplay, t as useDefaultCurrency, T as TaxTypeSearchSelect, v as useFormTypeId, f as ExpenseFormType, m as useMileageRates, w as useEffectiveMileageRate, c as isMileageExpense, x as isExpenseItemDraft, b as isRegularExpense } from "./decimal-DtOUxi8k.js";
import { o as object, s as string, c as boolean, d as custom, e as Controller, h as createDecimalChangeHandler, f as useWatch, C as ConfirmDialog } from "./schemas-BGLcgluO.js";
import { importShared } from "./__federation_fn_import-CZ2UOLBn.js";
import { c as useBusinessPurposes } from "./business-purpose-api-CBL-aEx9.js";
import { a as useDefaultCompany } from "./queryClient-C1e0nhMw.js";
import { I as Icon } from "./Icon-DBeU9qcx.js";
import { T as Trash2, S as Send } from "./trash-2-BOTmliDT.js";
const __iconNode$1 = [
...
const buildExpenseItemFormDialogProps = /* @__PURE__ */ __name((result) => {
  const showFooter = result.mode !== "preview" && (result.isNewItem || !result.isLoading);
  return {
    footer: showFooter ? {
...
function FormPageDialog({
  ...
  const renderFooter = /* @__PURE__ */ __name(() => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ss, { className: "pt-4 gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between w-full", children: [
