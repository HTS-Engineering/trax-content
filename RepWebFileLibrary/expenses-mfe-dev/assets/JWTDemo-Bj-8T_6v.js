...
import { D as DOMEventNames, S as SessionStorageKeys, T as TokenPlaceholders, a as apiClient, b as axios } from "./axiosInstance-DyMZFiGB.js";
import { u as useAuth, a as useJWT, b as useUser, c as usePermissions, d as useTokenExpiration, e as useJWTStatus, f as useJWTPayload } from "./hooks-C_kjX_Uq.js";
import { C as CONFIGURATION_ENDPOINTS } from "./configuration-DOdFh11b.js";
import { m as ms, a as $r, ad as ct, U as Ue, ae as zn, af as en } from "./index.es-CeB-gwY0.js";
...
const TokenCountdown = ({ expiresAt, compact = false }) => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      const ms2 = Math.max(0, expiresAt.getTime() - Date.now());
      setRemainingMs(ms2);
      if (ms2 === 0) clearInterval(interval);
    }, 1e3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(en, { value: progress, className: "h-2" }),
...
const JWTDemo = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto p-6 space-y-6 max-w-6xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "p-6", children: [
    ...
    user && /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        (apiResponse.status || apiResponse.error) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx($r, { variant: apiResponse.error ? "destructive" : "default", children: apiResponse.status || "Error" })
          ] }),
