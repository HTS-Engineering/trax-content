...
import { b as apiClient, s as hs, x as xs, i as ir, w as ws, B as Bn, n as ms, e as Tr, f as Us, t as p, v as mt, y as Et, U as Ue, A as ht, T as Ta, C as create, D as devtools, F as devWarn, d as devError, a as devLog, G as Gt, m as ln$1, K as Ka, g as qt, h as Ut, Y as Yt, H as Bs, I as js, N as Gs, L as La, $ as $a, O as sr, V as Qs, X as Ye, _ as Oa } from "./configuration-D11IOZL_.js";
import { I as Icon } from "./Icon-CjLzMHV-.js";
import { h as useTaxTypesDisplay, m as useFormTypeName, E as ExpenseFormType, n as ECostAllocation, j as useDefaultCurrency, a as useExpenseTypes, F as FormTypeId, A as AllowedMimeType, o as FILE_SIZE_LIMITS, M as MIME_TYPE_CONFIG, p as FilePreviewType, f as useCountries, q as useDefaultCountry, k as useFormTypeId } from "./expense-api-CVqvVm0I.js";
import { d as formatCurrency, e as formatDistance, c as formatRate } from "./formatters-DqvanaXQ.js";
import { F as FILE_ENDPOINTS, e as useCompanyStore, i as formatExpenseDate, y as EMPTY_CURRENCY_SYMBOL, v as formatExpensePeriod, j as useQuery, E as EXPENSE_ENDPOINTS, q as queryKeys, z as formatHistoryTimestamp, D as DEFAULT_CURRENCY_CODE, s as formatToISODate, B as useDebouncedCallback, m as useQueryClient, C as useNumericDisplay, G as getCurrencySymbol } from "./date-format-Dkqd_MkG.js";
import { importShared } from "./__federation_fn_import-B1oJrOwd.js";
import { I as Info, s as string, D as DECIMAL_FORMAT_REGEX, o as object, d as custom, c as boolean, b as array, h as date, i as unknown, n as number, C as ConfirmDialog, g as useWatch, u as useForm, a, l as literal, j as useFormState, e as Controller, f as createDecimalChangeHandler } from "./schemas-DLyAVKsc.js";
import { a as useDefaultCompany, q as queryClient } from "./queryClient-C5rxGB0h.js";
...
import { P as Plus } from "./plus-AEnAbVqL.js";
import { R as RefreshCw } from "./refresh-cw-BmVFBEd1.js";
...
function SupportingFiles({
  ...
  const {
    ...
    expenseId: expenseId ?? void 0,
    shouldKeepUrl: /* @__PURE__ */ __name((url) => attachmentsForCleanupRef.current.some((a2) => a2.blobUrl === url) || initialFiles.some((a2) => a2.blobUrl === url), "shouldKeepUrl")
  });
...
export {
  useMileageTripFormHandlers as $,
  isConvertedExpense as A,
  useSetDefaultCurrency as B,
  CostAllocationHeaderActions as C,
  ExpenseTypeSelect as D,
  ExpensePreview as E,
  MileagePeriodFormField as F,
  MAX_SUPPORTING_FILES_FOR_MILEAGE_PERIOD as G,
  FormSectionType as H,
  expenseDetailsSchema as I,
  expenseJustificationSchema as J,
  costAllocationSchema as K,
  additionalCommentsSchema as L,
  MileageTripPreview as M,
  MileageTripFormField as N,
  mileageDetailsSchema as O,
  mileageJustificationSchema as P,
  useBaseExpenseForm as Q,
  useValidatePrefilledFields as R,
  SupportingFiles as S,
  useAutoSave as T,
  useFormButtonStateSync as U,
  useFormImperativeHandle as V,
  BaseExpenseFormRenderer as W,
  useExpenseFormHandlers as X,
  useExpenseFormSync as Y,
  fullExpenseValidationStrategy as Z,
  ExpenseFormLeftColumn as _,
  CostAllocationSection as a,
  mapMileageTripToDefaultValues as a0,
  mileageTripValidationStrategy as a1,
  supportingFilesSchema as a2,
  useMileagePeriodFormHandlers as a3,
  mapMileagePeriodToDefaultValues as a4,
  mileagePeriodValidationStrategy as a5,
  MileageFormType as a6,
  usePendingUploadStore as a7,
  isMileagePeriodData as b,
  costAllocationItemSchema as c,
  MileagePeriodPreview as d,
  ExpenseFormHistoryLog as e,
  isValidFileAttachment as f,
  getExpenseBaseAmount as g,
  ExpenseFormField as h,
  isMileageTripData as i,
  useFormFieldValues as j,
  useMileageRateSync as k,
  useReimbursableAmountSync as l,
  mapCostAllocation as m,
  useAmountAllocationSync as n,
  mapFormDataToUpdateRequest as o,
  mapFormDataToCreateRequest as p,
  parseOptionalInt as q,
  parseOptionalDecimal as r,
  getMileageTypesFromCache as s,
