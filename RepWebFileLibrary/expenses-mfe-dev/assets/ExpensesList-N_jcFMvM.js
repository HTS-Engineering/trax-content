...
import { p, d as Er, f as Bs, R as Ra, g as Un, O as Oa, A as As, k as _a, m as Na, _ as _n } from "./index.es-DjMdAnbR.js";
import { u as useCompanyStore, l as useQuery, q as queryKeys, v as keepPreviousData } from "./query-keys-D9Ju7pUf.js";
...
import { k as useSearchParams, e as useLocation, u as useNavigate, j as generatePath, a as RoutePaths } from "./routes-DUmYp1nr.js";
...
const useExpensesList = (queryParams, options = {}) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const allItems = response.data.results.map(mapApiResponseToListItem);
      return allItems;
    },
    staleTime: 60 * 1e3
  });
