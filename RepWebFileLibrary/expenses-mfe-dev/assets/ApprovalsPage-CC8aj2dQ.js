...
import { M as MISSING_VALUE_INDICATOR, A as ApprovalTab, u as useRoles, R as Role, c as useExpenseSwapStore, d as ApprovalsList } from "./ApprovalsList-CPit77ex.js";
import { d as devError, Z as Zs, b as apiClient, e as as, H as Ha, U as Ue, Y as Yn, f as Mt, E as Et, P as Pt, g as gr, o as oi, r as rs } from "./configuration-CaBH14y1.js";
import { i as useQueryClient, f as useCompanyStore, j as useMutation, q as queryKeys, E as EXPENSE_ENDPOINTS, k as useScrollIntoViewRef, u as useErrorToast, l as formatDate, m as useParams, d as useLocation, e as useNavigate, a as RoutePaths } from "./formatters-Dvm414Po.js";
import { m as mapCostAllocation, g as getExpenseBaseAmount, u as useCostAllocationHandlers, C as CostAllocationHeaderActions, a as CostAllocationSection, v as validateCostAllocation, c as costAllocationItemSchema, b as getExpenseErrorMessage, E as ExpensePreview, i as isMileageTripData, M as MileageTripPreview, d as isMileagePeriodData, e as MileagePeriodPreview, f as ExpenseFormHistoryLog, h as EtlErrorBanner } from "./CostAllocationSection-C8xQU--T.js";
import { F as FormTypeId, i as isExpenseItemSubmitted, b as isRegularExpense, c as isMileageExpense, d as useExpenseItem, e as isSubmittedPreviewRenderable } from "./TaxTypeSearchSelect-BWWNgvpC.js";
import { b as buildHeaderFromExpenseItem, P as PreviewLoadError, E as ExpenseDialogHeader } from "./ExpenseDialogHeader-Wn8ByKmN.js";
import "./hooks-CQpxfriY.js";
import { t as toastApiError, u as useForm, a as u, o as object, b as array, s as string, c as boolean, d as custom, C as ConfirmDialog } from "./schemas-D_ZTVCQ9.js";
...
const useApproveExpense = /* @__PURE__ */ __name(() => {
  ...
  return useMutation({
    ...
    onError: /* @__PURE__ */ __name((error) => {
      ...
      toastApiError(error, { fallback: "Failed to approve. Please try again." });
    }, "onError")
  });
}, "useApproveExpense");
const useCancelExpense = /* @__PURE__ */ __name(() => {
  ...
  return useMutation({
    ...
    onError: /* @__PURE__ */ __name((error) => {
      ...
      toastApiError(error, { fallback: "Failed to cancel. Please try again." });
    }, "onError")
  });
}, "useCancelExpense");
const useManagerDecision = /* @__PURE__ */ __name(() => {
  ...
  return useMutation({
    ...
    onError: /* @__PURE__ */ __name((error, { action }) => {
      ...
      toastApiError(error, {
        fallback: action === "rejected" ? "Failed to reject. Please try again." : "Failed to save manager decision. Please try again."
      });
    }, "onError")
  });
}, "useManagerDecision");
const useSaveCostAllocation = /* @__PURE__ */ __name(() => {
  ...
  return useMutation({
    ...
    onError: /* @__PURE__ */ __name((error) => {
      ...
      toastApiError(error, { fallback: "Failed to save cost allocation. Please try again." });
    }, "onError")
  });
