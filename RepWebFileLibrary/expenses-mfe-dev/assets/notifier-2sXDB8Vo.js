...
import { Z as Zs } from "./configuration-Cg_hJZZz.js";
import { aA as toErrorText, a3 as interpretError } from "./use-scroll-into-view-ref-BYTXl063.js";
...
function show(text) {
  Zs.error(text, { duration: TOAST_DURATION_MS, className: TOAST_CLASS_NAME });
}
__name(show, "show");
