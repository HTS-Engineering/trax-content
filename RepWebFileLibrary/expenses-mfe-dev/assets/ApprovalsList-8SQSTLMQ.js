...
import { g as getExpenseItemAmount, f as isExpenseItemSubmitted, h as isMileageExpense, j as isRegularExpense, o as useExpenseItem } from "./TaxTypeSearchSelect-BOBAPbzh.js";
import { g as getExpenseTypeBadgeConfig } from "./expense-type-badge-Dl5VNgz1.js";
import { I as Icon } from "./Icon-qrAJyYZL.js";
import { v as getExpenseActionSubtitle, A as isMileageTripData, z as isMileagePeriodData, H as mapCostAllocation, ae as validateCostAllocation, w as getExpenseBaseAmount, $ as useCostAllocationHandlers, C as CostAllocationHeaderActions, a as CostAllocationSection, n as costAllocationItemSchema, d as ExpensePreview, j as MileageTripPreview, h as MileagePeriodPreview, b as ExpenseFormHistoryLog } from "./CostAllocationSection-BLB7826b.js";
import "./hooks-DhGJjjwf.js";
import { o as object, s as string, c as boolean, b as array, e as custom, r as useForm, u, C as ConfirmDialog } from "./useMileageRates-Bjejcicl.js";
...
const useApprovalsColumns = /* @__PURE__ */ __name(({
  ...
  const staticColumns = useMemo$4(() => [
    {
      ...
      enableSorting: false,
      size: 80,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "ID" }), "header"),
    ...
    },
    {
      ...
      minSize: 120,
      maxSize: 200,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Employee" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ws,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 160,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Expense Date" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ws,
        {
          context,
    ...
    },
    {
      ...
      minSize: 100,
      maxSize: 200,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Vendor" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ws,
        {
          context,
    ...
    },
    {
      ...
      minSize: 120,
      maxSize: 250,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Expense Type" }), "header"),
      cell: /* @__PURE__ */ __name((context) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            context,
            viewContent: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(zr, { variant: "outline", className: `${badgeConfig.bgColor} ${badgeConfig.textColor}`, children: badgeConfig.label }) })
          }
        );
      }, "cell")
    },
    ...
    },
    {
      ...
      enableSorting: false,
      size: 160,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Payment Method" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ws,
        {
          context,
  ...
  const actionDateColumn = useMemo$4(() => ({
    ...
    enableSorting: true,
    size: 150,
    header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: getActionDateColumnHeader(currentTab) }), "header"),
    cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Ws,
      {
        context,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex shrink-0 items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Ue,
          {
            ...
            children: [
              isSubmittingDecision && /* @__PURE__ */ jsxRuntimeExports.jsx(jn, { className: "size-4" }),
              "Reject"
            ]
          }
        ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(_t, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Ft, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Ue,
        {
          ...
          children: [
            isApproving ? /* @__PURE__ */ jsxRuntimeExports.jsx(jn, { className: "size-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "check", className: "size-4" }),
            "Approve"
          ]
        }
      ) }) }),
      isAllocationRequired && !isApproving && /* @__PURE__ */ jsxRuntimeExports.jsx(Dt, { className: "text-sm", children: "Cost allocation must be added before approval" })
    ] })
  ] }) });
}, "ApproverFooter");
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(_t, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Ft, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ue,
        {
          ...
          children: isSaving ? /* @__PURE__ */ jsxRuntimeExports.jsx(jn, { className: "size-4" }) : "Save Changes"
        }
      ) }) }),
      saveButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Dt, { className: "text-sm", children: saveButtonState.tooltip })
    ] })
  ] }) });
}, "ApproverEditFooter");
      ...
      Za,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Qa, { className: "pb-3 mb-3 border-b border-exp-primary-blue-100", children: header ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(jn, { className: "size-5 text-exp-primary-blue-600" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-hidden flex flex-col min-w-[600px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 relative overflow-y-auto py-4 exp-custom-scrollbar", children: isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(jn, { className: "size-8 text-exp-primary-blue-600" }) }) : expenseItem && renderContent(expenseItem) }),
