...
import { c as createLucideIcon, at as DOMEventNames, S as SessionStorageKeys, a2 as ys, B as Br, au as ht, av as TokenPlaceholders, U as Ue, aw as jn, ax as sn, b as apiClient, C as CONFIGURATION_ENDPOINTS, ay as axios } from "./configuration-BMQ0fbSl.js";
import { u as useAuth, a as useJWT, b as useUser, c as usePermissions, d as useTokenExpiration, e as useJWTStatus, f as useJWTPayload } from "./hooks-BvR8ZH8t.js";
import { S as Shield } from "./shield-Cyf2tUOs.js";
import { C as CircleAlert } from "./circle-alert-CjKpb4LQ.js";
import { R as RefreshCw } from "./refresh-cw-1PYzRBqq.js";
import { T as Trash2, S as Send } from "./trash-2-Dhig74qb.js";
const __iconNode$5 = [
...
const jwtUtils = {
   ...
   */
  emitJWTUpdateEvent: /* @__PURE__ */ __name((eventName) => {
   ...
   */
  decodeJWT: /* @__PURE__ */ __name((token) => {
    try {
...
const TokenCountdown = /* @__PURE__ */ __name(({ expiresAt, compact = false }) => {
  ...
  if (!expiresAt) return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "N/A" });
  ...
  const progress = Math.max(0, remainingMs / (3600 * 1e3) * 100);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(sn, { value: progress, className: "h-2" }),
...
const JWTDemo = /* @__PURE__ */ __name(() => {
  var _a;
  const [testToken, setTestToken] = useState("");
  const [showTokens, setShowTokens] = useState(false);
  const [storageValue, setStorageValue] = useState(
    () => sessionStorage.getItem(SessionStorageKeys.JWT_TOKEN) || "null"
  );
  const [apiResponse, setApiResponse] = useState({ status: null, data: null, error: null, loading: false });
  ...
  const createDemoToken = /* @__PURE__ */ __name(() => {
    const header = btoa(JSON.stringify({ alg: "HS256", typ: "JWT" }));
    const payload2 = btoa(JSON.stringify({
      sub: "demo-user-123",
      name: "Demo User",
      email: "demo@trax.com",
      roles: ["user", "manager"],
    ...
    return `${header}.${payload2}.${signature}`;
  }, "createDemoToken");
  const handleSetDemoToken = /* @__PURE__ */ __name(() => {
    const demoToken = createDemoToken();
    setToken(demoToken);
    setTestToken(demoToken);
    setStorageValue(demoToken);
  }, "handleSetDemoToken");
  const handleSetCustomToken = /* @__PURE__ */ __name(() => {
    if (testToken.trim()) {
      sessionStorage.setItem(SessionStorageKeys.JWT_TOKEN, testToken.trim());
      setStorageValue(testToken.trim());
    }
  }, "handleSetCustomToken");
  const handleClearToken = /* @__PURE__ */ __name(() => {
    clearToken();
    setTestToken("");
    setStorageValue("null");
  }, "handleClearToken");
  const handleEmitEvent = /* @__PURE__ */ __name(() => {
    jwtUtils.emitJWTUpdateEvent();
    setStorageValue(sessionStorage.getItem(SessionStorageKeys.JWT_TOKEN) || "null");
  }, "handleEmitEvent");
  const handleTestAPI = /* @__PURE__ */ __name(async () => {
    var _a2, _b, _c;
    setApiResponse({ status: null, data: null, error: null, loading: true });
    try {
      const response = await apiClient.get(CONFIGURATION_ENDPOINTS.LOGICAL_COMPANIES.build());
      setApiResponse({
      ...
      if (axios.isAxiosError(error)) {
        setApiResponse({
          status: ((_a2 = error.response) == null ? void 0 : _a2.status) || null,
  ...
  const getStatusBadgeProps = /* @__PURE__ */ __name(() => {
    if (isLoading) return { variant: "secondary", children: "Loading" };
    if (isAuthenticated) return { variant: "default", children: "Authenticated" };
    return { variant: "outline", children: "Not Authenticated" };
  }, "getStatusBadgeProps");
  const formatToken = /* @__PURE__ */ __name((token2) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto p-6 space-y-6 max-w-6xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ys, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Br, { ...getStatusBadgeProps() })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ys, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TokenCountdown, { expiresAt: tokenExpiration.expiresAt, compact: true }) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ys, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ys, { className: "p-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "checkbox",
              checked: showTokens,
              onChange: /* @__PURE__ */ __name((e) => setShowTokens(e.target.checked), "onChange"),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
            ...
            token && token !== TokenPlaceholders.NO_TOKEN_AVAILABLE && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Ue,
              {
                variant: "outlined",
                size: "sm",
                onClick: /* @__PURE__ */ __name(() => copyToClipboard(token), "onClick"),
        ...
        tokenExpiration.expiresAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TokenCountdown, { expiresAt: tokenExpiration.expiresAt }) })
        ] }),
    ...
    user && /* @__PURE__ */ jsxRuntimeExports.jsxs(ys, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-1", children: roles.length > 0 ? roles.map((role) => /* @__PURE__ */ jsxRuntimeExports.jsx(Br, { variant: "project", className: "font-mono text-xs", children: role }, role)) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500", children: "No roles assigned" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-sm font-medium text-gray-700", children: [
              "Permissions (",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-1", children: permissions.length > 0 ? permissions.map((permission) => /* @__PURE__ */ jsxRuntimeExports.jsx(Br, { variant: "team", className: "font-mono text-xs", children: permission }, permission)) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500", children: "No permissions granted" }) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Decoded Payload (JSON)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          jn,
          {
            value: payload ? JSON.stringify(payload, null, 2) : "No payload",
            readOnly: true,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ys, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Ue, { onClick: handleSetDemoToken, className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Key, { className: "h-4 w-4" }),
            "Set Demo Token"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Ue, { variant: "error", onClick: handleClearToken, className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Ue,
            {
              ...
              children: [
                ...
                apiResponse.loading ? "Loading..." : "Test API Request"
              ]
            }
          ),
          false
        ] }),
        (apiResponse.status || apiResponse.error) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "API Response" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Br, { variant: apiResponse.error ? "destructive" : "default", children: apiResponse.status || "Error" })
          ] }),
          apiResponse.error ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-red-50 border border-red-200 rounded-lg text-red-800 text-sm", children: apiResponse.error }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Error Details" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                jn,
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Ue,
              {
                onClick: /* @__PURE__ */ __name(() => handleSetCustomToken(), "onClick"),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ys, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Ue, { onClick: handleEmitEvent, className: "w-full", children: "Emit JWT Update Event" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ht,
            {
              value: SessionStorageKeys.JWT_TOKEN,
              readOnly: true,
              className: "font-mono text-sm"
            }
          )
