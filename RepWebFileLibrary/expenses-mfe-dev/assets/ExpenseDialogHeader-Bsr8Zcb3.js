...
import { k as getExpenseActionSubtitle, i as isMileageTripData, b as isMileagePeriodData } from "./CostAllocationSection-D5ua25mR.js";
import { c as isMileageExpense, r as getExpenseItemAmount, i as isExpenseItemSubmitted, b as isRegularExpense } from "./TaxTypeSearchSelect-BPtsO4N4.js";
import { p as formatAmountWithCurrency, M as formatExpensePeriod } from "./use-scroll-into-view-ref-PERXLDXX.js";
import { j as jsxRuntimeExports } from "./jsx-runtime-aCTp6CKK.js";
import { I as as, J as is, m as us, Y as Yn } from "./configuration-BGy6T4Ra.js";
...
const ExpenseDialogHeader = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(as, { className: "pb-3 mb-3 border-b border-exp-primary-blue-100", children: header ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-nowrap items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(is, { className: "text-exp-neutral-900 text-xl font-bold flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        us,
        {
          variant: "light",
          size: "sm",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(is, { className: "sr-only", children: "Expense details" }),
