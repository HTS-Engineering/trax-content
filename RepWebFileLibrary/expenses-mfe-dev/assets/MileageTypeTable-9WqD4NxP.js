...
import { _ as QueryObserver, $ as hasPreviousPage, a0 as hasNextPage, a1 as useBaseQuery, m as useQueryClient, q as queryKeys, a2 as useEscapeHandler, e as useCompanyStore, j as useQuery, n as useMutation, s as formatToISODate, t as parseDateOnlyAsLocal, a3 as DEFAULT_CURRENCY_SYMBOL } from "./date-format-Dkqd_MkG.js";
import { d as devError, $ as $a, T as Ta, U as Ue, B as Bn, a1 as Xs, t as p, e as Tr, a2 as Ir, a3 as Dr, a4 as Er, a5 as Mr, l as Zs, b as apiClient, a0 as CONFIGURATION_ENDPOINTS, a6 as Ba, f as Us, a as devLog, m as ln, a7 as jr, g as qt, h as Ut, Y as Yt, p as ar, j as Js, Z as Za, a8 as ti, Q as Qa, k as es, K as Ka, n as ms, a9 as ts, aa as $s } from "./configuration-D11IOZL_.js";
import { E as EmptyState } from "./EmptyState-D16ibyHT.js";
import { I as Icon } from "./Icon-CjLzMHV-.js";
import { o as object, _ as _enum, s as string, l as literal, u as useForm, a, e as Controller, C as ConfirmDialog, g as useWatch, n as number, h as date, f as createDecimalChangeHandler, k as filterDecimalInput, I as Info } from "./schemas-DLyAVKsc.js";
import { a as useExpenseTypes, r as ExpenseTypeScope, F as FormTypeId, E as ExpenseFormType, s as useCreateExpenseType, t as useUpdateExpenseType, v as useToggleExpenseTypeStatus, w as useFormTypeOptions, e as useCurrencies, x as MileageRateStatus, h as useTaxTypesDisplay } from "./expense-api-CVqvVm0I.js";
import { a as useCreateBusinessPurpose, b as useUpdateBusinessPurpose, c as useToggleBusinessPurposeStatus, u as useBusinessPurposes } from "./business-purpose-api-EMHtgv-q.js";
import { g as formatRateCompact } from "./formatters-DqvanaXQ.js";
...
const getFieldError$6 = /* @__PURE__ */ __name((errors, touchedFields, dirtyFields, fieldName, fieldValue) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Ue,
      {
        ...
        children: isFormLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "check", className: "size-4" })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Ue,
...
const getFormTypeBadge = /* @__PURE__ */ __name((formType) => {
  switch (formType) {
    case "standard":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Tr, { variant: "outline", className: "text-trax-blue-600 bg-trax-primary-blue-50", children: EXPENSE_TYPE_LABELS.STANDARD });
    case "entertainment":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Tr, { variant: "outline", className: "text-trax-green-800 bg-trax-green-100", children: EXPENSE_TYPE_LABELS.ENTERTAINMENT });
    default:
      return null;
  }
}, "getFormTypeBadge");
...
const ActionsCell$3 = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Ir, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Dr, { asChild: true, disabled: isToggling, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ue,
        {
          variant: "ghost",
...
const ExpenseTypeTable = /* @__PURE__ */ __name(({ className }) => {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-8 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, {}) });
  }
...
const getFieldError$5 = /* @__PURE__ */ __name((errors, touchedFields, dirtyFields, fieldName, fieldValue) => {
  const fieldError = errors == null ? void 0 : errors[fieldName];
  const isTouched = touchedFields == null ? void 0 : touchedFields[fieldName];
  const isDirty = dirtyFields == null ? void 0 : dirtyFields[fieldName];
  const hasValue = fieldValue !== void 0 && fieldValue !== "" && fieldValue !== null;
...
const SetAsInactiveDialog = /* @__PURE__ */ __name(({
  ...
  const handleConfirm = /* @__PURE__ */ __name(async () => {
    ...
    try {
      ...
      onOpenChange(false);
      Us.success(`Successfully marked "${masterAccountName}" as inactive`, { duration: 3e3 });
    } catch (error) {
      devError("Failed to mark as inactive:", error);
      Us.error(`Failed to mark "${masterAccountName}" as inactive. Please try again`, { duration: 3e3 });
    }
  }, "handleConfirm");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ConfirmDialog,
...
const useCardholderOperations = /* @__PURE__ */ __name((companyShortName, masterAccountId, onSuccess) => {
  ...
  const handleCreateCardholder = useCallback$f(async (data) => {
    ...
    try {
      ...
      Us.error(CARDHOLDER_MESSAGES.CREATE_ERROR, { duration: 3e3 });
      throw error;
    }
  ...
  const handleUpdateCardholder = useCallback$f(async (id, data, originalData) => {
    ...
    try {
      ...
      Us.error(CARDHOLDER_MESSAGES.UPDATE_ERROR, { duration: 3e3 });
      throw error;
    }
  ...
  const toggleActiveCardholder = useCallback$f(async (id, currentStatus) => {
    ...
    try {
      ...
      Us.error(CARDHOLDER_MESSAGES.TOGGLE_ERROR, { duration: 3e3 });
      throw error;
    }
  }, [companyShortName, masterAccountId, updateMutation, onSuccess]);
  return {
...
const ActionsCell$1 = /* @__PURE__ */ __name(({
  ...
  if (!isActive) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(jr, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(qt, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ue,
          {
            variant: "ghost",
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "pencil", className: "size-4 svg-color-inherit" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Yt, { side: "top", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", children: CARDHOLDER_MESSAGES.CANNOT_EDIT_INACTIVE }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Ir, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dr, { asChild: true, disabled: isToggling, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ue,
...
const ManageCardholdersDialog = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Js, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Za,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Qa, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(es, { className: "flex items-center gap-2 text-base font-semibold text-exp-primary-blue-800", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-6" }) }) : error ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-exp-red-500 py-4", children: CARDHOLDER_MESSAGES.LOADING_ERROR }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          CardholderTable,
          {
            cardholders: cardholders ?? [],
            companyShortName,
...
const MasterAccountTable = /* @__PURE__ */ __name(({ className }) => {
  ...
  const loadingState = useMemo$8(() => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-3 p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-8 text-exp-primary-blue-600" }) }), []);
  if (error) {
...
const useMileageTypeOperations = /* @__PURE__ */ __name((companyId, onSuccess) => {
  ...
  const handleCreateMileageType = useCallback$6(async (data) => {
    ...
    try {
      ...
      Us.error("Failed to create mileage type. Please try again", { duration: 3e3 });
      throw error;
    }
  }, [companyId, createExpenseTypeMutation, onSuccess]);
  const handleUpdateMileageType = useCallback$6(async (id, data, originalData) => {
    ...
    try {
      ...
      Us.error("Failed to update mileage type. Please try again", { duration: 3e3 });
      throw error;
    }
  }, [companyId, updateExpenseTypeMutation, onSuccess]);
  const toggleActiveMileageType = useCallback$6(async (id, currentStatus) => {
    ...
    try {
      ...
      Us.error("Failed to update status. Please try again", { duration: 3e3 });
      throw error;
    }
  }, [companyId, toggleExpenseTypeMutation, onSuccess]);
  return {
...
const createActionsColumn = /* @__PURE__ */ __name(({
  ...
  cell: /* @__PURE__ */ __name((context) => {
    ...
    if (isThisRowDeleting) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center p-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-4" }) });
    }
    ...
    if (tooltip) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(qt, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex", children: deleteButton }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Yt,
          {
            variant: "light",
...
const MileageRateTable = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    !isAddingNew && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center px-2 py-1.5 border border-t-0.5! border-exp-neutral-30 rounded-b-lg", children: canAddNewRate ? addNewRateButton : /* @__PURE__ */ jsxRuntimeExports.jsxs(qt, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: addNewRateButton }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Yt,
        {
          variant: "light",
...
const ManageMileageRatesDialog = /* @__PURE__ */ __name(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Js, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Za,
    {
      ...
      onInteractOutside: /* @__PURE__ */ __name((e) => e.preventDefault(), "onInteractOutside"),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ti, { className: "absolute right-6 top-6 text-exp-neutral-100 hover:text-exp-primary-blue-600 focus:text-exp-primary-blue-800 disabled:text-exp-neutral-70 focus:outline-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "close", className: "size-6" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Qa, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(es, { className: "flex items-center gap-2 text-base font-semibold text-exp-primary-blue-800", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: isFetching ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-6" }) }) : error ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-exp-red-500 py-4", children: MILEAGE_RATE_MESSAGES.LOADING_ERROR }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
          MileageRateTable,
          {
            rates: rates ?? [],
            unit: unit || "-",
...
const AssignEmployeesDialog = /* @__PURE__ */ __name(({
  ...
  const handleSave = useCallback$1(async () => {
    ...
    try {
      ...
      Us.error("Failed to save. Please try again", { duration: 3e3 });
    }
    ...
    Za,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: scrollContainerRef, className: "mt-4 h-[400px] overflow-y-auto exp-custom-scrollbar border border-exp-neutral-30 rounded-lg", children: [
          ...
          isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-6" }) }) : noResults ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-start py-2.5 px-6 text-sm text-exp-neutral-300 italic", children: MILEAGE_TYPE_MESSAGES.ASSIGN_EMPLOYEES_NO_RESULTS }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            isFetchingNextPage && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-4" }) })
          ] })
        ] }),
...
const SetAsDefaultDialog = /* @__PURE__ */ __name(({
  ...
  const handleConfirm = /* @__PURE__ */ __name(async () => {
    ...
    try {
      ...
      onOpenChange(false);
      Us.success(MILEAGE_TYPE_MESSAGES.SET_AS_DEFAULT_SUCCESS, { duration: 3e3 });
    } catch (error) {
      devError("Failed to set as default:", error);
      Us.error(MILEAGE_TYPE_MESSAGES.SET_AS_DEFAULT_FAILURE, { duration: 3e3 });
    }
  }, "handleConfirm");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Js, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Za,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(es, { className: "text-base font-semibold text-exp-neutral-900", children: MILEAGE_TYPE_MESSAGES.SET_AS_DEFAULT_TITLE }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ts, { className: "text-sm font-normal text-exp-grey-600", children: `Set "${expenseTypeName}" ${MILEAGE_TYPE_MESSAGES.SET_AS_DEFAULT_MESSAGE}` })
        ] }),
...
const TaxTypeField = /* @__PURE__ */ __name(({ control, errors, touchedFields, dirtyFields, taxTypes }) => {
    ...
    Controller,
    {
      ...
      render: /* @__PURE__ */ __name(({ field }) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ta,
          {
            value: ((_a2 = field.value) == null ? void 0 : _a2.toString()) || NONE_TAX_TYPE_VALUE,
            onValueChange: /* @__PURE__ */ __name((value) => field.onChange(value === NONE_TAX_TYPE_VALUE ? null : parseInt(value, 10)), "onValueChange"),
...
const createEffectiveFromColumn = /* @__PURE__ */ __name(({
  ...
  header: /* @__PURE__ */ __name(() => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(qt, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { className: "size-3.5 text-exp-neutral-100 cursor-help" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Yt, { side: "top", className: "max-w-xs", children: MILEAGE_TYPE_MESSAGES.EFFECTIVE_FROM_TOOLTIP })
    ] })
  ] }), "header"),
  cell: /* @__PURE__ */ __name((context) => {
    var _a2;
    ...
    const effectiveDate = rowData.effectiveFrom || ((_a2 = rowData.mileageEffectiveRate) == null ? void 0 : _a2.effectiveDate);
...
const DefaultBadge = /* @__PURE__ */ __name(() => /* @__PURE__ */ jsxRuntimeExports.jsxs(qt, { children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Tr,
    {
      variant: "secondary",
...
const MileageTypeTable = /* @__PURE__ */ __name(({ className }) => {
  ...
  const processedData = useMemo(() => {
    ...
    return sorted.map((item) => {
      var _a2, _b;
      const uomId = (_a2 = unitOfMeasurements == null ? void 0 : unitOfMeasurements.find((u) => u.unit === item.unitOfMeasurement)) == null ? void 0 : _a2.id;
      return {
        ...item,
        employeeCount: item.assignedEmployeeCount ?? 0,
        effectiveFrom: ((_b = item.mileageEffectiveRate) == null ? void 0 : _b.effectiveDate) ? parseDateOnlyAsLocal(item.mileageEffectiveRate.effectiveDate) : void 0,
