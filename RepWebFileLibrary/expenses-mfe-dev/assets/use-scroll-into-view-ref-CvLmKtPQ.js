...
var RoutePaths = /* @__PURE__ */ ((RoutePaths2) => {
  ...
  RoutePaths2["Reconciliation"] = "/reconciliation";
  return RoutePaths2;
})(RoutePaths || {});
var RouteNames = /* @__PURE__ */ ((RouteNames2) => {
  ...
  RouteNames2["Reconciliation"] = "Reconciliations";
  return RouteNames2;
})(RouteNames || {});
...
const useNavigateBack = (options = {}) => {
  ...
  const [returnUrl] = useState$1(() => {
    ...
    devLog("[useNavigateBack] resolved returnUrl", {
      locationState: location.state,
      locationKey: location.key,
      pathnameAndSearch: `${location.pathname}${location.search}`,
      windowHref: typeof window !== "undefined" ? window.location.href : "n/a",
      historyState: typeof window !== "undefined" ? window.history.state : "n/a",
      fallback,
      basePath,
      resolvedReturnUrl: resolved
    });
    return resolved;
  });
...
const useNavigateWithReturn = () => {
  ...
  return useCallback$2(
    (to, options) => {
      ...
      devLog("[useNavigateWithReturn] pushing with returnUrl", {
        to,
...
export {
  ...
  RouteNames as b,
  NavLink as c,
  usePreventPageReload as d,
  createHashRouter as e,
  useSearchParams as f,
  generatePath as g,
  useLocation as h,
  useScrollIntoViewRef as i,
  useErrorToast as j,
  useParams as k,
  useNavigateBack as l,
  useNavigateWithReturn as m,
  useDebouncedCallback as n,
  useNumericDisplay as o,
  useEscapeHandler as p,
  useNavigate as u
};
