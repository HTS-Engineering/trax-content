...
import { j as formatAmountWithCurrency, k as formatDate, l as formatDateRange, m as formatExpenseDate, e as useCompanyStore, n as useQuery, q as queryKeys, o as keepPreviousData, E as EXPENSE_ENDPOINTS, p as useSearchParams, u as useLocation, a as RoutePaths, d as useNavigate, r as generatePath, F as FormTypeId, s as isExpenseItemSubmitted, t as useQueryClient, v as useMutation, w as isRegularExpense, x as isMileageExpense, y as useScrollIntoViewRef, z as useExpenseItem, B as useErrorToast, C as useParams } from "./use-scroll-into-view-ref-DRd2DuRO.js";
import { g as getExpenseTypeBadgeConfig, E as EtlErrorIndicator } from "./EtlErrorIndicator-DCwPDdNy.js";
import { I as Icon } from "./Icon-DBeU9qcx.js";
import "./hooks-BtYwdTmy.js";
import { m as mapCostAllocation, v as validateCostAllocation, g as getExpenseBaseAmount, a as useCostAllocationHandlers, C as CostAllocationHeaderActions, b as CostAllocationSection, c as costAllocationItemSchema, d as getExpenseErrorMessage, E as ExpensePreview, i as isMileageTripData, M as MileageTripPreview, e as isMileagePeriodData, f as MileagePeriodPreview, h as ExpenseFormHistoryLog, j as EtlErrorBanner } from "./CostAllocationSection-CC7EWCqn.js";
import { b as buildHeaderFromExpenseItem, E as ExpenseDialogHeader } from "./ExpenseDialogHeader-BAsGnMDd.js";
import { o as object, s as string, b as boolean, a as array, c as custom, u as useForm, d as u, C as ConfirmDialog } from "./useMileageRates-CjKYx2Sx.js";
...
const useApprovalsColumns = /* @__PURE__ */ __name(({
  ...
  const etlErrorColumn = useMemo$4(() => ({
    id: "etlError",
    enableSorting: false,
    size: 44,
    header: /* @__PURE__ */ __name(() => null, "header"),
