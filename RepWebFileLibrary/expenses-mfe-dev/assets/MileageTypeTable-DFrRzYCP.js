...
import { f as QueryObserver, x as hasPreviousPage, w as hasNextPage, Y as useBaseQuery, ac as useQueryClient, P as queryKeys, a1 as useEscapeHandler, _ as useCompanyStore, ab as useQuery, a4 as useMutation, r as formatToISODate, K as parseDateOnlyAsLocal, b as DEFAULT_CURRENCY_SYMBOL } from "./date-format-D3C_Myvb.js";
import { a4 as devError, $ as $a, T as Ta, U as Ue, c as Bn, X as Xs, am as p, u as Tr, I as Ir, f as Dr, h as Er, n as Mr, z as Zs, A as apiClient, C as CONFIGURATION_ENDPOINTS, b as Ba, v as Us, a5 as devLog, ai as ln, af as jr, ao as qt, w as Ut, y as Yt, H as ar, l as Js, Z as Za, ar as ti, Q as Qa, aa as es, K as Ka, aj as ms, at as ts, a as $s } from "./configuration-CJUUGdgp.js";
...
const MasterAccountTable = /* @__PURE__ */ __name(({ className }) => {
  ...
  const loadingState = useMemo$9(() => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center gap-3 p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-8 text-exp-primary-blue-600" }) }), []);
  if (error) {
...
const createCurrentRateColumn = /* @__PURE__ */ __name(({
  ...
  cell: /* @__PURE__ */ __name((context) => {
    ...
    const viewContent = rowData.isRateFetching ? /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-4 text-exp-primary-blue-600" }) : rate ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      Tr,
      {
        variant: "secondary",
...
const createEffectiveFromColumn = /* @__PURE__ */ __name(({
  ...
  cell: /* @__PURE__ */ __name((context) => {
    ...
    const viewContent = rowData.isRateFetching ? /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-4 text-exp-primary-blue-600" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: formatEffectiveDate(rowData.effectiveFrom) });
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Xs,
      {
        context: cellContext,
...
export {
  ...
  BusinessPurposeTable as a,
  ExpenseTypeTable as b,
  MasterAccountTable as c,
  MileageTypeTable as d
};
