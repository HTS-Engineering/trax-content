...
import { O as createLucideIcon, x as apiClient, a0 as devError, s as Us, U as Ue, ab as jn, az as zr, au as wn, I as Io, b as $t, m as Mo, g as Eo, ax as yn, k as Js, Z as Za, aq as ti, Q as Qa, a6 as es, t as Ws, E as Ea, v as Zs, al as ns, am as p, M as Ma, af as ka } from "./configuration-B4FJFUoo.js";
import { a4 as useCompanyStore, ah as useQuery, K as keepPreviousData, R as RECONCILIATION_ENDPOINTS, Y as queryKeys, s as formatExpenseDate, t as formatExpensePeriod, W as parseDateOnlyAsLocal, aa as useMutation, ai as useQueryClient, B as getCurrencySymbol, o as formatCurrency, n as formatAmountWithCurrency, al as useSearchParams, a9 as useLocation, g as RoutePaths, ad as useNavigateWithReturn, a6 as useErrorToast, z as generatePath, E as EMPTY_CURRENCY_SYMBOL } from "./use-scroll-into-view-ref-B9ZfFHUy.js";
...
const ProcessingView = /* @__PURE__ */ __name(({ phase, onCancel }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-exp-grey-100 flex flex-col items-center justify-center gap-3 py-16 px-8 min-h-[280px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-24 rounded-full bg-exp-teal-100 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(jn, { className: "size-16" }) }),
...
const DataErrorsSection = /* @__PURE__ */ __name(({ rows }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(BgSection, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(wn, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Io, { className: "[&_tr]:border-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs($t, { className: "border-0 hover:bg-transparent", children: [
...
const ActionStatusCell = /* @__PURE__ */ __name(({ value, onUpload }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(zr, { variant: "outline", className: `${config.bgColor} ${config.textColor} rounded-[20px]`, children: config.label }),
  ...
  const staticColumns = useMemo$5(() => [
    {
      ...
      minSize: 150,
      maxSize: 250,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Master Account" }), "header"),
    ...
    },
    {
      ...
      enableSorting: false,
      size: 100,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Currency" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ws,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 160,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Statement Period" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ws,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: true,
      size: 160,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Due Date" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ws,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 140,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Total Amount" }) }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ws,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 140,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Reconciled" }) }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ws,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 140,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Variance" }) }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ws,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 140,
      header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Action/Status" }), "header"),
      cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ws,
        {
          context,
...
const ReconciliationsList = /* @__PURE__ */ __name(() => {
  ...
  const customLoadingState = useMemo$3(() => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(jn, { className: "size-8 text-exp-primary-blue-600" }),
...
const StatusCell = /* @__PURE__ */ __name(({ value }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(zr, { variant: "outline", className: `${config.bgColor} ${config.textColor} rounded-[20px]`, children: config.label });
}, "StatusCell");
    ...
    return [
      {
        ...
        minSize: 140,
        maxSize: 200,
        header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Cardholder" }), "header"),
        cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ws,
          {
            context,
      ...
      },
      {
        ...
        minSize: 160,
        maxSize: 220,
        header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Logical Company" }), "header"),
        cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ws,
          {
            context,
      ...
      },
      {
        ...
        enableSorting: true,
        size: 140,
        header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Transaction Date" }), "header"),
        cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ws,
          {
            context,
      ...
      },
      {
        ...
        minSize: 160,
        maxSize: 240,
        header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Transaction" }), "header"),
        cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ws,
          {
            context,
      ...
      },
      {
        ...
        enableSorting: false,
        size: 140,
        header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Amount" }) }), "header"),
        cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ws,
          {
            context,
      ...
      },
      {
        ...
        enableSorting: false,
        size: 160,
        header: /* @__PURE__ */ __name(({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Matched Expense" }), "header"),
        cell: /* @__PURE__ */ __name((context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ws,
          {
            context,
      ...
      // (header/cell return null) on the filtered tabs.
      {
        ...
        header: /* @__PURE__ */ __name(({ column }) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { column, title: "Status" });
        }, "header"),
...
const TransactionsList = /* @__PURE__ */ __name(({
  ...
  const renderToolbar = useCallback(
    (table) => /* @__PURE__ */ jsxRuntimeExports.jsx(Ma, { table, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ka,
      {
        className: "gap-2",
        column: "status",
