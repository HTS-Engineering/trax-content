const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=[(()=>{const f="assets/ExpensesPage-CGp6El-u.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/jsx-runtime-DLKWXVrv.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/ExpensesList-ZBMT558d.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/createLucideIcon-pu26MF0q.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/__federation_fn_import-CFnudcB9.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/receipt-Dll19OHf.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/ExpensePage-CTsXmuNB.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Icon-CPUYJCTZ.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/preload-helper-e_IRvegh.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/LoadingSpinner-CJp2omDf.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/receipt-DLrGlexy.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/axiosInstance-BiB8Ce56.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/useMutation-eZm-mCcH.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/file-text-C5PLCptG.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/send-VjcpEmS2.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Configurations-CgUIRpiX.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/CorporateCards-BGn--eZB.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Payroll-CHdye5gV.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Allocations-C-yIwG6T.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/ExpenseType-BDRg1NUV.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/store-B92vRb4W.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/store-CnNlVsiW.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/plus-BVzo2w3d.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/BusinessPurpose-BzRma73z.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/circle-check-big-D2W4LJyJ.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/JWTDemo-BYs525H2.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/shield-DJrnMPNz.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/IconsTestingPage-CQSt2wCZ.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/mockingStrategy-DqG8Rei2.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})()])))=>i.map(i=>d[i]);
...
import { R as RouterProvider$1, u as useNavigate, L as Link, F as FileText, C as ChartColumn, a as CreditCard, b as ChevronRight, N as NavLink, c as useLocation, d as useParams, O as Outlet, e as createHashRouter } from "./file-text-C5PLCptG.js";
import { c as createLucideIcon, W as Wo, D as De, B as Bo } from "./createLucideIcon-pu26MF0q.js";
...
import { S as Shield } from "./shield-DJrnMPNz.js";
...
const Expenses = lazy(() => __vitePreload(() => import("./ExpensesPage-CGp6El-u.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0, import.meta.url));
const NewExpense = lazy(() => __vitePreload(() => import("./ExpensePage-CTsXmuNB.js"), true ? __vite__mapDeps([6,4,1,2,3,5,7,8,9,10,11,12,13,14]) : void 0, import.meta.url));
...
const ExpensesType = lazy(() => __vitePreload(() => import("./ExpenseType-BDRg1NUV.js"), true ? __vite__mapDeps([19,1,4,20,9,11,12,21,3,22]) : void 0, import.meta.url));
const BusinessPurpose = lazy(() => __vitePreload(() => import("./BusinessPurpose-BzRma73z.js"), true ? __vite__mapDeps([23,1,4,20,9,11,12,21,3,24]) : void 0, import.meta.url));
const TestingAuthentication = lazy(() => __vitePreload(() => import("./JWTDemo-BYs525H2.js"), true ? __vite__mapDeps([25,4,1,11,3,26,24,14]) : void 0, import.meta.url));
const TestingIcons = lazy(() => __vitePreload(() => import("./IconsTestingPage-CQSt2wCZ.js"), true ? __vite__mapDeps([27,4,1,7,8]) : void 0, import.meta.url));
...
async function initializeMocking() {
  const { mockingStrategy } = await __vitePreload(async () => {
    const { mockingStrategy: mockingStrategy2 } = await import("./mockingStrategy-DqG8Rei2.js");
