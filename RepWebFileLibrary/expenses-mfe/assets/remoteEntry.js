...
let moduleMap = {
  "./mount": () => {
    ...
    return __federation_import("./assets/__federation_expose_Mount-xBw84AI9.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
  }
};
const seen = {};
