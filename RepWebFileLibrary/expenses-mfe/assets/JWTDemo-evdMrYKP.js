...
const { useCallback, useMemo, useEffect } = await importShared("react");
const useAuth = () => {
...
const usePermissions = () => {
  ...
  const permissions = useMemo(() => (user == null ? void 0 : user.permissions) || [], [user == null ? void 0 : user.permissions]);
  const roles = useMemo(() => (user == null ? void 0 : user.roles) || [], [user == null ? void 0 : user.roles]);
