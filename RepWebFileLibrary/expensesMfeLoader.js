...
(function() {
  ...
  const FILE_NAME = 'expensesMfeLoader.js';
  ...
  "branch": "HEAD",
  "tag": "v0.2.0",
  "timestamp": "2026-09-15T10:06:35.456Z",
  "outDir": "expenses-mfe",
  "bootstrap": "__federation_expose_Mount-T07r2sEo.js",
  ...
  async function loadMFE() {
    try {
      ...
      const getAssetUrl = (filename) => `${basePath}/expenses-mfe/assets/${filename}`;
