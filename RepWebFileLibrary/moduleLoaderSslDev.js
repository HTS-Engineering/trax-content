...
(function() {
  ...
  const FILE_NAME = 'moduleLoaderSslDev.js';
  ...
  async function loadManifest(basePath) {
    const possibleManifestPaths = [
      `${basePath}/expenses-mfe-ssl-dev/mfe-manifest.json`,
      `${basePath}/mfe-manifest.json`,
      `${window.location.origin}/expenses-mfe-ssl-dev/mfe-manifest.json`,
  ...
  async function loadMFE() {
    try {
      ...
      const getAssetUrl = (filename) => {
        const possiblePaths = [
          `${basePath}/expenses-mfe-ssl-dev/assets/${filename}`,
          `${basePath}/assets/${filename}`,
          `/expenses-mfe-ssl-dev/assets/${filename}`,
          `/assets/${filename}`,
          `${window.location.origin}/expenses-mfe-ssl-dev/assets/${filename}`,
