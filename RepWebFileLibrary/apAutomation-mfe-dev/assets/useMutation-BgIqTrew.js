...
var _client, _observers, _mutationCache, _retryer, __this_instances, dispatch_fn, _a, _client2, _currentResult, _currentMutation, _mutateOptions, __this_instances2, updateResult_fn, notify_fn, _b;
import { importShared } from "./__federation_fn_import-BLt6jPdS.js";
import { R as Removable, G as createRetryer, n as notifyManager, S as Subscribable, H as shallowEqualObjects, d as hashKey, u as useQueryClient, a as noop, I as shouldThrowError } from "./factory-BAIl8rNu.js";
...
}, "#dispatch"), __name(_a, "Mutation"), _a);
...
var MutationObserver = (_b = class extends Subscribable {
  constructor(client, options) {
    ...
    this.bindMethods();
    __privateMethod(this, __this_instances2, updateResult_fn).call(this);
  }
  bindMethods() {
  ...
  onMutationUpdate(action) {
    __privateMethod(this, __this_instances2, updateResult_fn).call(this);
    __privateMethod(this, __this_instances2, notify_fn).call(this, action);
  }
  getCurrentResult() {
  ...
  reset() {
    ...
    __privateMethod(this, __this_instances2, updateResult_fn).call(this);
    __privateMethod(this, __this_instances2, notify_fn).call(this);
  }
...
}, _client2 = new WeakMap(), _currentResult = new WeakMap(), _currentMutation = new WeakMap(), _mutateOptions = new WeakMap(), __this_instances2 = new WeakSet(), updateResult_fn = /* @__PURE__ */ __name(function() {
  var _a2;
...
}, "#updateResult"), notify_fn = /* @__PURE__ */ __name(function(action) {
  notifyManager.batch(() => {
...
}, "#notify"), __name(_b, "MutationObserver"), _b);
