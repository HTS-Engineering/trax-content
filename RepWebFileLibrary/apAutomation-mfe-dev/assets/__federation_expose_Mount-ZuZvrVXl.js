...
var _a, _b, _c, _d, _e, _f, _focused, _cleanup, _setup, _g, _provider, _providerCalled, _h, _online, _cleanup2, _setup2, _i, _j, _gcTimeout, _k, _queryType, _initialState, _revertState, _cache, _client, _retryer, _defaultOptions, _abortSignalConsumed, __this_instances, isInitialPausedFetch_fn, dispatch_fn, _l, _client2, _observers, _mutationCache, _retryer2, __this_instances2, dispatch_fn2, _m, _mutations, _scopes, _mutationId, _n, _queries, _o, _queryCache, _mutationCache2, _defaultOptions2, _queryDefaults, _mutationDefaults, _mountCount, _unsubscribeFocus, _unsubscribeOnline, _p;
import { importShared } from "./__federation_fn_import-BLt6jPdS.js";
import { S as STORAGE_PREFIX, j as jsxRuntimeExports, U as Ue, d as devError, Y as Yn, Q as Qs, Z as Zs, E as Er, a as SCOPE_CLASS, C as CONTAINER_ID, b as apiClient, e as ensureJWTInitialized, c as SERVICE_NAME, f as devWarn, g as devLog } from "./axiosInstance-__qKT0Ru.js";
...
var DataRouterContext = React$3.createContext(null);
DataRouterContext.displayName = "DataRouter";
var DataRouterStateContext = React$3.createContext(null);
DataRouterStateContext.displayName = "DataRouterState";
var RSCRouterContext = React$3.createContext(false);
function useIsRSCRouterContext() {
  return React$3.useContext(RSCRouterContext);
}
__name(useIsRSCRouterContext, "useIsRSCRouterContext");
var ViewTransitionContext = React$3.createContext({
  isTransitioning: false
});
ViewTransitionContext.displayName = "ViewTransition";
var FetchersContext = React$3.createContext(
  /* @__PURE__ */ new Map()
);
FetchersContext.displayName = "Fetchers";
var AwaitContext = React$3.createContext(null);
AwaitContext.displayName = "Await";
var NavigationContext = React$3.createContext(
  null
);
NavigationContext.displayName = "Navigation";
var LocationContext = React$3.createContext(
  null
);
LocationContext.displayName = "Location";
var RouteContext = React$3.createContext({
  outlet: null,
  matches: [],
  isDataRoute: false
});
RouteContext.displayName = "Route";
var RouteErrorContext = React$3.createContext(null);
...
function RouterProvider2(props) {
  return /* @__PURE__ */ React$2.createElement(RouterProvider$1, { flushSync: ReactDOM.flushSync, ...props });
}
...
const router = createHashRouter([
  {
    ...
    children: [
      { index: true, element: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: RoutePaths.Home, replace: true }) },
      { path: toRelativePath(RoutePaths.Home), element: /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, {}) },
      { path: "*", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: RoutePaths.Home, replace: true }) }
    ]
  }
]);
...
var MutationCache = (_n = class extends Subscribable {
  constructor(config = {}) {
    super();
...
}, _mutations = new WeakMap(), _scopes = new WeakMap(), _mutationId = new WeakMap(), __name(_n, "MutationCache"), _n);
function scopeFor(mutation) {
  var _a2;
  return (_a2 = mutation.options.scope) == null ? void 0 : _a2.id;
}
__name(scopeFor, "scopeFor");
var QueryCache = (_o = class extends Subscribable {
  constructor(config = {}) {
    super();
...
}, _queries = new WeakMap(), __name(_o, "QueryCache"), _o);
var QueryClient = (_p = class {
  constructor(config = {}) {
...
}, _queryCache = new WeakMap(), _mutationCache2 = new WeakMap(), _defaultOptions2 = new WeakMap(), _queryDefaults = new WeakMap(), _mutationDefaults = new WeakMap(), _mountCount = new WeakMap(), _unsubscribeFocus = new WeakMap(), _unsubscribeOnline = new WeakMap(), __name(_p, "QueryClient"), _p);
