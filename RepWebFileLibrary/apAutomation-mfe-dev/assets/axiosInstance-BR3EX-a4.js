...
var _a, _b, _c, _d, _e;
import { u as useJWTStore, T as TokenPlaceholders, D as DOMEventNames } from "./store-Bn-YuemF.js";
import { d as devError, a as devWarn } from "./index-CFVMMdzN.js";
...
let AxiosError$1 = (_b = class extends Error {
  static from(error, code, config, request, response, customProps) {
    const axiosError = new _b(error.message, code || error.code, config, request, response);
