...
let moduleMap = {
  "./mount": /* @__PURE__ */ __name(() => {
    ...
    return __federation_import("./assets/__federation_expose_Mount-DXKf7mjr.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
  }, "./mount")
};
const seen = {};
