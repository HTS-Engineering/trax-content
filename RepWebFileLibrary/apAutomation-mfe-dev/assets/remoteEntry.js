...
let moduleMap = {
  "./mount": /* @__PURE__ */ __name(() => {
    dynamicLoadingCss(["style-Cc8V60M0.css"], false, "./mount");
    return __federation_import("./assets/__federation_expose_Mount-CyPokxJJ.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
  }, "./mount")
};
const seen = {};
