...
let moduleMap = {
  "./mount": /* @__PURE__ */ __name(() => {
    dynamicLoadingCss(["style-BtvSoZYE.css"], false, "./mount");
    return __federation_import("./assets/__federation_expose_Mount-XqNKUQ3w.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
  }, "./mount")
};
const seen = {};
const dynamicLoadingCss = /* @__PURE__ */ __name((cssFilePaths, dontAppendStylesToHead, exposeItemName) => {
  ...
  cssFilePaths.forEach((cssPath) => {
    ...
    if (dontAppendStylesToHead) {
      const key = "css__apAutomation-mfe-dev__" + exposeItemName;
