...
(function() {
  ...
  const FILE_NAME = 'moduleLoaderSslTest.js';
  ...
  async function loadManifest(basePath) {
    const possibleManifestPaths = [
      `${basePath}/expenses-mfe-ssl-test/mfe-manifest.json`,
      `${basePath}/mfe-manifest.json`,
      `${window.location.origin}/expenses-mfe-ssl-test/mfe-manifest.json`,
  ...
  async function loadMFE() {
    try {
      ...
      const getAssetUrl = (filename) => {
        const possiblePaths = [
          `${basePath}/expenses-mfe-ssl-test/assets/${filename}`,
          `${basePath}/assets/${filename}`,
          `/expenses-mfe-ssl-test/assets/${filename}`,
          `/assets/${filename}`,
          `${window.location.origin}/expenses-mfe-ssl-test/assets/${filename}`,
