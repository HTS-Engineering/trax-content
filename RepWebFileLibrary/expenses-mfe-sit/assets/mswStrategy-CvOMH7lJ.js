...
import { z as MileageRateStatus } from "./expense-api-zIc4GXVn.js";
...
var MemoryCookieStore = class extends Store {
  ...
  findCookie(domain, path, key, callback) {
    ...
    const result = (_b3 = (_a3 = this.idx[domain]) == null ? void 0 : _a3[path]) == null ? void 0 : _b3[key];
  ...
  removeCookie(domain, path, key, callback) {
    var _a3, _b3;
    const promiseCallback = createPromiseCallback(callback);
    (_b3 = (_a3 = this.idx[domain]) == null ? void 0 : _a3[path]) == null ? true : delete _b3[key];
    return promiseCallback.resolve(void 0);
  }
  /**
   * @internal No doc because this is an overload that supports the implementation
...
const kCancelable = /* @__PURE__ */ Symbol("kCancelable");
...
const kEmitter$1 = /* @__PURE__ */ Symbol("kEmitter");
const kBoundListener$1 = /* @__PURE__ */ Symbol("kBoundListener");
...
const kPassthroughPromise = /* @__PURE__ */ Symbol("kPassthroughPromise");
const kOnSend = /* @__PURE__ */ Symbol("kOnSend");
...
const kBoundListener = /* @__PURE__ */ Symbol("kBoundListener");
const kSend = /* @__PURE__ */ Symbol("kSend");
...
var WebSocketInterceptor = (_b2 = class extends Interceptor$1 {
  constructor() {
    super(_b2.symbol);
  }
  checkEnvironment() {
...
}, _b2.symbol = /* @__PURE__ */ Symbol("websocket"), _b2);
...
var RequestController = (_c2 = class {
  constructor(request, source) {
    __privateAdd(this, _RequestController2_instances);
    this.request = request;
    this.source = source;
    this.readyState = _c2.PENDING;
  ...
  */
  async passthrough() {
    invariant.as(InterceptorError, this.readyState === _c2.PENDING, 'Failed to passthrough the "%s %s" request: the request has already been handled', this.request.method, this.request.url);
    this.readyState = _c2.PASSTHROUGH;
  ...
  */
  respondWith(response) {
    invariant.as(InterceptorError, this.readyState === _c2.PENDING, 'Failed to respond to the "%s %s" request with "%d %s": the request has already been handled (%d)', this.request.method, this.request.url, response.status, response.statusText || "OK", this.readyState);
    this.readyState = _c2.RESPONSE;
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  ...
  */
  errorWith(reason) {
    invariant.as(InterceptorError, this.readyState === _c2.PENDING, 'Failed to error the "%s %s" request with "%s": the request has already been handled (%d)', this.request.method, this.request.url, reason == null ? void 0 : reason.toString(), this.readyState);
    this.readyState = _c2.ERROR;
    this.source.errorWith(reason);
    __privateGet(this, _RequestController2_instances, handled_get).resolve();
  }
}, _RequestController2_instances = new WeakSet(), handled_get = function() {
  return this.handled;
}, _c2.PENDING = 0, _c2.PASSTHROUGH = 1, _c2.RESPONSE = 2, _c2.ERROR = 3, _c2);
...
var FetchResponse$1 = (_d = class extends Response {
  static isConfigurableStatusCode(status) {
    return status >= 200 && status <= 599;
  }
  static isRedirectResponse(status) {
    return _d.STATUS_CODES_WITH_REDIRECT.includes(status);
  }
  /**
  ...
  */
  static isResponseWithBody(status) {
    return !_d.STATUS_CODES_WITHOUT_BODY.includes(status);
  }
  ...
  */
  ...
  constructor(body, init = {}) {
    ...
    const safeStatus = _d.isConfigurableStatusCode(status) ? status : 200;
    const finalBody = _d.isResponseWithBody(status) ? body : null;
    super(finalBody, {
      status: safeStatus,
    ...
    _d.setUrl(init.url, this);
  }
}, _d.STATUS_CODES_WITHOUT_BODY = [
  101,
  103,
  204,
  205,
  304
], _d.STATUS_CODES_WITH_REDIRECT = [
  301,
  302,
  303,
  307,
...
function createResponseListener(context) {
  return (event) => {
    ...
    if ((_a3 = responseMessage.response.type) == null ? void 0 : _a3.includes("opaque")) {
      return;
    }
...
var Emitter2 = class {
  ...
  */
  ...
  #callListener(event, listener) {
    ...
    if ((_a3 = listener[kListenerOptions]) == null ? void 0 : _a3.once) {
...
var FetchInterceptor = (_e = class extends Interceptor2 {
  constructor() {
    super(_e.symbol);
  }
  checkEnvironment() {
...
}, _e.symbol = /* @__PURE__ */ Symbol("fetch"), _e);
...
function createResponse(request, body) {
  return new FetchResponse$1(FetchResponse$1.isResponseWithBody(request.status) ? body : null, {
      ...
      methodCall: ([methodName, args], invoke) => {
        switch (methodName) {
          ...
          case "send": {
            ...
            queueMicrotask(() => {
              var _a3;
              (((_a3 = this.onRequest) == null ? void 0 : _a3.call(this, {
                request: fetchRequest,
                requestId: this.requestId
...
var XMLHttpRequestInterceptor = (_f = class extends Interceptor2 {
  constructor() {
    super(_f.interceptorSymbol);
  }
  checkEnvironment() {
...
}, _f.interceptorSymbol = /* @__PURE__ */ Symbol("xhr"), _f);
...
var SetupWorkerApi = class extends SetupApi {
  ...
  stop() {
    ...
    window.postMessage({ type: "msw/worker:stop" });
    printStopMessage({
      quiet: (_a3 = this.context.startOptions) == null ? void 0 : _a3.quiet
    });
  }
};
...
const fileHandlers = [
  ...
  http.post(ENDPOINT_PATTERNS.FILES_UPLOAD, async ({ request, params }) => {
    ...
    try {
      ...
      const fileExtension = ((_a3 = file.name.split(".").pop()) == null ? void 0 : _a3.toLowerCase()) || "unknown";
...
const configurationHandlers = [
  ...
  http.get(ENDPOINT_PATTERNS.CONFIG_LOGICAL_COMPANIES, async () => {
    ...
    const response = {
      userDefaultLogicalCompanyId: (defaultCompany == null ? void 0 : defaultCompany.id) ?? ((_a3 = mockLogicalCompanies[0]) == null ? void 0 : _a3.id) ?? 0,
...
const reconciliationHandlers = [
  ...
  http.post(ENDPOINT_PATTERNS.RECONCILIATION_CSV_UPLOAD, async ({ request, params }) => {
    ...
    const formData = await request.formData();
    const file = formData.get("file");
    const name = ((_a3 = file == null ? void 0 : file.name) == null ? void 0 : _a3.toLowerCase()) ?? "";
    await delay(1200);
