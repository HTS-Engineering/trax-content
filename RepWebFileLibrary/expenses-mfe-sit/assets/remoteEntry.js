...
let moduleMap = {
  "./mount": () => {
    dynamicLoadingCss(["style-DtrjLVCP.css"], false, "./mount");
    return __federation_import("./assets/__federation_expose_Mount-CPO_Xozf.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
  }
};
const seen = {};
const dynamicLoadingCss = (cssFilePaths, dontAppendStylesToHead, exposeItemName) => {
  ...
  cssFilePaths.forEach((cssPath) => {
    ...
    if (dontAppendStylesToHead) {
      const key = "css__expenses-mfe-sit__" + exposeItemName;
