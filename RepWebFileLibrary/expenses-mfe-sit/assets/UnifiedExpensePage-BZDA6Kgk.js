...
import { $ as $a, q as qs, V as Va, T as Ta, s as sn, Y as Ya, z as za, p as ps, f as Qs, X as Xa, Z as Za, J as Ja, A as An, Q as Qa, b as Gt, c as qt, U as Ue, d as Ut, t as ts } from "./index.es-BcmpdPPF.js";
import { a as ExpenseStatusBadge, E as ExpensesList } from "./ExpensesList-BJjc9MvM.js";
import { a as apiClient } from "./axiosInstance-C8gKj5Wx.js";
import { n as useDefaultCompany, c as useExpenseTypes, F as FormTypeId, h as useQueryClient, a as useCompanyStore, j as useMutation, q as queryKeys, E as EXPENSE_ENDPOINTS, I as ItemCategory, d as useQuery, o as formatToISODate, D as DEFAULT_CURRENCY_CODE, p as useCurrencies, r as useCountries, s as useTaxTypesDisplay, t as useDefaultCurrency, v as parseDateOnlyAsLocal, w as useFormTypeId, x as ExpenseFormType, e as isRegularExpense, l as isMileageExpense, y as formatExpensePeriod, i as isExpenseItemSubmitted, m as useExpenseItem, z as isExpenseItemDraft } from "./expense-api-BtNAFYOg.js";
import { E as ExpenseFormHistoryLog } from "./ExpenseFormHistoryLog-DbUInO_B.js";
import { e as isValidFileAttachment, f as ExpenseFormField, h as useFormFieldValues, j as useMileageRateSync, k as useReimbursableAmountSync, l as useAmountAllocationSync, n as mapFormDataToUpdateRequest, o as mapFormDataToCreateRequest, m as mapCostAllocation, p as parseOptionalInt, q as parseOptionalDecimal, r as getMileageTypesFromCache, i as isMileageTripData, s as affidavitSchema, t as basicDetailsSchema, w as createValidationStrategy, x as createDraftSaveChecker, y as useTaxFieldVisibility, z as isConvertedExpense, A as useSetDefaultCurrency, B as ExpenseTypeSelect, D as MileagePeriodFormField, S as SupportingFiles, F as MAX_SUPPORTING_FILES_FOR_MILEAGE_PERIOD, G as FormSectionType, H as expenseDetailsSchema, I as expenseJustificationSchema, J as costAllocationSchema, K as additionalCommentsSchema, g as getExpenseBaseAmount, C as CostAllocationHeaderActions, a as CostAllocationSection, L as MileageTripFormField, N as mileageDetailsSchema, O as mileageJustificationSchema, P as useBaseExpenseForm, Q as useValidatePrefilledFields, R as useAutoSave, T as useFormButtonStateSync, U as useFormImperativeHandle, V as BaseExpenseFormRenderer, W as useExpenseFormHandlers, X as useExpenseFormSync, Y as fullExpenseValidationStrategy, Z as ExpenseFormLeftColumn, _ as useMileageTripFormHandlers, $ as mapMileageTripToDefaultValues, a0 as mileageTripValidationStrategy, a1 as supportingFilesSchema, a2 as useMileagePeriodFormHandlers, a3 as mapMileagePeriodToDefaultValues, a4 as mileagePeriodValidationStrategy, b as isMileagePeriodData, a5 as MileageFormType, a6 as usePendingUploadStore, E as ExpensePreview, M as MileageTripPreview, d as MileagePeriodPreview } from "./CostAllocationSection-Cos5IVjz.js";
import { d as devError, a as devLog } from "./index-BZGB3DCm.js";
import { o as object, s as string, c as boolean, d as custom, e as Controller, f as createDecimalChangeHandler, g as useWatch, C as ConfirmDialog } from "./schemas-BZkGzsPE.js";
import { importShared } from "./__federation_fn_import-VIrFz_yB.js";
import { c as createLucideIcon } from "./configuration-BQHaqkMo.js";
import { u as useBusinessPurposes } from "./business-purpose-api-BMe9M5EV.js";
import { I as Icon } from "./Icon-BRsOXDbZ.js";
import { c as formatRate, d as formatCurrency, a as formatDate } from "./formatters-DJsE8pjs.js";
import { c as useNavigateBack } from "./use-scroll-into-view-ref-BwmfzUKR.js";
import { T as Trash2, S as Send } from "./trash-2-B-nvNLzs.js";
import { u as useNavigate, g as generatePath, a as RoutePaths, e as useParams, i as useSearchParams } from "./routes-qNoXVp_B.js";
const __iconNode$1 = [
...
const useSaveExpenseDraft = () => {
  ...
  return useMutation({
    ...
    onError: (error, variables) => {
      ...
      qs.error("Failed to save. Please try again", {
        duration: 3e3
      });
    }
  });
...
const useDeleteExpenseDraft = (options) => {
  ...
  return useMutation({
    ...
    onError: (error) => {
      ...
      qs.error("Fail to delete. Please try again.", {
        duration: 3e3
      });
    }
  });
        ...
        render: ({ field, fieldState }) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            Ta,
            {
              ...
              onChange: (date) => field.onChange(date ? formatToISODate(date) : ""),
              onBlur: field.onBlur,
              error: (_a = fieldState.error) == null ? void 0 : _a.message,
              disabled,
...
function FormPageDialog({
  ...
  const renderHeader = () => /* @__PURE__ */ jsxRuntimeExports.jsx(Za, { className: "pb-3 mb-3 border-b border-exp-primary-blue-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between gap-2 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-nowrap items-center justify-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Ja, { className: "text-exp-neutral-900 text-xl font-bold", children: header.title }),
      header.titleSuffix,
  ...
  const renderFooter = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Qa, { className: "pt-4 gap-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: footer.showDeleteButton && /* @__PURE__ */ jsxRuntimeExports.jsxs(Gt, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { className: "text-sm", children: "Delete draft" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Gt, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(qt, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Ue,
            {
              type: "button",
              variant: "outlined",
          ...
          footer.saveDraftButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { variant: "light", size: "sm", side: "bottom", showArrow: false, children: footer.saveDraftButtonState.tooltip })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Gt, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(qt, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Ue,
            {
              type: "button",
              variant: "primary",
              ...
              children: [
                footer.isSubmitting ? /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "size-5" }),
                "Submit Expense"
              ]
            }
          ) }) }),
          footer.submitButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { className: "text-sm", children: footer.submitButtonState.tooltip })
        ] })
      ] })
    ] }) });
  };
  const renderLoadingOrContent = () => {
    if (isLoading) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-8 text-exp-primary-blue-600" }) });
    }
    return renderContent();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    backgroundContent,
    /* @__PURE__ */ jsxRuntimeExports.jsx(Qs, { open: true, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Xa,
      {
