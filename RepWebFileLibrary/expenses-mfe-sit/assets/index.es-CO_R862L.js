...
const { useState: Nn, useEffect: _n, useRef: ir } = y;
const Sr = await importShared("react-dom");
...
function Cs({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Nr, { "data-slot": "dialog-portal", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(_r, {}),
...
const Ft = Root2$1, It = Value, gt = h.forwardRef(({ className: e, children: n, iconClassName: t, ...r2 }, o) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Trigger$2,
  {
    ref: o,
    className: p(
...
const Ln = h.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  ScrollUpButton,
  {
    ref: t,
    className: p(
...
Ln.displayName = ScrollUpButton.displayName;
const On = h.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  ScrollDownButton,
  {
    ref: t,
    className: p(
...
On.displayName = ScrollDownButton.displayName;
const ft = h.forwardRef(({ className: e, children: n, position: t = "popper", viewportClassName: r2, widthMode: o = "trigger", ...a }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$2, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Content2$2,
  {
    ...
    ...a,
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Ln, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Viewport,
        {
          className: p(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(On, {})
    ]
  }
) }));
ft.displayName = Content2$2.displayName;
const Mr = h.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Label,
  {
    ref: t,
...
Mr.displayName = Label.displayName;
...
Pr.displayName = Separator.displayName;
function mt({
  ...e
}) {
...
function $r({ className: e, variant: n, ...t }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: p(Vr({ variant: n }), e), ...t });
}
function cn({
  className: e,
  classNames: n,
...
const en = h.forwardRef(({ className: e, indicatorClassName: n, value: t, minWidthOnZero: r2 = false, ...o }, a) => {
...
en.displayName = Root$3.displayName;
...
), jt = h.forwardRef(({ className: e, variant: n, ...t }, r2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Root$2,
  {
    ref: r2,
    "data-slot": "selection-chip",
    className: p(zr({ variant: n }), e),
    ...t
  }
));
jt.displayName = "SelectionChip";
function Or({
  ...e
}) {
...
function Bs({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ar, { asChild: e, ...n });
}
function js({
  className: e,
  ...n
...
function Gt({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Br, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Root3, { "data-slot": "tooltip", ...e }) });
}
function qt({
  ...e
}) {
...
function Ut({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Portal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Content2,
    {
      ...
      sideOffset: o ? -4 : n,
      className: Ve(
        jr({ variant: i, size: d, className: e }),
...
}, Yr = Array(12).fill(0), Kr = ({ visible: e, className: n }) => /* @__PURE__ */ y.createElement("div", {
  className: [
...
}, Yr.map((t, r2) => /* @__PURE__ */ y.createElement("div", {
  className: "sonner-loading-bar",
  key: `spinner-bar-${r2}`
})))), Wr = /* @__PURE__ */ y.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 20 20",
  fill: "currentColor",
  height: "20",
...
class to {
  constructor() {
    this.subscribe = (n) => (this.subscribers.push(n), () => {
      ...
      var t;
      const { message: r2, ...o } = n, a = typeof (n == null ? void 0 : n.id) == "number" || ((t = n.id) == null ? void 0 : t.length) > 0 ? n.id : Yt++, i = this.toasts.find((u) => u.id === a), d = n.dismissible === void 0 ? true : n.dismissible;
      ...
      const r2 = (t == null ? void 0 : t.id) || Yt++;
      return this.create({
        jsx: n(r2),
        id: r2,
        ...t
...
const Pe = new to(), no = (e, n) => {
  const t = (n == null ? void 0 : n.id) || Yt++;
  return Pe.addToast({
    title: e,
    ...n,
    id: t
  }), t;
}, ro = (e) => e && typeof e == "object" && "ok" in e && typeof e.ok == "boolean" && "status" in e && typeof e.status == "number", oo = no, ao = () => Pe.toasts, so = () => Pe.getActiveToasts(), vt = Object.assign(oo, {
  success: Pe.success,
  info: Pe.info,
  warning: Pe.warning,
  error: Pe.error,
...
const ho = (e) => {
  ...
  const { invert: f, toast: l, unstyled: m, interacting: g, setHeights: x, visibleToasts: b, heights: C, index: w, toasts: F, expanded: _, removeToast: M, defaultRichColors: I, closeButton: D, style: O, cancelButtonStyle: B, actionButtonStyle: q, className: U = "", descriptionClassName: K = "", duration: A, position: V, gap: X2, expandByDefault: xe, classNames: S, icons: $, closeButtonAriaLabel: Y = "Close toast" } = e, [z, ee] = y.useState(null), [we, pe] = y.useState(null), [G, Z] = y.useState(false), [Q, j] = y.useState(false), [re2, L] = y.useState(false), [le, me] = y.useState(false), [Te, te] = y.useState(false), [ne, ve] = y.useState(0), [Ie, he] = y.useState(0), be = y.useRef(l.duration || A || gn), ie = y.useRef(null), ue = y.useRef(null), Ce = w === 0, De = w + 1 <= b, J = l.type, ze = l.dismissible !== false, ke = l.className || "", Ee = l.descriptionClassName || "", Le = y.useMemo(() => C.findIndex((H) => H.toastId === l.id) || 0, [
    C,
    l.id
  ]), Xe = y.useMemo(() => {
    var H;
    return (H = l.closeButton) != null ? H : D;
  }, [
    l.closeButton,
    D
  ]), Be = y.useMemo(() => l.duration || A || gn, [
    l.duration,
    A
  ]), ye = y.useRef(0), Oe = y.useRef(0), tt = y.useRef(0), Me = y.useRef(null), [Ze, je] = V.split("-"), nt = y.useMemo(() => C.reduce((H, ae, ge) => ge >= Le ? H : H + ae.height, 0), [
    C,
    Le
  ]), Ke = eo(), rt = l.invert || f, Qe = J === "loading";
  Oe.current = y.useMemo(() => Le * X2 + nt, [
    ...
    const H = ue.current;
    if (H) {
      const ae = H.getBoundingClientRect().height;
      return he(ae), x((ge) => [
        {
          toastId: l.id,
          height: ae,
    ...
    if (!G) return;
    const H = ue.current, ae = H.style.height;
    H.style.height = "auto";
    const ge = H.getBoundingClientRect().height;
    H.style.height = ae, he(ge), x((Re) => Re.find((E) => E.toastId === l.id) ? Re.map((E) => E.toastId === l.id ? {
      ...E,
      height: ge
    } : E) : [
      {
  ...
  const R = y.useCallback(() => {
    j(true), ve(Oe.current), x((H) => H.filter((ae) => ae.toastId !== l.id)), setTimeout(() => {
      M(l);
    }, po);
  }, [
    l,
  ...
  y.useEffect(() => {
    ...
    })() : be.current !== 1 / 0 && (ye.current = (/* @__PURE__ */ new Date()).getTime(), H = setTimeout(() => {
      l.onAutoClose == null || l.onAutoClose.call(l, l), R();
    }, be.current)), () => clearTimeout(H);
  }, [
    _,
    g,
    l,
  ...
  function T() {
    ...
    return /* @__PURE__ */ y.createElement(Kr, {
      className: qe(S == null ? void 0 : S.loader, l == null || (H = l.classNames) == null ? void 0 : H.loader),
      visible: J === "loading"
    });
  }
  const W = l.icon || ($ == null ? void 0 : $[J]) || Ur(J);
  var oe, Ge;
  return /* @__PURE__ */ y.createElement("li", {
    ...
    onDragEnd: () => {
      L(false), ee(null), Me.current = null;
    },
    onPointerDown: (H) => {
      H.button !== 2 && (Qe || !ze || (ie.current = /* @__PURE__ */ new Date(), ve(Oe.current), H.target.setPointerCapture(H.pointerId), H.target.tagName !== "BUTTON" && (L(true), Me.current = {
        x: H.clientX,
        y: H.clientY
      })));
    },
    onPointerUp: () => {
      ...
      if (le || !ze) return;
      Me.current = null;
      const Re = Number(((H = ue.current) == null ? void 0 : H.style.getPropertyValue("--swipe-amount-x").replace("px", "")) || 0), N = Number(((ae = ue.current) == null ? void 0 : ae.style.getPropertyValue("--swipe-amount-y").replace("px", "")) || 0), E = (/* @__PURE__ */ new Date()).getTime() - ((ge = ie.current) == null ? void 0 : ge.getTime()), se = z === "x" ? Re : N, _e = Math.abs(se) / E;
      if (Math.abs(se) >= fo || _e > 0.11) {
        ve(Oe.current), l.onDismiss == null || l.onDismiss.call(l, l), pe(z === "x" ? Re > 0 ? "right" : "left" : N > 0 ? "down" : "up"), R(), me(true);
        return;
      } else {
        var de, Fe;
        (de = ue.current) == null || de.style.setProperty("--swipe-amount-x", "0px"), (Fe = ue.current) == null || Fe.style.setProperty("--swipe-amount-y", "0px");
      }
      te(false), L(false), ee(null);
    },
    onPointerMove: (H) => {
      var ae, ge, Re;
      if (!Me.current || !ze || ((ae = window.getSelection()) == null ? void 0 : ae.toString().length) > 0) return;
      const E = H.clientY - Me.current.y, se = H.clientX - Me.current.x;
      var _e;
      const de = (_e = e.swipeDirections) != null ? _e : mo(V);
      !z && (Math.abs(se) > 1 || Math.abs(E) > 1) && ee(Math.abs(se) > Math.abs(E) ? "x" : "y");
      let Fe = {
        x: 0,
        y: 0
      };
      const ln = (ot) => 1 / (1.5 + Math.abs(ot) / 20);
      if (z === "y") {
      ...
      } else if (z === "x" && (de.includes("left") || de.includes("right")))
  ...
  }, (Ge = $ == null ? void 0 : $.close) != null ? Ge : Jr) : null, (J || l.icon || l.promise) && l.icon !== null && (($ == null ? void 0 : $[J]) !== null || l.icon) ? /* @__PURE__ */ y.createElement("div", {
    "data-icon": "",
    ...
    "data-button": true,
    "data-cancel": true,
    style: l.cancelButtonStyle || B,
    onClick: (H) => {
      bt(l.cancel) && ze && (l.cancel.onClick == null || l.cancel.onClick.call(l.cancel, H), R());
    },
    ...
    onClick: (H) => {
      bt(l.action) && (l.action.onClick == null || l.action.onClick.call(l.action, H), !H.defaultPrevented && R());
    },
...
function xo(e, n) {
  ...
  return [
    ...
    const a = o === 1, i = a ? "--mobile-offset" : "--offset", d = a ? uo : lo;
    function u(c) {
      [
        "top",
        "right",
...
const vo = /* @__PURE__ */ y.forwardRef(function(n, t) {
  const { id: r2, invert: o, position: a = "bottom-right", hotkey: i = [
    "altKey",
    "KeyT"
  ], expand: d, closeButton: u, className: c, offset: f, mobileOffset: l, theme: m = "light", richColors: g, duration: x, style: b, visibleToasts: C = io, toastOptions: w, dir: F = fn(), gap: _ = go, icons: M, containerAriaLabel: I = "Notifications" } = n, [D, O] = y.useState([]), B = y.useMemo(() => r2 ? D.filter((G) => G.toasterId === r2) : D.filter((G) => !G.toasterId), [
    D,
    r2
  ]), q = y.useMemo(() => Array.from(new Set([
    a
  ].concat(B.filter((G) => G.position).map((G) => G.position)))), [
    B,
    a
  ]), [U, K] = y.useState([]), [A, V] = y.useState(false), [X2, xe] = y.useState(false), [S, $] = y.useState(m !== "system" ? m : typeof window < "u" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), Y = y.useRef(null), z = i.join("+").replace(/Key/g, "").replace(/Digit/g, ""), ee = y.useRef(null), we = y.useRef(false), pe = y.useCallback((G) => {
    O((Z) => {
      var Q;
      return (Q = Z.find((j) => j.id === G.id)) != null && Q.delete || Pe.dismiss(G.id), Z.filter(({ id: j }) => j !== G.id);
    });
  }, []);
  return y.useEffect(() => Pe.subscribe((G) => {
    if (G.dismiss) {
      requestAnimationFrame(() => {
        O((Z) => Z.map((Q) => Q.id === G.id ? {
          ...Q,
          delete: true
        } : Q));
      });
    ...
    setTimeout(() => {
      Sr.flushSync(() => {
        O((Z) => {
          const Q = Z.findIndex((j) => j.id === G.id);
          return Q !== -1 ? [
            ...Z.slice(0, Q),
            {
              ...Z[Q],
  ...
  /* @__PURE__ */ y.createElement("section", {
    ...
    var Q;
    const [j, re2] = G.split("-");
    return B.length ? /* @__PURE__ */ y.createElement("ol", {
      key: G,
      dir: F === "auto" ? fn() : F,
      tabIndex: -1,
      ref: Y,
      ...
      onBlur: (L) => {
        we.current && !L.currentTarget.contains(L.relatedTarget) && (we.current = false, ee.current && (ee.current.focus({
          preventScroll: true
        }), ee.current = null));
      },
      onFocus: (L) => {
        L.target instanceof HTMLElement && L.target.dataset.dismissible === "false" || we.current || (we.current = true, ee.current = L.relatedTarget);
      },
      onMouseEnter: () => V(true),
      onMouseMove: () => V(true),
      onMouseLeave: () => {
      ...
      onDragEnd: () => V(false),
      onPointerDown: (L) => {
        L.target instanceof HTMLElement && L.target.dataset.dismissible === "false" || xe(true);
      },
      onPointerUp: () => xe(false)
    }, B.filter((L) => !L.position && Z === 0 || L.position === G).map((L, le) => {
      var me, Te;
      return /* @__PURE__ */ y.createElement(ho, {
        key: L.id,
        icons: M,
        index: le,
        toast: L,
        defaultRichColors: g,
        duration: (me = w == null ? void 0 : w.duration) != null ? me : x,
        className: w == null ? void 0 : w.className,
        descriptionClassName: w == null ? void 0 : w.descriptionClassName,
        invert: o,
        visibleToasts: C,
        closeButton: (Te = w == null ? void 0 : w.closeButton) != null ? Te : u,
        interacting: X2,
        position: G,
        ...
        removeToast: pe,
        toasts: B.filter((te) => te.position == L.position),
...
var Hn = {
  ...
  style: void 0,
  attr: void 0
}, pn = y.createContext && /* @__PURE__ */ y.createContext(Hn), bo = ["attr", "size", "title"];
function wo(e, n) {
  if (e == null) return {};
  var t, r2, o = yo(e, n);
...
function _t(e) {
  for (var n = 1; n < arguments.length; n++) {
    ...
    n % 2 ? mn(Object(t), true).forEach(function(r2) {
      So(e, r2, t[r2]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : mn(Object(t)).forEach(function(r2) {
...
function So(e, n, t) {
  return (n = Co(n)) in e ? Object.defineProperty(e, n, { value: t, enumerable: true, configurable: true, writable: true }) : e[n] = t, e;
}
function Co(e) {
  var n = Ro(e, "string");
...
function Bn(e) {
  return e && e.map((n, t) => /* @__PURE__ */ y.createElement(n.tag, _t({
    key: t
  }, n.attr), Bn(n.child)));
}
function tn(e) {
  return (n) => /* @__PURE__ */ y.createElement(No, Nt({
    attr: _t({}, e.attr)
  }, n), Bn(e.child));
}
function No(e) {
  var n = (t) => {
    var {
      ...
      size: o,
      title: a
    } = e, i = wo(e, bo), d = o || t.size || "1em", u;
    return t.className && (u = t.className), e.className && (u = (u ? u + " " : "") + e.className), /* @__PURE__ */ y.createElement("svg", Nt({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, t.attr, r2, i, {
  ...
  return pn !== void 0 ? /* @__PURE__ */ y.createElement(pn.Consumer, null, (t) => n(t)) : n(Hn);
}
function _o(e) {
  return tn({ attr: { viewBox: "0 0 24 24", fill: "currentColor" }, child: [{ tag: "path", attr: { d: "M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM11 15V17H13V15H11ZM11 7V13H13V7H11Z" }, child: [] }] })(e);
}
function Fo(e) {
  return tn({ attr: { viewBox: "0 0 512 512" }, child: [{ tag: "path", attr: { d: "M256 48C141.1 48 48 141.1 48 256s93.1 208 208 208 208-93.1 208-208S370.9 48 256 48zm106.5 150.5L228.8 332.8h-.1c-1.7 1.7-6.3 5.5-11.6 5.5-3.8 0-8.1-2.1-11.7-5.7l-56-56c-1.6-1.6-1.6-4.1 0-5.7l17.8-17.8c.8-.8 1.8-1.2 2.8-1.2 1 0 2 .4 2.8 1.2l44.4 44.4 122-122.9c.8-.8 1.8-1.2 2.8-1.2 1.1 0 2.1.4 2.8 1.2l17.5 18.1c1.8 1.7 1.8 4.2.2 5.8z" }, child: [] }] })(e);
}
const Gs = ({ ...e }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  vo,
  {
    ...
    vt.custom((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Fo, { className: "h-5 w-5 text-trax-green-500" }) }),
      ...
      duration: n.duration || hn.duration
    });
  },
  error: (e, n = {}) => {
    vt.custom((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(_o, { className: "h-5 w-5 text-trax-red-500" }) }),
...
function P(e, n, t) {
  ...
  return (a) => {
    ...
    if (t.key && t.debug && (c = Date.now()), o = n(...d), t == null || t.onChange == null || t.onChange(o), t.key && t.debug && t != null && t.debug()) {
      const f = Math.round((Date.now() - i) * 100) / 100, l = Math.round((Date.now() - c) * 100) / 100, m = l / 16, g = (x, b) => {
...
function wt(e, n, t, r2) {
  ...
  const d = function(m, g) {
    g === void 0 && (g = 1), i = Math.max(i, g), m.filter((x) => x.getIsVisible()).forEach((x) => {
      var b;
      (b = x.columns) != null && b.length && d(x.columns, g + 1);
    }, 0);
  };
  d(e);
  let u = [];
  const c = (m, g) => {
    ...
    m.forEach((C) => {
      const w = [...b].reverse()[0], F = C.column.depth === x.depth;
      let _, M = false;
      if (F && C.column.parent ? _ = C.column.parent : (_ = C.column, M = true), w && (w == null ? void 0 : w.column) === _)
        w.subHeaders.push(C);
      else {
        const I = bn(t, _, {
          id: [r2, g, _.id, C == null ? void 0 : C.id].filter(Boolean).join("_"),
          isPlaceholder: M,
          placeholderId: M ? `${b.filter((D) => D.column === _).length}` : void 0,
          depth: g,
          index: b.length
        });
        I.subHeaders.push(C), b.push(I);
      }
      x.headers.push(C), C.headerGroup = x;
    }), u.push(x), g > 0 && c(b, g - 1);
  }, f = n.map((m, g) => bn(t, m, {
    depth: i,
    index: g
  }));
  ...
  const l = (m) => m.filter((x) => x.column.getIsVisible()).map((x) => {
    ...
    const F = Math.min(...w);
    return C = C + F, x.colSpan = b, x.rowSpan = C, {
      colSpan: b,
      rowSpan: C
    };
  });
...
const nn = (e, n, t, r2, o, a, i) => {
  let d = {
    ...
    subRows: [],
    getLeafRows: () => Po(d.subRows, (u) => u.subRows),
    ...
    getAllCells: P(() => [e.getAllLeafColumns()], (u) => u.map((c) => ko(e, d, c, c.id)), k(e.options, "debugRows")),
...
const Yn = (e, n, t) => !t.some((r2) => {
  var o;
  return !((o = e.getValue(n)) != null && o.includes(r2));
});
Yn.autoRemove = (e) => Ae(e) || !(e != null && e.length);
const Kn = (e, n, t) => t.some((r2) => {
  var o;
  return (o = e.getValue(n)) == null ? void 0 : o.includes(r2);
});
Kn.autoRemove = (e) => Ae(e) || !(e != null && e.length);
const Wn = (e, n, t) => e.getValue(n) === t;
Wn.autoRemove = (e) => Ae(e);
const Xn = (e, n, t) => e.getValue(n) == t;
Xn.autoRemove = (e) => Ae(e);
const rn = (e, n, t) => {
  let [r2, o] = t;
  const a = e.getValue(n);
  return a >= r2 && a <= o;
};
rn.resolveFilterValue = (e) => {
...
const zo = {
  ...
  createColumn: (e, n) => {
    e.getAutoFilterFn = () => {
      ...
      var t, r2;
      return Et(e.columnDef.filterFn) ? e.columnDef.filterFn : e.columnDef.filterFn === "auto" ? e.getAutoFilterFn() : (
        // @ts-ignore
...
const Lo = (e, n, t) => t.reduce((r2, o) => {
...
}, Go = (e, n) => Array.from(new Set(n.map((t) => t.getValue(e))).values()), qo = (e, n) => new Set(n.map((t) => t.getValue(e))).size, Uo = (e, n) => n.length, Pt = {
  sum: Lo,
  min: Oo,
  max: Ao,
  extent: Ho,
  ...
  createColumn: (e, n) => {
    e.toggleGrouping = () => {
      ...
      if (!e)
        throw new Error();
      return Et(e.columnDef.aggregationFn) ? e.columnDef.aggregationFn : e.columnDef.aggregationFn === "auto" ? e.getAutoAggregationFn() : (t = (r2 = n.options.aggregationFns) == null ? void 0 : r2[e.columnDef.aggregationFn]) != null ? t : Pt[e.columnDef.aggregationFn];
    };
  },
  createTable: (e) => {
...
const Wo = {
  ...
  createTable: (e) => {
    e.setColumnPinning = (n) => e.options.onColumnPinningChange == null ? void 0 : e.options.onColumnPinningChange(n), e.resetColumnPinning = (n) => {
      var t, r2;
      return e.setColumnPinning(n ? kt() : (t = (r2 = e.initialState) == null ? void 0 : r2.columnPinning) != null ? t : kt());
...
const yt = {
  ...
  createHeader: (e, n) => {
    e.getSize = () => {
      ...
      return (a) => {
        if (!r2 || !o || (a.persist == null || a.persist(), $t(a) && a.touches && a.touches.length > 1))
          return;
        const i = e.getSize(), d = e ? e.getLeafHeaders().map((w) => [w.column.id, w.column.getSize()]) : [[r2.id, r2.getSize()]], u = $t(a) ? Math.round(a.touches[0].clientX) : a.clientX, c = {}, f = (w, F) => {
          typeof F == "number" && (n.setColumnSizingInfo((_) => {
            var M, I;
            const D = n.options.columnResizeDirection === "rtl" ? -1 : 1, O = (F - ((M = _ == null ? void 0 : _.startOffset) != null ? M : 0)) * D, B = Math.max(O / ((I = _ == null ? void 0 : _.startSize) != null ? I : 0), -0.999999);
            return _.columnSizingStart.forEach((q) => {
              let [U, K] = q;
              c[U] = Math.round(Math.max(K + K * B, 0) * 100) / 100;
            }), {
              ..._,
              deltaOffset: O,
              deltaPercentage: B
          ...
          f("end", w), n.setColumnSizingInfo((F) => ({
            ...F,
            isResizingColumn: false,
            startOffset: null,
            startSize: null,
          ...
          upHandler: (w) => {
            g == null ? void 0 : g.removeEventListener("mousemove", x.moveHandler), g == null ? void 0 : g.removeEventListener("mouseup", x.upHandler), m(w.clientX);
          }
        }, b = {
          moveHandler: (w) => (w.cancelable && (w.preventDefault(), w.stopPropagation()), l(w.touches[0].clientX), false),
          upHandler: (w) => {
            var F;
            g == null ? void 0 : g.removeEventListener("touchmove", b.moveHandler), g == null ? void 0 : g.removeEventListener("touchend", b.upHandler), w.cancelable && (w.preventDefault(), w.stopPropagation()), m((F = w.touches[0]) == null ? void 0 : F.clientX);
          }
        }, C = Jo() ? {
          passive: false
        } : false;
        $t(a) ? (g == null ? void 0 : g.addEventListener("touchmove", b.moveHandler, C), g == null ? void 0 : g.addEventListener("touchend", b.upHandler, C)) : (g == null ? void 0 : g.addEventListener("mousemove", x.moveHandler, C), g == null ? void 0 : g.addEventListener("mouseup", x.upHandler, C)), n.setColumnSizingInfo((w) => ({
          ...w,
          startOffset: u,
          startSize: i,
          deltaOffset: 0,
...
const ta = {
  ...
  createTable: (e) => {
    e.getGlobalAutoFilterFn = () => We.includesString, e.getGlobalFilterFn = () => {
      ...
      return Et(r2) ? r2 : r2 === "auto" ? e.getGlobalAutoFilterFn() : (n = (t = e.options.filterFns) == null ? void 0 : t[r2]) != null ? n : We[r2];
    }, e.setGlobalFilter = (n) => {
  ...
  createTable: (e) => {
    ...
    e._autoResetPageIndex = () => {
      ...
      var o;
      e.setPagination(r2 ? Tt() : (o = e.initialState.pagination) != null ? o : Tt());
    }, e.setPageIndex = (r2) => {
      e.setPagination((o) => {
      ...
      var o, a;
      e.setPageIndex(r2 ? Kt : (o = (a = e.initialState) == null || (a = a.pagination) == null ? void 0 : a.pageIndex) != null ? o : Kt);
    }, e.resetPageSize = (r2) => {
      var o, a;
      e.setPageSize(r2 ? Wt : (o = (a = e.initialState) == null || (a = a.pagination) == null ? void 0 : a.pageSize) != null ? o : Wt);
    }, e.setPageSize = (r2) => {
      e.setPagination((o) => {
    ...
    e.pin = (t, r2, o) => {
      ...
      n.setRowPinning((u) => {
        ...
        if (t === "bottom") {
          var l, m;
          return {
            top: ((l = u == null ? void 0 : u.top) != null ? l : []).filter((b) => !(d != null && d.has(b))),
            bottom: [...((m = u == null ? void 0 : u.bottom) != null ? m : []).filter((b) => !(d != null && d.has(b))), ...Array.from(d)]
          };
        }
        if (t === "top") {
          var g, x;
          return {
            top: [...((g = u == null ? void 0 : u.top) != null ? g : []).filter((b) => !(d != null && d.has(b))), ...Array.from(d)],
            bottom: ((x = u == null ? void 0 : u.bottom) != null ? x : []).filter((b) => !(d != null && d.has(b)))
          };
        }
        return {
          top: ((c = u == null ? void 0 : u.top) != null ? c : []).filter((b) => !(d != null && d.has(b))),
          bottom: ((f = u == null ? void 0 : u.bottom) != null ? f : []).filter((b) => !(d != null && d.has(b)))
        };
      });
    }, e.getCanPin = () => {
      var t;
  ...
  createTable: (e) => {
    e.setRowPinning = (n) => e.options.onRowPinningChange == null ? void 0 : e.options.onRowPinningChange(n), e.resetRowPinning = (n) => {
      var t, r2;
      return e.setRowPinning(n ? zt() : (t = (r2 = e.initialState) == null ? void 0 : r2.rowPinning) != null ? t : zt());
  ...
  createTable: (e) => {
    ...
    }), e.getPreSelectedRowModel = () => e.getCoreRowModel(), e.getSelectedRowModel = P(() => [e.getState().rowSelection, e.getCoreRowModel()], (n, t) => Object.keys(n).length ? Lt(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, k(e.options, "debugTable")), e.getFilteredSelectedRowModel = P(() => [e.getState().rowSelection, e.getFilteredRowModel()], (n, t) => Object.keys(n).length ? Lt(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, k(e.options, "debugTable")), e.getGroupedSelectedRowModel = P(() => [e.getState().rowSelection, e.getSortedRowModel()], (n, t) => Object.keys(n).length ? Lt(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
  ...
  createRow: (e, n) => {
    e.toggleSelected = (t, r2) => {
      ...
      n.setRowSelection((a) => {
        ...
        return Xt(d, e.id, t, (i = r2 == null ? void 0 : r2.selectChildren) != null ? i : true, n), d;
      });
    }, e.getIsSelected = () => {
      const {
        rowSelection: t
  ...
  t ? (i.getCanMultiSelect() || Object.keys(e).forEach((d) => delete e[d]), i.getCanSelect() && (e[n] = true)) : delete e[n], r2 && (a = i.subRows) != null && a.length && i.getCanSelectSubRows() && i.subRows.forEach((d) => Xt(e, d.id, t, r2, o));
};
function Lt(e, n) {
...
function Zt(e, n, t) {
  ...
  return e.subRows.forEach((i) => {
    if (!(a && !o) && (i.getCanSelect() && (on(i, n) ? a = true : o = false), i.subRows && i.subRows.length)) {
      const d = Zt(i, n);
      d === "all" ? a = true : (d === "some" && (a = true), o = false);
    }
  }), o ? "all" : a ? "some" : false;
}
const Qt = /([0-9]+)/gm, ia = (e, n, t) => Zn(et(e.getValue(t)).toLowerCase(), et(n.getValue(t)).toLowerCase()), la = (e, n, t) => Zn(et(e.getValue(t)), et(n.getValue(t))), ua = (e, n, t) => an(et(e.getValue(t)).toLowerCase(), et(n.getValue(t)).toLowerCase()), da = (e, n, t) => an(et(e.getValue(t)), et(n.getValue(t))), ca = (e, n, t) => {
  const r2 = e.getValue(t), o = n.getValue(t);
  return r2 > o ? 1 : r2 < o ? -1 : 0;
}, ga = (e, n, t) => an(e.getValue(t), n.getValue(t));
function an(e, n) {
...
function Zn(e, n) {
  const t = e.split(Qt).filter(Boolean), r2 = n.split(Qt).filter(Boolean);
    ...
    e.getAutoSortingFn = () => {
      ...
      for (const o of t) {
        ...
        if (Object.prototype.toString.call(a) === "[object Date]")
          return lt.datetime;
        if (typeof a == "string" && (r2 = true, a.split(Qt).length > 1))
      ...
      if (!e)
        throw new Error();
      return Et(e.columnDef.sortingFn) ? e.columnDef.sortingFn : e.columnDef.sortingFn === "auto" ? e.getAutoSortingFn() : (t = (r2 = n.options.sortingFns) == null ? void 0 : r2[e.columnDef.sortingFn]) != null ? t : lt[e.columnDef.sortingFn];
...
function ma(e) {
  var n, t;
  const r2 = [...pa, ...(n = e._features) != null ? n : []];
  let o = {
    _features: r2
  };
  ...
  const l = {
    ...
    _getRowId: (m, g, x) => {
      var b;
      return (b = o.options.getRowId == null ? void 0 : o.options.getRowId(m, g, x)) != null ? b : `${x ? [x.id, g].join(".") : g}`;
    },
    ...
    _getDefaultColumnDef: P(() => [o.options.defaultColumn], (m) => {
      ...
      return m = (g = m) != null ? g : {}, {
        ...
        cell: (x) => {
          var b, C;
          return (b = (C = x.renderValue()) == null || C.toString == null ? void 0 : C.toString()) != null ? b : null;
        },
    ...
    getAllColumns: P(() => [o._getColumnDefs()], (m) => {
      const g = function(x, b, C) {
        return C === void 0 && (C = 0), x.map((w) => {
          const F = Vo(o, w, C, b), _ = w;
  ...
  return (e) => P(() => [e.options.data], (n) => {
    const t = {
      ...
      for (let c = 0; c < o.length; c++) {
        const f = nn(e, e._getRowId(o[c], c, i), o[c], c, a, void 0, i == null ? void 0 : i.id);
...
function Qn(e, n, t) {
  return t.options.filterFromLeafRows ? va(e, n, t) : ba(e, n, t);
}
function va(e, n, t) {
  var r2;
  const o = [], a = {}, i = (r2 = t.options.maxLeafRowFilterDepth) != null ? r2 : 100, d = function(u, c) {
    ...
    for (let m = 0; m < u.length; m++) {
      var l;
      let g = u[m];
      const x = nn(t, g.id, g.original, g.index, g.depth, void 0, g.parentId);
    ...
    for (let m = 0; m < u.length; m++) {
      ...
      if (n(g)) {
        ...
        if ((l = g.subRows) != null && l.length && c < i) {
          const b = nn(t, g.id, g.original, g.index, g.depth, void 0, g.parentId);
          b.subRows = d(g.subRows, c + 1), g = b;
        }
    ...
    for (let m = 0; m < n.flatRows.length; m++) {
      ...
      if (g.columnFilters = {}, o.length)
        for (let x = 0; x < o.length; x++) {
          c = o[x];
          const b = c.id;
          g.columnFilters[b] = c.filterFn(g, b, c.resolvedValue, (C) => {
            g.columnFiltersMeta[b] = C;
          });
        }
      if (a.length) {
        for (let x = 0; x < a.length; x++) {
          f = a[x];
          const b = f.id;
          if (f.filterFn(g, b, f.resolvedValue, (C) => {
            g.columnFiltersMeta[b] = C;
          })) {
    ...
    const d = (u) => {
      ...
      return c.sort((f, l) => {
        for (let g = 0; g < a.length; g += 1) {
          var m;
          const x = a[g], b = i[x.id], C = b.sortUndefined, w = (m = x == null ? void 0 : x.desc) != null ? m : false;
          let F = 0;
          if (C) {
          ...
          if (F === 0 && (F = b.sortingFn(f, l, x.id)), F !== 0)
            return w && (F *= -1), b.invertSorting && (F *= -1), F;
        }
...
function yn(e, n) {
  return e ? Na(e) ? /* @__PURE__ */ h.createElement(e, n) : e : null;
}
function Na(e) {
  return _a(e) || typeof e == "function" || Fa(e);
}
function _a(e) {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              gt,
              {
                ...
                disabled: o,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(It, { placeholder: t.toString() })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ft,
...
Jn.displayName = "DataTablePagination";
function Da({
  column: e,
  title: n,
  className: t,
...
Da.displayName = "DataTableColumnHeader";
function Ks({
  context: e,
  viewContent: n,
  editContent: t,
...
function Xs({
  ...
  const [X2, xe] = h.useState({
    pageIndex: 0,
    pageSize: g
  }), [S, $] = h.useState([]), [Y, z] = h.useState([]), ee = b ?? X2, we = x ?? xe, pe = M ?? S, G = I ?? $, Z = B ?? Y, Q = q ?? z, j = Ia({
    data: n,
    columns: e,
    getCoreRowModel: ha(),
    getPaginationRowModel: m && !C ? Ca() : void 0,
    getSortedRowModel: _ && !D ? Ra() : void 0,
    getFilteredRowModel: O && !U ? Sa() : void 0,
    getFacetedRowModel: O ? wa() : void 0,
    getFacetedUniqueValues: O ? ya() : void 0,
    onPaginationChange: m ? we : void 0,
    onSortingChange: _ ? G : void 0,
    onColumnFiltersChange: O ? Q : void 0,
    manualPagination: C,
    manualSorting: D,
    manualFiltering: U,
    pageCount: w,
  ...
  ] }) }), L = typeof K == "function" ? K(j) : K, le = () => /* @__PURE__ */ jsxRuntimeExports.jsx(Io, { className: "bg-trax-neutral-10", children: j.getHeaderGroups().map((te) => /* @__PURE__ */ jsxRuntimeExports.jsx(Mt, { className: l == null ? void 0 : l.headerRow, children: te.headers.map((ne) => /* @__PURE__ */ jsxRuntimeExports.jsx(Eo, { className: l == null ? void 0 : l.headerCell, children: ne.isPlaceholder ? null : yn(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-5" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-normal italic text-trax-neutral-300", children: "Searching" })
  ] }), Te = () => /* @__PURE__ */ jsxRuntimeExports.jsx(Mt, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(vn, { colSpan: e.length, className: "h-32 text-center", children: V || me }) });
  return !((_a2 = j.getRowModel().rows) == null ? void 0 : _a2.length) && !A ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: p("overflow-hidden rounded-md border", r2), children: [
    L,
    /* @__PURE__ */ jsxRuntimeExports.jsx(xn, { className: o, children: le() }),
    ...
    L,
    /* @__PURE__ */ jsxRuntimeExports.jsxs(xn, { className: o, children: [
      le(),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Do, { children: A ? Te() : j.getRowModel().rows.map((te) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          Mt,
          {
            ...
            children: te.getVisibleCells().map((he) => /* @__PURE__ */ jsxRuntimeExports.jsx(vn, { className: l == null ? void 0 : l.bodyCell, children: yn(he.column.columnDef.cell, {
              ...he.getContext(),
              isEditing: ne,
    ...
    m && /* @__PURE__ */ jsxRuntimeExports.jsx(Jn, { table: j, styles: l == null ? void 0 : l.pagination })
  ] });
}
const er = h.createContext(null);
function tr() {
  const e = h.useContext(er);
  if (!e)
...
function Ea({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(er.Provider, { value: { table: e }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: p(
...
Ea.displayName = "DataTableToolbar";
function Ma({
  column: e,
  title: n,
  ...
  const { table: i } = tr(), d = typeof e == "string" ? i.getColumn(e) : e, u = d == null ? void 0 : d.getFilterValue(), c = h.useMemo(() => {
    if (a)
      return a;
    if (!d) return [];
...
Ma.displayName = "DataTableCategoryFilter";
function nr(e) {
  return tn({ attr: { viewBox: "0 0 24 24" }, child: [{ tag: "path", attr: { fill: "none", d: "M0 0h24v24H0z" }, child: [] }, { tag: "path", attr: { d: "M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z" }, child: [] }] })(e);
}
function Pa(e, n) {
  const [t, r2] = Nn(e);
  return _n(() => {
...
const rr = h.forwardRef(
  ({
    ...
    const w = h.useId(), F = f || `search-input-${w}`, _ = h.useRef(null), M = l !== void 0, [I, D] = h.useState(""), [O, B] = h.useState(false), q = M ? l : I, U = Pa(q, a);
    ...
    const A = (z) => {
      M || D(z.target.value), g == null ? void 0 : g(z);
    }, V = () => {
      var _a2, _b;
      M || D(""), g == null ? void 0 : g({
        target: { value: "" }
      ...
      var _a2;
      B(true), (_a2 = b.onFocus) == null ? void 0 : _a2.call(b, z);
    }, S = (z) => {
      B(false), x == null ? void 0 : x(z);
    }, $ = (z) => {
      var _a2;
      if ((z.key === "Backspace" || z.key === "Delete") && (z.metaKey || z.ctrlKey || z.altKey) && q) {
        z.preventDefault(), V();
        return;
      }
      (_a2 = b.onKeyDown) == null ? void 0 : _a2.call(b, z);
    }, Y = O && q && !c;
...
const Va = h.forwardRef(
  ({
    ...
    const D = h.useMemo(() => M.length, [M]), O = d ? D > d : false;
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ct,
          {
            ...
            onChange: (B) => {
              I(B.target.value), l ? _.onChange(B) : C.onChange && C.onChange(B);
            },
            onBlur: l ? _.onBlur : g
          }
        ),
...
const $a = h.forwardRef(
  ({
    ...
    const b = `select-${Math.random().toString(36).substr(2, 9)}`, C = (w) => {
      w || (m == null ? void 0 : m());
    };
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: p("flex flex-col gap-1 w-full", c), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Ft, { value: i, onValueChange: d, onOpenChange: C, disabled: u, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            gt,
            {
              ref: x,
              ...
              ...g,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(It, { placeholder: o })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ft, { children: a.map((w) => /* @__PURE__ */ jsxRuntimeExports.jsx(pt, { value: w.value, children: w.label }, w.value)) })
        ] })
      ] }),
      t && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-nowrap justify-start items-center gap-0.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "text-trax-red-500 size-3.5" }),
...
const Ta = h.forwardRef(
  (e, n) => {
    const {
      ...
      numberOfMonths: C = 1,
      mode: w = "single"
    } = e, F = l || `date-picker-${Math.random().toString(36).substr(2, 9)}`, [_, M] = h.useState(false), I = h.useRef(false), D = h.useRef(false), O = w === "range";
    h.useEffect(() => {
      if (O && u) {
    ...
    const B = (S) => {
      ...
      if (O && c) {
        ...
        if (($ == null ? void 0 : $.from) && ($ == null ? void 0 : $.to) && $.from.getTime() !== $.to.getTime() && (S == null ? void 0 : S.from) && $.from && $.to) {
          let z;
          if (S.from.getTime() !== $.from.getTime() ? z = S.from : S.to && S.to.getTime() !== $.to.getTime() && (z = S.to), z) {
            const ee = { from: z, to: void 0 };
      ...
      if (M(S), !S) {
        ...
        I.current = false, b == null ? void 0 : b();
      }
    }, K = (S) => {
      if (O && I.current) {
        const $ = u;
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        mt,
        {
          open: _,
          onOpenChange: U,
          modal: O ? false : void 0,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Dt, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Ue,
              {
                ref: n,
                id: F,
...
const za = h.forwardRef(
  ({ label: e, required: n = false, helperText: t, error: r2, id: o, className: a, register: i, registerOptions: d, touched: u, showCharacterCount: c = false, maxCharacters: f, enforceMaxLength: l = false, value: m, ...g }, x) => {
    const b = h.useId(), C = o ?? `textarea-${b}`, w = i ? i(d) : {}, [F, _] = h.useState(() => typeof m == "string" ? m : typeof m == "number" ? String(m) : "");
    h.useEffect(() => {
      if (!i && m !== void 0) {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          zn,
          {
            ...
            ...g,
            ...i ? { name: w.name } : { value: m },
            onChange: (D) => {
              _(D.target.value), i ? w.onChange(D) : g.onChange && g.onChange(D);
            },
            onBlur: i ? w.onBlur : g.onBlur
          }
        ),
...
za.displayName = "FormTextarea";
const La = h.forwardRef(({ className: e, indicatorClassName: n, value: t = 0, disabled: r2 = false, error: o, ...a }, i) => {
...
La.displayName = "FormProgress";
function or(e = {}) {
  const { enabled: n = true, externalRef: t, deps: r2 = [] } = e, o = ir(null), a = t ?? o, [i, d] = Nn(false);
  return _n(() => {
    const u = a.current;
    let c = true;
    const f = () => {
      if (c)
        if (u && n) {
          const m = u.scrollWidth > u.offsetWidth;
          d(m);
        } else
          d(false);
    };
    ...
    return l.observe(u), () => {
      c = false, l.disconnect();
    };
  }, [n, ...r2]), { ref: a, isTruncated: i };
}
function Oa(e, n) {
  if (!n.trim()) return e;
...
function sn({
  ...
  var _a2;
  const xe = h.useId(), S = M || `search-select-${xe}`, $ = h.useRef(null), Y = h.useRef(null), z = h.useRef(null), ee = h.useRef(null), we = h.useRef([]), pe = I && B ? I(B, D) : null, G = h.useRef(pe);
  G.current = pe;
  const Z = h.useRef(e);
  Z.current = e;
  const Q = h.useCallback(
    (N) => {
      ...
      const se = (_a3 = G.current) == null ? void 0 : _a3.ref;
      se && (typeof se == "function" ? se(N) : se.current = N);
    },
    []
  ), [j, re2] = h.useState(""), [L, le] = h.useState(
    i ?? null
  ), [me, Te] = h.useState(
    i ?? null
  ), [te, ne] = h.useState(false), [ve, Ie] = h.useState([]), [he, be] = h.useState("idle"), [ie, ue] = h.useState(-1), [Ce, De] = h.useState(false), [J, ze] = h.useState(false), ke = h.useRef(void 0), Ee = h.useRef(void 0), Le = h.useRef(false), Xe = h.useRef(false), Be = h.useRef(false), ye = h.useRef(false), Oe = h.useRef(L), tt = h.useRef(me), Me = h.useRef(Ce), Ze = h.useRef(d);
  ...
  h.useEffect(() => {
    ...
    const N = c && (!Me.current || j.length === 0);
    if (J && (j.length >= l || N) && !Le.current && !Xe.current && !Be.current) {
      const E = N ? 0 : f;
      ke.current = setTimeout(() => {
        je(j);
      }, E);
    } else j.length < l && (ne(false), be("idle"), Ie([]));
    return () => {
      ke.current && clearTimeout(ke.current);
    };
  }, [J, j, f, l, c, je]), h.useEffect(() => {
    i !== void 0 && (le(i), Te(i), i ? (ye.current = true, re2(i.label)) : j && (ye.current = true, re2("")));
    const N = setTimeout(() => {
      ye.current = false;
    }, 0);
    return () => clearTimeout(N);
  }, [i]);
  const { isTruncated: nt } = or({
    externalRef: z,
    enabled: !!L && !Ce,
    deps: [L, Ce, J, U]
  }), Ke = (N) => {
    const E = N.target.value || "";
    re2(E), De(true), L && E !== L.label && (le(null), q === false && !I || (pe && pe.onChange({ target: { name: B, value: null } }), d == null ? void 0 : d(null)));
  }, rt = (N) => {
    Xe.current = true, le(N), Te(N), re2(N.label), ne(false), De(false), be("idle"), pe && pe.onChange({ target: { name: B, value: N } }), d == null ? void 0 : d(N), setTimeout(() => {
      Xe.current = false;
    }, 0);
  }, Qe = () => {
    var _a3;
    le(null), Te(null), re2(""), De(false), pe && pe.onChange({ target: { name: B, value: null } }), d == null ? void 0 : d(null), J && c ? je("") : (ne(false), be("idle")), (_a3 = z.current) == null ? void 0 : _a3.focus();
  }, R = (N) => {
    var _a3;
    if (N.stopPropagation(), !K && Ce && me) {
      le(me), ye.current = true, re2(""), De(false), J && c ? je("") : (ne(false), be("idle")), (_a3 = z.current) == null ? void 0 : _a3.focus();
      return;
    }
    Qe();
  }, T = () => {
    Be.current = false, ze(true), Ee.current && clearTimeout(Ee.current), L && !Ce && re2("");
  }, W = h.useCallback(() => {
    var _a3, _b;
    const N = Oe.current, E = tt.current, se = Me.current, _e = G.current;
    ne(false), be("idle"), Ie([]), q ? !N && se && (re2(""), De(false), _e && _e.onChange({ target: { name: B, value: null } }), (_a3 = Ze.current) == null ? void 0 : _a3.call(Ze, null)) : se && E && !N ? (le(E), ye.current = true, re2(E.label), De(false), _e && _e.onChange({ target: { name: B, value: E } }), (_b = Ze.current) == null ? void 0 : _b.call(Ze, E)) : !N && !E && (re2(""), De(false));
  }, [q, B]), oe = (N) => {
    ...
    }, 200), pe && pe.onBlur(N), O == null ? void 0 : O(N);
  }, Ge = (N) => {
    if ((N.key === "Backspace" || N.key === "Delete") && (N.metaKey || N.ctrlKey || N.altKey) && L) {
      N.preventDefault(), Qe();
      return;
    }
    if (te)
  ...
  const ae = L && !Ce ? !J && U ? U : K ? L.label : "" : j, ge = nt && L && !Ce && !((A == null ? void 0 : A.disabled) ?? false), Re = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: ee, className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ct,
      {
        ref: pe || e ? Q : z,
    ...
    "div",
    {
      ...
      children: [
        ...
        X2 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(mt, { open: te, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Gt, { delayDuration: (A == null ? void 0 : A.delayDuration) ?? 300, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(qt, { asChild: true, disabled: !ge, children: /* @__PURE__ */ jsxRuntimeExports.jsx(kr, { asChild: true, children: Re }) }),
            ge && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Ut,
              {
                variant: (A == null ? void 0 : A.variant) ?? "light",
                showArrow: (A == null ? void 0 : A.showArrow) ?? false,
                size: (A == null ? void 0 : A.size) ?? "sm",
                children: (A == null ? void 0 : A.renderContent) ? A.renderContent(ae) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-xs wrap-break-word", children: ae })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                "div",
                {
                  ...
                  children: [
                    he === "searching" && (x ?? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-3 py-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Rt, { className: "w-6 h-6" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-trax-neutral-600", children: m })
                    ] })),
                    he === "no-results" && (b ?? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-trax-neutral-400", children: g }) })),
                    he === "success" && ve.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-1", children: ve.map((N, E) => {
                      ...
                      return /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: C ? C(N, (de, Fe) => w(de, Fe ?? j), _e) : w(N.label, j)
                        },
                        N.value
                      );
                    }) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Gt, { delayDuration: (A == null ? void 0 : A.delayDuration) ?? 300, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(qt, { asChild: true, disabled: !ge, children: Re }),
            ge && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Ut,
              {
                variant: (A == null ? void 0 : A.variant) ?? "light",
...
function Aa({
  ...
  const D = h.useRef(null), O = h.useRef(null), B = h.useRef(null), q = h.useRef(null), [U, K] = h.useState(false);
  h.useImperativeHandle(I, () => D.current, [D.current]), h.useLayoutEffect(() => {
    var _a2;
    if (!U) {
      q.current && (clearTimeout(q.current), q.current = null);
      const V = (_a2 = B.current) == null ? void 0 : _a2.querySelector("input");
      V && (V.style.color = "transparent");
    }
  }, [U]);
  const A = h.useCallback((V) => {
    if (B.current = V, V) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: p("relative", m), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Dt, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: p("h-4 w-4 opacity-50", b) })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ht,
        {
          ...
          onOpenAutoFocus: (V) => {
            V.preventDefault(), q.current = setTimeout(() => {
              var _a2, _b;
              (_a2 = O.current) == null ? void 0 : _a2.focus();
              const X2 = (_b = B.current) == null ? void 0 : _b.querySelector("input");
              X2 && (X2.style.color = ""), q.current = null;
            }, 0);
          },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: A, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            sn,
            {
    ...
    M && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: p("flex flex-nowrap justify-start items-center gap-0.5", w), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "text-trax-red-500 size-3.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-trax-red-500 font-normal", children: M })
    ] })
  ] });
}
const Ha = h.forwardRef(Aa);
Ha.displayName = "SearchSelectTrigger";
function Zs({
  className: e,
  thumbClassName: n,
  ...t
...
const ja = h.forwardRef(
  ({
    ...
    const [c, f] = h.useState(false), l = h.useRef(null), m = (w) => {
      w.preventDefault(), i || f(true);
    }, g = (w) => {
      w.preventDefault(), f(false);
    }, x = (w) => {
      if (w.preventDefault(), f(false), i) return;
      const F = w.dataTransfer.files;
      F && F.length > 0 && (n == null ? void 0 : n(F));
    }, b = () => {
      !i && l.current && l.current.click();
    }, C = (w) => {
      const F = w.target.files;
      n == null ? void 0 : n(F);
    };
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
...
Ga.displayName = "CollapsibleSection";
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center justify-center f-full gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(en, { value: f || 3, className: "h-2", indicatorClassName: "bg-trax-neutral-100" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-medium text-trax-neutral-100", children: [
              f,
              "%"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-row gap-1.5", children: t.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between bg-grey-50 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx($r, { variant: "category", children: l.name }) }, l.id)) }),
...
const Ua = h.forwardRef(
  ({
    ...
    const I = l || `currency-input-${Math.random().toString(36).substring(2, 11)}`, D = t ?? (n ? Sn(n, r2, i) : void 0), O = o ?? (D ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground text-xs", "aria-hidden": true, children: D }) : null), B = a ?? (m && g.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-2 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Ft,
      {
        value: n,
        onValueChange: (q) => {
          const U = g.find((K) => K.code === q);
          U && x && x(U);
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(gt, { className: "h-6 border-0 shadow-none bg-transparent hover:bg-gray-50 focus:ring-0 focus:ring-offset-0 px-2 py-1 text-xs font-medium text-trax-grey-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(It, { children: n }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ft, { children: g.map((q) => {
            const U = q.symbol ?? Sn(q.code, q.locale || r2, i);
            return /* @__PURE__ */ jsxRuntimeExports.jsx(pt, { value: q.code, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: U }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: q.code })
            ] }) }, q.code);
          }) })
        ]
      }
...
const Ya = h.forwardRef(
  ({
    ...
    const C = h.useId(), w = m ?? `addon-input-${C}`, F = h.useRef(null), _ = h.useRef(null), M = h.useRef(null), [I, D] = h.useState(false), O = Ot(t);
    h.useEffect(() => {
      O || D(false);
    }, [O]), h.useLayoutEffect(() => {
      var _a2;
      if (!I) {
        ...
        const A = (_a2 = _.current) == null ? void 0 : _a2.querySelector("input");
        A && (A.style.color = "transparent");
      }
    }, [I]);
    const B = h.useCallback((A) => {
      if (_.current = A, A) {
        const V = A.querySelector("input");
        V && (V.style.color = "transparent");
      }
    }, []), q = !!(u == null ? void 0 : u.toString()), U = () => !n || Cn(n) || Ot(n) ? null : Rn(n) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        className: p(
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                gt,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(It, { placeholder: t.placeholder })
                }
              ),
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: p("shrink-0 pr-2", o), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(mt, { open: I, onOpenChange: D, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ht,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: B, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                sn,
                {
      ...
      return Rn(t) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          className: p(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: p(
            ...
            // Error state
            q && "border-trax-red-400",
            q && !g && "hover:border-trax-red-600",
            q && "focus-within:border-trax-red-700 focus-within:ring-trax-red-focus-shadow"
          ),
          children: [
            U(),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Fr, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Dr, { align: "end", className: "min-w-[200px]", children: t.map((c, f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Er,
            {
              onClick: c.onClick,
...
const Qs = Root$8, Wa = Portal$4, ei = Close, sr = h.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Overlay,
  {
    ref: t,
    className: Ve(
...
sr.displayName = Overlay.displayName;
const Xa = h.forwardRef(({ className: e, children: n, showCloseButton: t = true, ...r2 }, o) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Wa, { children: [
...
Xa.displayName = Content$1.displayName;
const Za = ({
  className: e,
  ...n
}) => /* @__PURE__ */ jsxRuntimeExports.jsx(
...
Za.displayName = "CustomDialogHeader";
const Qa = ({
  className: e,
  ...n
}) => /* @__PURE__ */ jsxRuntimeExports.jsx(
...
Qa.displayName = "CustomDialogFooter";
const Ja = h.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Title,
  {
    ref: t,
    className: p(
...
Ja.displayName = Title.displayName;
...
es.displayName = Description.displayName;
const ts = h.forwardRef(
  ({
    children: e,
    tooltipContent: n,
    renderTooltip: t,
    ...
    const { ref: C, isTruncated: w } = or({
      deps: [e, l]
    }), F = h.useCallback(
      (D) => {
        C.current = D, typeof b == "function" ? b(D) : b && (b.current = D);
      },
      [b, C]
    ), _ = w && !i, M = {
      ...g,
    ...
    return i ? I : /* @__PURE__ */ jsxRuntimeExports.jsxs(Gt, { delayDuration: a, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(qt, { asChild: true, disabled: !_, children: I }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ut,
        {
          side: d,
