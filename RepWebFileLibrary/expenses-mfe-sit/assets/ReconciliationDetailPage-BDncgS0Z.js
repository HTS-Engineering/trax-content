...
import { i as useQuery, q as queryKeys, r as useParams, l as useLocation, w as useNavigateBack, a as RoutePaths } from "./date-format-Dh5rGvDF.js";
import { B as Bn, p, U as Ue } from "./index.es-CApEQq_T.js";
import { I as Icon } from "./Icon-08JP3B1K.js";
import { a as RECONCILIATION_ENDPOINTS, C as CompanySummaryCard } from "./CompanySummaryCard-BK5SdspU.js";
import { a as apiClient } from "./axiosInstance-D1uLEIcR.js";
const sortCompanyBreakdown = (items) => {
...
const mapCompanyTransactionsAggregation = (api) => ({
...
const useCompanyTransactionsAggregation = (statementId, { enabled = true } = {}) => {
  return useQuery({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PanelShell, { className, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CompanySummaryCard,
      {
        ...
        onSelect: () => onSelectionChange(ALL_COMPANIES_SELECTION),
