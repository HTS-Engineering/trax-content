...
import { w as ms, x as hs, l as ar, I as Icon, y as bs, A as An, p as ps, e as $r, q as qs, B as p, F as mt, H as Dt, U as Ue, L as ht, $ as $a, P as jt, s as sn, Y as Ya, i as Gt, j as qt, k as Ut, S as Hs, W as Bs, _ as js, z as za, V as Va, a0 as or, a1 as Zs, a2 as Ye, a3 as La } from "./index.es-DvVeXAAw.js";
import { c as createLucideIcon, z as FILE_ENDPOINTS, u as useCompanyStore, r as useTaxTypesDisplay, f as formatExpenseDate, A as useFormTypeName, w as ExpenseFormType, B as EMPTY_CURRENCY_SYMBOL, C as ECostAllocation, s as useDefaultCurrency, x as formatExpensePeriod, d as useQuery, q as queryKeys, E as EXPENSE_ENDPOINTS, G as formatHistoryTimestamp, D as DEFAULT_CURRENCY_CODE, n as formatToISODate, b as useExpenseTypes, F as FormTypeId, H as AllowedMimeType, J as FILE_SIZE_LIMITS, M as MIME_TYPE_CONFIG, K as FilePreviewType, p as useCountries, L as useDefaultCountry, h as useQueryClient, v as useFormTypeId, N as getCurrencySymbol } from "./expense-api-BPXCx7E0.js";
import { d as formatCurrency, e as formatDistance, c as formatRate, P as Plus } from "./formatters-BX6vKaEe.js";
import { a as apiClient, c as create, d as devtools } from "./axiosInstance-BZOkNtMm.js";
import { importShared } from "./__federation_fn_import-VIrFz_yB.js";
import { I as Info, s as string, D as DECIMAL_FORMAT_REGEX, o as object, d as custom, c as boolean, b as array, h as date, i as unknown, n as number, C as ConfirmDialog, g as useWatch, u as useForm, a, l as literal, j as useFormState, e as Controller, f as createDecimalChangeHandler } from "./schemas-D-AZdsqE.js";
import { a as useDefaultCompany, q as queryClient } from "./queryClient-i_9PNVNC.js";
import { b as devWarn, d as devError, a as devLog } from "./index-BZGB3DCm.js";
import { _ as __vitePreload } from "./preload-helper-e_IRvegh.js";
import { d as useDebouncedCallback, e as useNumericDisplay } from "./use-scroll-into-view-ref-DuitV4vb.js";
...
const PreviewReceiptSection = ({ receipt, stretchToFill = false }) => {
  ...
  const renderLoading = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center h-64 bg-exp-neutral-30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-10" }) });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "shadow-none border-0 bg-transparent p-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(hs, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ar,
      {
        title: "RECEIPT",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(bs, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-lg overflow-hidden bg-exp-neutral-30 border border-exp-primary-blue-100", children: [
...
const PreviewAffidavitSection = ({ affidavit }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(bs, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-exp-yellow-200 bg-exp-yellow-100 p-4", children: [
...
const PreviewExpenseDetailsSection = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(bs, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-x-8 gap-y-4", children: [
...
const PreviewExpenseJustificationSection = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(bs, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
...
const PreviewCostAllocationSection = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: deferred ? "shadow-none border-0 bg-transparent p-0 gap-0" : "shadow-none border-0 bg-transparent p-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(hs, { className: deferred ? "p-0 gap-0" : "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ar,
        {
    ...
    allocations && !deferred && /* @__PURE__ */ jsxRuntimeExports.jsx(bs, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: allocations.map((allocation, index) => {
...
const PreviewSupportingFilesSection = ({
  ...
  const handleFileClick = async (file) => {
    ...
    try {
      ...
      if (controller.signal.aborted) return;
      qs.error("Failed to download file. Please try again.");
    } finally {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(bs, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: files.map((file) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-4 shrink-0" }) : getFileIcon(file.mimeType),
...
const PreviewAdditionalCommentsSection = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "shadow-none border-0 bg-transparent p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(bs, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-exp-neutral-900 wrap-break-word", children: comments }) })
  ] });
};
const PreviewMileageTripDetailsSection = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "shadow-none border-0 bg-transparent p-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: "p-0 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ar,
        {
...
function config(obj) {
  ...
  var i, p2, v, useDefaults = obj.defaults === true, ps2 = [
    "precision",
    1,
    MAX_DIGITS,
    "rounding",
  ...
  for (i = 0; i < ps2.length; i += 3) {
    if (p2 = ps2[i], useDefaults) this[p2] = DEFAULTS[p2];
    if ((v = obj[p2]) !== void 0) {
      if (mathfloor(v) === v && v >= ps2[i + 1] && v <= ps2[i + 2]) this[p2] = v;
...
function clone(obj) {
  ...
  if (obj) {
    if (obj.defaults !== true) {
      ...
      for (i = 0; i < ps2.length; ) if (!obj.hasOwnProperty(p2 = ps2[i++])) obj[p2] = this[p2];
    }
  }
  Decimal2.config(obj);
  return Decimal2;
...
const ReceiptUpload = ({
  ...
  const handleFileUploadInternal = useCallback$j(async (file, targetExpenseId) => {
    ...
    if (!effectiveExpenseId || !(userDefaultCompany == null ? void 0 : userDefaultCompany.shortName)) {
      ...
      qs.error(errorMsg, { duration: 4e3 });
  ...
  const renderLoadingState = (message) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full items-center justify-center p-8 text-center gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4.5 flex items-center justify-center bg-exp-teal-200 rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-14" }) }),
  ...
  if (section.hideHeader) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConditionalSection,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-section-id": section.id, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(bs, { children: section.render(finalProps) }) }) }, section.id)
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ConditionalSection,
    {
      ...
      behavior,
      onDisabledChange: handleDisabledChange,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-section-id": section.id, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: hideCardGap, children: [
        "    ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(hs, { className: hideCardGap, children: headerActionsNode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ar,
            {
              title: section.title,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(bs, { children: section.render(finalProps) })
      ] }) }, section.id)
    }
  );
};
...
const AllocationTypeChips = memo$2(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: allocationTypes.map((allocationType) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Gt, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(qt, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      jt,
      {
        disabled,
...
const AddAllocationExpandable = memo$1(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Hs, { open: isOpen, onOpenChange: setIsOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Bs, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ue, { variant: "outlined", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, {}), disabled, children: COST_ALLOCATION_LABELS.ADD_ALLOCATION }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(js, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AllocationTypeChips, { onSelect: handleTypeSelect, disabled }) })
  ] });
});
...
function AffidavitContent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex-1 flex flex-col min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "w-full max-h-full bg-yellow-50 border border-yellow-200 p-3 flex flex-col overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 h-full overflow-y-auto", children: [
...
function ReceiptSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(hs, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-nowrap justify-between items-center min-h-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ar,
        {
          iconClassName: "bg-exp-yellow-001 justify-center items-center flex",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(bs, { className: "min-h-0 h-full", children: isReceiptUnavailable ? hideUploadWhenUnavailable ? null : /* @__PURE__ */ jsxRuntimeExports.jsx(AffidavitContent, { control, disabled }) : !shouldHideUpload && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ReceiptUpload,
      {
        onReceiptChange,
        onUploadingChange,
...
function FileName({ name, showTooltip = true }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Gt, { open: canShowTooltip && isOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(qt, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        ref,
...
function SupportingFileCard({
  ...
  if (isUploading || isLoadingPreview) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "bg-white px-2 py-2 w-full flex justify-between flex-row items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-4 shrink-0" }),
  ...
  if (hasError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "bg-exp-red-100 px-2 py-2 w-full flex justify-between flex-row items-center", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "bg-white hover:bg-trax-neutral-20 px-2 py-2 w-full flex justify-between flex-row items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
...
function SupportingFiles({
  ...
  const handleFileChange = useCallback$1(async (e) => {
    ...
    if (totalFiles > maxFiles) {
      ...
      if (filesToAdd <= 0) {
        qs.error(`Maximum ${maxFiles} supporting file${maxFiles > 1 ? "s" : ""} allowed`, {
          duration: 3e3
        });
        return;
      }
      qs.error(`Only ${filesToAdd} more file(s) can be added`, {
        duration: 3e3
      });
    ...
    if (!onSaveDraftForUpload) {
      qs.error("Cannot upload files: please save the expense first", {
        duration: 3e3
      });
      return;
    }
    ...
    try {
      ...
      qs.error("Failed to save expense. Please try again.", {
        duration: 3e3
      });
    }
  ...
  const handleDeleteConfirm = useCallback$1(async () => {
    ...
    if (file) {
      ...
      try {
        ...
        qs.error("Failed to delete file", {
          duration: 3e3
        });
      }
    }
  ...
  const handlePreviewClick = useCallback$1(async (file) => {
    ...
    if (!blobUrl && ((_a = file.url) == null ? void 0 : _a.startsWith("/api/"))) {
      ...
      try {
        ...
        const isCanceled = error instanceof Error && (error.name === "AbortError" || error.name === "CanceledError");
        if (isCanceled) return;
        qs.error("Failed to download file. Please try again.", { duration: 3e3 });
        return;
      } finally {
        previewAbortControllersRef.current.delete(file.id);
    ...
    try {
      ...
      qs.error("Failed to open file preview", {
        duration: 3e3
      });
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { className: `flex items-center flex-col w-full h-fit overflow-clip ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row w-full items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center w-full ml-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Gt, { delayDuration: TOOLTIP_DELAY_QUICK, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(qt, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(GrCircleInformation, { className: "text-gray-500 hover:cursor-pointer select-none" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { variant: "default", side: "top", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-trax-blue-700 text-white border-none text-sm p-2 w-64", children: displayTooltip }) })
      ] }) }),
      ...
      ) : !hideAddButtonWhenFull ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Gt, { delayDuration: TOOLTIP_DELAY_QUICK, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(qt, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleAddSupportingDocumentClick, disabled: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaPlus, { className: "opacity-20 hover:cursor-not-allowed" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ut,
          {
            variant: "light",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: `bg-white w-full p-0 ${state.attachments.length === 0 && !state.isUploading && pendingSupportingFiles.length === 0 ? "h-0" : "h-auto"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col my-1 mx-2 gap-1", children: [
      ...
      (isSavingDraft || isUploading) && pendingSupportingFiles.map((file, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "bg-white px-2 py-2 w-full flex justify-between flex-row items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
...
const ExpenseFormLeftColumn = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "w-full h-full flex flex-col pt-1", children: [
...
function CostAllocationSectionComponent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(La, { value: progressValue, disabled: isProgressDisabled, error: progressError }),
