...
import { K as Ks, D as Da, a as $r, q as qs, Q as Qa, V as Va, U as Ue, A as An, b as Gt, c as qt, d as Ut, e as ar, f as Qs, X as Xa, Z as Za, J as Ja, E as Ea, M as Ma, g as Xs } from "./index.es-BcmpdPPF.js";
import { f as formatExpenseDate, a as useCompanyStore, d as useQuery, q as queryKeys, k as keepPreviousData, E as EXPENSE_ENDPOINTS, i as isExpenseItemSubmitted, e as isRegularExpense, g as getExpenseItemAmount, h as useQueryClient, j as useMutation, l as isMileageExpense, m as useExpenseItem } from "./expense-api-BtNAFYOg.js";
import { a as apiClient } from "./axiosInstance-C8gKj5Wx.js";
import { f as formatAmountWithCurrency, a as formatDate, b as formatDateRange } from "./formatters-DJsE8pjs.js";
import { g as getExpenseTypeBadgeConfig } from "./expense-type-badge-CmIFG5WW.js";
import { i as useSearchParams, d as useLocation, a as RoutePaths, u as useNavigate, e as useParams, g as generatePath } from "./routes-qNoXVp_B.js";
import { a as useScrollIntoViewRef, b as useErrorToast } from "./use-scroll-into-view-ref-BwmfzUKR.js";
import { I as Icon } from "./Icon-BRsOXDbZ.js";
import { m as mapCostAllocation, g as getExpenseBaseAmount, u as useCostAllocationHandlers, C as CostAllocationHeaderActions, a as CostAllocationSection, v as validateCostAllocation, c as costAllocationItemSchema, E as ExpensePreview, i as isMileageTripData, M as MileageTripPreview, b as isMileagePeriodData, d as MileagePeriodPreview } from "./CostAllocationSection-Cos5IVjz.js";
import { d as devError } from "./index-BZGB3DCm.js";
import { u as useRoles, R as Role } from "./hooks-DWdQehoB.js";
import "./hooks-BHXM1iOZ.js";
import { E as ExpenseFormHistoryLog } from "./ExpenseFormHistoryLog-DbUInO_B.js";
import { u as useForm, a, o as object, b as array, s as string, c as boolean, d as custom, C as ConfirmDialog } from "./schemas-BZkGzsPE.js";
...
const useApprovalsColumns = ({
  ...
  const staticColumns = useMemo$4(() => [
    {
      ...
      enableSorting: false,
      size: 80,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "ID" }),
    ...
    },
    {
      ...
      minSize: 120,
      maxSize: 200,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Employee" }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ks,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 160,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Expense Date" }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ks,
        {
          context,
    ...
    },
    {
      ...
      minSize: 100,
      maxSize: 200,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Vendor" }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ks,
        {
          context,
    ...
    },
    {
      ...
      minSize: 120,
      maxSize: 250,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Expense Type" }),
      cell: (context) => {
    ...
    },
    {
      ...
      enableSorting: false,
      size: 140,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Total Amount" }) }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ks,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 160,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: "Payment Method" }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ks,
        {
          context,
  ...
  const actionDateColumn = useMemo$4(() => ({
    ...
    enableSorting: true,
    size: 150,
    header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Da, { column, title: getActionDateColumnHeader(currentTab) }),
    cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Ks,
      {
        context,
...
const useApproveExpense = () => {
  ...
  return useMutation({
    ...
    onSuccess: (_data, { expenseFormId }) => {
      ...
      qs.success("Expense approved successfully");
    },
    onError: (error) => {
      devError("Failed to approve expense:", error);
      qs.error("Failed to approve. Please try again.");
    }
  });
};
...
const useSaveCostAllocation = () => {
  ...
  return useMutation({
    ...
    onSuccess: (_data, { expenseFormId }) => {
      ...
      qs.success("Cost allocation saved successfully");
    },
    onError: (error) => {
      devError("Failed to save cost allocation:", error);
      qs.error("Failed to save cost allocation. Please try again.");
    }
  });
};
...
const ApproverFooter = ({
  ...
  if (isRejecting) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Qa, { className: "pt-4 w-full max-w-[600px] ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex shrink-0 items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Ue,
          {
            ...
            children: [
              isSubmittingDecision && /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-4" }),
              "Reject"
            ]
          }
        ),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Qa, { className: "pt-4 gap-4 w-full max-w-[600px] ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end w-full gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Ue,
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Gt, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(qt, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Ue,
        {
          ...
          children: [
            isApproving ? /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "check", className: "size-4" }),
            "Approve"
          ]
        }
      ) }) }),
      isAllocationRequired && !isApproving && /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { className: "text-sm", children: "Cost allocation must be added before approval" })
    ] })
  ] }) });
};
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Gt, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(qt, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Ue,
        {
          ...
          children: isSaving ? /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-4" }) : "Save Changes"
        }
      ) }) }),
      saveButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { className: "text-sm", children: saveButtonState.tooltip })
    ] })
  ] }) });
};
...
const ApproverExpenseDetail = ({ expenseId, item, onClose }) => {
  ...
  const logicalCompanyShortName = useCompanyStore((state) => {
    var _a2;
    return ((_a2 = state.selectedCompany) == null ? void 0 : _a2.shortName) ?? null;
  });
  ...
  useEffect(() => {
    if (!isEmployee) {
      ...
      qs.error("Insufficient permissions to view expense details.", { duration: 5e3 });
      onClose();
    }
  }, [isEmployee, onClose]);
  ...
  useEffect(() => {
    if (expenseItem && expenseItem.status === "draft") {
      qs.error("Expense form is still in draft and cannot be viewed in the approval flow.", { duration: 5e3 });
      onClose();
    }
  }, [expenseItem, onClose]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Qs, { open: true, onOpenChange: handleDialogOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Xa,
      {
        className: "w-auto max-w-none max-h-[90vh] h-full overflow-hidden flex flex-col",
        onInteractOutside: (e) => e.preventDefault(),
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Za, { className: "pb-3 mb-3 border-b border-exp-primary-blue-100", children: header ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-5 text-exp-primary-blue-600" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-hidden flex flex-col min-w-[600px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 relative overflow-y-auto py-4 exp-custom-scrollbar", children: isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-8 text-exp-primary-blue-600" }) }) : expenseItem && renderContent(expenseItem) }),
...
const ApprovalsList = () => {
  ...
  const customLoadingState = useMemo(() => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(An, { className: "size-8 text-exp-primary-blue-600" }),
