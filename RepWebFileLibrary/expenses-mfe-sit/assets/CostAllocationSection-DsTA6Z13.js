...
import { o as hs, x as xs, i as ir, w as ws, B as Bn, m as ms, a as Tr, b as Us, p, r as mt, s as Et, U as Ue, t as ht, T as Ta, G as Gt, l as ln$1, K as Ka, d as qt, e as Ut, Y as Yt, u as Bs, v as js, y as Gs, L as La, $ as $a, A as sr, C as Qs, D as Ye, O as Oa } from "./index.es-CApEQq_T.js";
import { I as Icon } from "./Icon-08JP3B1K.js";
import { n as FILE_ENDPOINTS, h as useTaxTypesDisplay, o as useFormTypeName, l as ExpenseFormType, p as ECostAllocation, j as useDefaultCurrency, E as EXPENSE_ENDPOINTS, a as useExpenseTypes, F as FormTypeId, A as AllowedMimeType, q as FILE_SIZE_LIMITS, M as MIME_TYPE_CONFIG, r as FilePreviewType, f as useCountries, s as useDefaultCountry, k as useFormTypeId } from "./expense-api-CkfEvbcZ.js";
import { d as formatCurrency, e as formatDistance, c as formatRate } from "./formatters-CW5N4Qkc.js";
import { d as useCompanyStore, h as formatExpenseDate, E as EMPTY_CURRENCY_SYMBOL, v as formatExpensePeriod, i as useQuery, q as queryKeys, y as formatHistoryTimestamp, D as DEFAULT_CURRENCY_CODE, s as formatToISODate, z as useDebouncedCallback, m as useQueryClient, A as useNumericDisplay, B as getCurrencySymbol } from "./date-format-Dh5rGvDF.js";
import { a as apiClient, c as create, d as devtools } from "./axiosInstance-D1uLEIcR.js";
import { importShared } from "./__federation_fn_import-CJZmLbkm.js";
import { I as Info, s as string, D as DECIMAL_FORMAT_REGEX, o as object, d as custom, c as boolean, b as array, h as date, i as unknown, n as number, C as ConfirmDialog, g as useWatch, u as useForm, a, l as literal, j as useFormState, e as Controller, f as createDecimalChangeHandler } from "./schemas-Cabw2nNb.js";
import { a as useDefaultCompany, q as queryClient } from "./queryClient-D9cjqx6i.js";
import { b as devWarn, d as devError, a as devLog } from "./index-BZGB3DCm.js";
import { _ as __vitePreload } from "./preload-helper-e_IRvegh.js";
import { i as isHttpApiError, g as getHttpErrorMessage, T as TOOLTIP_DELAY_QUICK, a as TOOLTIP_DELAY_TRUNCATED_TEXT } from "./http-errors-B33aXf1a.js";
import { P as Plus } from "./plus-BBQZm1PS.js";
import { E as ExpenseFormStatus } from "./expense-data-Du2WjKhi.js";
import { R as RefreshCw } from "./refresh-cw-CFI4x4gx.js";
...
const PreviewReceiptSection = ({ receipt, stretchToFill = false }) => {
  ...
  const renderLoading = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center h-64 bg-exp-neutral-30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bn, { className: "size-10" }) });
...
const loadFileTypeModule = async () => {
  if (!fileTypeModule) {
    fileTypeModule = await __vitePreload(() => import("./core-h6I_NSVU.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
  }
