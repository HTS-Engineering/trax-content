...
(function() {
  ...
  const FILE_NAME = 'expensesMfeStageLoader.js';
  ...
  "commit": "b20fd13",
  "branch": "dev",
  "timestamp": "2026-06-22T14:34:22.418Z",
  "environment": "expenses-mfe-stage",
  "bootstrap": "__federation_expose_Mount-rdw53JNO.js",
  "css": "style-BmbTngFv.css"
};
  ...
  async function loadManifest(basePath) {
    ...
    const possibleManifestPaths = [
      `${basePath}/expenses-mfe-stage/mfe-manifest.json`,
  ...
  async function loadMFE() {
    try {
      ...
      const getAssetUrl = (filename) => `${basePath}/expenses-mfe-stage/assets/${filename}`;
