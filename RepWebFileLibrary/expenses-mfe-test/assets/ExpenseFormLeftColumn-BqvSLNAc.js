...
import { s as string, o as object, b as boolean, f as custom, a as array, g as date, u as unknown, n as number, l as literal, c as useForm, d as a, e as useWatch, C as Controller, h as useFormState } from "./zod-BOBWyz_O.js";
import { importShared } from "./__federation_fn_import-DYyjX-5O.js";
import { j as jsxRuntimeExports } from "./jsx-runtime-TULtkvNU.js";
import { W as fs, Z as ps, $ as hs, a0 as vs, a1 as bs, a2 as xs, P as Pe, _ as _n, i as is, V as Pa, D as Da, L as Ls, l as ls, Y as Yn, s as ss, b as cs, a5 as Dt, a6 as ka, H as Ha, N as Nn, F as Fn, I as In, a7 as Vs, a8 as ks, a9 as Ts, aa as qn } from "./index.es-CUiG0ZaM.js";
import { d as devError, c as useDebouncedCallback, b as devWarn, a as devLog } from "./use-debounced-callback-DEP13P8i.js";
...
import { c as create, d as devtools, a as apiClient } from "./axiosInstance-C1LM7jUN.js";
import { P as Plus } from "./plus-DmuDo9Sy.js";
import { u as useCompanyStore } from "./query-keys-vUS6fvLP.js";
...
const { useCallback: useCallback$j, useEffect: useEffect$f, useRef: useRef$c, useState: useState$6 } = await importShared("react");
...
const { useCallback: useCallback$i, useEffect: useEffect$e, useMemo: useMemo$g, useRef: useRef$b } = await importShared("react");
...
const { useCallback: useCallback$f, useEffect: useEffect$d, useRef: useRef$a } = await importShared("react");
...
const { useCallback: useCallback$e, useEffect: useEffect$c, useMemo: useMemo$d } = await importShared("react");
const useEqualSplit = ({
  allocations,
  isEqualSplit,
  setValue,
...
const { useEffect: useEffect$b, useRef: useRef$9 } = await importShared("react");
...
const { useCallback: useCallback$c, useEffect: useEffect$a, useMemo: useMemo$b, useRef: useRef$8 } = await importShared("react");
...
const { useCallback: useCallback$a, useImperativeHandle, useRef: useRef$7, useEffect: useEffect$9 } = await importShared("react");
...
const { useEffect: useEffect$8, useRef: useRef$6 } = await importShared("react");
...
const { useEffect: useEffect$6, useMemo: useMemo$8 } = await importShared("react");
...
const ReceiptUpload = ({
  ...
  const handleFileUploadInternal = useCallback$4(async (file, targetExpenseId) => {
    ...
    if (!effectiveExpenseId || !(selectedCompany == null ? void 0 : selectedCompany.shortName)) {
      ...
      Ls.error(errorMsg, { duration: 4e3 });
  ...
  if (section.hideHeader) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConditionalSection,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-section-id": section.id, children: /* @__PURE__ */ jsxRuntimeExports.jsx(is, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(cs, { children: section.render(finalProps) }) }) }, section.id)
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ConditionalSection,
    {
      ...
      behavior,
      onDisabledChange: handleDisabledChange,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-section-id": section.id, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(is, { className: hideCardGap, children: [
        "    ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ls, { className: hideCardGap, children: headerActionsNode ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Yn,
            {
              title: section.title,
...
function FileName({ name, showTooltip = true }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Nn, { open: canShowTooltip && isOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Fn, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        ref,
...
function SupportingFileCard({
  ...
  if (isUploading || isLoadingPreview) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(is, { className: "bg-white px-2 py-2 w-full flex justify-between flex-row items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0 flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(_n, { className: "size-4 shrink-0" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(is, { className: "bg-white hover:bg-trax-neutral-20 px-2 py-2 w-full flex justify-between flex-row items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
...
function SupportingFiles({
  ...
  const handleFileChange = useCallback$1(async (e) => {
    ...
    if (!onSaveDraftForUpload) {
      Ls.error("Cannot upload files: please save the expense first", {
        duration: 3e3
      });
      return;
    }
    ...
    try {
      ...
      Ls.error("Failed to save expense. Please try again.", {
        duration: 3e3
      });
    }
  ...
  const handlePreviewClick = useCallback$1(async (file) => {
    ...
    if (!blobUrl && ((_a = file.url) == null ? void 0 : _a.startsWith("/api/"))) {
      ...
      try {
        ...
        const isCanceled = error instanceof Error && (error.name === "AbortError" || error.name === "CanceledError");
        if (isCanceled) return;
        Ls.error("Failed to download file. Please try again.", { duration: 3e3 });
        return;
      } finally {
        previewAbortControllersRef.current.delete(file.id);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(ls, { className: `flex items-center flex-col w-full h-fit overflow-clip ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row w-full items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center w-full ml-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Nn, { delayDuration: TOOLTIP_DELAY_QUICK, children: [
      ...
      ) : !hideAddButtonWhenFull ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Nn, { delayDuration: TOOLTIP_DELAY_QUICK, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(is, { className: `bg-white w-full p-0 ${state.attachments.length === 0 && !state.isUploading && pendingSupportingFiles.length === 0 ? "h-0" : "h-auto"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col my-1 mx-2 gap-1", children: [
      ...
      (isSavingDraft || isUploading) && pendingSupportingFiles.map((file, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(is, { className: "bg-white px-2 py-2 w-full flex justify-between flex-row items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
