...
const { useState: hn, useEffect: xn, useRef: nr } = y;
const br = await importShared("react-dom");
const wr = "trax-ui-component";
function p(...e) {
  return twMerge(clsx(e));
}
function he(...e) {
  return twMerge(clsx(wr, e));
}
const Tt = cva(
...
), Te = x.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Root$9,
  {
    ref: t,
    className: p(yr(), e),
...
Te.displayName = Root$9.displayName;
...
function bs({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sr, { "data-slot": "dialog-portal", children: [
...
const wt = Root2$1, yt = Value, rt = x.forwardRef(({ className: e, children: n, iconClassName: t, ...r2 }, o) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Trigger$2,
  {
    ref: o,
    className: p(
...
rt.displayName = Trigger$2.displayName;
const Fn = x.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  ScrollUpButton,
  {
    ref: t,
    className: p(
...
Fn.displayName = ScrollUpButton.displayName;
const In = x.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  ScrollDownButton,
  {
    ref: t,
    className: p(
...
In.displayName = ScrollDownButton.displayName;
const ot = x.forwardRef(({ className: e, children: n, position: t = "popper", viewportClassName: r2, widthMode: o = "trigger", ...a }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$2, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Content2$2,
  {
    ref: i,
    className: he(
    ...
    ...a,
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Fn, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Viewport,
        {
          className: p(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(In, {})
    ]
  }
) }));
ot.displayName = Content2$2.displayName;
const Ir = x.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Label,
  {
    ref: t,
...
Ir.displayName = Label.displayName;
const at = x.forwardRef(({ className: e, children: n, showCheckIcon: t = true, ...r2 }, o) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Item,
  {
    ref: o,
    className: p(
...
at.displayName = Item.displayName;
const Dr = x.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Separator,
  {
    ref: t,
...
Dr.displayName = Separator.displayName;
function Er({
  ...e
}) {
...
function kr({
  ...
  const o = getDefaultClassNames(), a = x.useRef(null);
  return x.useEffect(() => {
    var _a2;
...
const Ut = x.forwardRef(({ className: e, indicatorClassName: n, value: t, minWidthOnZero: r2 = false, ...o }, a) => {
  const i = Math.min(Math.max(t || 0, 0), 100), u = () => r2 ? i === 0 ? { width: "14px" } : { width: `${i}%` } : { transform: `translateX(-${100 - i}%)` };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Root$3,
    {
      ref: a,
...
Ut.displayName = Root$3.displayName;
...
), zt = x.forwardRef(({ className: e, variant: n, ...t }, r2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Root$2,
  {
    ref: r2,
    "data-slot": "selection-chip",
    className: p(Tr({ variant: n }), e),
    ...t
  }
));
zt.displayName = "SelectionChip";
function Lr({
  ...e
}) {
...
function Mn({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ar, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Root3, { "data-slot": "tooltip", ...e }) });
}
function Pn({
  ...e
}) {
...
function Vn({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Portal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Content2,
    {
      ...
      sideOffset: o ? -4 : n,
      className: he(
        Br({ variant: i, size: u, className: e }),
        `origin-(--radix-popover-content-transform-origin) animate-slide-out-from-${r2 ? "none" : d.side}`
      ),
      ...d,
      children: [
        t,
        o && /* @__PURE__ */ jsxRuntimeExports.jsx(Arrow2, { className: he(
...
}, qr = Array(12).fill(0), Yr = ({ visible: e, className: n }) => /* @__PURE__ */ y.createElement("div", {
  className: [
...
}, qr.map((t, r2) => /* @__PURE__ */ y.createElement("div", {
  className: "sonner-loading-bar",
  key: `spinner-bar-${r2}`
})))), Kr = /* @__PURE__ */ y.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 20 20",
  fill: "currentColor",
  height: "20",
...
class eo {
  constructor() {
    this.subscribe = (n) => (this.subscribers.push(n), () => {
      ...
      var t;
      const { message: r2, ...o } = n, a = typeof (n == null ? void 0 : n.id) == "number" || ((t = n.id) == null ? void 0 : t.length) > 0 ? n.id : Lt++, i = this.toasts.find((d) => d.id === a), u = n.dismissible === void 0 ? true : n.dismissible;
      ...
      const r2 = (t == null ? void 0 : t.id) || Lt++;
      return this.create({
        jsx: n(r2),
        id: r2,
        ...t
...
const ge = new eo(), to = (e, n) => {
  const t = (n == null ? void 0 : n.id) || Lt++;
  return ge.addToast({
    title: e,
    ...n,
    id: t
  }), t;
}, no = (e) => e && typeof e == "object" && "ok" in e && typeof e.ok == "boolean" && "status" in e && typeof e.status == "number", ro = to, oo = () => ge.toasts, ao = () => ge.getActiveToasts(), ct = Object.assign(ro, {
  success: ge.success,
  info: ge.info,
  warning: ge.warning,
  error: ge.error,
...
const po = (e) => {
  ...
  const { invert: f, toast: l, unstyled: m, interacting: g, setHeights: h, visibleToasts: v, heights: C, index: b, toasts: _, expanded: N, removeToast: z, defaultRichColors: E, closeButton: F, style: T, cancelButtonStyle: H, actionButtonStyle: A, className: O = "", descriptionClassName: ee = "", duration: Z, position: J, gap: fe, expandByDefault: re2, classNames: S, icons: V, closeButtonAriaLabel: $ = "Close toast" } = e, [te, Q] = y.useState(null), [ye, ie] = y.useState(null), [M, L] = y.useState(false), [B, j] = y.useState(false), [ve, G] = y.useState(false), [oe, be] = y.useState(false), [Se, W] = y.useState(false), [Y, le] = y.useState(0), [Ae, ne] = y.useState(0), ue = y.useRef(l.duration || Z || nn), me = y.useRef(null), pe = y.useRef(null), Ce = b === 0, Be = b + 1 <= v, ae = l.type, Fe = l.dismissible !== false, Ke = l.className || "", Me = l.descriptionClassName || "", Pe = y.useMemo(() => C.findIndex((k) => k.toastId === l.id) || 0, [
    C,
    l.id
  ]), st = y.useMemo(() => {
    var k;
    return (k = l.closeButton) != null ? k : F;
  }, [
    l.closeButton,
    F
  ]), Xe = y.useMemo(() => l.duration || Z || nn, [
    l.duration,
    Z
  ]), Ge = y.useRef(0), Ie = y.useRef(0), je = y.useRef(0), ze = y.useRef(null), [Ct, it] = J.split("-"), Ze = y.useMemo(() => C.reduce((k, R, P) => P >= Pe ? k : k + R.height, 0), [
    C,
    Pe
  ]), lt = Qr(), Rt = l.invert || f, Ue = ae === "loading";
  Ie.current = y.useMemo(() => Pe * fe + Ze, [
    Pe,
    Ze
  ]), y.useEffect(() => {
    ue.current = Xe;
    ...
    const k = pe.current;
    if (k) {
      const R = k.getBoundingClientRect().height;
      return ne(R), h((P) => [
        {
          toastId: l.id,
          height: R,
    ...
    if (!M) return;
    const k = pe.current, R = k.style.height;
    k.style.height = "auto";
    const P = k.getBoundingClientRect().height;
    k.style.height = R, ne(P), h((U) => U.find((q) => q.toastId === l.id) ? U.map((q) => q.toastId === l.id ? {
      ...q,
      height: P
    } : q) : [
      {
  ...
  const De = y.useCallback(() => {
    j(true), le(Ie.current), h((k) => k.filter((R) => R.toastId !== l.id)), setTimeout(() => {
      z(l);
    }, fo);
  }, [
    l,
  ...
  y.useEffect(() => {
    if (l.promise && ae === "loading" || l.duration === 1 / 0 || l.type === "loading") return;
    let k;
    return N || g || lt ? (() => {
      if (je.current < Ge.current) {
        const U = (/* @__PURE__ */ new Date()).getTime() - Ge.current;
        ue.current = ue.current - U;
      }
      je.current = (/* @__PURE__ */ new Date()).getTime();
    })() : ue.current !== 1 / 0 && (Ge.current = (/* @__PURE__ */ new Date()).getTime(), k = setTimeout(() => {
      l.onAutoClose == null || l.onAutoClose.call(l, l), De();
    }, ue.current)), () => clearTimeout(k);
  }, [
    N,
    g,
    l,
  ...
  function Nt() {
    var k;
    if (V == null ? void 0 : V.loading) {
      var R;
      return /* @__PURE__ */ y.createElement("div", {
        className: Ee(S == null ? void 0 : S.loader, l == null || (R = l.classNames) == null ? void 0 : R.loader, "sonner-loader"),
        "data-visible": ae === "loading"
      }, V.loading);
    }
    return /* @__PURE__ */ y.createElement(Yr, {
      className: Ee(S == null ? void 0 : S.loader, l == null || (k = l.classNames) == null ? void 0 : k.loader),
      visible: ae === "loading"
    });
  }
  const Je = l.icon || (V == null ? void 0 : V[ae]) || Ur(ae);
  var Le, Qe;
  return /* @__PURE__ */ y.createElement("li", {
    tabIndex: 0,
    ref: pe,
    className: Ee(O, Ke, S == null ? void 0 : S.toast, l == null || (n = l.classNames) == null ? void 0 : n.toast, S == null ? void 0 : S.default, S == null ? void 0 : S[ae], l == null || (t = l.classNames) == null ? void 0 : t[ae]),
    "data-sonner-toast": "",
    "data-rich-colors": (Le = l.richColors) != null ? Le : E,
    ...
    "data-expanded": !!(N || re2 && M),
    "data-testid": l.testId,
    style: {
      "--index": b,
      "--toasts-before": b,
      "--z-index": _.length - b,
      "--offset": `${B ? Y : Ie.current}px`,
      "--initial-height": re2 ? "auto" : `${Ae}px`,
      ...T,
      ...l.style
    },
    onDragEnd: () => {
      G(false), Q(null), ze.current = null;
    },
    onPointerDown: (k) => {
      k.button !== 2 && (Ue || !Fe || (me.current = /* @__PURE__ */ new Date(), le(Ie.current), k.target.setPointerCapture(k.pointerId), k.target.tagName !== "BUTTON" && (G(true), ze.current = {
        x: k.clientX,
        y: k.clientY
      })));
    },
    onPointerUp: () => {
      ...
      if (oe || !Fe) return;
      ze.current = null;
      const U = Number(((k = pe.current) == null ? void 0 : k.style.getPropertyValue("--swipe-amount-x").replace("px", "")) || 0), we = Number(((R = pe.current) == null ? void 0 : R.style.getPropertyValue("--swipe-amount-y").replace("px", "")) || 0), q = (/* @__PURE__ */ new Date()).getTime() - ((P = me.current) == null ? void 0 : P.getTime()), ce = te === "x" ? U : we, dt = Math.abs(ce) / q;
      if (Math.abs(ce) >= go || dt > 0.11) {
        le(Ie.current), l.onDismiss == null || l.onDismiss.call(l, l), ie(te === "x" ? U > 0 ? "right" : "left" : we > 0 ? "down" : "up"), De(), be(true);
        return;
      } else {
        var Re, Ne;
        (Re = pe.current) == null || Re.style.setProperty("--swipe-amount-x", "0px"), (Ne = pe.current) == null || Ne.style.setProperty("--swipe-amount-y", "0px");
      }
      W(false), G(false), Q(null);
    },
    onPointerMove: (k) => {
      var R, P, U;
      if (!ze.current || !Fe || ((R = window.getSelection()) == null ? void 0 : R.toString().length) > 0) return;
      const q = k.clientY - ze.current.y, ce = k.clientX - ze.current.x;
      var dt;
      const Re = (dt = e.swipeDirections) != null ? dt : mo(J);
      !te && (Math.abs(ce) > 1 || Math.abs(q) > 1) && Q(Math.abs(ce) > Math.abs(q) ? "x" : "y");
      let Ne = {
        x: 0,
        y: 0
      };
      const Zt = (qe) => 1 / (1.5 + Math.abs(qe) / 20);
      if (te === "y") {
        if (Re.includes("top") || Re.includes("bottom"))
          if (Re.includes("top") && q < 0 || Re.includes("bottom") && q > 0)
            Ne.y = q;
          else {
            const qe = q * Zt(q);
            Ne.y = Math.abs(qe) < Math.abs(q) ? qe : q;
          }
      } else if (te === "x" && (Re.includes("left") || Re.includes("right")))
        if (Re.includes("left") && ce < 0 || Re.includes("right") && ce > 0)
          Ne.x = ce;
        else {
          const qe = ce * Zt(ce);
          Ne.x = Math.abs(qe) < Math.abs(ce) ? qe : ce;
        }
      (Math.abs(Ne.x) > 0 || Math.abs(Ne.y) > 0) && W(true), (P = pe.current) == null || P.style.setProperty("--swipe-amount-x", `${Ne.x}px`), (U = pe.current) == null || U.style.setProperty("--swipe-amount-y", `${Ne.y}px`);
    }
  }, st && !l.jsx && ae !== "loading" ? /* @__PURE__ */ y.createElement("button", {
    "aria-label": $,
    "data-disabled": Ue,
    ...
    className: Ee(S == null ? void 0 : S.closeButton, l == null || (r2 = l.classNames) == null ? void 0 : r2.closeButton)
  }, (Qe = V == null ? void 0 : V.close) != null ? Qe : Jr) : null, (ae || l.icon || l.promise) && l.icon !== null && ((V == null ? void 0 : V[ae]) !== null || l.icon) ? /* @__PURE__ */ y.createElement("div", {
    "data-icon": "",
    className: Ee(S == null ? void 0 : S.icon, l == null || (o = l.classNames) == null ? void 0 : o.icon)
  }, l.promise || l.type === "loading" && !l.icon ? l.icon || Nt() : null, l.type !== "loading" ? Je : null) : null, /* @__PURE__ */ y.createElement("div", {
    "data-content": "",
    className: Ee(S == null ? void 0 : S.content, l == null || (a = l.classNames) == null ? void 0 : a.content)
  }, /* @__PURE__ */ y.createElement("div", {
    "data-title": "",
    className: Ee(S == null ? void 0 : S.title, l == null || (i = l.classNames) == null ? void 0 : i.title)
  }, l.jsx ? l.jsx : typeof l.title == "function" ? l.title() : l.title), l.description ? /* @__PURE__ */ y.createElement("div", {
    "data-description": "",
    className: Ee(ee, Me, S == null ? void 0 : S.description, l == null || (u = l.classNames) == null ? void 0 : u.description)
  }, typeof l.description == "function" ? l.description() : l.description) : null), /* @__PURE__ */ y.isValidElement(l.cancel) ? l.cancel : l.cancel && gt(l.cancel) ? /* @__PURE__ */ y.createElement("button", {
    "data-button": true,
    "data-cancel": true,
    style: l.cancelButtonStyle || H,
    onClick: (k) => {
      gt(l.cancel) && Fe && (l.cancel.onClick == null || l.cancel.onClick.call(l.cancel, k), De());
    },
    className: Ee(S == null ? void 0 : S.cancelButton, l == null || (d = l.classNames) == null ? void 0 : d.cancelButton)
  }, l.cancel.label) : null, /* @__PURE__ */ y.isValidElement(l.action) ? l.action : l.action && gt(l.action) ? /* @__PURE__ */ y.createElement("button", {
    "data-button": true,
    "data-action": true,
    style: l.actionButtonStyle || A,
    onClick: (k) => {
      gt(l.action) && (l.action.onClick == null || l.action.onClick.call(l.action, k), !k.defaultPrevented && De());
    },
    className: Ee(S == null ? void 0 : S.actionButton, l == null || (c = l.classNames) == null ? void 0 : c.actionButton)
  }, l.action.label) : null);
};
function rn() {
...
function ho(e, n) {
  ...
  return [
    ...
    const a = o === 1, i = a ? "--mobile-offset" : "--offset", u = a ? lo : io;
    function d(c) {
      [
        "top",
        "right",
...
const xo = /* @__PURE__ */ y.forwardRef(function(n, t) {
  const { id: r2, invert: o, position: a = "bottom-right", hotkey: i = [
    "altKey",
    "KeyT"
  ], expand: u, closeButton: d, className: c, offset: f, mobileOffset: l, theme: m = "light", richColors: g, duration: h, style: v, visibleToasts: C = so, toastOptions: b, dir: _ = rn(), gap: N = co, icons: z, containerAriaLabel: E = "Notifications" } = n, [F, T] = y.useState([]), H = y.useMemo(() => r2 ? F.filter((M) => M.toasterId === r2) : F.filter((M) => !M.toasterId), [
    F,
    r2
  ]), A = y.useMemo(() => Array.from(new Set([
    a
  ].concat(H.filter((M) => M.position).map((M) => M.position)))), [
    H,
    a
  ]), [O, ee] = y.useState([]), [Z, J] = y.useState(false), [fe, re2] = y.useState(false), [S, V] = y.useState(m !== "system" ? m : typeof window < "u" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), $ = y.useRef(null), te = i.join("+").replace(/Key/g, "").replace(/Digit/g, ""), Q = y.useRef(null), ye = y.useRef(false), ie = y.useCallback((M) => {
    T((L) => {
      var B;
      return (B = L.find((j) => j.id === M.id)) != null && B.delete || ge.dismiss(M.id), L.filter(({ id: j }) => j !== M.id);
    });
  }, []);
  return y.useEffect(() => ge.subscribe((M) => {
    if (M.dismiss) {
      requestAnimationFrame(() => {
        T((L) => L.map((B) => B.id === M.id ? {
          ...B,
          delete: true
        } : B));
      });
    ...
    setTimeout(() => {
      br.flushSync(() => {
        T((L) => {
          const B = L.findIndex((j) => j.id === M.id);
          return B !== -1 ? [
            ...L.slice(0, B),
            {
              ...L[B],
    ...
    if (m === "system" && (window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? V("dark") : V("light")), typeof window > "u") return;
    ...
    const M = (L) => {
      var B;
      if (i.every((G) => L[G] || L.code === G)) {
        var ve;
        J(true), (ve = $.current) == null || ve.focus();
      }
      L.code === "Escape" && (document.activeElement === $.current || (B = $.current) != null && B.contains(document.activeElement)) && J(false);
    };
    ...
    if ($.current)
      return () => {
        Q.current && (Q.current.focus({
          preventScroll: true
        }), Q.current = null, ye.current = false);
      };
  }, [
    $.current
  ...
  /* @__PURE__ */ y.createElement("section", {
    ...
    return H.length ? /* @__PURE__ */ y.createElement("ol", {
      ...
      "data-x-position": ve,
      style: {
        "--front-toast-height": `${((B = O[0]) == null ? void 0 : B.height) || 0}px`,
        "--width": `${uo}px`,
        "--gap": `${N}px`,
        ...v,
        ...ho(f, l)
      ...
      onBlur: (G) => {
        ye.current && !G.currentTarget.contains(G.relatedTarget) && (ye.current = false, Q.current && (Q.current.focus({
          preventScroll: true
        }), Q.current = null));
      },
      onFocus: (G) => {
        G.target instanceof HTMLElement && G.target.dataset.dismissible === "false" || ye.current || (ye.current = true, Q.current = G.relatedTarget);
      },
      onMouseEnter: () => J(true),
      onMouseMove: () => J(true),
      onMouseLeave: () => {
      ...
      onDragEnd: () => J(false),
      onPointerDown: (G) => {
        G.target instanceof HTMLElement && G.target.dataset.dismissible === "false" || re2(true);
      },
      onPointerUp: () => re2(false)
    }, H.filter((G) => !G.position && L === 0 || G.position === M).map((G, oe) => {
      var be, Se;
      return /* @__PURE__ */ y.createElement(po, {
        key: G.id,
        icons: z,
        index: oe,
        toast: G,
        defaultRichColors: g,
        duration: (be = b == null ? void 0 : b.duration) != null ? be : h,
        className: b == null ? void 0 : b.className,
        descriptionClassName: b == null ? void 0 : b.descriptionClassName,
        invert: o,
        visibleToasts: C,
        closeButton: (Se = b == null ? void 0 : b.closeButton) != null ? Se : d,
        interacting: fe,
        position: M,
        ...
        removeToast: ie,
        toasts: H.filter((W) => W.position == G.position),
        heights: O.filter((W) => W.position == G.position),
        setHeights: ee,
        expandByDefault: u,
        gap: N,
        expanded: Z,
...
var $n = {
  ...
  style: void 0,
  attr: void 0
}, on = y.createContext && /* @__PURE__ */ y.createContext($n), vo = ["attr", "size", "title"];
function bo(e, n) {
  if (e == null) return {};
  var t = wo(e, n), r2, o;
...
function xt(e) {
  for (var n = 1; n < arguments.length; n++) {
    ...
    n % 2 ? an(Object(t), true).forEach(function(r2) {
      yo(e, r2, t[r2]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : an(Object(t)).forEach(function(r2) {
...
function yo(e, n, t) {
  return n = So(n), n in e ? Object.defineProperty(e, n, { value: t, enumerable: true, configurable: true, writable: true }) : e[n] = t, e;
}
function So(e) {
  var n = Co(e, "string");
...
function kn(e) {
  return e && e.map((n, t) => /* @__PURE__ */ y.createElement(n.tag, xt({
    key: t
  }, n.attr), kn(n.child)));
}
function qt(e) {
  return (n) => /* @__PURE__ */ y.createElement(Ro, ht({
    attr: xt({}, e.attr)
  }, n), kn(e.child));
}
function Ro(e) {
  var n = (t) => {
    var {
      ...
      size: o,
      title: a
    } = e, i = bo(e, vo), u = o || t.size || "1em", d;
    return t.className && (d = t.className), e.className && (d = (d ? d + " " : "") + e.className), /* @__PURE__ */ y.createElement("svg", ht({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, t.attr, r2, i, {
  ...
  return on !== void 0 ? /* @__PURE__ */ y.createElement(on.Consumer, null, (t) => n(t)) : n($n);
}
function No(e) {
  return qt({ attr: { viewBox: "0 0 24 24", fill: "currentColor" }, child: [{ tag: "path", attr: { d: "M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM11 15V17H13V15H11ZM11 7V13H13V7H11Z" }, child: [] }] })(e);
}
function _o(e) {
  return qt({ attr: { viewBox: "0 0 512 512" }, child: [{ tag: "path", attr: { d: "M256 48C141.1 48 48 141.1 48 256s93.1 208 208 208 208-93.1 208-208S370.9 48 256 48zm106.5 150.5L228.8 332.8h-.1c-1.7 1.7-6.3 5.5-11.6 5.5-3.8 0-8.1-2.1-11.7-5.7l-56-56c-1.6-1.6-1.6-4.1 0-5.7l17.8-17.8c.8-.8 1.8-1.2 2.8-1.2 1 0 2 .4 2.8 1.2l44.4 44.4 122-122.9c.8-.8 1.8-1.2 2.8-1.2 1.1 0 2.1.4 2.8 1.2l17.5 18.1c1.8 1.7 1.8 4.2.2 5.8z" }, child: [] }] })(e);
}
const As = ({ ...e }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  xo,
  {
  ...
  success: (e, n = {}) => {
    ct.custom((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: he(
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(_o, { className: "h-5 w-5 text-trax-green-500" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: (r2) => {
                r2.stopPropagation(), ct.dismiss(t);
              },
      ...
      duration: n.duration || sn.duration
    });
  },
  error: (e, n = {}) => {
    ct.custom((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(No, { className: "h-5 w-5 text-trax-red-500" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: (r2) => {
                r2.stopPropagation(), r2.preventDefault(), ct.dismiss(t);
              },
...
function I(e, n, t) {
  ...
  return (a) => {
    ...
    if (t.key && t.debug && (c = Date.now()), o = n(...u), t == null || t.onChange == null || t.onChange(o), t.key && t.debug && t != null && t.debug()) {
      const f = Math.round((Date.now() - i) * 100) / 100, l = Math.round((Date.now() - c) * 100) / 100, m = l / 16, g = (h, v) => {
...
const $o = {
  createTable: (e) => {
    e.getHeaderGroups = I(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.left, e.getState().columnPinning.right], (n, t, r2, o) => {
      var a, i;
      const u = (a = r2 == null ? void 0 : r2.map((l) => t.find((m) => m.id === l)).filter(Boolean)) != null ? a : [], d = (i = o == null ? void 0 : o.map((l) => t.find((m) => m.id === l)).filter(Boolean)) != null ? i : [], c = t.filter((l) => !(r2 != null && r2.includes(l.id)) && !(o != null && o.includes(l.id)));
      return ft(n, [...u, ...c, ...d], e);
    }, D(e.options, de)), e.getCenterHeaderGroups = I(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.left, e.getState().columnPinning.right], (n, t, r2, o) => (t = t.filter((a) => !(r2 != null && r2.includes(a.id)) && !(o != null && o.includes(a.id))), ft(n, t, e, "center")), D(e.options, de)), e.getLeftHeaderGroups = I(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.left], (n, t, r2) => {
      var o;
      const a = (o = r2 == null ? void 0 : r2.map((i) => t.find((u) => u.id === i)).filter(Boolean)) != null ? o : [];
      return ft(n, a, e, "left");
    }, D(e.options, de)), e.getRightHeaderGroups = I(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.right], (n, t, r2) => {
      var o;
      const a = (o = r2 == null ? void 0 : r2.map((i) => t.find((u) => u.id === i)).filter(Boolean)) != null ? o : [];
      return ft(n, a, e, "right");
    }, D(e.options, de)), e.getFooterGroups = I(() => [e.getHeaderGroups()], (n) => [...n].reverse(), D(e.options, de)), e.getLeftFooterGroups = I(() => [e.getLeftHeaderGroups()], (n) => [...n].reverse(), D(e.options, de)), e.getCenterFooterGroups = I(() => [e.getCenterHeaderGroups()], (n) => [...n].reverse(), D(e.options, de)), e.getRightFooterGroups = I(() => [e.getRightHeaderGroups()], (n) => [...n].reverse(), D(e.options, de)), e.getFlatHeaders = I(() => [e.getHeaderGroups()], (n) => n.map((t) => t.headers).flat(), D(e.options, de)), e.getLeftFlatHeaders = I(() => [e.getLeftHeaderGroups()], (n) => n.map((t) => t.headers).flat(), D(e.options, de)), e.getCenterFlatHeaders = I(() => [e.getCenterHeaderGroups()], (n) => n.map((t) => t.headers).flat(), D(e.options, de)), e.getRightFlatHeaders = I(() => [e.getRightHeaderGroups()], (n) => n.map((t) => t.headers).flat(), D(e.options, de)), e.getCenterLeafHeaders = I(() => [e.getCenterFlatHeaders()], (n) => n.filter((t) => {
      var r2;
      return !((r2 = t.subHeaders) != null && r2.length);
    }), D(e.options, de)), e.getLeftLeafHeaders = I(() => [e.getLeftFlatHeaders()], (n) => n.filter((t) => {
      var r2;
      return !((r2 = t.subHeaders) != null && r2.length);
    }), D(e.options, de)), e.getRightLeafHeaders = I(() => [e.getRightFlatHeaders()], (n) => n.filter((t) => {
      var r2;
      return !((r2 = t.subHeaders) != null && r2.length);
    }), D(e.options, de)), e.getLeafHeaders = I(() => [e.getLeftHeaderGroups(), e.getCenterHeaderGroups(), e.getRightHeaderGroups()], (n, t, r2) => {
      var o, a, i, u, d, c;
...
function ft(e, n, t, r2) {
  var o, a;
  let i = 0;
  const u = function(m, g) {
    g === void 0 && (g = 1), i = Math.max(i, g), m.filter((h) => h.getIsVisible()).forEach((h) => {
      var v;
      (v = h.columns) != null && v.length && u(h.columns, g + 1);
    }, 0);
  };
  u(e);
  let d = [];
  const c = (m, g) => {
    ...
    m.forEach((C) => {
      const b = [...v].reverse()[0], _ = C.column.depth === h.depth;
      let N, z = false;
      if (_ && C.column.parent ? N = C.column.parent : (N = C.column, z = true), b && (b == null ? void 0 : b.column) === N)
        b.subHeaders.push(C);
      else {
        const E = un(t, N, {
          id: [r2, g, N.id, C == null ? void 0 : C.id].filter(Boolean).join("_"),
          isPlaceholder: z,
          placeholderId: z ? `${v.filter((F) => F.column === N).length}` : void 0,
          depth: g,
          index: v.length
        });
  ...
  const l = (m) => m.filter((h) => h.column.getIsVisible()).map((h) => {
    let v = 0, C = 0, b = [0];
    h.subHeaders && h.subHeaders.length ? (b = [], l(h.subHeaders).forEach((N) => {
      let {
        colSpan: z,
        rowSpan: E
      } = N;
    ...
    const _ = Math.min(...b);
    return C = C + _, h.colSpan = v, h.rowSpan = C, {
      colSpan: v,
      rowSpan: C
    };
  });
...
const Yt = (e, n, t, r2, o, a, i) => {
  let u = {
    ...
    subRows: [],
    getLeafRows: () => Mo(u.subRows, (d) => d.subRows),
    ...
    getAllCells: I(() => [e.getAllLeafColumns()], (d) => d.map((c) => Po(e, u, c, c.id)), D(e.options, "debugRows")),
    _getAllCellsByColumnId: I(() => [u.getAllCells()], (d) => d.reduce((c, f) => (c[f.column.id] = f, c), {}), D(e.options, "debugRows"))
  };
...
Tn.autoRemove = (e) => _e(e);
const zn = (e, n, t) => {
  var r2;
  return !!(!((r2 = e.getValue(n)) == null || (r2 = r2.toString()) == null) && r2.includes(t));
};
zn.autoRemove = (e) => _e(e);
const Ln = (e, n, t) => {
  var r2;
  return ((r2 = e.getValue(n)) == null || (r2 = r2.toString()) == null ? void 0 : r2.toLowerCase()) === (t == null ? void 0 : t.toLowerCase());
};
Ln.autoRemove = (e) => _e(e);
const Hn = (e, n, t) => {
  var r2;
  return (r2 = e.getValue(n)) == null ? void 0 : r2.includes(t);
};
Hn.autoRemove = (e) => _e(e);
const On = (e, n, t) => !t.some((r2) => {
  var o;
  return !((o = e.getValue(n)) != null && o.includes(r2));
});
On.autoRemove = (e) => _e(e) || !(e != null && e.length);
const An = (e, n, t) => t.some((r2) => {
  var o;
  return (o = e.getValue(n)) == null ? void 0 : o.includes(r2);
});
An.autoRemove = (e) => _e(e) || !(e != null && e.length);
const Bn = (e, n, t) => e.getValue(n) === t;
Bn.autoRemove = (e) => _e(e);
const Gn = (e, n, t) => e.getValue(n) == t;
Gn.autoRemove = (e) => _e(e);
const Kt = (e, n, t) => {
  let [r2, o] = t;
  const a = e.getValue(n);
  return a >= r2 && a <= o;
};
Kt.resolveFilterValue = (e) => {
...
Kt.autoRemove = (e) => _e(e) || _e(e[0]) && _e(e[1]);
const Ve = {
  includesString: Tn,
...
const To = {
  ...
  createColumn: (e, n) => {
    e.getAutoFilterFn = () => {
      ...
      return typeof r2 == "string" ? Ve.includesString : typeof r2 == "number" ? Ve.inNumberRange : typeof r2 == "boolean" || r2 !== null && typeof r2 == "object" ? Ve.equals : Array.isArray(r2) ? Ve.arrIncludes : Ve.weakEquals;
    }, e.getFilterFn = () => {
      var t, r2;
      return St(e.columnDef.filterFn) ? e.columnDef.filterFn : e.columnDef.filterFn === "auto" ? e.getAutoFilterFn() : (
        // @ts-ignore
        (t = (r2 = n.options.filterFns) == null ? void 0 : r2[e.columnDef.filterFn]) != null ? t : Ve[e.columnDef.filterFn]
      );
    }, e.getCanFilter = () => {
      var t, r2, o;
      ...
      n.setColumnFilters((r2) => {
        const o = e.getFilterFn(), a = r2 == null ? void 0 : r2.find((f) => f.id === e.id), i = He(t, a ? a.value : void 0);
        if (cn(o, i, e)) {
          var u;
  ...
  createTable: (e) => {
    e.setColumnFilters = (n) => {
      const t = e.getAllLeafColumns(), r2 = (o) => {
        var a;
        return (a = He(n, o)) == null ? void 0 : a.filter((i) => {
...
const zo = (e, n, t) => t.reduce((r2, o) => {
...
}, Go = (e, n) => Array.from(new Set(n.map((t) => t.getValue(e))).values()), jo = (e, n) => new Set(n.map((t) => t.getValue(e))).size, Uo = (e, n) => n.length, Ft = {
  sum: zo,
  min: Lo,
  max: Ho,
  extent: Oo,
  ...
  createColumn: (e, n) => {
    e.toggleGrouping = () => {
      ...
      if (!e)
        throw new Error();
      return St(e.columnDef.aggregationFn) ? e.columnDef.aggregationFn : e.columnDef.aggregationFn === "auto" ? e.getAutoAggregationFn() : (t = (r2 = n.options.aggregationFns) == null ? void 0 : r2[e.columnDef.aggregationFn]) != null ? t : Ft[e.columnDef.aggregationFn];
    };
  },
  createTable: (e) => {
...
const Ko = {
  ...
  createColumn: (e, n) => {
    e.getIndex = I((t) => [tt(n, t)], (t) => t.findIndex((r2) => r2.id === e.id), D(n.options, "debugColumns")), e.getIsFirstColumn = (t) => {
      var r2;
      return ((r2 = tt(n, t)[0]) == null ? void 0 : r2.id) === e.id;
    }, e.getIsLastColumn = (t) => {
      var r2;
      const o = tt(n, t);
  ...
  createTable: (e) => {
    ...
    }, e._getOrderColumnsFn = I(() => [e.getState().columnOrder, e.getState().grouping, e.options.groupedColumnMode], (n, t, r2) => (o) => {
      let a = [];
      if (!(n != null && n.length))
        a = o;
      else {
  ...
  createRow: (e, n) => {
    e.getCenterVisibleCells = I(() => [e._getAllVisibleCells(), n.getState().columnPinning.left, n.getState().columnPinning.right], (t, r2, o) => {
      const a = [...r2 ?? [], ...o ?? []];
      return t.filter((i) => !a.includes(i.column.id));
    }, D(n.options, "debugRows")), e.getLeftVisibleCells = I(() => [e._getAllVisibleCells(), n.getState().columnPinning.left], (t, r2) => (r2 ?? []).map((a) => t.find((i) => i.column.id === a)).filter(Boolean).map((a) => ({
      ...a,
      position: "left"
    })), D(n.options, "debugRows")), e.getRightVisibleCells = I(() => [e._getAllVisibleCells(), n.getState().columnPinning.right], (t, r2) => (r2 ?? []).map((a) => t.find((i) => i.column.id === a)).filter(Boolean).map((a) => ({
      ...a,
      position: "right"
    })), D(n.options, "debugRows"));
  },
  createTable: (e) => {
    e.setColumnPinning = (n) => e.options.onColumnPinningChange == null ? void 0 : e.options.onColumnPinningChange(n), e.resetColumnPinning = (n) => {
      var t, r2;
      return e.setColumnPinning(n ? It() : (t = (r2 = e.initialState) == null ? void 0 : r2.columnPinning) != null ? t : It());
...
const mt = {
  ...
  createColumn: (e, n) => {
    e.getSize = () => {
      ...
      return Math.min(Math.max((t = e.columnDef.minSize) != null ? t : mt.minSize, (r2 = a ?? e.columnDef.size) != null ? r2 : mt.size), (o = e.columnDef.maxSize) != null ? o : mt.maxSize);
    }, e.getStart = I((t) => [t, tt(n, t), n.getState().columnSizing], (t, r2) => r2.slice(0, e.getIndex(t)).reduce((o, a) => o + a.getSize(), 0), D(n.options, "debugColumns")), e.getAfter = I((t) => [t, tt(n, t), n.getState().columnSizing], (t, r2) => r2.slice(e.getIndex(t) + 1).reduce((o, a) => o + a.getSize(), 0), D(n.options, "debugColumns")), e.resetSize = () => {
      n.setColumnSizing((t) => {
        let {
          [e.id]: r2,
          ...o
  ...
  createHeader: (e, n) => {
    e.getSize = () => {
      ...
      return (a) => {
        if (!r2 || !o || (a.persist == null || a.persist(), Et(a) && a.touches && a.touches.length > 1))
          return;
        const i = e.getSize(), u = e ? e.getLeafHeaders().map((b) => [b.column.id, b.column.getSize()]) : [[r2.id, r2.getSize()]], d = Et(a) ? Math.round(a.touches[0].clientX) : a.clientX, c = {}, f = (b, _) => {
          typeof _ == "number" && (n.setColumnSizingInfo((N) => {
            var z, E;
            const F = n.options.columnResizeDirection === "rtl" ? -1 : 1, T = (_ - ((z = N == null ? void 0 : N.startOffset) != null ? z : 0)) * F, H = Math.max(T / ((E = N == null ? void 0 : N.startSize) != null ? E : 0), -0.999999);
            return N.columnSizingStart.forEach((A) => {
              let [O, ee] = A;
              c[O] = Math.round(Math.max(ee + ee * H, 0) * 100) / 100;
            }), {
              ...N,
              deltaOffset: T,
              deltaPercentage: H
            };
          }), (n.options.columnResizeMode === "onChange" || b === "end") && n.setColumnSizing((N) => ({
            ...N,
            ...c
          })));
        }, l = (b) => f("move", b), m = (b) => {
          f("end", b), n.setColumnSizingInfo((_) => ({
            ..._,
            isResizingColumn: false,
            startOffset: null,
            startSize: null,
          ...
          upHandler: (b) => {
            g == null ? void 0 : g.removeEventListener("mousemove", h.moveHandler), g == null ? void 0 : g.removeEventListener("mouseup", h.upHandler), m(b.clientX);
          }
        }, v = {
          moveHandler: (b) => (b.cancelable && (b.preventDefault(), b.stopPropagation()), l(b.touches[0].clientX), false),
          upHandler: (b) => {
            var _;
            g == null ? void 0 : g.removeEventListener("touchmove", v.moveHandler), g == null ? void 0 : g.removeEventListener("touchend", v.upHandler), b.cancelable && (b.preventDefault(), b.stopPropagation()), m((_ = b.touches[0]) == null ? void 0 : _.clientX);
          }
        }, C = Jo() ? {
          passive: false
        } : false;
        Et(a) ? (g == null ? void 0 : g.addEventListener("touchmove", v.moveHandler, C), g == null ? void 0 : g.addEventListener("touchend", v.upHandler, C)) : (g == null ? void 0 : g.addEventListener("mousemove", h.moveHandler, C), g == null ? void 0 : g.addEventListener("mouseup", h.upHandler, C)), n.setColumnSizingInfo((b) => ({
          ...b,
          startOffset: d,
          startSize: i,
          deltaOffset: 0,
  ...
  createTable: (e) => {
    e.setColumnSizing = (n) => e.options.onColumnSizingChange == null ? void 0 : e.options.onColumnSizingChange(n), e.setColumnSizingInfo = (n) => e.options.onColumnSizingInfoChange == null ? void 0 : e.options.onColumnSizingInfoChange(n), e.resetColumnSizing = (n) => {
      ...
      var t;
      e.setColumnSizingInfo(n ? Dt() : (t = e.initialState.columnSizingInfo) != null ? t : Dt());
    }, e.getTotalSize = () => {
      var n, t;
...
const Qo = {
  ...
  createRow: (e, n) => {
    e._getAllVisibleCells = I(() => [e.getAllCells(), n.getState().columnVisibility], (t) => t.filter((r2) => r2.column.getIsVisible()), D(n.options, "debugRows")), e.getVisibleCells = I(() => [e.getLeftVisibleCells(), e.getCenterVisibleCells(), e.getRightVisibleCells()], (t, r2, o) => [...t, ...r2, ...o], D(n.options, "debugRows"));
  },
  createTable: (e) => {
    const n = (t, r2) => I(() => [r2(), r2().filter((o) => o.getIsVisible()).map((o) => o.id).join("_")], (o) => o.filter((a) => a.getIsVisible == null ? void 0 : a.getIsVisible()), D(e.options, "debugColumns"));
...
const ea = {
  ...
  createTable: (e) => {
    e.getGlobalAutoFilterFn = () => Ve.includesString, e.getGlobalFilterFn = () => {
      ...
      return St(r2) ? r2 : r2 === "auto" ? e.getGlobalAutoFilterFn() : (n = (t = e.options.filterFns) == null ? void 0 : t[r2]) != null ? n : Ve[r2];
    }, e.setGlobalFilter = (n) => {
  ...
  createTable: (e) => {
    ...
    e._autoResetPageIndex = () => {
      ...
      var o;
      e.setPagination(r2 ? Mt() : (o = e.initialState.pagination) != null ? o : Mt());
    }, e.setPageIndex = (r2) => {
      e.setPagination((o) => {
        let a = He(r2, o.pageIndex);
      ...
      var o, a;
      e.setPageIndex(r2 ? Ht : (o = (a = e.initialState) == null || (a = a.pagination) == null ? void 0 : a.pageIndex) != null ? o : Ht);
    }, e.resetPageSize = (r2) => {
      var o, a;
      e.setPageSize(r2 ? Ot : (o = (a = e.initialState) == null || (a = a.pagination) == null ? void 0 : a.pageSize) != null ? o : Ot);
    }, e.setPageSize = (r2) => {
      e.setPagination((o) => {
        const a = Math.max(1, He(r2, o.pageSize)), i = o.pageSize * o.pageIndex, u = Math.floor(i / a);
        return {
          ...o,
          pageIndex: u,
          pageSize: a
      ...
      var a;
      let i = He(r2, (a = e.options.pageCount) != null ? a : -1);
      return typeof i == "number" && (i = Math.max(-1, i)), {
        ...o,
        pageCount: i
      };
    }), e.getPageOptions = I(() => [e.getPageCount()], (r2) => {
      let o = [];
    ...
    e.pin = (t, r2, o) => {
      ...
      n.setRowPinning((d) => {
        ...
        if (t === "bottom") {
          var l, m;
          return {
            top: ((l = d == null ? void 0 : d.top) != null ? l : []).filter((v) => !(u != null && u.has(v))),
            bottom: [...((m = d == null ? void 0 : d.bottom) != null ? m : []).filter((v) => !(u != null && u.has(v))), ...Array.from(u)]
          };
        }
        if (t === "top") {
          var g, h;
          return {
            top: [...((g = d == null ? void 0 : d.top) != null ? g : []).filter((v) => !(u != null && u.has(v))), ...Array.from(u)],
            bottom: ((h = d == null ? void 0 : d.bottom) != null ? h : []).filter((v) => !(u != null && u.has(v)))
          };
        }
        return {
          top: ((c = d == null ? void 0 : d.top) != null ? c : []).filter((v) => !(u != null && u.has(v))),
          bottom: ((f = d == null ? void 0 : d.bottom) != null ? f : []).filter((v) => !(u != null && u.has(v)))
        };
      });
    }, e.getCanPin = () => {
      var t;
  ...
  createTable: (e) => {
    e.setRowPinning = (n) => e.options.onRowPinningChange == null ? void 0 : e.options.onRowPinningChange(n), e.resetRowPinning = (n) => {
      var t, r2;
      return e.setRowPinning(n ? Pt() : (t = (r2 = e.initialState) == null ? void 0 : r2.rowPinning) != null ? t : Pt());
    ...
    }, e.getTopRows = I(() => [e.getRowModel().rows, e.getState().rowPinning.top], (n, t) => e._getPinnedRows(n, t, "top"), D(e.options, "debugRows")), e.getBottomRows = I(() => [e.getRowModel().rows, e.getState().rowPinning.bottom], (n, t) => e._getPinnedRows(n, t, "bottom"), D(e.options, "debugRows")), e.getCenterRows = I(() => [e.getRowModel().rows, e.getState().rowPinning.top, e.getState().rowPinning.bottom], (n, t, r2) => {
  ...
  createTable: (e) => {
    ...
    }), e.getPreSelectedRowModel = () => e.getCoreRowModel(), e.getSelectedRowModel = I(() => [e.getState().rowSelection, e.getCoreRowModel()], (n, t) => Object.keys(n).length ? Vt(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, D(e.options, "debugTable")), e.getFilteredSelectedRowModel = I(() => [e.getState().rowSelection, e.getFilteredRowModel()], (n, t) => Object.keys(n).length ? Vt(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, D(e.options, "debugTable")), e.getGroupedSelectedRowModel = I(() => [e.getState().rowSelection, e.getSortedRowModel()], (n, t) => Object.keys(n).length ? Vt(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
  ...
  createRow: (e, n) => {
    e.toggleSelected = (t, r2) => {
      ...
      n.setRowSelection((a) => {
        ...
        return At(u, e.id, t, (i = r2 == null ? void 0 : r2.selectChildren) != null ? i : true, n), u;
      });
    }, e.getIsSelected = () => {
      const {
        rowSelection: t
  ...
  t ? (i.getCanMultiSelect() || Object.keys(e).forEach((u) => delete e[u]), i.getCanSelect() && (e[n] = true)) : delete e[n], r2 && (a = i.subRows) != null && a.length && i.getCanSelectSubRows() && i.subRows.forEach((u) => At(e, u.id, t, r2, o));
};
function Vt(e, n) {
...
function Bt(e, n, t) {
  ...
  return e.subRows.forEach((i) => {
    if (!(a && !o) && (i.getCanSelect() && (Wt(i, n) ? a = true : o = false), i.subRows && i.subRows.length)) {
      const u = Bt(i, n);
      u === "all" ? a = true : (u === "some" && (a = true), o = false);
    }
  }), o ? "all" : a ? "some" : false;
}
const Gt = /([0-9]+)/gm, sa = (e, n, t) => jn(Oe(e.getValue(t)).toLowerCase(), Oe(n.getValue(t)).toLowerCase()), ia = (e, n, t) => jn(Oe(e.getValue(t)), Oe(n.getValue(t))), la = (e, n, t) => Xt(Oe(e.getValue(t)).toLowerCase(), Oe(n.getValue(t)).toLowerCase()), da = (e, n, t) => Xt(Oe(e.getValue(t)), Oe(n.getValue(t))), ua = (e, n, t) => {
  const r2 = e.getValue(t), o = n.getValue(t);
  return r2 > o ? 1 : r2 < o ? -1 : 0;
}, ca = (e, n, t) => Xt(e.getValue(t), n.getValue(t));
function Xt(e, n) {
...
function jn(e, n) {
  const t = e.split(Gt).filter(Boolean), r2 = n.split(Gt).filter(Boolean);
    ...
    e.getAutoSortingFn = () => {
      ...
      for (const o of t) {
        ...
        if (Object.prototype.toString.call(a) === "[object Date]")
          return et.datetime;
        if (typeof a == "string" && (r2 = true, a.split(Gt).length > 1))
          return et.alphanumeric;
      }
      return r2 ? et.text : et.basic;
    }, e.getAutoSortDir = () => {
      ...
      if (!e)
        throw new Error();
      return St(e.columnDef.sortingFn) ? e.columnDef.sortingFn : e.columnDef.sortingFn === "auto" ? e.getAutoSortingFn() : (t = (r2 = n.options.sortingFns) == null ? void 0 : r2[e.columnDef.sortingFn]) != null ? t : et[e.columnDef.sortingFn];
...
function ma(e) {
  var n, t;
  const r2 = [...fa, ...(n = e._features) != null ? n : []];
  let o = {
    _features: r2
  };
  ...
  const l = {
    ...
    _getRowId: (m, g, h) => {
      var v;
      return (v = o.options.getRowId == null ? void 0 : o.options.getRowId(m, g, h)) != null ? v : `${h ? [h.id, g].join(".") : g}`;
    },
    ...
    _getDefaultColumnDef: I(() => [o.options.defaultColumn], (m) => {
      var g;
      return m = (g = m) != null ? g : {}, {
        header: (h) => {
        ...
        cell: (h) => {
          var v, C;
          return (v = (C = h.renderValue()) == null || C.toString == null ? void 0 : C.toString()) != null ? v : null;
        },
        ...o._features.reduce((h, v) => Object.assign(h, v.getDefaultColumnDef == null ? void 0 : v.getDefaultColumnDef()), {}),
        ...m
      };
    }, D(e, "debugColumns")),
    _getColumnDefs: () => o.options.columns,
    getAllColumns: I(() => [o._getColumnDefs()], (m) => {
      const g = function(h, v, C) {
        return C === void 0 && (C = 0), h.map((b) => {
          const _ = Vo(o, b, C, v), N = b;
          return _.columns = N.columns ? g(N.columns, _, C + 1) : [], _;
        });
      };
      return g(m);
    }, D(e, "debugColumns")),
    getAllFlatColumns: I(() => [o.getAllColumns()], (m) => m.flatMap((g) => g.getFlatColumns()), D(e, "debugColumns")),
    _getAllFlatColumnsById: I(() => [o.getAllFlatColumns()], (m) => m.reduce((g, h) => (g[h.id] = h, g), {}), D(e, "debugColumns")),
    getAllLeafColumns: I(() => [o.getAllColumns(), o._getOrderColumnsFn()], (m, g) => {
  ...
  return (e) => I(() => [e.options.data], (n) => {
    const t = {
      ...
      for (let c = 0; c < o.length; c++) {
        const f = Yt(e, e._getRowId(o[c], c, i), o[c], c, a, void 0, i == null ? void 0 : i.id);
...
function Un(e, n, t) {
  return t.options.filterFromLeafRows ? xa(e, n, t) : va(e, n, t);
}
function xa(e, n, t) {
  var r2;
  const o = [], a = {}, i = (r2 = t.options.maxLeafRowFilterDepth) != null ? r2 : 100, u = function(d, c) {
    c === void 0 && (c = 0);
    const f = [];
    for (let m = 0; m < d.length; m++) {
      var l;
      let g = d[m];
      const h = Yt(t, g.id, g.original, g.index, g.depth, void 0, g.parentId);
      if (h.columnFilters = g.columnFilters, (l = g.subRows) != null && l.length && c < i) {
    ...
    for (let m = 0; m < d.length; m++) {
      ...
      if (n(g)) {
        ...
        if ((l = g.subRows) != null && l.length && c < i) {
          const v = Yt(t, g.id, g.original, g.index, g.depth, void 0, g.parentId);
          v.subRows = u(g.subRows, c + 1), g = v;
        }
...
function ba() {
  return (e, n) => I(() => [e.getPreFilteredRowModel(), e.getState().columnFilters, e.getState().globalFilter, e.getFilteredRowModel()], (t, r2, o) => {
    if (!t.rows.length || !(r2 != null && r2.length) && !o)
      return t;
    const a = [...r2.map((u) => u.id).filter((u) => u !== n), o ? "__global__" : void 0].filter(Boolean), i = (u) => {
      for (let d = 0; d < a.length; d++)
        if (u.columnFilters[a[d]] === false)
          return false;
      return true;
    };
    return Un(t.rows, i, e);
  }, D(e.options, "debugTable"));
}
function wa() {
  return (e, n) => I(() => {
...
function ya() {
  return (e) => I(() => [e.getPreFilteredRowModel(), e.getState().columnFilters, e.getState().globalFilter], (n, t, r2) => {
    ...
    const i = (t ?? []).map((m) => m.id), u = e.getGlobalFilterFn(), d = e.getAllLeafColumns().filter((m) => m.getCanGlobalFilter());
    r2 && u && d.length && (i.push("__global__"), d.forEach((m) => {
      var g;
      a.push({
        id: m.id,
        filterFn: u,
    ...
    for (let m = 0; m < n.flatRows.length; m++) {
      ...
      if (g.columnFilters = {}, o.length)
        for (let h = 0; h < o.length; h++) {
          c = o[h];
          const v = c.id;
          g.columnFilters[v] = c.filterFn(g, v, c.resolvedValue, (C) => {
            g.columnFiltersMeta[v] = C;
          });
        }
      if (a.length) {
        for (let h = 0; h < a.length; h++) {
          f = a[h];
          const v = f.id;
          if (f.filterFn(g, v, f.resolvedValue, (C) => {
            g.columnFiltersMeta[v] = C;
          })) {
    ...
    return Un(n.rows, l, e);
  }, D(e.options, "debugTable", "getFilteredRowModel", () => e._autoResetPageIndex()));
}
function Sa(e) {
  return (n) => I(() => [n.getState().pagination, n.getPrePaginationRowModel(), n.options.paginateExpandedRows ? void 0 : n.getState().expanded], (t, r2) => {
    if (!r2.rows.length)
      return r2;
    const {
      pageSize: o,
    ...
    const u = (d) => {
      ...
      return c.sort((f, l) => {
        for (let g = 0; g < a.length; g += 1) {
          var m;
          const h = a[g], v = i[h.id], C = v.sortUndefined, b = (m = h == null ? void 0 : h.desc) != null ? m : false;
          let _ = 0;
          if (C) {
            const N = f.getValue(h.id), z = l.getValue(h.id), E = N === void 0, F = z === void 0;
            if (E || F) {
              if (C === "first") return E ? -1 : 1;
              if (C === "last") return E ? 1 : -1;
              _ = E && F ? 0 : E ? C : -C;
            }
          }
          if (_ === 0 && (_ = v.sortingFn(f, l, h.id)), _ !== 0)
            return b && (_ *= -1), v.invertSorting && (_ *= -1), _;
        }
...
function gn(e, n) {
  return e ? Ra(e) ? /* @__PURE__ */ x.createElement(e, n) : e : null;
}
function Ra(e) {
  return Na(e) || typeof e == "function" || _a(e);
}
function Na(e) {
...
function Fa(e) {
  const n = {
    ...
    current: ma(n)
  })), [r2, o] = x.useState(() => t.current.initialState);
...
function qn({
  ...
  const t = e.getState().pagination.pageIndex + 1, r2 = e.getPageCount(), o = r2 <= 1, a = x.useMemo(() => Array.from({ length: r2 }, (l, m) => m + 1), [r2]), { pageIndex: i, pageSize: u } = e.getState().pagination, d = e.getRowCount(), c = d === 0 ? 0 : i * u + 1, f = Math.min((i + 1) * u, d);
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              rt,
              {
                ...
                disabled: o,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(yt, { placeholder: t.toString() })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ot,
...
qn.displayName = "DataTablePagination";
function Us({
  columns: e,
  data: n,
  emptyState: t,
  ...
  pageCount: b,
  rowCount: _,
  enableSorting: N = false,
  sorting: z,
  onSortingChange: E,
  manualSorting: F = false,
  enableFiltering: T = false,
  columnFilters: H,
  onColumnFiltersChange: A,
  manualFiltering: O = false,
  toolbar: ee,
  isLoading: Z = false,
  loadingState: J
}) {
  var _a2;
  const [fe, re2] = x.useState({
    pageIndex: 0,
    pageSize: g
  }), [S, V] = x.useState([]), [$, te] = x.useState([]), Q = v ?? fe, ye = h ?? re2, ie = z ?? S, M = E ?? V, L = H ?? $, B = A ?? te, j = Fa({
    data: n,
    columns: e,
    getCoreRowModel: pa(),
    getPaginationRowModel: m && !C ? Sa() : void 0,
    getSortedRowModel: N && !F ? Ca() : void 0,
    getFilteredRowModel: T && !O ? ya() : void 0,
    getFacetedRowModel: T ? ba() : void 0,
    getFacetedUniqueValues: T ? wa() : void 0,
    onPaginationChange: m ? ye : void 0,
    onSortingChange: N ? M : void 0,
    onColumnFiltersChange: T ? B : void 0,
    manualPagination: C,
    manualSorting: F,
    manualFiltering: O,
    pageCount: b,
  ...
  }), ve = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center py-12 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
  ...
  ] }) }), G = typeof ee == "function" ? ee(j) : ee, oe = () => /* @__PURE__ */ jsxRuntimeExports.jsx(Fo, { className: "bg-trax-neutral-10", children: j.getHeaderGroups().map((W) => /* @__PURE__ */ jsxRuntimeExports.jsx(_t, { className: l == null ? void 0 : l.headerRow, children: W.headers.map((Y) => /* @__PURE__ */ jsxRuntimeExports.jsx(Do, { className: l == null ? void 0 : l.headerCell, children: Y.isPlaceholder ? null : gn(
    Y.column.columnDef.header,
    Y.getContext()
  ) }, Y.id)) }, W.id)) }), be = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3", children: [
  ...
  ] }), Se = () => /* @__PURE__ */ jsxRuntimeExports.jsx(_t, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(dn, { colSpan: e.length, className: "h-32 text-center", children: J || be }) });
  return !((_a2 = j.getRowModel().rows) == null ? void 0 : _a2.length) && !Z ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: p("overflow-hidden rounded-md border", r2), children: [
    G,
    /* @__PURE__ */ jsxRuntimeExports.jsx(ln, { className: o, children: oe() }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t", children: t || ve })
  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: p("overflow-hidden rounded-md border", r2), children: [
    G,
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ln, { className: o, children: [
      oe(),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Io, { children: Z ? Se() : j.getRowModel().rows.map((W) => {
        const Y = a === W.id, le = !!c && !Y, Ae = (ne) => {
          !c || Y || ne.target.closest(
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          _t,
          {
            ...
            "data-editing": Y ? "true" : void 0,
            onClick: Ae,
            className: p(
              Y && "bg-blue-50 border-blue-200",
              le && "cursor-pointer hover:bg-trax-neutral-10",
              l == null ? void 0 : l.bodyRow
            ),
            children: W.getVisibleCells().map((ne) => /* @__PURE__ */ jsxRuntimeExports.jsx(dn, { className: l == null ? void 0 : l.bodyCell, children: gn(ne.column.columnDef.cell, {
              ...ne.getContext(),
              isEditing: Y,
              onEdit: () => i == null ? void 0 : i(W),
              onSave: () => u == null ? void 0 : u(W),
              onCancel: d
            }) }, ne.id))
          },
          W.id
    ...
    m && /* @__PURE__ */ jsxRuntimeExports.jsx(qn, { table: j, styles: l == null ? void 0 : l.pagination })
  ] });
}
function Ia({
  column: e,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      onClick: i,
      onKeyDown: (u) => {
        (u.key === "Enter" || u.key === " ") && (u.preventDefault(), i());
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
...
Ia.displayName = "DataTableColumnHeader";
const Yn = x.createContext(null);
function Kn() {
  const e = x.useContext(Yn);
  if (!e)
...
function Da({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Yn.Provider, { value: { table: e }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: p(
...
Da.displayName = "DataTableToolbar";
function Ea({
  column: e,
  title: n,
  ...
  const { table: i } = Kn(), u = typeof e == "string" ? i.getColumn(e) : e;
  if (!u)
    return console.warn("Column not found for category filter"), null;
  const d = u.getFilterValue(), c = x.useMemo(() => {
    if (a)
      return a;
...
Ea.displayName = "DataTableCategoryFilter";
function Wn(e) {
  return qt({ attr: { viewBox: "0 0 24 24" }, child: [{ tag: "path", attr: { fill: "none", d: "M0 0h24v24H0z" }, child: [] }, { tag: "path", attr: { d: "M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z" }, child: [] }] })(e);
}
function Ma(e, n) {
  const [t, r2] = hn(e);
  return xn(() => {
...
const Xn = x.forwardRef(
  ({
    ...
    const b = f || `search-input-${x.useId()}`, _ = x.useRef(null), N = l !== void 0, [z, E] = x.useState(""), [F, T] = x.useState(false), H = N ? l : z, A = Ma(H, a);
    x.useImperativeHandle(C, () => _.current);
    const O = x.useRef(o);
    O.current = o, x.useEffect(() => {
      var _a2;
      (_a2 = O.current) == null ? void 0 : _a2.call(O, String(A));
    }, [A]);
    const ee = ($) => {
      N || E($.target.value), g == null ? void 0 : g($);
    }, Z = () => {
      var _a2, _b;
      N || E(""), g == null ? void 0 : g({
        target: { value: "" }
      }), (_a2 = O.current) == null ? void 0 : _a2.call(O, ""), (_b = _.current) == null ? void 0 : _b.focus();
    }, J = ($) => {
      $.stopPropagation(), Z();
    }, fe = ($) => {
      var _a2;
      T(true), (_a2 = v.onFocus) == null ? void 0 : _a2.call(v, $);
    }, re2 = ($) => {
      T(false), h == null ? void 0 : h($);
    }, S = ($) => {
      var _a2;
      if (($.key === "Backspace" || $.key === "Delete") && ($.metaKey || $.ctrlKey || $.altKey) && H) {
        $.preventDefault(), Z();
        return;
      }
      (_a2 = v.onKeyDown) == null ? void 0 : _a2.call(v, $);
    }, V = F && H && !c;
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        V && /* @__PURE__ */ jsxRuntimeExports.jsx(
          $e,
          {
            ...
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Wn, {}),
...
const Va = x.forwardRef(
  ({
    ...
    const _ = c || `input-${Math.random().toString(36).substring(2, 11)}`, N = l ? l(m) : {}, [z, E] = x.useState(() => typeof f == "string" ? f : typeof f == "number" ? String(f) : "");
    x.useEffect(() => {
      if (!l && f !== void 0) {
    ...
    const F = x.useMemo(() => z.length, [z]), T = u ? F > u : false;
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          bt,
          {
            ...
            ...C,
            ...l ? { name: N.name } : { value: f },
            onChange: (H) => {
              E(H.target.value), l ? N.onChange(H) : C.onChange && C.onChange(H);
            },
            onBlur: l ? N.onBlur : g
          }
        ),
...
const $a = x.forwardRef(
  ({
    ...
    const v = `select-${Math.random().toString(36).substr(2, 9)}`, C = (b) => {
      b || (m == null ? void 0 : m());
    };
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: p("flex flex-col gap-1 w-full", c), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(wt, { value: i, onValueChange: u, onOpenChange: C, disabled: d, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            rt,
            {
              ref: h,
              ...
              ...g,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(yt, { placeholder: o })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ot, { children: a.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(at, { value: b.value, children: b.label }, b.value)) })
        ] })
      ] }),
      t && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-nowrap justify-start items-center gap-0.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "text-trax-red-500 size-3.5" }),
...
const ka = x.forwardRef(
  (e, n) => {
    const {
      ...
      numberOfMonths: C = 1,
      mode: b = "single"
    } = e, _ = l || `date-picker-${Math.random().toString(36).substr(2, 9)}`, [N, z] = x.useState(false), E = x.useRef(false), F = x.useRef(false), T = b === "range";
    x.useEffect(() => {
      if (T && d) {
        const S = d, V = S.from && S.to && S.from.getTime() !== S.to.getTime();
        F.current = !!V;
      }
    }, [d, T]);
    const H = (S) => {
      ...
      if (T && c) {
        const V = d;
        if ((V == null ? void 0 : V.from) && (V == null ? void 0 : V.to) && V.from.getTime() !== V.to.getTime() && (S == null ? void 0 : S.from) && V.from && V.to) {
          let te;
          if (S.from.getTime() !== V.from.getTime() ? te = S.from : S.to && S.to.getTime() !== V.to.getTime() && (te = S.to), te) {
            const Q = { from: te, to: void 0 };
            E.current = true, F.current = false, c(Q);
            return;
          }
        }
        if ((S == null ? void 0 : S.from) && !(S == null ? void 0 : S.to))
          E.current = true, F.current = false;
        else if ((S == null ? void 0 : S.from) && (S == null ? void 0 : S.to))
          if (S.from.getTime() === S.to.getTime()) {
            const Q = { from: S.from, to: void 0 };
            E.current = true, F.current = false, c(Q);
            return;
          } else
            E.current = false, F.current = true, z(false);
        else
          E.current = false, F.current = false;
        c(S);
      }
    }, O = (S) => {
      if (z(S), !S) {
        ...
        E.current = false, v == null ? void 0 : v();
      }
    }, ee = (S) => {
      if (T && E.current) {
        const V = d;
      ...
      if (T) {
        const S = d;
        return (S == null ? void 0 : S.from) ? S.to ? `${format(S.from, "yyyy-MM-dd")} - ${format(S.to, "yyyy-MM-dd")}` : format(S.from, "yyyy-MM-dd") : u;
      } else {
        const S = d;
        return S ? format(S, "yyyy-MM-dd") : u;
      }
    }, re2 = T ? !!(d == null ? void 0 : d.from) : !!d;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Er,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mr, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              $e,
              {
                ref: n,
                id: _,
                ...
                className: p(
                  ...
                  !re2 && "text-muted-foreground",
                  t
                ),
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: p(
                    "text-left",
                    re2 ? "text-trax-neutral-900" : "text-trax-grey-500"
                  ), children: fe() }),
...
ka.displayName = "FormDatePicker";
const Ta = x.forwardRef(
  ({ label: e, required: n = false, helperText: t, error: r2, id: o, className: a, register: i, registerOptions: u, touched: d, showCharacterCount: c = false, maxCharacters: f, enforceMaxLength: l = false, value: m, ...g }, h) => {
    const v = x.useId(), C = o ?? `textarea-${v}`, b = i ? i(u) : {}, [_, N] = x.useState(() => typeof m == "string" ? m : typeof m == "number" ? String(m) : "");
    x.useEffect(() => {
      if (!i && m !== void 0) {
        const F = typeof m == "string" ? m : String(m || "");
        N(F);
      }
    }, [m, i]);
    const z = x.useMemo(() => _.length, [_]), E = f ? z > f : false;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full flex-col gap-1", children: [
      e && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Te, { htmlFor: C, className: "text-xs font-medium text-trax-neutral-900", children: e }),
        n && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-trax-red-400", children: "*" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          _n,
          {
            ...
            onChange: (F) => {
              N(F.target.value), i ? b.onChange(F) : g.onChange && g.onChange(F);
            },
...
const za = x.forwardRef(({ className: e, indicatorClassName: n, value: t = 0, disabled: r2 = false, error: o, ...a }, i) => {
...
za.displayName = "FormProgress";
function Zn(e = {}) {
  const { enabled: n = true, externalRef: t, deps: r2 = [] } = e, o = nr(null), a = t ?? o, [i, u] = hn(false);
  return xn(() => {
    const d = a.current;
    let c = true;
    const f = () => {
      if (c)
        if (d && n) {
          const m = d.scrollWidth > d.offsetWidth;
          u(m);
        } else
          u(false);
    };
...
function Jn({
  ...
  clearOnBlur: T = false,
  displayLabel: H,
  showLabelOnFocus: A = true,
  tooltipProps: O,
  dropdownClassName: ee
}) {
  const Z = _ || `search-select-${x.useId()}`, J = x.useRef(null), fe = x.useRef(null), re2 = x.useRef(null), S = x.useRef(null), V = x.useRef([]), $ = N && F ? N(F, z) : null, te = x.useRef($);
  te.current = $;
  const Q = x.useRef(e);
  Q.current = e;
  const ye = x.useCallback(
    (R) => {
      ...
      re2.current = R;
      const P = Q.current;
      P && (typeof P == "function" ? P(R) : P.current = R);
      const U = (_a2 = te.current) == null ? void 0 : _a2.ref;
      U && (typeof U == "function" ? U(R) : U.current = R);
    },
    []
  ), [ie, M] = x.useState(""), [L, B] = x.useState(
    i ?? null
  ), [j, ve] = x.useState(
    i ?? null
  ), [G, oe] = x.useState(false), [be, Se] = x.useState([]), [W, Y] = x.useState("idle"), [le, Ae] = x.useState(-1), [ne, ue] = x.useState(false), [me, pe] = x.useState(false), Ce = x.useRef(void 0), Be = x.useRef(void 0), ae = x.useRef(false), Fe = x.useRef(false), Ke = x.useRef(false), Me = x.useRef(false), Pe = x.useRef(false), st = x.useRef(L), Xe = x.useRef(j), Ge = x.useRef(ne), Ie = x.useRef(u);
  Ie.current = u, x.useEffect(() => {
    st.current = L;
  }, [L]), x.useEffect(() => {
    Xe.current = j;
  }, [j]), x.useEffect(() => {
  ...
  const je = x.useCallback(
    async (R) => {
      Y("searching"), oe(true), Ae(-1);
      try {
        const P = await d(R);
        Se(P), Y(P.length > 0 ? "success" : "no-results");
      } catch {
        Se([]), Y("no-results");
      }
    },
  ...
  x.useEffect(() => {
    if (Ce.current && clearTimeout(Ce.current), Me.current) {
      Me.current = false;
      return;
    }
    const R = c && (!Ge.current || ie.length === 0);
    if (me && (ie.length >= l || R) && !ae.current && !Fe.current && !Ke.current) {
      const P = R ? 0 : f;
      Ce.current = setTimeout(() => {
        je(ie);
      }, P);
    } else ie.length < l && (oe(false), Y("idle"), Se([]));
    return () => {
      Ce.current && clearTimeout(Ce.current);
    };
  }, [me, ie, f, l, c, je]), x.useEffect(() => {
    i !== void 0 && (B(i), ve(i), i ? (Me.current = true, M(i.label)) : ie && (Me.current = true, M("")));
  }, [i]);
  const { isTruncated: ze } = Zn({
    externalRef: re2,
    enabled: !!L && !ne,
    deps: [L, ne, me, H]
  }), Ct = (R) => {
    const P = R.target.value || "";
    M(P), ue(true), L && P !== L.label && (B(null), T === false && !N || ($ && $.onChange({ target: { name: F, value: null } }), u == null ? void 0 : u(null)));
  }, it = (R) => {
    Fe.current = true, B(R), ve(R), M(R.label), oe(false), ue(false), Y("idle"), $ && $.onChange({ target: { name: F, value: R } }), u == null ? void 0 : u(R), setTimeout(() => {
      Fe.current = false;
    }, 0);
  }, Ze = () => {
    var _a2;
    B(null), ve(null), M(""), ue(false), $ && $.onChange({ target: { name: F, value: null } }), u == null ? void 0 : u(null), me && c ? je("") : (oe(false), Y("idle")), (_a2 = re2.current) == null ? void 0 : _a2.focus();
  }, lt = (R) => {
    var _a2;
    if (R.stopPropagation(), !A && ne && j) {
      B(j), Me.current = true, M(""), ue(false), me && c ? je("") : (oe(false), Y("idle")), (_a2 = re2.current) == null ? void 0 : _a2.focus();
      return;
    }
    Ze();
  }, Rt = () => {
    Ke.current = false, pe(true), Be.current && clearTimeout(Be.current), L && !ne && M("");
  }, Ue = x.useCallback(() => {
    var _a2, _b;
    const R = st.current, P = Xe.current, U = Ge.current, we = te.current;
    oe(false), Y("idle"), Se([]), T ? !R && U && (M(""), ue(false), we && we.onChange({ target: { name: F, value: null } }), (_a2 = Ie.current) == null ? void 0 : _a2.call(Ie, null)) : U && P && !R ? (B(P), Me.current = true, M(P.label), ue(false), we && we.onChange({ target: { name: F, value: P } }), (_b = Ie.current) == null ? void 0 : _b.call(Ie, P)) : !R && !P && (M(""), ue(false));
  }, [T, F]), De = (R) => {
    Ke.current = true, pe(false), Ce.current && clearTimeout(Ce.current), Be.current = setTimeout(() => {
      var _a2;
      !((_a2 = fe.current) == null ? void 0 : _a2.contains(document.activeElement)) && !Pe.current && Ue(), setTimeout(() => {
        Ke.current = false;
      }, 100);
    }, 200), $ && $.onBlur(R), E == null ? void 0 : E(R);
  }, Nt = (R) => {
    if ((R.key === "Backspace" || R.key === "Delete") && (R.metaKey || R.ctrlKey || R.altKey) && L) {
      R.preventDefault(), Ze();
      return;
    }
    if (G)
      switch (R.key) {
        case "ArrowDown":
          R.preventDefault(), Ae(
            (P) => P < be.length - 1 ? P + 1 : P
          );
          break;
        case "ArrowUp":
          R.preventDefault(), Ae((P) => P > 0 ? P - 1 : -1);
          break;
        case "Enter":
          R.preventDefault(), le >= 0 && be[le] && it(be[le]);
          break;
        case "Escape":
          R.preventDefault(), oe(false), Y("idle"), j ? (B(j), Me.current = true, M(j.label), ue(false)) : (M(""), B(null));
          break;
      }
  };
  x.useEffect(() => {
    var _a2;
    le >= 0 && V.current[le] && ((_a2 = V.current[le]) == null ? void 0 : _a2.scrollIntoView({
      block: "nearest",
      behavior: "smooth"
    }));
  }, [le]);
  const Je = x.useCallback((R) => {
    J.current && (J.current.contains(R.target) || (Ce.current && clearTimeout(Ce.current), pe(false), Ue()));
  }, [Ue]);
  x.useEffect(() => {
    if (G)
      return document.addEventListener("mousedown", Je), () => document.removeEventListener("mousedown", Je);
  }, [G, Je]);
  const Le = L && !ne ? !me && H ? H : me && !A ? "" : L.label : ie, Qe = ze && L && !ne && !((O == null ? void 0 : O.disabled) ?? false), k = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: S, className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      bt,
      {
        ref: $ || e ? ye : re2,
        ...
        "aria-controls": `${Z}-dropdown`,
        "aria-activedescendant": le >= 0 ? `${Z}-option-${le}` : void 0,
        className: p(
          L && "truncate",
          me && Le && "pr-10",
          "transition-all"
        ...
        onCompositionEnd: (R) => {
          ae.current = false, M(R.target.value);
        }
      }
    ),
    me && Le && !b && /* @__PURE__ */ jsxRuntimeExports.jsx(
      $e,
      {
        type: "button",
        onClick: lt,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ref: J,
      className: p("flex flex-col gap-1 w-full relative", C),
      onMouseDown: (R) => {
        R.target === R.currentTarget && R.preventDefault();
      },
      children: [
        n && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Te, { htmlFor: Z, className: "text-xs font-medium text-trax-neutral-900", children: n }),
          t && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-trax-red-400", children: "*" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Mn, { delayDuration: (O == null ? void 0 : O.delayDuration) ?? 300, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pn, { asChild: true, disabled: !Qe, children: k }),
          Qe && /* @__PURE__ */ jsxRuntimeExports.jsx(
            Vn,
            {
              ...
              children: (O == null ? void 0 : O.renderContent) ? O.renderContent(Le) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-xs wrap-break-word", children: Le })
            }
          )
        ] }),
        G && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ref: fe,
            id: `${Z}-dropdown`,
            ...
            children: [
              W === "searching" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-3 py-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Dn, { className: "w-6 h-6" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-trax-neutral-600", children: m })
              ] }),
              W === "no-results" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-trax-neutral-400", children: g }) }),
              W === "success" && be.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-1", children: be.map((R, P) => {
                const U = P === le, we = (j == null ? void 0 : j.value) === R.value;
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    id: `${Z}-option-${P}`,
                    ...
                    className: p(
                      ...
                      we ? "text-white bg-trax-blue-600 hover:bg-trax-blue-700 active:bg-trax-blue-900" : p(
                        "text-trax-neutral-900 hover:bg-trax-primary-blue-50 active:bg-trax-primary-blue-100",
                        U && "bg-trax-neutral-20"
                      )
                    ),
                    children: h ? h(R, (q, ce) => v(q, ce ?? ie), we) : v(R.label, ie)
                  },
                  R.value
                );
              }) })
...
Oa.displayName = "CollapsibleSection";
const Aa = x.forwardRef(
  ({
    className: e,
    title: n,
    allocations: t,
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center justify-center f-full gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { value: f || 3, className: "h-2", indicatorClassName: "bg-trax-neutral-100" }),
...
Aa.displayName = "CostAllocation";
function fn(e, n, t = "narrow") {
  var _a2;
...
const Ba = x.forwardRef(
  ({
    ...
    const E = l || `currency-input-${Math.random().toString(36).substring(2, 11)}`, F = t ?? (n ? fn(n, r2, i) : void 0), T = o ?? (F ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground text-xs", "aria-hidden": true, children: F }) : null), H = a ?? (m && g.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-2 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      wt,
      {
        value: n,
        onValueChange: (A) => {
          const O = g.find((ee) => ee.code === A);
          O && h && h(O);
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(rt, { className: "h-6 border-0 shadow-none bg-transparent hover:bg-gray-50 focus:ring-0 focus:ring-offset-0 px-2 py-1 text-xs font-medium text-trax-grey-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(yt, { children: n }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ot, { children: g.map((A) => {
            const O = A.symbol ?? fn(A.code, A.locale || r2, i);
            return /* @__PURE__ */ jsxRuntimeExports.jsx(at, { value: A.code, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: O }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: A.code })
            ] }) }, A.code);
          }) })
        ]
      }
...
const Ga = x.forwardRef(
  ({
    ...
    const C = x.useId(), b = m ?? `addon-input-${C}`, _ = x.useRef(null), [N, z] = x.useState(false), E = $t(t);
    x.useEffect(() => {
      E || z(false);
    }, [E]), x.useEffect(() => {
      if (N) {
    ...
    const F = !!(d == null ? void 0 : d.toString()), T = () => !n || mn(n) || $t(n) ? null : pn(n) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        className: p(
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                rt,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(yt, { placeholder: t.placeholder })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ot, { children: t.options.map((O) => /* @__PURE__ */ jsxRuntimeExports.jsx(at, { value: O.value, showCheckIcon: t.showCheckIcon ?? false, children: O.label }, O.value)) })
            ]
          }
        ) });
      }
      if ($t(t)) {
        const A = t.disabled ?? g;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: p("shrink-0 pr-2 relative", o), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
          ...
          N && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: p(
            "absolute top-full right-0 mt-1.5 z-50 min-w-32 bg-white border border-gray-200 rounded-md shadow-lg",
            t.popoverClassName
          ), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Jn,
            {
              className: "[&_input::placeholder]:text-xs px-1 py-2",
              value: t.value,
              onValueChange: (O) => {
                var _a2;
                (_a2 = t.onValueChange) == null ? void 0 : _a2.call(t, O), O && z(false);
              },
      ...
      return pn(t) ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          className: p(
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: p("flex flex-col gap-1 w-full", e), children: [
      i && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
        ...
        u && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-trax-red-400", children: "*" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: p(
            ...
            // Error state
            F && "border-trax-red-400",
            F && !g && "hover:border-trax-red-600",
            F && "focus-within:border-trax-red-700 focus-within:ring-trax-red-focus-shadow"
          ),
          children: [
            T(),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      c && !d && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-trax-grey-600", children: c })
    ] });
  }
);
Ga.displayName = "AddonInput";
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Rr, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(_r, { align: "end", className: "min-w-[200px]", children: t.map((c, f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Fr,
            {
              onClick: c.onClick,
...
ja.displayName = "SplitButton";
const Ws = Root$8, Ua = Portal$4, Zs = Close, er = x.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Overlay,
  {
    ref: t,
    className: he(
...
er.displayName = Overlay.displayName;
const qa = x.forwardRef(({ className: e, children: n, showCloseButton: t = true, ...r2 }, o) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Ua, { children: [
...
qa.displayName = Content$1.displayName;
const Ya = ({
  className: e,
  ...n
}) => /* @__PURE__ */ jsxRuntimeExports.jsx(
...
Ya.displayName = "CustomDialogHeader";
const Ka = ({
  className: e,
  ...n
}) => /* @__PURE__ */ jsxRuntimeExports.jsx(
...
Ka.displayName = "CustomDialogFooter";
const Wa = x.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Title,
  {
    ref: t,
    className: p(
...
Wa.displayName = Title.displayName;
const Xa = x.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Description,
  {
    ref: t,
...
const Za = x.forwardRef(
  ({
    ...
    const { ref: C, isTruncated: b } = Zn({
      deps: [e, l]
    }), _ = x.useCallback(
      (F) => {
        C.current = F, typeof v == "function" ? v(F) : v && (v.current = F);
      },
      [v, C]
    ), N = b && !i, z = {
      ...g,
    ...
    return i ? E : /* @__PURE__ */ jsxRuntimeExports.jsxs(Mn, { delayDuration: a, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Pn, { asChild: true, disabled: !N, children: E }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Vn,
        {
          side: u,
...
export {
  ...
  _r as _,
  $a as a,
  CONFIGURATION_ENDPOINTS as a0,
  Zs as a1,
  Xa as a2,
  Es as a3,
  BUSINESS_PURPOSE_ENDPOINTS as a4,
  bt as a5,
  Ut as a6,
  _n as a7,
  $r as b,
