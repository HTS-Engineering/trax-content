...
import { E as ExpenseFormField, u as useFormFieldValues, a as useAmountAllocationSync, b as useReceiptCheckboxEffects, c as useExpenseFormLeftColumn, S as SupportingFiles, d as useExpenseFormHandlers, f as fullExpenseValidationStrategy, r as resolveFileUrl, C as ConfirmDialog } from "./SupportingFilesSection-CJh3DL8H.js";
import { u as useNavigateBack, C as ChevronLeft } from "./use-navigate-back-CQbfJyFC.js";
import { E as ExpensesList, s as statusBadgeConfig } from "./ExpensesList-BfuHkI0t.js";
import { o as os, b as as, A as An, l as ls, _ as _r, k as ks, d as apiClient, B as Bs, O as Oa, e as Aa, G as Ga, M as Me, f as Ba, $ as $r, g as Vr, z as zr, S as Sn } from "./axiosInstance-DJ0IFTL8.js";
import { E as EXPENSE_DETAILS_SECTION, a as EXPENSE_JUSTIFICATION_SECTION, C as COST_ALLOCATION_SECTION, A as ADDITIONAL_COMMENTS_SECTION } from "./expense-form-sections-BnTuTbP9.js";
import { I as Icon } from "./Icon-5_58Mq6r.js";
import "./mileage-trip-sections-j9oU7tEU.js";
import { c as createExpenseForm } from "./form-factory-DvvIbzux.js";
import { R as ReceiptSection } from "./ReceiptSection-CddVMSQu.js";
...
import { u as useQueryClient, k as useQuery, q as queryKeys } from "./query-keys-Cg9Inajk.js";
import { a as useMutation } from "./store-DwzDWWWf.js";
import { E as EXPENSE_ENDPOINTS } from "./endpoints-B5IysDN2.js";
import { C as ChevronRight } from "./chevron-right-BwsBCAZW.js";
import { T as Trash2, S as Send } from "./trash-2-CaXe8WRt.js";
...
const ExpensePage = () => {
  ...
  const expenseTitle = useMemo(() => {
    if (!expenseData) {
      return isNewExpense ? "New Expense" : "Expense";
    }
    if (mode === "preview") {
  ...
  const renderFooter = () => {
    if (mode === "preview" || !isNewExpense && isLoading) {
      return null;
    }
