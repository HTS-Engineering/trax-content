...
import { l as Ma, a as Pa, n as qs, p, f as Pr, P as Pe, S as Sr, C as Cr, R as Rr, N as Nr, I as In, j as js } from "./index.es-BBFLzT0B.js";
import { E as EmptyState } from "./EmptyState-D-Cgqm3F.js";
import { I as Icon } from "./Icon-iZGOgNHC.js";
import { E as EXPENSE_TYPE_VALIDATION, a as EXPENSE_TYPE_PLACEHOLDERS, b as EXPENSE_TYPE_LABELS, c as ExpenseTypeStatus, d as EXPENSE_TYPE_MESSAGES, u as useNonMileageTypes, e as useExpenseTypeTableState, N as NEW_ROW_ID } from "./useExpenseTypeTableState-CUKilVAa.js";
import { o as object, n as number, _ as _enum, s as string, l as literal, c as useForm, d as a, C as Controller } from "./zod-PpMdyx4R.js";
import { E as ExpenseFormType, b as useCreateExpenseType, c as useUpdateExpenseType, d as useToggleExpenseTypeStatus, e as useFormTypeOptions, f as useMileageRateOptions } from "./api-wgNniSVy.js";
import { u as useSubmitOnEnter, C as Check, X, P as Pencil, E as EllipsisVertical, s as sortByCreatedDate } from "./date-sorting.utils-BYAoE8w2.js";
...
const useExpenseTypeForm = ({
  ...
  const getFieldError2 = useCallback$2(
    (fieldName) => {
  ...
  const hasFieldError = useCallback$2(
    (fieldName) => {
      const fieldError = errors[fieldName];
      const isTouched = touchedFields[fieldName];
  ...
  switch (formType) {
    ...
    case "mileage":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 flex-nowrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pr, { variant: "outline", className: "text-trax-yellow-800 bg-trax-yellow-100", children: EXPENSE_TYPE_LABELS.MILEAGE }),
        mileage && /* @__PURE__ */ jsxRuntimeExports.jsx(Pr, { variant: "outline", className: "bg-trax-neutral-20 text-trax-grey-900", children: `$${mileage}/mile` }),
        taxDisplayText && /* @__PURE__ */ jsxRuntimeExports.jsx(Pr, { variant: "outline", className: "bg-trax-neutral-20 text-trax-grey-900", children: taxDisplayText })
      ] });
    default:
      return null;
  }
