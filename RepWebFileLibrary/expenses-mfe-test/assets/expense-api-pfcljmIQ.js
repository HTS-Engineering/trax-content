...
import { a0 as CONFIGURATION_ENDPOINTS, B as Bs } from "./configuration-EGHx9r2n.js";
import { b as devWarn } from "./index-CvL7PQqL.js";
import { j as jsxRuntimeExports } from "./jsx-runtime-TULtkvNU.js";
import { c as create, d as devtools, s as subscribeWithSelector, i as immer, a as apiClient } from "./axiosInstance-CHke4UEB.js";
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
var RoutePathConfigChunks = /* @__PURE__ */ ((RoutePathConfigChunks2) => {
  ...
  RoutePathConfigChunks2["MileageType"] = "mileage-type";
...
var RoutePaths = /* @__PURE__ */ ((RoutePaths2) => {
  ...
  RoutePaths2["MileageTypeId"] = `/configurations/mileage-type/:companyId`;
...
const { useCallback: useCallback$1, useEffect: useEffect$4, useRef: useRef$1 } = await importShared("react");
...
const { useEffect: useEffect$3, useRef } = await importShared("react");
const useErrorToast = (isError, message, duration = 3e3) => {
  const shownRef = useRef(false);
  useEffect$3(() => {
    if (isError && !shownRef.current) {
      shownRef.current = true;
      Bs.error(message, { duration });
    }
    if (!isError) {
...
export {
  ...
  FormTypeId as F,
  useCountries as G,
  useDefaultCountry as H,
  ItemCategory as I,
  ExpenseFormType as J,
  AllowedMimeType as K,
  FILE_SIZE_LIMITS as L,
  MIME_TYPE_CONFIG as M,
  Navigate as N,
  Outlet as O,
  useDebouncedCallback as P,
  QueryClientProvider as Q,
  RouterProvider as R,
  useDefaultCompany as S,
  useFormTypeId as T,
  FilePreviewType as U,
  FILE_ENDPOINTS as V,
  useCurrencies as W,
  useTaxTypesDisplay as X,
  useDefaultCurrency as Y,
  useNavigateBack as Z,
  isExpenseItemDraft as _,
  RoutePaths as a,
  Mutation as a0,
  notifyManager as a1,
  matchMutation as a2,
  noop as a3,
  hashQueryKeyByOptions as a4,
  Query as a5,
  matchQuery as a6,
  focusManager as a7,
  onlineManager as a8,
  resolveStaleTime as a9,
  functionalUpdate as aa,
  hashKey as ab,
  partialMatchKey as ac,
  skipToken as ad,
  useFormTypeName as ae,
  EMPTY_CURRENCY_SYMBOL as af,
  QueryObserver as ag,
  useBaseQuery as ah,
  ExpenseTypeScope as ai,
  useEscapeHandler as aj,
  useCreateExpenseType as ak,
  useUpdateExpenseType as al,
  useToggleExpenseTypeStatus as am,
  useFormTypeOptions as an,
  MileageRateStatus as ao,
  DEFAULT_CURRENCY_SYMBOL as ap,
  ensureQueryFn as aq,
  addToStart as ar,
  addToEnd as as,
  addConsumeAwareSignal as at,
  getCurrencySymbol as au,
  DEFAULT_CURRENCY as av,
  RouteNames as b,
  ...
  useLocation as g,
  useParams as h,
  useCompanyStore as i,
  usePreventPageReload as j,
  RoutePathConfigChunks as k,
  createHashRouter as l,
  useFormTypes as m,
  useExpenseTypes as n,
  useQuery as o,
  keepPreviousData as p,
  queryKeys as q,
  useSearchParams as r,
  isExpenseItemSubmitted as s,
  isRegularExpense as t,
  useCompanies as u,
  getExpenseItemAmount as v,
  useExpenseItem as w,
  useErrorToast as x,
  isMileageExpense as y,
  generatePath as z
};
