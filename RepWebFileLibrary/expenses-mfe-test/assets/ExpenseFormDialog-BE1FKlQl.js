...
import { b as useQueryClient, a as useCompanyStore, q as queryKeys, E as EXPENSE_ENDPOINTS, d as useQuery, c as DEFAULT_CURRENCY, g as useDefaultCompany, h as getCurrencyLocale, D as DEFAULT_CURRENCY_CODE } from "./currency-D0toBGrD.js";
import { u as useForm, d as a, q as useWatch, s as string, D as DECIMAL_FORMAT_REGEX, o as object, t as boolean, v as custom, w as array, p as date, x as unknown, n as number, l as literal, C as Controller, e as createDecimalChangeHandler, m as useBusinessPurposes, y as useFormState, c as formatRate, a as formatCurrency } from "./formatters-DM7qZzq1.js";
import { E as ECostAllocation, I as ItemCategory } from "./expense-item-oPdxtthH.js";
import { importShared } from "./__federation_fn_import-VIrFz_yB.js";
import { q as queryClient, C as CreditCard } from "./queryClient-CPCeDfx9.js";
...
const totalDistanceFieldOptional = string().optional().nullable().refine((val) => !val || distanceRegex.test(val), "Invalid distance format");
const rateRegex = /^\d+(\.\d{1,4})?$/;
const ratePerUnitField = string().min(1, "Rate is required").regex(rateRegex, "Invalid rate format");
const ratePerUnitFieldOptional = string().optional().refine((val) => !val || rateRegex.test(val), "Invalid rate format");
...
const reimbursableAmountFieldOptional = string().optional().refine((val) => !val || distanceRegex.test(val), "Invalid amount format");
...
const ExpenseDetailsSection = ({
  ...
  const defaultCurrencyApplied = useRef$7(false);
  useEffect$6(() => {
    if (defaultCurrencyApplied.current || !(countries == null ? void 0 : countries.length) || expenseLocation) return;
    const homeCurrency = countries[0].defaultCurrencyIso;
    if (homeCurrency) {
      setValue("netCurrency", { code: homeCurrency, locale: getCurrencyLocale(homeCurrency) });
      defaultCurrencyApplied.current = true;
    }
  }, [countries, expenseLocation, setValue]);
...
const MileageDetailsSection = ({
  ...
  const { data: countries } = useCountries();
  const defaultCurrencyCode = ((_a = countries == null ? void 0 : countries[0]) == null ? void 0 : _a.defaultCurrencyIso) || DEFAULT_CURRENCY_CODE;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          label: "Rate",
          value: ratePerUnit ? formatRate(ratePerUnit, rateUnit || "-", { currencyCode: defaultCurrencyCode }) : "",
          disabled: true,
          readOnly: true
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Va,
        {
          ...
          value: formatCurrency(reimbursableAmount || "0", { currencyCode: defaultCurrencyCode }),
          disabled: true,
          readOnly: true
        }
      )
