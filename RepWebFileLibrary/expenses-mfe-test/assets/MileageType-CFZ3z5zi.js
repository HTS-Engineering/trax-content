...
import { B as Ba, l as qs, a as Pa, e as Pr, P as Pe, I as In, D as Dn, E as En, M as Mn, j as js, K as Ks, U as Ua, n as Xs, q as qa, b as Ka, k as Ma, p, C as Cr, S as Sr, R as Rr, N as Nr, o as Ds } from "./index.es-fHErn31W.js";
import { E as EmptyState } from "./EmptyState-0igdkMlj.js";
import { I as Icon } from "./Icon-BxYHdB7c.js";
import { f as useMileageTypes, e as useExpenseTypeTableState } from "./useExpenseTypeTableState-CygEjD0E.js";
...
import { a as devLog, d as devError, u as useMutation } from "./use-debounced-callback-DXpXujA5.js";
import { b as useEscapeHandler } from "./use-prevent-page-reload-gmWWS9L9.js";
import { b as useCreateExpenseType, c as useUpdateExpenseType, d as useToggleExpenseTypeStatus, E as ExpenseFormType } from "./api-Dl_E-N41.js";
...
const { useCallback: useCallback$6, useEffect, useMemo: useMemo$4, useRef } = await importShared("react");
...
const useMileageRates = ({
  ...
  return useQuery({
    queryKey: companyShortName && expenseTypeId ? queryKeys.mileageRates.byExpenseType(companyShortName, expenseTypeId) : queryKeys.mileageRates.all(),
    queryFn: async () => {
  ...
  return useMutation({
    ...
    onSuccess: (_data, variables) => {
      queryClient.invalidateQueries({
        queryKey: queryKeys.mileageRates.byExpenseType(
  ...
  cell: (context) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ActionsCell,
      {
        ...
        onToggleActive,
        onManageRates,
        onAssignEmployees: () => devLog("Clicked: Assign employees (TRX-296 - not implemented)"),
