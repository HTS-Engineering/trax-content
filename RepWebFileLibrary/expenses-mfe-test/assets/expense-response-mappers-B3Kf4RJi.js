...
import { c as RouteCompanyIds } from "./routes-C5J7GVU-.js";
...
const MOCKED_ENDPOINTS_CONFIG = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // EXPENSE ENDPOINTS
  // Uncomment to use mock data instead of real backend
  // ═══════════════════════════════════════════════════════════════════════════
  // {
...
export {
  ...
  getMileageSubmitted as f,
  getUploadedFile as g,
  hasUploadedFile as h,
  getMileageDrafts as i,
  mockFormTypes as j,
  getExpenseTypes as k,
  getNextExpenseTypeId as l,
  mockLogicalCompanies as m,
  addExpenseType as n,
  getExpenseType as o,
  getMileageRates as p,
  sortRatesByStatus as q,
  recalculateAllRateStatuses as r,
  shouldSimulateError as s,
  getNextMileageRateId as t,
  updateExpenseType as u,
  setMileageRates as v,
  calculateRateStatus as w,
  mapMockToExpenseFormResponse as x,
  findItemById as y,
