...
import { D as DOMEventNames, S as SessionStorageKeys, T as TokenPlaceholders, a as apiClient, b as axios } from "./axiosInstance-DRv32qzS.js";
import { u as useAuth, a as useJWT, b as useUser, c as usePermissions, d as useTokenExpiration, e as useJWTStatus, f as useJWTPayload } from "./hooks-JK31w3zL.js";
import { c as createLucideIcon, h as cs, b as $r, a5 as bt, $ as $e, a6 as _n, a7 as Ut, a0 as CONFIGURATION_ENDPOINTS } from "./configuration-Bjg01YDW.js";
import { S as Shield } from "./shield-BLTfCefq.js";
import { R as RefreshCw } from "./refresh-cw-Dc4Ct-uZ.js";
...
const TokenCountdown = ({ expiresAt, compact = false }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ut, { value: progress, className: "h-2" }),
...
const JWTDemo = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto p-6 space-y-6 max-w-6xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(cs, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx($r, { ...getStatusBadgeProps() })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(cs, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(cs, { className: "p-6", children: [
    ...
    user && /* @__PURE__ */ jsxRuntimeExports.jsxs(cs, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(bt, { value: user.id || "N/A", readOnly: true })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(bt, { value: user.name || "N/A", readOnly: true })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Email" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(bt, { value: user.email || "N/A", readOnly: true })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-1", children: roles.length > 0 ? roles.map((role) => /* @__PURE__ */ jsxRuntimeExports.jsx($r, { variant: "project", className: "font-mono text-xs", children: role }, role)) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500", children: "No roles assigned" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-sm font-medium text-gray-700", children: [
              "Permissions (",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(cs, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs($e, { onClick: handleSetDemoToken, className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Key, { className: "h-4 w-4" }),
            "Set Demo Token"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs($e, { variant: "destructive", onClick: handleClearToken, className: "flex items-center gap-2", children: [
        ...
        (apiResponse.status || apiResponse.error) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx($r, { variant: apiResponse.error ? "destructive" : "success", children: apiResponse.status || "Error" })
          ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(cs, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx($e, { onClick: handleEmitEvent, className: "w-full", children: "Emit JWT Update Event" }),
