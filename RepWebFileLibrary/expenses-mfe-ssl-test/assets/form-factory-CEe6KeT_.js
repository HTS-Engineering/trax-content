...
import { P as useBaseExpenseForm, Z as useAutoSave, T as useFormButtonStateSync, U as useFormImperativeHandle, _ as BaseExpenseFormRenderer } from "./ExpenseFormLeftColumn-DcKgV5GH.js";
  ...
  const FormComponent = forwardRef(
    (props, ref) => {
      ...
      const leftColumn = useMemo(
        ...
        [config.leftColumnRenderer, control, setValue, getValues, isSubmitting, isDrafting, draftId, onSaveDraft, onSaveDraftForUpload]
      );
