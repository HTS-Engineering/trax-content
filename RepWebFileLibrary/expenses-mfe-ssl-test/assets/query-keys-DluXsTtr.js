...
import { c as create, d as devtools, s as subscribeWithSelector, i as immer } from "./axiosInstance-C5DXrAKo.js";
...
const queryKeys = {
  ...
  mileageRates: {
    ...
    byExpenseType: (companyShortName, expenseTypeId) => [...queryKeys.mileageRates.lists(), companyShortName, expenseTypeId],
  ...
  expenseItem: {
    all: () => ["expenseItem"],
    details: () => [...queryKeys.expenseItem.all(), "detail"],
