...
import { u as us, d as cs, X as Xn, m as ms, V as Va, l as Ma, W as hs, $ as xs, P as Pe, a0 as vs, a1 as bs, a2 as ys, a3 as Ss, a4 as ws, a5 as Hr, D as Dn, E as En, M as Mn, a as Pa, a6 as $a } from "./index.es-BBFLzT0B.js";
import { d as devError } from "./index-D4vrrc7u.js";
import { R as ReceiptSection, N as minimalExpenseValidationStrategy, O as useBaseExpenseForm, V as VENDOR_OPTIONS, P as EXPENSE_LOCATION_OPTIONS, F as FormSectionType, d as useReceiptCheckboxEffects, Q as useFormButtonStateSync, S as useFormImperativeHandle, T as FormSectionProvider, U as FormRenderer, W as affidavitExpenseValidationStrategy } from "./ExpenseFormLeftColumn-C4dIk4Dc.js";
import { s as sortFormSections } from "./form-factory-BFAjWF9c.js";
import "./axiosInstance-BKijOuwr.js";
import "./query-keys-BOqauSXC.js";
import "./use-debounced-callback-BQrts8Y5.js";
import { C as Controller, f as useWatch } from "./zod-PpMdyx4R.js";
...
function AffidavitSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(cs, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Xn,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { className: "min-h-0 h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex-1 flex flex-col min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(us, { className: "w-full max-h-full bg-yellow-50 border border-yellow-200 p-3 flex flex-col overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 h-full overflow-y-auto", children: [
...
function ExpenseFormDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(hs, { open, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(xs, { asChild: true, children: trigger || /* @__PURE__ */ jsxRuntimeExports.jsx(Pe, { children: "New Expense" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(vs, { className: dialogClassName, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(bs, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ys, { children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ss, { children: description })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FormComponent,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ws, { className: "gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Pe,
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Hr, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Dn, { children: [
          ...
          draftButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Mn, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: draftButtonState.tooltip }) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Hr, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Dn, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(En, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Pe,
          ...
          submitButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Mn, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: submitButtonState.tooltip }) })
        ] }) })
      ] })
    ] })
  ] });
...
function MinimalDetailsSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Controller,
        {
          name: "vendor",
...
const AffidavitDetailsSection = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Controller,
        {
          name: "vendor",
...
function FormsTestingPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto p-6 space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(us, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(cs, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(cs, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Last Submitted" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { children: lastSubmitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(cs, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Last Draft" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ms, { children: lastDraft ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(us, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(cs, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "Code Reusability Demonstration" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ms, { className: "prose prose-sm max-w-none", children: [
