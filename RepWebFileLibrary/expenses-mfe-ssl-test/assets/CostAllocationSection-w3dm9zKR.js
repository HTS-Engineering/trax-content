...
import { m as ms, i as hs, e as ar, j as bs, A as An, p as ps, a as $r, q as qs, $ as $a, U as Ue, k as jt, s as sn, Y as Ya, b as Gt, c as qt, d as Ut, H as Hs, B as Bs, l as js, z as za, V as Va, o as or, n as Zs, u as Ye, L as La } from "./index.es-BcmpdPPF.js";
import { I as Icon } from "./Icon-BRsOXDbZ.js";
import { w as FILE_ENDPOINTS, a as useCompanyStore, p as useTaxTypesDisplay, x as useFormTypeName, t as ExpenseFormType, y as EMPTY_CURRENCY_SYMBOL, z as ECostAllocation, r as useDefaultCurrency, D as DEFAULT_CURRENCY_CODE, m as useDefaultCompany, c as useExpenseTypes, F as FormTypeId, A as AllowedMimeType, B as FILE_SIZE_LIMITS, M as MIME_TYPE_CONFIG, C as FilePreviewType, o as useCountries, G as useDefaultCountry, q as queryKeys, E as EXPENSE_ENDPOINTS, f as useQueryClient, s as useFormTypeId, H as getCurrencySymbol } from "./expense-api-JnNuSWBC.js";
import { b as formatDate, d as formatCurrency, e as formatDistance, c as formatRate, P as Plus } from "./formatters-C18G5OvS.js";
import { importShared } from "./__federation_fn_import-VIrFz_yB.js";
import { a as apiClient, c as create, d as devtools } from "./axiosInstance-Bd_gl01G.js";
import { a as formatExpensePeriod } from "./ExpenseFormHistoryLog-mYXKU9n5.js";
import { s as string, D as DECIMAL_FORMAT_REGEX, o as object, d as custom, c as boolean, b as array, h as date, i as unknown, n as number, C as ConfirmDialog, g as useWatch, u as useForm, a, l as literal, j as useFormState, e as Controller, f as createDecimalChangeHandler } from "./schemas-BZkGzsPE.js";
import { b as devWarn, d as devError, a as devLog } from "./index-BFfbLHEc.js";
import { _ as __vitePreload } from "./preload-helper-e_IRvegh.js";
import { q as queryClient } from "./queryClient-BQnXv6pg.js";
import { d as useDebouncedCallback, e as useNumericDisplay } from "./use-scroll-into-view-ref-D3XM8xPn.js";
...
const PreviewReceiptSection = ({ receipt, stretchToFill = false }) => {
  var _a;
  const [imageError, setImageError] = useState$7(false);
  const [loadedBlobUrl, setLoadedBlobUrl] = useState$7();
...
const { useEffect: useEffect$i, useRef: useRef$f, useState: useState$6 } = await importShared("react");
...
const PreviewSupportingFilesSection = ({
  ...
  const [loadingFileIds, setLoadingFileIds] = useState$6(/* @__PURE__ */ new Set());
  const [cachedBlobUrls, setCachedBlobUrls] = useState$6(/* @__PURE__ */ new Map());
...
export {
  ...
  isValidFileAttachment as e,
  ExpenseFormField as f,
  getExpenseBaseAmount as g,
  useFormFieldValues as h,
  isMileageTripData as i,
  useMileageRateSync as j,
  useReimbursableAmountSync as k,
  useAmountAllocationSync as l,
  mapCostAllocation as m,
  mapFormDataToUpdateRequest as n,
  mapFormDataToCreateRequest as o,
