...
import { s as string, o as object, b as boolean, f as custom, a as array, g as date, u as unknown, n as number, l as literal, d as useForm, e as a, c as useWatch, C as Controller, h as useFormState } from "./zod-Cj9_4baa.js";
import { j as jsxRuntimeExports } from "./jsx-runtime-TULtkvNU.js";
import { a8 as fs, aa as ps, ab as hs, ac as vs, ad as bs, ae as xs, P as Pe, _ as _n, p as ECostAllocation, i as is, g as Pa, D as Da, q as apiClient, ag as FILE_ENDPOINTS, m as ls, Y as Yn, s as ss, n as cs, ah as Dt, ai as ka, H as Ha, N as Nn, F as Fn, I as In, aj as Vs, ak as ks, al as Ts, L as Ls } from "./axiosInstance-CGD2-_de.js";
...
import { P as Plus } from "./plus-Bn9mf7Z0.js";
import { _ as __vitePreload } from "./preload-helper-e_IRvegh.js";
const { useCallback: useCallback$h, useEffect: useEffect$e, useRef: useRef$b, useState: useState$5 } = await importShared("react");
...
const ConfirmDialog = ({
  ...
  const handleAnimationEnd = useCallback$h(() => {
    var _a;
...
const { useCallback: useCallback$g, useEffect: useEffect$d, useMemo: useMemo$g, useRef: useRef$a } = await importShared("react");
...
const { useCallback: useCallback$e, useMemo: useMemo$e } = await importShared("react");
...
const { useCallback: useCallback$c, useEffect: useEffect$b, useMemo: useMemo$d } = await importShared("react");
const useEqualSplit = ({
  allocations,
  isEqualSplit,
  setValue,
...
const { useCallback: useCallback$a, useEffect: useEffect$9, useMemo: useMemo$b, useRef: useRef$7 } = await importShared("react");
const { useCallback: useCallback$9, useMemo: useMemo$a } = await importShared("react");
...
const { useEffect: useEffect$4, useMemo: useMemo$8 } = await importShared("react");
...
const { useEffect: useEffect$3, useMemo: useMemo$7 } = await importShared("react");
const MILEAGE_RATES = {
...
const { Fragment, memo: memo$2, useCallback: useCallback$2, useContext, useMemo: useMemo$3, useState: useState$2 } = await importShared("react");
const FormSectionComponent = ({
  ...
  const propsWithDisabled = useMemo$3(
    () => ({
      ...renderProps,
...
const CostAllocationFieldComponent = ({
  ...
  const allocationConfig = useMemo$1(
...
const createExpenseForm = (config2) => {
  const FormComponent = forwardRef(
    (props, ref) => {
      ...
      config2.customHook({ control, setValue, getValues, formState, watch });
      useAutoSave({
        draftId,
        isDrafting,
        onSaveDraft,
      ...
      const formSections = useMemo(() => sortFormSections(config2.sections), [config2.sections]);
      const handlersMap = config2.handlersHook(setValue, getValues);
      const leftColumn = useMemo(
        ...
        [config2.leftColumnRenderer, control, setValue, getValues, isSubmitting, isDrafting, draftId, onSaveDraft]
      );
      const errorDisplay = useMemo(
        ...
        [config2.errorDisplayRenderer, form.validationErrors]
      );
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
...
export {
  totalDistanceFieldOptional as $,
  AllocationTypeChips as A,
  expenseJustificationSchema as B,
  ConfirmDialog as C,
  costAllocationSchema as D,
  ExpenseFormField as E,
  FormSectionType as F,
  additionalCommentsSchema as G,
  MileageTripFormField as H,
  mileageDetailsSchema as I,
  mileageJustificationSchema as J,
  createExpenseForm as K,
  useExpenseFormHandlers as L,
  MAX_SUPPORTING_FILES_FOR_MILEAGE_PERIOD as M,
  fullExpenseValidationStrategy as N,
  useMileageTripFormHandlers as O,
  PAYMENT_METHOD_DATA as P,
  mapMileageTripToDefaultValues as Q,
  ReceiptSection as R,
  SupportingFiles as S,
  mileageTripValidationStrategy as T,
  supportingFilesSchema as U,
  createValidationStrategy as V,
  ...
  ratePerUnitFieldOptional as _,
  additionalCommentsFieldOptional as a,
  expensePeriodFieldOptional as a0,
  mileageTypeFieldOptional as a1,
  createDraftSaveChecker as a2,
  createRequiredFieldsChecker as a3,
  useCostAllocationHandlers as a4,
  resolveFileUrl as a5,
  minimalExpenseValidationStrategy as a6,
  useBaseExpenseForm as a7,
  VENDOR_OPTIONS as a8,
  useFormButtonStateSync as a9,
  useFormImperativeHandle as aa,
  sortFormSections as ab,
  FormSectionProvider as ac,
  FormRenderer as ad,
  affidavitExpenseValidationStrategy as ae,
  businessPurposeField as b,
  rateUnitField as c,
  ratePerUnitField as d,
  expenseDescriptionField as e,
  expensePeriodField as f,
  costAllocationTypeSchema as g,
  CostAllocationValidationRules as h,
  useMileageRateSync as i,
  useReimbursableAmountSync as j,
  useAmountAllocationSync as k,
  useReceiptCheckboxEffects as l,
  mileageTypeField as m,
  EXPENSE_LOCATION_OPTIONS as n,
  CURRENCY_OPTIONS as o,
  useExpenseFormLeftColumn as p,
  useEqualSplit as q,
  reimbursableAmountField as r,
  supportingFilesField as s,
  totalDistanceField as t,
  useFormFieldValues as u,
  COST_ALLOCATION_LABELS as v,
  useCostAllocation as w,
  CostAllocationField as x,
  AddAllocationExpandable as y,
  expenseDetailsSchema as z
};
