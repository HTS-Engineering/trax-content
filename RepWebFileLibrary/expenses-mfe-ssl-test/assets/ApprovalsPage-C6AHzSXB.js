...
import { a as useCompanyStore, d as useQuery, q as queryKeys, k as keepPreviousData, E as EXPENSE_ENDPOINTS, i as isExpenseItemSubmitted, e as isRegularExpense, g as getExpenseItemAmount, f as useQueryClient, h as useMutation, j as isMileageExpense, l as useExpenseItem } from "./expense-api-JnNuSWBC.js";
import { a as apiClient } from "./axiosInstance-Bd_gl01G.js";
import { f as formatAmountWithCurrency, a as formatDateRange, b as formatDate } from "./formatters-C18G5OvS.js";
import { f as formatExpenseDate, E as ExpenseFormHistoryLog } from "./ExpenseFormHistoryLog-mYXKU9n5.js";
...
import { a as useScrollIntoViewRef, b as useErrorToast } from "./use-scroll-into-view-ref-D3XM8xPn.js";
import { I as Icon } from "./Icon-BRsOXDbZ.js";
import { m as mapCostAllocation, g as getExpenseBaseAmount, u as useCostAllocationHandlers, C as CostAllocationHeaderActions, a as CostAllocationSection, v as validateCostAllocation, c as costAllocationItemSchema, E as ExpensePreview, i as isMileageTripData, M as MileageTripPreview, b as isMileagePeriodData, d as MileagePeriodPreview } from "./CostAllocationSection-w3dm9zKR.js";
import { d as devError } from "./index-BFfbLHEc.js";
import { u as useRoles } from "./hooks-vKKxn728.js";
import "./hooks-D7M4Hbj-.js";
...
const ApproverExpenseDetail = ({ expenseId, item, onClose }) => {
  ...
  useEffect(() => {
    if (!isEmployee) {
      ...
      qs.error("Insufficient permissions to view expense details.");
      onClose();
    }
  }, [isEmployee, onClose]);
  ...
  useEffect(() => {
    if (expenseItem && expenseItem.status === "draft") {
      qs.error("This expense is not available in the approval flow.");
      onClose();
    }
  }, [expenseItem, onClose]);
