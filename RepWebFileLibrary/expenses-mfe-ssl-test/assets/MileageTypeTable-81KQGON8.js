...
import { _ as QueryObserver, $ as useBaseQuery, f as useQueryClient, c as useExpenseTypes, a0 as ExpenseTypeScope, q as queryKeys, F as FormTypeId, t as ExpenseFormType, a1 as useCreateExpenseType, a2 as useUpdateExpenseType, a3 as useToggleExpenseTypeStatus, a4 as useFormTypeOptions, a as useCompanyStore, a5 as MileageRateStatus, d as useQuery, h as useMutation, a6 as DEFAULT_CURRENCY_SYMBOL, p as useTaxTypesDisplay } from "./expense-api-BnJCYQGc.js";
import { V as Va, a as $a, t as Ys, v as p, b as $r, $ as $e, E as En, R as Rr, N as Nr, _ as _r, F as Fr, U as Us, a0 as CONFIGURATION_ENDPOINTS, G as Ga, M as Mn, P as Pn, d as Vn, W as Ws, e as qa, a1 as Zs, Y as Ya, f as Wa, B as Bs, X as Xn, u as us, a2 as Xa, a3 as Es } from "./configuration-Bjg01YDW.js";
import { E as EmptyState } from "./EmptyState-DgYKpsAS.js";
import { I as Icon } from "./Icon-vRMTtv5F.js";
import { o as object, _ as _enum, s as string, l as literal, u as useForm, a, C as Controller, e as createDecimalChangeHandler, n as number, g as date, f as useWatch, j as filterDecimalInput } from "./schemas-CxGcuJwB.js";
import { d as devError, a as devLog } from "./index-BFfbLHEc.js";
import { r as useEscapeHandler } from "./use-scroll-into-view-ref-BCIQUNB8.js";
import { a as useCreateBusinessPurpose, b as useUpdateBusinessPurpose, c as useToggleBusinessPurposeStatus, u as useBusinessPurposes } from "./business-purpose-api-BiHTMD-3.js";
import { a as apiClient } from "./axiosInstance-JUJGFny-.js";
import { g as formatRateCompact, P as Plus } from "./formatters-R0Ve-k96.js";
import { i as infiniteQueryBehavior, h as hasPreviousPage, a as hasNextPage } from "./infiniteQueryBehavior-UkSoYkUu.js";
import { I as Info } from "./info-DPbh_umM.js";
...
const useMileageTypeOperations = (companyId, onSuccess) => {
  ...
  const handleCreateMileageType = useCallback$2(async (data) => {
    ...
    try {
      ...
      Bs.error("Failed to create mileage type. Please try again", { duration: 3e3 });
      throw error;
    }
  }, [companyId, createExpenseTypeMutation, onSuccess]);
  const handleUpdateMileageType = useCallback$2(async (id, data, originalData) => {
    ...
    try {
      ...
      Bs.error("Failed to update mileage type. Please try again", { duration: 3e3 });
      throw error;
    }
  }, [companyId, updateExpenseTypeMutation, onSuccess]);
  const toggleActiveMileageType = useCallback$2(async (id, currentStatus) => {
    ...
    try {
      ...
      Bs.error("Failed to update status. Please try again", { duration: 3e3 });
      throw error;
    }
  }, [companyId, toggleExpenseTypeMutation, onSuccess]);
  return {
...
const SetAsDefaultDialog = ({
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      onOpenChange(false);
      Bs.success(MILEAGE_TYPE_MESSAGES.SET_AS_DEFAULT_SUCCESS, { duration: 3e3 });
    } catch (error) {
      devError("Failed to set as default:", error);
      Bs.error(MILEAGE_TYPE_MESSAGES.SET_AS_DEFAULT_FAILURE, { duration: 3e3 });
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ws, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    qa,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Wa, { className: "text-base font-semibold text-exp-neutral-900", children: MILEAGE_TYPE_MESSAGES.SET_AS_DEFAULT_TITLE }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Xa, { className: "text-sm font-normal text-exp-grey-600", children: `Set "${expenseTypeName}" ${MILEAGE_TYPE_MESSAGES.SET_AS_DEFAULT_MESSAGE}` })
        ] }),
