...
import { e as Pr, g as Us, _ as _a, h as Kn, G as Ga, j as js, F as Fa, i as Ia, I as In } from "./index.es-fHErn31W.js";
import { u as useCompanyStore, l as useQuery, q as queryKeys, v as keepPreviousData } from "./factory-D3SqUmAa.js";
import { a as apiClient } from "./axiosInstance-DEJx0M-h.js";
import { E as EXPENSE_ENDPOINTS } from "./expenses-BLPZFCX-.js";
import { E as EmptyState } from "./EmptyState-0igdkMlj.js";
...
const useExpensesColumns = ({
  ...
  const staticColumns = useMemo$2(() => [
    {
      ...
      filterFn: "equals",
      size: 80,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(_a, { column, title: "ID" }),
    ...
    },
    {
      ...
      enableSorting: true,
      size: 150,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(_a, { column, title: "Expense Date" }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Us,
        {
          context,
    ...
    },
    {
      ...
      minSize: 100,
      maxSize: 250,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(_a, { column, title: "Vendor" }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Us,
        {
          context,
    ...
    },
    {
      ...
      minSize: 120,
      maxSize: 300,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(_a, { column, title: "Expense Type" }),
      cell: (context) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            context,
            viewContent: /* @__PURE__ */ jsxRuntimeExports.jsx(Pr, { variant: "outline", className: `${badgeConfig.bgColor} ${badgeConfig.textColor}`, children: badgeConfig.label })
          }
        );
      }
    },
    {
      ...
      enableSorting: false,
      size: 140,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(_a, { column, title: "Total Amount" }) }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Us,
        {
          context,
    ...
    },
    {
      ...
      enableSorting: false,
      size: 160,
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(_a, { column, title: "Payment Method" }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Us,
        {
          context,
  ...
  const statusColumn = useMemo$2(() => ({
    ...
    header: ({ column }) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(_a, { column, title: "Status" });
    },
    cell: (context) => {
      if (currentStatusFilter !== "all") return null;
  ...
  const statusDateColumn = useMemo$2(() => {
    ...
    return {
      ...
      header: ({ column }) => /* @__PURE__ */ jsxRuntimeExports.jsx(_a, { column, title: getStatusColumnHeader(currentStatusFilter) }),
      cell: (context) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Us,
        {
          context,
...
const ExpensesList = () => {
  ...
  const queryParams = useMemo(() => {
    ...
    return {
      ...
      sortBy: mapSortFieldToApi(((_a2 = sorting[0]) == null ? void 0 : _a2.id) ?? "expenseDate"),
  ...
  const renderToolbar = (table) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Fa, { table, children: [
  ...
  const customLoadingState = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(In, { className: "size-8 text-exp-primary-blue-600" }),
